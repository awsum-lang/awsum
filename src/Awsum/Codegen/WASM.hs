  ...
  let (pool, _emptyOff, heapStart) = buildStringPool prog
   ...
   in T.intercalate
        ...
        [ header,
          ...
          T.intercalate "\n\n" [renderWat (funcIdxMap wasmInfo) f | f <- wiGatedHelpers wasmInfo],
          T.intercalate "\n\n" [renderWat (funcIdxMap wasmInfo) (userDeclFunc wasmInfo typeMap d) | d <- decls],
          "",
          renderWat (funcIdxMap wasmInfo) startFunc,
          ")"
        ]
