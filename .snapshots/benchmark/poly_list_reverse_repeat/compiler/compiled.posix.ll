...
define internal ptr @v_revInto(ptr %v_acc, ptr %v_lst) {
entry:
  %t3 = alloca ptr
  store ptr %v_acc, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.14.12:
  ...
  %t14 = load ptr, ptr %t13
  %t15 = getelementptr ptr, ptr %t6, i32 2
  %t16 = load ptr, ptr %t15
...
reuse.in_place.25:
  ...
  %t18 = load ptr, ptr %t17
  call void @__free_recursive(ptr %t18)
  %t20 = inttoptr i64 14 to ptr
  %t21 = getelementptr ptr, ptr %t6, i32 0
  store ptr %t20, ptr %t21
  call void @__inc_ref(ptr %t5)
  %t19 = getelementptr ptr, ptr %t6, i32 2
  store ptr %t5, ptr %t19
...
define internal ptr @v_revN(ptr %v_times, ptr %v_lst) {
entry:
  %t3 = alloca ptr
