...
define internal ptr @v_repeatSum(ptr %v_n, ptr %v_t, ptr %v_acc) {
entry:
  %t3 = alloca ptr
  store ptr %v_n, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.4.23:
  ...
  %t27 = inttoptr i64 29 to ptr
  %t28 = getelementptr ptr, ptr %t26, i32 0
  store ptr %t27, ptr %t28
  call void @__inc_ref(ptr %t7)
  %t29 = getelementptr ptr, ptr %t26, i32 1
  store ptr %t7, ptr %t29
  %t30 = call ptr @v_zero()
  %t31 = getelementptr ptr, ptr %t26, i32 2
...
case.arm.4.24:
  ...
  call void @__inc_ref(ptr %t27)
  %t32 = call ptr @v_zero()
  %t33 = call ptr @v_repeatSum(ptr %t31, ptr %t27, ptr %t32)
  ...
  %t43 = getelementptr ptr, ptr %t28, i32 2
...
case.default.8:
  unreachable
case.join.9:
  %t44 = phi ptr [ %t12, %case.end.3.11 ], [ %t28, %case.end.4.25 ]
  call void @__free_recursive(ptr %t4)
  ret ptr %t44
}
