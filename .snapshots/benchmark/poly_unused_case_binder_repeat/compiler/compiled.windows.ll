...
define internal ptr @v_length(ptr %v_xs, ptr %v_acc) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  switch i64 %t9, label %tco.case.default.10 [ i64 13, label %tco.case.arm.13.11 i64 14, label %tco.case.arm.14.12 ]
tco.case.arm.13.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
tco.case.arm.14.12:
  call void @__inc_ref(ptr %t6)
  %t13 = call ptr @__succInt32(ptr %t6)
...
define internal ptr @v_runN(ptr %v_iters, ptr %v_listLen, ptr %v_accSum) {
entry:
  %t3 = alloca ptr
  store ptr %v_iters, ptr %t3
  %t4 = alloca ptr
  store ptr %v_listLen, ptr %t4
  %t5 = alloca ptr
  store ptr %v_accSum, ptr %t5
  %t2 = alloca ptr
  br label %tco.loop.0
tco.loop.0:
  %t6 = load ptr, ptr %t3
  ...
  switch i64 %t13, label %tco.case.default.14 [ i64 1, label %tco.case.arm.1.15 i64 2, label %tco.case.arm.2.16 ]
tco.case.arm.1.15:
...
tco.case.arm.2.16:
  call void @__inc_ref(ptr %t6)
  %t17 = call ptr @__predInt32(ptr %t6)
...
tco.case.arm.4.23:
  ...
  %t29 = call ptr @v_build(ptr %t7, ptr %t26)
  %t30 = call ptr @v_zero()
  %t31 = call ptr @v_length(ptr %t29, ptr %t30)
  %t32 = call ptr @__addInt32(ptr %t8, ptr %t31)
  %t33 = getelementptr ptr, ptr %t32, i32 0
  %t34 = load ptr, ptr %t33
  %t35 = ptrtoint ptr %t34 to i64
  switch i64 %t35, label %tco.case.default.36 [ i64 3, label %tco.case.arm.3.37 i64 4, label %tco.case.arm.4.38 ]
tco.case.arm.3.37:
...
define internal ptr @v_main() {
  ...
  store i32 1000, ptr %t3
  %t4 = call ptr @__alloc(i64 4, i32 0)
  store i32 10000, ptr %t4
  %t5 = call ptr @v_zero()
  %t6 = call ptr @v_runN(ptr %t3, ptr %t4, ptr %t5)
