...
define internal ptr @v_repeatMirror(ptr %v_n, ptr %v_t) {
entry:
  %t3 = alloca ptr
  store ptr %v_n, ptr %t3
  %t4 = alloca ptr
...
case.arm.4.24:
  ...
  store i32 1000, ptr %t31
  call void @__inc_ref(ptr %t27)
  %t32 = call ptr @v_repeatMirror(ptr %t31, ptr %t27)
  %t33 = call ptr @v_zero()
  %t34 = call ptr @v_spineLast(ptr %t32, ptr %t33)
  ...
  store ptr %t40, ptr %t43
  %t44 = getelementptr ptr, ptr %t28, i32 2
...
case.default.8:
  unreachable
case.join.9:
  %t45 = phi ptr [ %t12, %case.end.3.11 ], [ %t28, %case.end.4.25 ]
  call void @__free_recursive(ptr %t4)
  ret ptr %t45
}
...
tco.loop.0:
  ...
  %t6 = load ptr, ptr %t5
  %t7 = ptrtoint ptr %t6 to i64
  switch i64 %t7, label %tco.case.default.8 [ i64 29, label %tco.case.arm.29.9 i64 30, label %tco.case.arm.30.61 ]
tco.case.arm.29.9:
  %t10 = getelementptr ptr, ptr %t4, i32 1
  %t11 = load ptr, ptr %t10
  call void @__inc_ref(ptr %t11)
