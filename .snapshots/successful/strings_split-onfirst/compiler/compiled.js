...
function __splitOnFirst(sep, str){ const i = str.indexOf(sep); if (i < 0) return [9]; return [10, [11, str.substring(0, i), str.substring(i + sep.length)]]; }
