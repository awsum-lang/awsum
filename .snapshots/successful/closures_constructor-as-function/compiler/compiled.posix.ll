...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [7 x i8]} { i32 0, i32 0, i32 0, i32 7, i32 7, [7 x i8] c"wrapped" }
...
define internal ptr @v_main() {
  ...
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__df_wrap_0(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
