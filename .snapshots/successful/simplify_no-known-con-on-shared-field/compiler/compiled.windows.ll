...
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [8 x i8]} { i32 0, i32 0, i32 0, i32 8, i32 8, [8 x i8] c"too long" }
...
define internal ptr @v_main() {
  ...
  store ptr %t7, ptr %t8
  %t9 = getelementptr ptr, ptr %t3, i32 0
  %t10 = load ptr, ptr %t9
  %t11 = ptrtoint ptr %t10 to i64
  switch i64 %t11, label %case.default.12 [ i64 11, label %case.arm.11.14 i64 12, label %case.arm.12.16 ]
case.arm.11.14:
  br label %case.end.11.15
case.end.11.15:
...
case.arm.12.16:
  ...
  call void @__inc_ref(ptr %t19)
  call void @__inc_ref(ptr %t19)
  %t20 = call ptr @__concat(ptr %t19, ptr %t19)
...
case.default.24:
  unreachable
case.join.25:
  %t32 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.3.27 ], [ %t31, %case.end.4.29 ]
  call void @__free_recursive(ptr %t20)
  br label %case.end.12.17
case.end.12.17:
  br label %case.join.13
case.default.12:
  unreachable
case.join.13:
  %t33 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.11.15 ], [ %t32, %case.end.12.17 ]
  ...
  %t42 = getelementptr ptr, ptr %t0, i32 2
