...
(module
  ...
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v_$cps$$scc$walkA__walkB $v_$apply$$scc$walkA__walkB)
  ...
  (func $v_$cps$$scc$walkA__walkB (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v_$apply$$scc$walkA__walkB (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
