...
@.str.2 = private unnamed_addr constant {i32, i32, [14 x i8]} { i32 14, i32 14, [14 x i8] c"UnderflowError" }
...
case.arm.3.5:
  ...
  %t10 = call ptr @__concat(ptr @.str.3, ptr %t9)
...
case.arm.4.11:
  ...
  %t14 = load ptr, ptr %t13
  %t15 = call ptr @v_showBool(ptr %t14)
...
tco.case.arm.9.46:
  ...
  switch i64 %t53, label %tco.case.default.54 [ i64 1, label %tco.case.arm.1.55 i64 2, label %tco.case.arm.2.63 ]
tco.case.arm.1.55:
...
tco.case.arm.2.63:
  ...
  switch i64 %t67, label %tco.case.default.68 [ i64 3, label %tco.case.arm.3.69 i64 4, label %tco.case.arm.4.76 ]
tco.case.arm.3.69:
