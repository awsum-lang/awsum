...
(module
  ...
  (table 7 funcref)
  (elem (i32.const 0) $v_showBool $v_runIO $v_showUnderflowError $v_showResult $v__let_7 $v__scc_evenInt_oddInt $v_evenInt)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    (local $__drop_tmp i32)
    (call $v__let_7 (call $v_showResult (call $v_evenInt (call $__box_i32 (i32.const 1000000))))))
