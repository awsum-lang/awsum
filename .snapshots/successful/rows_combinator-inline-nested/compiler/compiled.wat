...
(module
  ...
  (table 9 funcref)
  (elem (i32.const 0) $v_pureEither $v_runIO $v_describe $v__lam_18 $v__lam_19 $v__lam_20 $v__df__rowmono_0_bindEither_0 $v__df__rowmono_2_bindEither_1 $v__df__rowmono_1_bindEither_2)
  ...
  (func $v__df__rowmono_2_bindEither_1 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v__df__rowmono_1_bindEither_2 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
