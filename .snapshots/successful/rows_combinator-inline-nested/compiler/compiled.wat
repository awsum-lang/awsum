...
(module
  ...
  (table 9 funcref)
  (elem (i32.const 0) $v_pureEither $v_runIO $v_describe $v__lam_13 $v__lam_14 $v__lam_15 $v__df__rowmono_0_bindEither_0 $v__df__rowmono_2_bindEither_1 $v__df__rowmono_1_bindEither_2)
