...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 7, label %tco.case.arm.7.20 ]
tco.case.arm.5.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
...
tco.case.arm.7.20:
  ...
  %t25 = getelementptr i8, ptr %t5, i64 -8
  %t26 = load i32, ptr %t25
  %t27 = icmp eq i32 %t26, 1
  br i1 %t27, label %reuse.in_place.28, label %reuse.copy.29
reuse.in_place.28:
...
reuse.copy.29:
  ...
  %t41 = getelementptr ptr, ptr %t37, i32 2
  store ptr %t22, ptr %t41
  call void @__free_recursive(ptr %t5)
  br label %reuse.join.30
reuse.join.30:
  %t42 = phi ptr [ %t5, %reuse.in_place.28 ], [ %t37, %reuse.copy.29 ]
  call void @__inc_ref(ptr %t24)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t24)
