...
const main = (v__df_bindIO_0)((v__df_mapIO_2)(v_source));

function v__lift_1(v___input){
    return (v__cps__lift_1)(v___input, [16]);
}
...
function v__df_mapIO_2(v_io){
    return (v__cps__df_mapIO_2)(v_io, [20]);
}

function v__cps__df_mapIO_2(v_io, v__k){
  while (true) {
    {
      const __s = v_io;
      switch (__s[0]) {
        case 5: {
          const v_a = __s[1];
          return (v__apply__df_mapIO_2)(v__k, [5, (v__lam_7)(v_a)]);
        }
        case 6: {
          const v_e = __s[1];
          return (v__apply__df_mapIO_2)(v__k, [6, v_e]);
        }
        case 7: {
          const v_s = __s[1];
          const v_next = __s[2];
          const __t0 = v_next;
          const __t1 = (v_io[0] = 21, v_io[1] = v__k, v_io[2] = v_s, v_io);
          v__k = null;
          v_io = __t0;
          v__k = __t1;
          continue;
        ...
        case 8: {
          const v_cont = __s[1];
          return (v__apply__df_mapIO_2)(v__k, [8, [9, v_cont]]);
        }
      }
    }
  }
...
function v__apply__df_mapIO_2(v__k, v__x){
  while (true) {
    {
      const __s = v__k;
      switch (__s[0]) {
...
function v__scc__apply1__df__lam_4_3__df_bindIOAfterArgs_1__lift_2(v__args){
    return (v__cps__scc__apply1__df__lam_4_3__df_bindIOAfterArgs_1__lift_2)(v__args, [22]);
}

function v__cps__scc__apply1__df__lam_4_3__df_bindIOAfterArgs_1__lift_2(v__args, v__k){
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
          ...
          const v__arg0 = __s[2];
          {
            ...
            switch (__s[0]) {
              case 9: {
                ...
                const __t0 = (v__args[0] = 13, v__args[1] = v__cap9_0, v__args[2] = v__arg0, v__args);
                const __t1 = v__k;
                v__k = null;
                v__args = __t0;
                v__k = __t1;
        ...
        case 13: {
          ...
          const __t0 = (v__args[0] = 12, v__args[1] = v_cont, v__args[2] = v_result, v__args);
          const __t1 = [23, v__k];
          v__k = null;
          v__args = __t0;
          v__k = __t1;
        ...
        case 15: {
          const v___f = __s[1];
          const v___arg = __s[2];
          const __t0 = (v__args[0] = 12, v__args[1] = v___f, v__args[2] = v___arg, v__args);
          const __t1 = [25, v__k];
          v__k = null;
          v__args = __t0;
          v__k = __t1;
...
function v__apply1(v__cl, v__arg0){
    return (v__scc__apply1__df__lam_4_3__df_bindIOAfterArgs_1__lift_2)([12, v__cl, v__arg0]);
}
