...
const v__cps__scc__apply1__df__lam_6_4__df__lam_7_5__df_bindIOAfterArgs_1__df_bindIOAfterStdin_2__lift_2__lift_3 = (v__args, v__k) => {
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
...
const v__scc__apply1__df__lam_6_4__df__lam_7_5__df_bindIOAfterArgs_1__df_bindIOAfterStdin_2__lift_2__lift_3 = (v__args) => {
...
const v__apply__df_mapIO_3 = (v__k, v__x) => {
  while (true) {
    {
      const __s = v__k;
      switch (__s[0]) {
...
const v__cps__df_mapIO_3 = (v_io, v__k) => {
  while (true) {
    {
      const __s = v_io;
      switch (__s[0]) {
