...
(() => {
  ...
  const v__lam_13 = (v__s) => {
    return "after";
  };

  const v__cps__scc__apply1__df__lam_3_5__df__lam_4_6__df__lam_5_7__df_bindIOAfterArgs_1__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinString_2 = (
    v__args,
    v__k
  ) => {
    while (true) {
  ...
  const v__scc__apply1__df__lam_3_5__df__lam_4_6__df__lam_5_7__df_bindIOAfterArgs_1__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinString_2 = (
    v__args
  ) => {
    return v__cps__scc__apply1__df__lam_3_5__df__lam_4_6__df__lam_5_7__df_bindIOAfterArgs_1__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinString_2(
      v__args,
      [28]
    );
  };
  ...
  const v__apply1 = (v__cl, v__arg0) => {
    return v__scc__apply1__df__lam_3_5__df__lam_4_6__df__lam_5_7__df_bindIOAfterArgs_1__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinString_2(
      [17, v__cl, v__arg0]
    );
  };
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df_mapIO_4(v__k, [5, v__lam_13(v_a)]);
          }
          case 6: {
            const v_e = __s[1];
          ...
          case 8: {
            const v_cont = __s[1];
            return v__apply__df_mapIO_4(v__k, [8, [11, v_cont]]);
          }
          case 9: {
            const v_cont = __s[1];
            return v__apply__df_mapIO_4(v__k, [9, [12, v_cont]]);
          }
          case 10: {
            const v_cont = __s[1];
            return v__apply__df_mapIO_4(v__k, [10, [13, v_cont]]);
          }
        }
      }
    }
  ...
  const v__df_mapIO_4 = (v_io) => {
    return v__cps__df_mapIO_4(v_io, [26]);
  };
