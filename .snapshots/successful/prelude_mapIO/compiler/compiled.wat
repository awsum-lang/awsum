...
(module
  ...
  (table 5 funcref)
  (elem (i32.const 0) $v_runIO $v_$cps$$df$bindIO$0 $v_$apply$$df$bindIO$0 $v_$cps$$df$mapIO$4 $v_$apply$$df$mapIO$4)
  ...
  (func $v_$cps$$df$mapIO$4 (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v_$apply$$df$mapIO$4 (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
