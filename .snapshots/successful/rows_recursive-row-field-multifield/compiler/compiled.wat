...
(module
  ...
  (table 2 funcref)
  (elem (i32.const 0) $v_runIO $v_$scc$$apply$$scc$sumSide__sumT__$cps$$scc$sumSide__sumT)
  ...
  (func $v_$scc$$apply$$scc$sumSide__sumT__$cps$$scc$sumSide__sumT (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
