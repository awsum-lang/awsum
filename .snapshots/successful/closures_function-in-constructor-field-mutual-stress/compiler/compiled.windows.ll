...
tco.loop.0:
  ...
  %t6 = load ptr, ptr %t5
  %t7 = ptrtoint ptr %t6 to i64
  switch i64 %t7, label %tco.case.default.8 [ i64 22, label %tco.case.arm.22.9 i64 23, label %tco.case.arm.23.23 i64 24, label %tco.case.arm.24.39 i64 25, label %tco.case.arm.25.83 ]
tco.case.arm.22.9:
  %t10 = getelementptr ptr, ptr %t4, i32 1
  %t11 = load ptr, ptr %t10
  call void @__inc_ref(ptr %t11)
  ...
  switch i64 %t16, label %tco.case.default.17 [ i64 21, label %tco.case.arm.21.18 ]
tco.case.arm.21.18:
...
tco.case.arm.4.67:
  ...
  switch i64 %t73, label %tco.case.default.74 [ i64 20, label %tco.case.arm.20.75 ]
tco.case.arm.20.75:
