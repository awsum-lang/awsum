...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_bBox (result i32)
    ...
    (local $__con_1 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 20)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 21)) (local.get $__con_1))) (local.get $__con_0)))
