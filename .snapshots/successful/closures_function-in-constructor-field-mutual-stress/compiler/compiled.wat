...
(module
  ...
  (table 6 funcref)
  (elem (i32.const 0) $v_runIO $v_$cps$$df$handleErrorIO$0 $v_$apply$$df$handleErrorIO$0 $v_$cps$$df$andThenIO$4 $v_$apply$$df$andThenIO$4 $v_$scc$$apply1__$lam$13__a__b)
  ...
  (func $v_$scc$$apply1__$lam$13__a__b (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
