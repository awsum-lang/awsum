...
(module
  ...
  (table 6 funcref)
  (elem (i32.const 0) $v_runIO $v__cps__df_handleErrorIO_0 $v__apply__df_handleErrorIO_0 $v__cps__df_andThenIO_4 $v__apply__df_andThenIO_4 $v__scc__apply1__lam_13_a_b)
  ...
  (func $v__scc__apply1__lam_13_a_b (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
