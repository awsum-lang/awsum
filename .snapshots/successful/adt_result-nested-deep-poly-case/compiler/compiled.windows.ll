...
define internal ptr @v_unwrap(ptr %v_r) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 24, label %case.arm.24.4 i64 25, label %case.arm.25.37 ]
case.arm.24.4:
...
case.arm.24.11:
  ...
  switch i64 %t16, label %case.default.17 [ i64 24, label %case.arm.24.18 i64 25, label %case.arm.25.21 ]
case.arm.24.18:
...
case.arm.25.24:
  ...
  switch i64 %t29, label %case.default.30 [ i64 24, label %case.arm.24.31 i64 25, label %case.arm.25.34 ]
case.arm.24.31:
...
case.arm.25.37:
  ...
  switch i64 %t42, label %case.default.43 [ i64 24, label %case.arm.24.44 i64 25, label %case.arm.25.57 ]
case.arm.24.44:
  ...
  switch i64 %t49, label %case.default.50 [ i64 24, label %case.arm.24.51 i64 25, label %case.arm.25.54 ]
case.arm.24.51:
...
case.arm.25.57:
  ...
  switch i64 %t62, label %case.default.63 [ i64 24, label %case.arm.24.64 i64 25, label %case.arm.25.67 ]
case.arm.24.64:
...
case.join.18:
  ...
  call void @__free_recursive(ptr %t13)
  %t352 = call ptr @v__let_23(ptr %t351)
  ret ptr %t352
}
