...
case.arm.1.205:
  ...
  switch i64 %t212, label %case.default.213 [ i64 0, label %case.arm.0.215 i64 1, label %case.arm.1.223 ]
case.arm.0.215:
...
case.arm.1.254:
  ...
  switch i64 %t261, label %case.default.262 [ i64 0, label %case.arm.0.264 i64 1, label %case.arm.1.272 ]
case.arm.0.264:
...
case.arm.1.272:
  ...
  switch i64 %t292, label %case.default.293 [ i64 0, label %case.arm.0.295 i64 1, label %case.arm.1.303 ]
case.arm.0.295:
...
case.arm.1.303:
  ...
  switch i64 %t310, label %case.default.311 [ i64 0, label %case.arm.0.313 i64 1, label %case.arm.1.321 ]
case.arm.0.313:
...
case.default.311:
  unreachable
case.join.312:
  %t339 = phi ptr [%t317, %case.end.0.314], [%t338, %case.end.1.322]
  br label %case.end.1.304
case.end.1.304:
  br label %case.join.294
case.default.293:
  unreachable
case.join.294:
  %t340 = phi ptr [%t299, %case.end.0.296], [%t339, %case.end.1.304]
  br label %case.end.1.273
case.end.1.273:
  br label %case.join.263
case.default.262:
  unreachable
case.join.263:
  %t341 = phi ptr [%t268, %case.end.0.265], [%t340, %case.end.1.273]
...
case.default.244:
  unreachable
case.join.245:
  %t342 = phi ptr [%t250, %case.end.0.247], [%t341, %case.end.1.255]
  br label %case.end.1.224
case.end.1.224:
  br label %case.join.214
case.default.213:
  unreachable
case.join.214:
  %t343 = phi ptr [%t219, %case.end.0.216], [%t342, %case.end.1.224]
...
case.default.195:
  unreachable
case.join.196:
  %t344 = phi ptr [%t201, %case.end.0.198], [%t343, %case.end.1.206]
...
case.default.164:
  unreachable
case.join.165:
  %t345 = phi ptr [%t170, %case.end.0.167], [%t344, %case.end.1.175]
...
case.default.146:
  unreachable
case.join.147:
  %t346 = phi ptr [%t152, %case.end.0.149], [%t345, %case.end.1.157]
...
case.default.115:
  unreachable
case.join.116:
  %t347 = phi ptr [%t121, %case.end.0.118], [%t346, %case.end.1.126]
...
case.default.97:
  unreachable
case.join.98:
  %t348 = phi ptr [%t103, %case.end.0.100], [%t347, %case.end.1.108]
...
case.default.66:
  unreachable
case.join.67:
  %t349 = phi ptr [%t72, %case.end.0.69], [%t348, %case.end.1.77]
...
case.default.48:
  unreachable
case.join.49:
  %t350 = phi ptr [%t54, %case.end.0.51], [%t349, %case.end.1.59]
  br label %case.end.1.28
case.end.1.28:
  br label %case.join.18
case.default.17:
  unreachable
case.join.18:
  %t351 = phi ptr [%t23, %case.end.0.20], [%t350, %case.end.1.28]
  %t352 = call ptr @v__let_2(ptr %t351)
  ret ptr %t352
}
