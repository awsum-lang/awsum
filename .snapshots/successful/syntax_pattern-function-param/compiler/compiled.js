...
function v__lam_13(v__arg_28_19){
    {
...
function v__let_14(v_n, v_m){
    return (v__let_12)(((s) => { switch(s[0]) { case 3: { const v__do_e_30_9 = s[1]; return [3, v__do_e_30_9]; } case 4: { const v_s0 = s[1]; return __concat(v_s0, String(v_m)); } } })(__concat(String(v_n), " / ")));
}
