...
define internal ptr @v__lam_3(ptr %v__arg_28_19) {
...
define internal ptr @v__let_4(ptr %v_n, ptr %v_m) {
...
define internal ptr @v__let_5(ptr %v_n) {
  %t0 = call ptr @v_pair()
  %t1 = call ptr @v__df_apply_0(ptr %t0)
  %t2 = call ptr @v__let_4(ptr %v_n, ptr %t1)
  ret ptr %t2
}

define internal ptr @v__df_apply_0(ptr %v_t) {
  %t0 = call ptr @v__lam_3(ptr %v_t)
  ret ptr %t0
}
