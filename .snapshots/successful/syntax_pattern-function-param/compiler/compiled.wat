...
(module
  ...
  (table 9 funcref)
  (elem (i32.const 0) $v_runIO $v_sumTriple $v_sumPair $v_main $v__let_2 $v__lam_3 $v__let_4 $v__let_5 $v__df_apply_0)
  ...
  (func $v_main (param $v__input i32) (result i32)
    (call $v__let_5 (call $v_sumTriple (call $v_triple))))
  ...
  (func $v__lam_3 (param $v__arg_28_19 i32) (result i32)
    (local $__con_0 i32)
    (local $v_a i32)
    (local $v_b i32)
    (local $__scrut i32)
  ...
  (func $v__let_4 (param $v_n i32) (param $v_m i32) (result i32)
    (local $__con_0 i32)
  ...
  (func $v__let_5 (param $v_n i32) (result i32)
    (call $v__let_4 (local.get $v_n) (call $v__df_apply_0 (call $v_pair))))

  (func $v__df_apply_0 (param $v_t i32) (result i32)
    (call $v__lam_3 (local.get $v_t)))
