...
(module
  ...
  (data (i32.const 95) "\03\00\00\00\03\00\00\00 / ")
  (table 8 funcref)
  ...
  (func $v_sumTriple (param $v__arg_5_11 i32) (result i32)
    ...
    (local $v_c i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v__arg_5_11)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (local.set $v_c (i32.load offset=12 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__addInt32 (local.get $v_a) (local.get $v_b))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__box_i32 (i32.const 0))) (else (local.set $v_ab (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__addInt32 (local.get $v_ab) (local.get $v_c))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__box_i32 (i32.const 0))) (else (local.set $v_abc (i32.load offset=4 (local.get $__scrut))) (local.get $v_abc)))))))))
  ...
  (func $v_sumPair (param $v__arg_15_9 i32) (result i32)
    ...
    (local $v_s i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v__arg_15_9)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__addInt32 (local.get $v_a) (local.get $v_b))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__box_i32 (i32.const 0))) (else (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (local.get $v_s))))))

  (func $v_triple (result i32)
    (local $__con_0 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 16))) (i32.const 12)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 10))) (i32.store offset=8 (local.get $__con_0) (call $__box_i32 (i32.const 20))) (i32.store offset=12 (local.get $__con_0) (call $__box_i32 (i32.const 30))) (local.get $__con_0)))

  (func $v_pair (result i32)
    (local $__con_0 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 11)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 100))) (i32.store offset=8 (local.get $__con_0) (call $__box_i32 (i32.const 200))) (local.get $__con_0)))
  ...
  (func $v__lam_8 (param $v__arg_28_19 i32) (result i32)
    ...
    (local $v_b i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v__arg_28_19)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (call $v_sumPair (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 11)) (i32.store offset=4 (local.get $__con_0) (local.get $v_a)) (i32.store offset=8 (local.get $__con_0) (local.get $v_b)) (local.get $__con_0)))))
  ...
  (func $v__let_9 (param $v_n i32) (param $v_m i32) (result i32)
    ...
    (local $v_s0 i32)
    (local $__scrut i32)
    (call $v__let_7 (block (result i32) (local.set $__scrut (call $__concat (call $__show_i32 (local.get $v_n)) (i32.const 95))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_30_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_30_9)) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__concat (local.get $v_s0) (call $__show_i32 (local.get $v_m))))))))

  (func $v__let_10 (param $v_n i32) (result i32)
    (call $v__let_9 (local.get $v_n) (call $v__df_apply_0 (call $v_pair))))

  (func $v__df_apply_0 (param $v_t i32) (result i32)
    (call $v__lam_8 (local.get $v_t)))
