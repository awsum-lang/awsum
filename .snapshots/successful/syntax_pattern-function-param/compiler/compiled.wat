...
(module
  ...
  (global $heap (mut i32) (i32.const 142))
  ...
  (table 8 funcref)
  (elem (i32.const 0) $v_runIO $v_sumTriple $v_sumPair $v__let_12 $v__lam_13 $v__let_14 $v__let_15 $v__df_apply_0)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_sumTriple (param $v__arg_6_11 i32) (result i32)
    (local $v___w0 i32)
    (local $v_a i32)
    (local $v_ab i32)
    (local $v_abc i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v__arg_6_11)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (local.set $v_c (i32.load offset=12 (local.get $__scrut))) (call $__inc_ref (local.get $v_c)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (call $__addInt32 (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_b)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___w0)) (block (result i32) (local.set $__drop_tmp (call $__box_i32 (i32.const 0))) (call $__free_recursive (local.get $v___w0)) (local.get $__drop_tmp))) (else (local.set $v_ab (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_ab)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (call $__addInt32 (block (result i32) (local.set $__inc_tmp (local.get $v_ab)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_c)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___w0)) (block (result i32) (local.set $__drop_tmp (call $__box_i32 (i32.const 0))) (call $__free_recursive (local.get $v___w0)) (local.get $__drop_tmp))) (else (local.set $v_abc (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_abc)) (block (result i32) (local.set $__drop_tmp (local.get $v_abc)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_abc)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_ab)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_c)) (local.get $__drop_tmp))) (call $__free_recursive (local.get $v_b)) (local.get $__drop_tmp))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))

  (func $v_sumPair (param $v__arg_16_9 i32) (result i32)
    (local $v___w0 i32)
    (local $v_a i32)
    (local $v_b i32)
    (local $v_s i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v__arg_16_9)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (call $__addInt32 (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_b)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___w0)) (block (result i32) (local.set $__drop_tmp (call $__box_i32 (i32.const 0))) (call $__free_recursive (local.get $v___w0)) (local.get $__drop_tmp))) (else (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s)) (block (result i32) (local.set $__drop_tmp (local.get $v_s)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_s)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_b)) (local.get $__drop_tmp))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))

  (func $v_triple (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 16) (i32.const 3))) (i32.const 13)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 10))) (i32.store offset=8 (local.get $__con_0) (call $__box_i32 (i32.const 20))) (i32.store offset=12 (local.get $__con_0) (call $__box_i32 (i32.const 30))) (local.get $__con_0)))

  (func $v_pair (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 12)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 100))) (i32.store offset=8 (local.get $__con_0) (call $__box_i32 (i32.const 200))) (local.get $__con_0)))

  (func $v_main (result i32)
    (local $__drop_tmp i32)
    (call $v__let_15 (call $v_sumTriple (call $v_triple))))
  ...
  (func $v__lam_13 (param $v__arg_29_19 i32) (result i32)
    (local $__con_0 i32)
    (local $v_a i32)
    (local $v_b i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v__arg_29_19)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__drop_tmp (call $v_sumPair (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 12)) (i32.store offset=4 (local.get $__con_0) (local.get $v_a)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (i32.store offset=8 (local.get $__con_0) (local.get $v_b)) (call $__inc_ref (i32.load offset=8 (local.get $__con_0))) (local.get $__con_0)))) (call $__free_recursive (local.get $v_b)) (local.get $__drop_tmp))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))

  (func $v__let_14 (param $v_n i32) (param $v_m i32) (result i32)
    (local $__con_0 i32)
    (local $v__do_e_31_9 i32)
    (local $v_s0 i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (block (result i32) (local.set $__scrut (call $__concat (call $__show_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))) (i32.const 131))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_31_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_31_9)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_31_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_31_9)) (local.get $__drop_tmp))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (block (result i32) (local.set $__drop_tmp (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $__show_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_m)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))) (call $__free_recursive (local.get $v_s0)) (local.get $__drop_tmp)))))))

  (func $v__let_15 (param $v_n i32) (result i32)
    (local $__drop_tmp i32)
    (call $v__let_14 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v__df_apply_0 (call $v_pair))))

  (func $v__df_apply_0 (param $v_t i32) (result i32)
    (local $__drop_tmp i32)
    (call $v__lam_13 (block (result i32) (local.set $__inc_tmp (local.get $v_t)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))
