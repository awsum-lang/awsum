...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_triple (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 16) (i32.const 3))) (i32.const 15)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 10))) (i32.store offset=8 (local.get $__con_0) (call $__box_i32 (i32.const 20))) (i32.store offset=12 (local.get $__con_0) (call $__box_i32 (i32.const 30))) (local.get $__con_0)))

  (func $v_pair (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 14)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 100))) (i32.store offset=8 (local.get $__con_0) (call $__box_i32 (i32.const 200))) (local.get $__con_0)))
  ...
  (func $v__lam_13 (param $v__arg_2 i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v__arg_2)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__drop_tmp (call $v_sumPair (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 14)) (i32.store offset=4 (local.get $__con_0) (local.get $v_a)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (i32.store offset=8 (local.get $__con_0) (local.get $v_b)) (call $__inc_ref (i32.load offset=8 (local.get $__con_0))) (local.get $__con_0)))) (call $__free_recursive (local.get $v_b)) (local.get $__drop_tmp))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))
