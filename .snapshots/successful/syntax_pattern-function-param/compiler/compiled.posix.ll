...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [3 x i8]} { i32 0, i32 0, i32 0, i32 3, i32 3, [3 x i8] c" / " }
...
define internal ptr @v_res() {
  ...
  %t1 = getelementptr ptr, ptr %t0, i32 1
  %t2 = load ptr, ptr %t1
  call void @__inc_ref(ptr %t2)
  %t3 = getelementptr ptr, ptr %t0, i32 2
  %t4 = load ptr, ptr %t3
  call void @__inc_ref(ptr %t4)
  %t5 = call ptr @__addInt32(ptr %t2, ptr %t4)
...
case.arm.4.14:
  ...
  call void @__inc_ref(ptr %t17)
  call void @__inc_ref(ptr %t17)
  %t18 = getelementptr ptr, ptr %t0, i32 3
  %t19 = load ptr, ptr %t18
  call void @__inc_ref(ptr %t19)
  %t20 = call ptr @__addInt32(ptr %t17, ptr %t19)
  %t21 = getelementptr ptr, ptr %t20, i32 0
  %t22 = load ptr, ptr %t21
  %t23 = ptrtoint ptr %t22 to i64
  switch i64 %t23, label %case.default.24 [ i64 3, label %case.arm.3.26 i64 4, label %case.arm.4.29 ]
case.arm.3.26:
...
case.arm.4.29:
  %t31 = getelementptr ptr, ptr %t20, i32 1
...
case.default.24:
  unreachable
case.join.25:
  %t33 = phi ptr [ %t28, %case.end.3.27 ], [ %t32, %case.end.4.30 ]
...
case.default.9:
  unreachable
case.join.10:
  %t34 = phi ptr [ %t13, %case.end.3.12 ], [ %t33, %case.end.4.15 ]
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t0)
  %t35 = call ptr @__showInt32(ptr %t34)
  %t36 = call ptr @__concat(ptr %t35, ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
...
case.arm.4.50:
  ...
  call void @__inc_ref(ptr %t53)
  %t54 = call ptr @v_pair()
  %t55 = getelementptr ptr, ptr %t54, i32 1
  %t56 = load ptr, ptr %t55
  call void @__inc_ref(ptr %t56)
  %t57 = getelementptr ptr, ptr %t54, i32 2
  %t58 = load ptr, ptr %t57
  call void @__inc_ref(ptr %t58)
  %t59 = call ptr @__addInt32(ptr %t56, ptr %t58)
  %t60 = getelementptr ptr, ptr %t59, i32 0
  %t61 = load ptr, ptr %t60
  %t62 = ptrtoint ptr %t61 to i64
  switch i64 %t62, label %case.default.63 [ i64 3, label %case.arm.3.65 i64 4, label %case.arm.4.68 ]
case.arm.3.65:
  %t67 = call ptr @__alloc(i64 4, i32 0)
  store i32 0, ptr %t67
...
case.default.63:
  unreachable
case.join.64:
  %t72 = phi ptr [ %t67, %case.end.3.66 ], [ %t71, %case.end.4.69 ]
  call void @__free_recursive(ptr %t59)
  call void @__free_recursive(ptr %t54)
  %t73 = call ptr @__showInt32(ptr %t72)
  %t74 = call ptr @__concat(ptr %t53, ptr %t73)
...
case.default.40:
  unreachable
case.join.41:
  %t75 = phi ptr [ %t46, %case.end.3.43 ], [ %t74, %case.end.4.51 ]
