...
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [7 x i8]} { i32 0, i32 0, i32 0, i32 7, i32 7, [7 x i8] c"Hello, " }
...
tco.case.arm.8.18:
  ...
  %t30 = call ptr @v_$cps$$scc$$apply1__$df$$lam$15$5__$df$$lam$18$9__$df$$lam$9$1(ptr %t20, ptr %t27)
...
define internal ptr @v_main() {
  ...
  store ptr %t8, ptr %t9
  %t10 = call ptr @v_$cps$$df$$rowmono$1$andThenIO$8(ptr %t0, ptr %t7)
  %t11 = call ptr @__alloc(i64 8, i32 0)
  %t12 = inttoptr i64 35 to ptr
  %t13 = getelementptr ptr, ptr %t11, i32 0
  store ptr %t12, ptr %t13
  %t14 = call ptr @v_$cps$$df$$rowmono$0$andThenIO$4(ptr %t10, ptr %t11)
...
tco.case.arm.6.13:
  ...
  switch i64 %t18, label %case.default.19 [ i64 502975519, label %case.arm.502975519.21 i64 589989748, label %case.arm.589989748.35 i64 3864168810, label %case.arm.3864168810.49 ]
...
case.arm.3864168810.49:
  ...
  br label %case.end.3864168810.50
case.end.3864168810.50:
  br label %case.join.20
case.default.19:
  unreachable
case.join.20:
  %t63 = phi ptr [ %t23, %case.end.502975519.22 ], [ %t37, %case.end.589989748.36 ], [ %t51, %case.end.3864168810.50 ]
  call void @__free_recursive(ptr %t15)
...
tco.case.arm.8.54:
  ...
  %t65 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$4(ptr %t6, ptr %t57)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.104 i64 7, label %tco.case.arm.7.106 i64 8, label %tco.case.arm.8.131 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
...
case.arm.14.32:
  ...
  %t36 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.3, i64 12), ptr %t35)
...
case.arm.3.42:
  ...
  %t50 = inttoptr i64 589989748 to ptr
...
case.arm.4.54:
  ...
  call void @__inc_ref(ptr %t57)
  %t58 = call ptr @__concat(ptr %t57, ptr getelementptr inbounds (i8, ptr @.str.4, i64 12))
  %t59 = getelementptr ptr, ptr %t58, i32 0
  %t60 = load ptr, ptr %t59
  %t61 = ptrtoint ptr %t60 to i64
  switch i64 %t61, label %case.default.62 [ i64 3, label %case.arm.3.64 i64 4, label %case.arm.4.76 ]
case.arm.3.64:
  ...
  %t70 = inttoptr i64 589989748 to ptr
  %t71 = getelementptr ptr, ptr %t69, i32 0
  store ptr %t70, ptr %t71
  %t72 = getelementptr ptr, ptr %t58, i32 1
  %t73 = load ptr, ptr %t72
  call void @__inc_ref(ptr %t73)
  %t74 = getelementptr ptr, ptr %t69, i32 1
  store ptr %t73, ptr %t74
  %t75 = getelementptr ptr, ptr %t66, i32 1
  store ptr %t69, ptr %t75
...
case.default.62:
  unreachable
case.join.63:
  %t78 = phi ptr [ %t66, %case.end.3.65 ], [ %t58, %case.end.4.77 ]
...
case.default.40:
  unreachable
case.join.41:
  %t79 = phi ptr [ %t46, %case.end.3.43 ], [ %t78, %case.end.4.55 ]
...
case.default.17:
  unreachable
case.join.18:
  %t80 = phi ptr [ %t21, %case.end.13.20 ], [ %t79, %case.end.14.33 ]
...
case.arm.4.94:
  %t96 = call ptr @__alloc(i64 16, i32 1)
  %t97 = inttoptr i64 5 to ptr
  %t98 = getelementptr ptr, ptr %t96, i32 0
  store ptr %t97, ptr %t98
  %t99 = getelementptr ptr, ptr %t80, i32 1
...
case.default.84:
  unreachable
case.join.85:
  %t102 = phi ptr [ %t88, %case.end.3.87 ], [ %t96, %case.end.4.95 ]
  call void @__free_recursive(ptr %t80)
  call void @__free_recursive(ptr %t13)
  %t103 = call ptr @v_$apply$$df$$rowmono$1$andThenIO$8(ptr %t6, ptr %t102)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.104:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t105 = call ptr @v_$apply$$df$$rowmono$1$andThenIO$8(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.7.106:
  ...
  %t117 = getelementptr i8, ptr %t5, i64 -8
  %t118 = load i32, ptr %t117
  %t119 = icmp eq i32 %t118, 1
  br i1 %t119, label %reuse.in_place.120, label %reuse.copy.121
reuse.in_place.120:
  ...
  call void @__inc_ref(ptr %t6)
  %t113 = getelementptr ptr, ptr %t5, i32 1
  store ptr %t6, ptr %t113
  %t114 = getelementptr ptr, ptr %t5, i32 2
  store ptr %t108, ptr %t114
  br label %reuse.in_place.end.123
reuse.in_place.end.123:
  br label %reuse.join.122
reuse.copy.121:
  %t125 = call ptr @__alloc(i64 24, i32 2)
  %t126 = inttoptr i64 38 to ptr
  ...
  store ptr %t108, ptr %t129
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.124
reuse.copy.end.124:
  br label %reuse.join.122
reuse.join.122:
  %t130 = phi ptr [ %t5, %reuse.in_place.end.123 ], [ %t125, %reuse.copy.end.124 ]
  call void @__free_recursive(ptr %t6)
  store ptr %t110, ptr %t3
  store ptr %t130, ptr %t4
  br label %tco.loop.0
tco.case.arm.8.131:
...
define internal ptr @v_$cps$$scc$$apply1__$df$$lam$15$5__$df$$lam$18$9__$df$$lam$9$1(ptr %v_$args, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
case.join.49:
  ...
  %t67 = call ptr @v_$apply$$scc$$apply1__$df$$lam$15$5__$df$$lam$18$9__$df$$lam$9$1(ptr %t6, ptr %t66)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$scc$$apply1__$df$$lam$15$5__$df$$lam$18$9__$df$$lam$9$1(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.41.19:
  ...
  %t25 = call ptr @v_$cps$$df$$rowmono$1$andThenIO$8(ptr %t6, ptr %t22)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
