...
tco.case.arm.9.59:
  ...
  %t69 = getelementptr ptr, ptr %t62, i32 1
  store ptr %t65, ptr %t69
  %t70 = call ptr @v__apply__df__rowmono_0_andThenIO_4(ptr %t6, ptr %t62)
  call void @__free_recursive(ptr %t61)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t70, ptr %t2
...
tco.case.arm.10.71:
  ...
  %t81 = getelementptr ptr, ptr %t74, i32 1
  store ptr %t77, ptr %t81
  %t82 = call ptr @v__apply__df__rowmono_0_andThenIO_4(ptr %t6, ptr %t74)
  call void @__free_recursive(ptr %t73)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t82, ptr %t2
...
tco.case.arm.9.59:
  ...
  %t69 = getelementptr ptr, ptr %t62, i32 1
  store ptr %t65, ptr %t69
  %t70 = call ptr @v__apply__df__rowmono_1_andThenIO_8(ptr %t6, ptr %t62)
  call void @__free_recursive(ptr %t61)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t70, ptr %t2
...
tco.case.arm.10.71:
  ...
  %t81 = getelementptr ptr, ptr %t74, i32 1
  store ptr %t77, ptr %t81
  %t82 = call ptr @v__apply__df__rowmono_1_andThenIO_8(ptr %t6, ptr %t74)
  call void @__free_recursive(ptr %t73)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t82, ptr %t2
...
define internal ptr @v__scc__apply1__df__lam_10_2__df__lam_11_3__df__lam_15_5__df__lam_16_6__df__lam_17_7__df__lam_18_9__df__lam_19_10__df__lam_20_11__df__lam_9_1(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 51 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_10_2__df__lam_11_3__df__lam_15_5__df__lam_16_6__df__lam_17_7__df__lam_18_9__df__lam_19_10__df__lam_20_11__df__lam_9_1(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_10_2__df__lam_11_3__df__lam_15_5__df__lam_16_6__df__lam_17_7__df__lam_18_9__df__lam_19_10__df__lam_20_11__df__lam_9_1(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 35, label %tco.case.arm.35.11 i64 36, label %tco.case.arm.36.203 i64 37, label %tco.case.arm.37.226 i64 38, label %tco.case.arm.38.249 i64 39, label %tco.case.arm.39.272 i64 40, label %tco.case.arm.40.295 i64 41, label %tco.case.arm.41.318 i64 42, label %tco.case.arm.42.341 i64 43, label %tco.case.arm.43.364 i64 44, label %tco.case.arm.44.387 ]
tco.case.arm.35.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 25, label %tco.case.arm.25.20 i64 26, label %tco.case.arm.26.40 i64 27, label %tco.case.arm.27.60 i64 28, label %tco.case.arm.28.80 i64 29, label %tco.case.arm.29.100 i64 30, label %tco.case.arm.30.120 i64 31, label %tco.case.arm.31.140 i64 32, label %tco.case.arm.32.160 i64 33, label %tco.case.arm.33.180 i64 34, label %tco.case.arm.34.200 ]
tco.case.arm.25.20:
...
tco.case.arm.34.200:
  ...
  %t202 = call ptr @v__apply__scc__apply1__df__lam_10_2__df__lam_11_3__df__lam_15_5__df__lam_16_6__df__lam_17_7__df__lam_18_9__df__lam_19_10__df__lam_20_11__df__lam_9_1(ptr %t6, ptr %t201)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v__apply__scc__apply1__df__lam_10_2__df__lam_11_3__df__lam_15_5__df__lam_16_6__df__lam_17_7__df__lam_18_9__df__lam_19_10__df__lam_20_11__df__lam_9_1(ptr %v__k, ptr %v__x) {
entry:
  %t3 = alloca ptr
  store ptr %v__k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 51, label %tco.case.arm.51.11 i64 52, label %tco.case.arm.52.12 i64 53, label %tco.case.arm.53.16 i64 54, label %tco.case.arm.54.20 i64 55, label %tco.case.arm.55.24 i64 56, label %tco.case.arm.56.28 i64 57, label %tco.case.arm.57.32 i64 58, label %tco.case.arm.58.36 i64 59, label %tco.case.arm.59.40 i64 60, label %tco.case.arm.60.44 ]
tco.case.arm.51.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
...
tco.case.arm.54.20:
  ...
  call void @__inc_ref(ptr %t22)
  call void @__inc_ref(ptr %t6)
  %t23 = call ptr @v__df__rowmono_0_andThenIO_4(ptr %t6)
  call void @__inc_ref(ptr %t22)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t22)
...
tco.case.arm.57.32:
  ...
  call void @__inc_ref(ptr %t6)
  %t35 = call ptr @v__df__rowmono_1_andThenIO_8(ptr %t6)
  call void @__inc_ref(ptr %t34)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
tco.case.arm.60.44:
  ...
  call void @__inc_ref(ptr %t46)
  call void @__inc_ref(ptr %t6)
  %t47 = call ptr @v__df_handleErrorIO_0(ptr %t6)
  call void @__inc_ref(ptr %t46)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t46)
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_10_2__df__lam_11_3__df__lam_15_5__df__lam_16_6__df__lam_17_7__df__lam_18_9__df__lam_19_10__df__lam_20_11__df__lam_9_1(ptr %t0)
