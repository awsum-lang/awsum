...
@.str.1 = private unnamed_addr constant {i32, i32, [24 x i8]} { i32 24, i32 24, [24 x i8] c"UNPAIRED_UTF16_SURROGATE" }
@.str.2 = private unnamed_addr constant {i32, i32, [5 x i8]} { i32 5, i32 5, [5 x i8] c"Hello" }
...
define internal ptr @v_printDecodeError(ptr %v_e) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 502975519, label %case.arm.502975519.5 i64 589989748, label %case.arm.589989748.21 ]
case.arm.502975519.5:
  ...
  br label %case.end.502975519.6
case.end.502975519.6:
...
case.default.3:
  unreachable
case.join.4:
  %t37 = phi ptr [%t9, %case.end.502975519.6], [%t25, %case.end.589989748.22]
  ret ptr %t37
}
...
define internal ptr @v_addGreeting(ptr %v_name) {
  ...
  %t1 = call ptr @__concat(ptr %t0, ptr @.str.3)
...
case.arm.4.15:
  ...
  %t19 = call ptr @__concat(ptr %t18, ptr %v_name)
...
case.arm.4.33:
  ...
  %t37 = call ptr @__concat(ptr %t36, ptr @.str.4)
...
case.default.5:
  unreachable
case.join.6:
  %t39 = phi ptr [%t11, %case.end.3.8], [%t38, %case.end.4.16]
  ret ptr %t39
}
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 13, label %tco.case.arm.13.11 i64 14, label %tco.case.arm.14.47 i64 15, label %tco.case.arm.15.61 i64 16, label %tco.case.arm.16.75 ]
tco.case.arm.13.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 9, label %tco.case.arm.9.20 i64 10, label %tco.case.arm.10.28 i64 11, label %tco.case.arm.11.36 i64 12, label %tco.case.arm.12.39 ]
tco.case.arm.9.20:
