...
(module
  ...
  (table 3 funcref)
  (elem (i32.const 0) $v_showUnderflowError $v_render $v_main)
  ...
  (func $v_render (export "v_render") (param $v_r i32) (result i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (call $__concat (i32.const 80) (call $v_showUnderflowError (i32.load offset=4 (local.get $__scrut))))) (else (call $__concat (i32.const 92) (call $__show_i32 (i32.load offset=4 (local.get $__scrut))))))))

  (func $v_main (export "v_main") (param $v__input i32) (result i32)
    (call $__print (call $__concat (call $__concat (call $__concat (call $__concat (call $v_render (call $__predUInt8 (call $__box_i32 (i32.const 0)))) (i32.const 97)) (call $v_render (call $__predUInt8 (call $__box_i32 (i32.const 1))))) (i32.const 97)) (call $v_render (call $__predUInt8 (call $__box_i32 (i32.const 255)))))))
