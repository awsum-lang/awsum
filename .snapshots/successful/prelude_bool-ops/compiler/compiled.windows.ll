...
define internal ptr @v_not(ptr %v_b) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 1, label %case.arm.1.5 i64 2, label %case.arm.2.10 ]
case.arm.1.5:
...
case.default.3:
  unreachable
case.join.4:
  %t15 = phi ptr [%t7, %case.end.1.6], [%t12, %case.end.2.11]
  ret ptr %t15
}
...
case.default.3:
  unreachable
case.join.4:
  %t12 = phi ptr [%t7, %case.end.1.6], [%v_b, %case.end.2.11]
  ret ptr %t12
}
...
define internal ptr @v_main() {
  ...
  switch i64 %t13, label %case.default.14 [ i64 3, label %case.arm.3.16 i64 4, label %case.arm.4.24 ]
case.arm.3.16:
...
case.default.92:
  unreachable
case.join.93:
  %t115 = phi ptr [%t98, %case.end.3.95], [%t114, %case.end.4.103]
...
case.default.66:
  unreachable
case.join.67:
  %t116 = phi ptr [%t72, %case.end.3.69], [%t115, %case.end.4.77]
...
case.default.40:
  unreachable
case.join.41:
  %t117 = phi ptr [%t46, %case.end.3.43], [%t116, %case.end.4.51]
...
case.default.14:
  unreachable
case.join.15:
  %t118 = phi ptr [%t20, %case.end.3.17], [%t117, %case.end.4.25]
  %t119 = call ptr @v__let_7(ptr %t118)
  ret ptr %t119
}
