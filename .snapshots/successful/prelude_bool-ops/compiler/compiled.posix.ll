...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [5 x i8]} { i32 0, i32 0, i32 0, i32 5, i32 5, [5 x i8] c"False" }
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [4 x i8]} { i32 0, i32 0, i32 0, i32 4, i32 4, [4 x i8] c"True" }
...
define internal ptr @v_res() {
  %v__inl6_scrut.jslot = alloca ptr
  %t0 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
...
case.arm.4.14:
  ...
  %t23 = getelementptr ptr, ptr %t18, i32 0
  %t24 = load ptr, ptr %t23
  %t25 = ptrtoint ptr %t24 to i64
  switch i64 %t25, label %join.case.default.26 [ i64 1, label %join.case.arm.1.27 i64 2, label %join.case.arm.2.29 ]
join.case.arm.1.27:
  br label %join.val.28
join.val.28:
  br label %join.after.22
join.case.arm.2.29:
  call void @__inc_ref(ptr %t18)
  store ptr %t18, ptr %v__inl6_scrut.jslot
  br label %join.21
join.case.default.26:
  unreachable
join.21:
  %t30 = load ptr, ptr %v__inl6_scrut.jslot
  %t31 = getelementptr ptr, ptr %t30, i32 0
  %t32 = load ptr, ptr %t31
  %t33 = ptrtoint ptr %t32 to i64
  switch i64 %t33, label %case.default.34 [ i64 1, label %case.arm.1.36 i64 2, label %case.arm.2.38 ]
case.arm.1.36:
  br label %case.end.1.37
case.end.1.37:
  br label %case.join.35
case.arm.2.38:
  br label %case.end.2.39
case.end.2.39:
  br label %case.join.35
case.default.34:
  unreachable
case.join.35:
  %t40 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.1.37 ], [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.2.39 ]
  call void @__free_recursive(ptr %t30)
  br label %join.end.41
join.end.41:
  br label %join.after.22
join.after.22:
  %t42 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %join.val.28 ], [ %t40, %join.end.41 ]
  call void @__free_recursive(ptr %t18)
  %t43 = call ptr @__concat(ptr %t17, ptr %t42)
  %t44 = getelementptr ptr, ptr %t43, i32 0
  %t45 = load ptr, ptr %t44
  %t46 = ptrtoint ptr %t45 to i64
  switch i64 %t46, label %case.default.47 [ i64 3, label %case.arm.3.49 i64 4, label %case.arm.4.57 ]
case.arm.3.49:
...
case.arm.4.57:
  ...
  call void @__inc_ref(ptr %t60)
  %t61 = call ptr @__concat(ptr %t60, ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
  %t62 = getelementptr ptr, ptr %t61, i32 0
  %t63 = load ptr, ptr %t62
  %t64 = ptrtoint ptr %t63 to i64
  switch i64 %t64, label %case.default.65 [ i64 3, label %case.arm.3.67 i64 4, label %case.arm.4.75 ]
case.arm.3.67:
...
case.arm.4.75:
  ...
  call void @__inc_ref(ptr %t78)
  %t79 = call ptr @__concat(ptr %t78, ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
...
case.arm.4.93:
  ...
  call void @__inc_ref(ptr %t96)
  %t97 = call ptr @__concat(ptr %t96, ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
...
case.default.83:
  unreachable
case.join.84:
  %t98 = phi ptr [ %t89, %case.end.3.86 ], [ %t97, %case.end.4.94 ]
  call void @__free_recursive(ptr %t79)
  br label %case.end.4.76
case.end.4.76:
  br label %case.join.66
case.default.65:
  unreachable
case.join.66:
  %t99 = phi ptr [ %t71, %case.end.3.68 ], [ %t98, %case.end.4.76 ]
...
case.default.47:
  unreachable
case.join.48:
  %t100 = phi ptr [ %t53, %case.end.3.50 ], [ %t99, %case.end.4.58 ]
...
case.default.4:
  unreachable
case.join.5:
  %t101 = phi ptr [ %t10, %case.end.3.7 ], [ %t100, %case.end.4.15 ]
...
tco.case.arm.6.13:
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.2, i64 12), ptr %t17
