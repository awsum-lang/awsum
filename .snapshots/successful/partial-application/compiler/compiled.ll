...
@.str.0 = private unnamed_addr constant [6 x i8] c"chain\00"
...
define ptr @v_apply(ptr %v_f, ptr %v_x) {
  %t0 = call ptr %v_f(ptr %v_x)
  ret ptr %t0
}

define ptr @v_compose(ptr %v_f, ptr %v_g, ptr %v_x) {
...
define ptr @v__pap_0(ptr %v__eta0) {
