...
(() => {
  ...
  const v_res = (s => {
    switch (s[0]) {
      ...
      case 4: {
        const v_a = s[1];
        const v_$inl6$r = [4, "good"];
        {
          const __s = (s => {
            switch (s[0]) {
              case 3: {
                return __concat("left: ", v_$inl6$r[1]);
              }
              case 4: {
                return __concat("right: ", v_$inl6$r[1]);
              }
            }
          })(v_$inl6$r);
          switch (__s[0]) {
    ...
    (s => {
      switch (s[0]) {
        case 3: {
          return __concat("left: ", v_$inl3$r[1]);
        }
        case 4: {
          return __concat("right: ", v_$inl3$r[1]);
        }
      }
    })(v_$inl3$r)
  );
