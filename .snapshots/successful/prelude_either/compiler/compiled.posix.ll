...
case.arm.1.42:
  ...
  %t46 = getelementptr [3 x i8], ptr @.str.4, i64 0, i64 0
  %t47 = call ptr @__concat(ptr %t22, ptr %t46)
...
case.arm.1.61:
  ...
  %t65 = call ptr @__concat(ptr %t64, ptr %t45)
...
case.default.51:
  unreachable
case.join.52:
  %t66 = phi ptr [%t57, %case.end.0.54], [%t65, %case.end.1.62]
...
case.default.32:
  unreachable
case.join.33:
  %t67 = phi ptr [%t38, %case.end.0.35], [%t66, %case.end.1.43]
...
case.default.9:
  unreachable
case.join.10:
  %t68 = phi ptr [%t15, %case.end.0.12], [%t67, %case.end.1.20]
  %t69 = call ptr @v__let_2(ptr %t68)
  ret ptr %t69
}
