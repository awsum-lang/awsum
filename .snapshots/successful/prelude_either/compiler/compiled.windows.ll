...
@.str.0 = private unnamed_addr constant {i32, i32, [6 x i8]} { i32 6, i32 6, [6 x i8] c"left: " }
@.str.1 = private unnamed_addr constant {i32, i32, [7 x i8]} { i32 7, i32 7, [7 x i8] c"right: " }
@.str.2 = private unnamed_addr constant {i32, i32, [3 x i8]} { i32 3, i32 3, [3 x i8] c"bad" }
@.str.3 = private unnamed_addr constant {i32, i32, [4 x i8]} { i32 4, i32 4, [4 x i8] c"good" }
...
define internal ptr @v_unwrap(ptr %v_r) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 3, label %case.arm.3.5 i64 4, label %case.arm.4.10 ]
case.arm.3.5:
...
case.default.3:
  unreachable
case.join.4:
  %t15 = phi ptr [%t9, %case.end.3.6], [%t14, %case.end.4.11]
  ret ptr %t15
}
...
case.arm.4.18:
  ...
  %t23 = inttoptr i64 4 to ptr
  %t24 = getelementptr ptr, ptr %t22, i32 0
  store ptr %t23, ptr %t24
  %t25 = getelementptr ptr, ptr %t22, i32 1
  store ptr @.str.3, ptr %t25
  %t26 = call ptr @v_unwrap(ptr %t22)
...
case.arm.4.40:
  ...
  %t44 = call ptr @__concat(ptr %t21, ptr @.str.4)
