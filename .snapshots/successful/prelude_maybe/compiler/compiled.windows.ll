...
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [6 x i8]} { i32 0, i32 0, i32 0, i32 6, i32 6, [6 x i8] c"just: " }
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [2 x i8]} { i32 0, i32 0, i32 0, i32 2, i32 2, [2 x i8] c"hi" }
...
define internal ptr @v_unwrap(ptr %v_m) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 9, label %case.arm.9.4 i64 10, label %case.arm.10.9 ]
case.arm.9.4:
...
case.arm.4.18:
  ...
  %t23 = inttoptr i64 9 to ptr
  %t24 = getelementptr ptr, ptr %t22, i32 0
  store ptr %t23, ptr %t24
  %t25 = call ptr @v__lift_7(ptr %t22)
  %t26 = call ptr @v_unwrap(ptr %t25)
...
case.arm.4.40:
  ...
  call void @__inc_ref(ptr %t21)
  %t44 = call ptr @__concat(ptr %t21, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
...
case.arm.4.58:
  ...
  call void @__inc_ref(ptr %t61)
  call void @__inc_ref(ptr %t43)
  %t62 = call ptr @__concat(ptr %t61, ptr %t43)
...
case.default.8:
  unreachable
case.join.9:
  %t65 = phi ptr [%t14, %case.end.3.11], [%t64, %case.end.4.19]
  call void @__free_recursive(ptr %t4)
  %t66 = call ptr @v__let_8(ptr %t65)
  ret ptr %t66
}
...
define internal ptr @v__lift_7(ptr %v___input) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 9, label %case.arm.9.4 i64 10, label %case.arm.10.8 ]
case.arm.9.4:
  %t5 = call ptr @__alloc(i64 8, i32 0)
  %t6 = inttoptr i64 9 to ptr
  %t7 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t6, ptr %t7
