...
(module
  ...
  (table 5 funcref)
  (elem (i32.const 0) $v_runIO $v_buildLeft $v_sumTree $v__scc__apply_sumTree__cps_sumTree $v__cps_sumTree)
  ...
  (func $v_sumTree (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
  ...
  (func $v__cps_sumTree (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
