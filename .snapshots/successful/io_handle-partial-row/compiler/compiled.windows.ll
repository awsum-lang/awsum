...
define internal ptr @v_handleSomeErrors(ptr %v_e) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 63694499, label %case.arm.63694499.4 i64 80472118, label %case.arm.80472118.17 ]
case.arm.63694499.4:
...
case.arm.80472118.17:
  ...
  switch i64 %t22, label %case.default.23 [ i64 25, label %case.arm.25.24 ]
case.arm.25.24:
  %t25 = call ptr @__alloc(i64 8, i32 0)
  %t26 = inttoptr i64 25 to ptr
  %t27 = getelementptr ptr, ptr %t25, i32 0
  store ptr %t26, ptr %t27
  %t28 = call ptr @v_failIO(ptr %t25)
  %t29 = call ptr @v__lift_26(ptr %t28)
...
case.arm.80472118.24:
  ...
  switch i64 %t29, label %case.default.30 [ i64 25, label %case.arm.25.31 ]
case.arm.25.31:
...
tco.case.arm.6.19:
  ...
  %t26 = inttoptr i64 63694499 to ptr
  %t27 = getelementptr ptr, ptr %t25, i32 0
  store ptr %t26, ptr %t27
  call void @__inc_ref(ptr %t21)
...
tco.case.arm.6.19:
  ...
  store ptr %t23, ptr %t24
  %t25 = call ptr @__alloc(i64 16, i32 1)
  %t26 = inttoptr i64 80472118 to ptr
  %t27 = getelementptr ptr, ptr %t25, i32 0
  store ptr %t26, ptr %t27
  call void @__inc_ref(ptr %t21)
  %t28 = getelementptr ptr, ptr %t25, i32 1
...
define internal ptr @v__scc__apply1__df__lam_14_1__df__lam_14_5__df__lam_15_2__df__lam_15_6__df__lam_16_3__df__lam_16_7__lift_19__lift_20__lift_21__lift_23__lift_24__lift_25__lift_27__lift_28__lift_29(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 67 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_14_1__df__lam_14_5__df__lam_15_2__df__lam_15_6__df__lam_16_3__df__lam_16_7__lift_19__lift_20__lift_21__lift_23__lift_24__lift_25__lift_27__lift_28__lift_29(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_14_1__df__lam_14_5__df__lam_15_2__df__lam_15_6__df__lam_16_3__df__lam_16_7__lift_19__lift_20__lift_21__lift_23__lift_24__lift_25__lift_27__lift_28__lift_29(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 41, label %tco.case.arm.41.11 i64 42, label %tco.case.arm.42.320 i64 43, label %tco.case.arm.43.343 i64 44, label %tco.case.arm.44.366 i64 45, label %tco.case.arm.45.389 i64 46, label %tco.case.arm.46.412 i64 47, label %tco.case.arm.47.435 i64 48, label %tco.case.arm.48.458 i64 49, label %tco.case.arm.49.481 i64 50, label %tco.case.arm.50.504 i64 51, label %tco.case.arm.51.527 i64 52, label %tco.case.arm.52.550 i64 53, label %tco.case.arm.53.573 i64 54, label %tco.case.arm.54.596 i64 55, label %tco.case.arm.55.619 i64 56, label %tco.case.arm.56.642 ]
tco.case.arm.41.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 26, label %tco.case.arm.26.20 i64 27, label %tco.case.arm.27.40 i64 28, label %tco.case.arm.28.60 i64 29, label %tco.case.arm.29.80 i64 30, label %tco.case.arm.30.100 i64 31, label %tco.case.arm.31.120 i64 32, label %tco.case.arm.32.140 i64 33, label %tco.case.arm.33.160 i64 34, label %tco.case.arm.34.180 i64 35, label %tco.case.arm.35.200 i64 36, label %tco.case.arm.36.220 i64 37, label %tco.case.arm.37.240 i64 38, label %tco.case.arm.38.260 i64 39, label %tco.case.arm.39.280 i64 40, label %tco.case.arm.40.300 ]
tco.case.arm.26.20:
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_14_1__df__lam_14_5__df__lam_15_2__df__lam_15_6__df__lam_16_3__df__lam_16_7__lift_19__lift_20__lift_21__lift_23__lift_24__lift_25__lift_27__lift_28__lift_29(ptr %t0)
