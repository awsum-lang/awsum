...
const v_failingComputation = (v_failIO)([63694499, [20]]);

function v_handleSomeErrors(v_e){
    {
      const __s = v_e;
      switch (__s[0]) {
        case 63694499: {
...
function v_handleRemainingErrors(v_e){
    {
      const __s = v_e;
      switch (__s[0]) {
        case 63694499: {
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 8: {
          const v_cont = __s[1];
          return (v__apply__df_handleErrorIO_3)(v__k, [8, [23, v_cont]]);
        }
        case 9: {
          const v_cont = __s[1];
          return (v__apply__df_handleErrorIO_3)(v__k, [9, [25, v_cont]]);
        }
      }
    }
  }
...
function v__scc__apply1__df__lam_10_1__df__lam_10_4__df__lam_11_2__df__lam_11_5(v__args){
    return (v__cps__scc__apply1__df__lam_10_1__df__lam_10_4__df__lam_11_2__df__lam_11_5)(v__args, [35]);
}

function v__cps__scc__apply1__df__lam_10_1__df__lam_10_4__df__lam_11_2__df__lam_11_5(v__args, v__k){
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
...
function v__apply1(v__cl, v__arg0){
    return (v__scc__apply1__df__lam_10_1__df__lam_10_4__df__lam_11_2__df__lam_11_5)([26, v__cl, v__arg0]);
}
