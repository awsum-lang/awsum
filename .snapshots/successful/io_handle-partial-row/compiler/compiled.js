...
const v_failingComputation = (v_failIO)([63694499, [0]]);
...
function v__df_handleErrorIO_2(v_io){
    return (v__cps__df_handleErrorIO_2)(v_io, [0]);
}
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        case 0: {
          const v_a = __s[1];
          return (v__apply__df_handleErrorIO_2)(v__k, [0, v_a]);
        }
        case 1: {
          const v_e = __s[1];
        ...
        case 3: {
          const v_cont = __s[1];
          return (v__apply__df_handleErrorIO_2)(v__k, [3, [1, v_cont]]);
        }
      }
    }
  }
...
function v__scc__apply1__df__lam_6_1__df__lam_6_3(v__args){
    return (v__cps__scc__apply1__df__lam_6_1__df__lam_6_3)(v__args, [0]);
}
...
function v__apply1(v__cl, v__arg0){
    return (v__scc__apply1__df__lam_6_1__df__lam_6_3)([0, v__cl, v__arg0]);
}
