...
const v_failingComputation = (v_failIO)([63694499, [19]]);
...
const main = (v__df_handleErrorIO_0)((v__df_handleErrorIO_2)(v_failingComputation));
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 6: {
          const v_e = __s[1];
          return (v__apply__df_handleErrorIO_2)(v__k, (v_handleSomeErrors)(v_e));
        }
        case 7: {
          const v_s = __s[1];
          const v_next = __s[2];
          const __t0 = v_next;
          const __t1 = [29, v__k, v_s];
          v_io = __t0;
          v__k = __t1;
          continue;
        }
...
function v__scc__apply1__df__lam_6_1__df__lam_6_3(v__args){
    return (v__cps__scc__apply1__df__lam_6_1__df__lam_6_3)(v__args, [30]);
}

function v__cps__scc__apply1__df__lam_6_1__df__lam_6_3(v__args, v__k){
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
          ...
          const v__arg0 = __s[2];
          {
            ...
            switch (__s[0]) {
              case 21: {
                ...
                const __t0 = [24, v__cap21_0, v__arg0];
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
              ...
              case 22: {
                ...
                const __t0 = [25, v__cap22_0, v__arg0];
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
...
function v__apply__scc__apply1__df__lam_6_1__df__lam_6_3(v__k, v__x){
  while (true) {
    {
      const __s = v__k;
      switch (__s[0]) {
        ...
        case 32: {
          ...
          const __t0 = v__pk_32;
          const __t1 = (v__df_handleErrorIO_2)(v__x);
          v__k = __t0;
          v__x = __t1;
          continue;
        }
...
function v__apply1(v__cl, v__arg0){
    return (v__scc__apply1__df__lam_6_1__df__lam_6_3)([23, v__cl, v__arg0]);
}
