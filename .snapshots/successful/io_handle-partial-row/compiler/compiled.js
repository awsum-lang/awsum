...
function main(v__input){
    return (v__df_handleErrorIO_0)((v__df_handleErrorIO_1)(v_failingComputation));
}
...
function v__df_handleErrorIO_1(v_io){
    return (v__cps__df_handleErrorIO_1)(v_io, [0]);
}

function v__cps__df_handleErrorIO_1(v_io, v__k){
  while (true) {
    {
      const __s = v_io;
      switch (__s[0]) {
        case 0: {
          const v_a = __s[1];
          return (v__apply__df_handleErrorIO_1)(v__k, [0, v_a]);
        }
        case 1: {
          const v_e = __s[1];
          return (v__apply__df_handleErrorIO_1)(v__k, (v_handleSomeErrors)(v_e));
        }
        case 2: {
          const v_s = __s[1];
          const v_next = __s[2];
...
function v__apply__df_handleErrorIO_1(v__k, v__x){
  while (true) {
    {
      const __s = v__k;
      switch (__s[0]) {
