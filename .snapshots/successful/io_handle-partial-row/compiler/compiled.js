...
(() => {
  ...
  const v_failingComputation = [6, [63694499, [24]]];
  ...
  const v_$cps$$df$handleErrorIO$4 = (v_io, v_$k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 6: {
          return v_$apply$$df$handleErrorIO$4(v_$k, [6, v_io[1]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_$cps$$df$handleErrorIO$0 = (v_io, v_$k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 6: {
          return v_$apply$$df$handleErrorIO$0(v_$k, [7, "got E1", [5, [0]]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const main = v_$cps$$df$handleErrorIO$0(
    v_$cps$$df$handleErrorIO$4(v_failingComputation, [27]),
    [25]
  );
