...
(module
  ...
  (data (i32.const 126) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00u")
  (table 6 funcref)
  (elem (i32.const 0) $v_runIO $v_make $v_eat $v_spin $v__cps__df_andThenIO_0 $v__apply__df_andThenIO_0)
  ...
  (func $v_make (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v_eat (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v_spin (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
