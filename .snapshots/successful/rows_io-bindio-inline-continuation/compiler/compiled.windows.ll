...
tco.case.arm.9.59:
  ...
  %t70 = call ptr @v__apply__df__rowmono_0_bindIO_0(ptr %t6, ptr %t62)
...
tco.case.arm.10.71:
  ...
  %t82 = call ptr @v__apply__df__rowmono_0_bindIO_0(ptr %t6, ptr %t74)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 32, label %tco.case.arm.32.11 i64 33, label %tco.case.arm.33.143 i64 34, label %tco.case.arm.34.166 i64 35, label %tco.case.arm.35.189 i64 36, label %tco.case.arm.36.212 i64 37, label %tco.case.arm.37.235 i64 38, label %tco.case.arm.38.258 ]
tco.case.arm.32.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 25, label %tco.case.arm.25.20 i64 26, label %tco.case.arm.26.40 i64 27, label %tco.case.arm.27.60 i64 28, label %tco.case.arm.28.80 i64 29, label %tco.case.arm.29.100 i64 30, label %tco.case.arm.30.120 i64 31, label %tco.case.arm.31.140 ]
tco.case.arm.25.20:
