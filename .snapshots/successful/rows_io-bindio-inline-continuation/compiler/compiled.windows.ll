...
tco.case.arm.8.18:
  ...
  %t28 = inttoptr i64 35 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @v_$cps$$scc$$apply1__$df$$lam$9$5__$df$$rowmono$1$bindIOAfterArgs$1(ptr %t20, ptr %t27)
...
define internal ptr @v_combined() {
  ...
  %t8 = inttoptr i64 31 to ptr
  %t9 = getelementptr ptr, ptr %t7, i32 0
  store ptr %t8, ptr %t9
  %t10 = call ptr @v_$cps$$df$$rowmono$0$bindIO$0(ptr %t0, ptr %t7)
  ret ptr %t10
}
...
define internal ptr @v_$cps$$df$$rowmono$0$bindIO$0(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.5.11:
  ...
  %t16 = inttoptr i64 718021640 to ptr
  ...
  %t22 = getelementptr ptr, ptr %t12, i32 1
  store ptr %t15, ptr %t22
  %t23 = call ptr @v_$apply$$df$$rowmono$0$bindIO$0(ptr %t6, ptr %t12)
...
tco.case.arm.6.24:
  ...
  %t25 = call ptr @v_$apply$$df$$rowmono$0$bindIO$0(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.51:
  ...
  %t62 = call ptr @v_$apply$$df$$rowmono$0$bindIO$0(ptr %t6, ptr %t54)
...
define internal ptr @v_$apply$$df$$rowmono$0$bindIO$0(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
...
case.join.20:
  ...
  call void @__free_recursive(ptr %t15)
  %t64 = call ptr @v_$apply$$df$handleErrorIO$4(ptr %t6, ptr %t63)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.90:
  ...
  %t101 = call ptr @v_$apply$$df$handleErrorIO$4(ptr %t6, ptr %t93)
...
define internal ptr @v_$cps$$scc$$apply1__$df$$lam$9$5__$df$$rowmono$1$bindIOAfterArgs$1(ptr %v_$args, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 28, label %tco.case.arm.28.11 i64 29, label %tco.case.arm.29.60 i64 30, label %tco.case.arm.30.71 ]
tco.case.arm.28.11:
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %tco.case.default.19 [ i64 25, label %tco.case.arm.25.20 i64 26, label %tco.case.arm.26.28 i64 27, label %tco.case.arm.27.36 ]
tco.case.arm.25.20:
...
case.join.41:
  ...
  %t59 = call ptr @v_$apply$$scc$$apply1__$df$$lam$9$5__$df$$rowmono$1$bindIOAfterArgs$1(ptr %t6, ptr %t58)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$scc$$apply1__$df$$lam$9$5__$df$$rowmono$1$bindIOAfterArgs$1(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 35, label %tco.case.arm.35.11 i64 36, label %tco.case.arm.36.12 i64 37, label %tco.case.arm.37.19 ]
tco.case.arm.35.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
tco.case.arm.36.12:
  ...
  %t17 = getelementptr ptr, ptr %t15, i32 0
  store ptr %t16, ptr %t17
  %t18 = call ptr @v_$cps$$df$handleErrorIO$4(ptr %t6, ptr %t15)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  store ptr %t14, ptr %t3
...
tco.case.arm.37.19:
  ...
  %t23 = inttoptr i64 31 to ptr
  %t24 = getelementptr ptr, ptr %t22, i32 0
  store ptr %t23, ptr %t24
  %t25 = call ptr @v_$cps$$df$$rowmono$0$bindIO$0(ptr %t6, ptr %t22)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
