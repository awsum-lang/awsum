...
(module
  ...
  (table 15 funcref)
  (elem (i32.const 0) $v_failIO $v_runIO $v_handler $v__lam_13 $v__io_getargs_cont $v__df__rowmono_0_bindIO_0 $v__cps__df__rowmono_0_bindIO_0 $v__apply__df__rowmono_0_bindIO_0 $v__df_handleErrorIO_4 $v__cps__df_handleErrorIO_4 $v__apply__df_handleErrorIO_4 $v__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1 $v__cps__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1 $v__apply__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1 $v__apply1)
  ...
  (func $v__df__rowmono_0_bindIO_0 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
  ...
  (func $v__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
