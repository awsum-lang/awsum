...
(() => {
  ...
  const v__df_handleErrorIO_4 = (v_io) => {
    return v__cps__df_handleErrorIO_4(v_io, [33]);
  };
  ...
  const v__df__rowmono_0_bindIO_0 = (v_io) => {
    return v__cps__df__rowmono_0_bindIO_0(v_io, [31]);
  };
  ...
  const v__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1 = (
    v__args
  ) => {
    return v__cps__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1(
      v__args,
      [35]
    );
  };
  ...
  const v__apply1 = (v__cl, v__arg0) => {
    return v__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1(
      [28, v__cl, v__arg0]
    );
  };
