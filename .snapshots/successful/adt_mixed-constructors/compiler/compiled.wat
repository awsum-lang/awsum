...
(module
  ...
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v_showToken $v__let_7)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_showToken (param $v_token i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_token)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 19)) (then (local.set $v_w (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_w)) (block (result i32) (local.set $__drop_tmp (call $__concat (i32.const 96) (block (result i32) (local.set $__inc_tmp (local.get $v_w)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__free_recursive (local.get $v_w)) (local.get $__drop_tmp))) (else (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 20)) (then (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_n)) (block (result i32) (local.set $__drop_tmp (call $__concat (i32.const 121) (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__free_recursive (local.get $v_n)) (local.get $__drop_tmp))) (else (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 21)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 145)) (local.get $__con_0))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 166)) (local.get $__con_0))))))))))
