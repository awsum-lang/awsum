...
(module
  ...
  (func $v_main (param $v__input i32) (result i32)
    (call $__print (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $v_render (call $__addUInt8 (call $__box_i32 (i32.const 200)) (call $__box_i32 (i32.const 55)))) (i32.const 95)) (call $v_render (call $__addUInt8 (call $__box_i32 (i32.const 200)) (call $__box_i32 (i32.const 56))))) (i32.const 95)) (call $v_render (call $__addUInt8 (call $__box_i32 (i32.const 255)) (call $__box_i32 (i32.const 255))))) (i32.const 95)) (call $v_render (call $__addUInt8 (call $__box_i32 (i32.const 0)) (call $__box_i32 (i32.const 0)))))))
