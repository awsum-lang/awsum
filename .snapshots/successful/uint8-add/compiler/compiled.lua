...
function M.__addUInt8(a, b) local s = a + b if s > 255 then return {0, {0}} else return {1, s} end end
...
function M.main(v__input)
  return M.__print(table.concat({(M.v_render)(M.__addUInt8(200, 55)), ", ", (M.v_render)(M.__addUInt8(200, 56)), ", ", (M.v_render)(M.__addUInt8(255, 255)), ", ", (M.v_render)(M.__addUInt8(0, 0))}))
end
