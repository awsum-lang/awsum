...
(() => {
  ...
  const v__inl3_r = [4, 4294967294 >>> 0];
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
      ...
      case 4: {
        const v_a = s[1];
        const v__inl6_r = [4, 4294967295 >>> 0];
        {
          const __s = (s => {
            switch (s[0]) {
              case 3: {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v__inl9_r = __addUInt32(v_maxUInt32, v_maxUInt32);
              {
                const __s = (s => {
                  switch (s[0]) {
                    case 3: {
                ...
                switch (__s[0]) {
                  ...
                  case 4: {
                    const v_c = __s[1];
                    const v__inl12_r = __addUInt32(v_minUInt32, v_minUInt32);
                    {
                      const __s = (s => {
                        switch (s[0]) {
                          case 3: {
                      ...
                      switch (__s[0]) {
                        ...
                        case 4: {
                          const v_d = __s[1];
                          const v__inl15_r = __addUInt32(v_maxUInt32, 1 >>> 0);
                          {
                            const __s = (s => {
                              switch (s[0]) {
                                case 3: {
