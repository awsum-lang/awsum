...
(() => {
  ...
  const v_$inl3$r = [4, 4294967294 >>> 0];
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
        const v_$do__e__11 = s[1];
      ...
      case 4: {
        ...
        const v_$inl6$r = [4, 4294967295 >>> 0];
        {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v_$inl9$r = __addUInt32(v_maxUInt32, v_maxUInt32);
              {
                const __s = (s => {
                  switch (s[0]) {
                    case 3: {
                ...
                switch (__s[0]) {
                  ...
                  case 4: {
                    const v_c = __s[1];
                    const v_$inl12$r = __addUInt32(v_minUInt32, v_minUInt32);
                    {
                      const __s = (s => {
                        switch (s[0]) {
                          case 3: {
                      ...
                      switch (__s[0]) {
                        ...
                        case 4: {
                          const v_d = __s[1];
                          const v_$inl15$r = __addUInt32(v_maxUInt32, 1 >>> 0);
                          {
                            const __s = (s => {
                              switch (s[0]) {
                                case 3: {
  ...
  const v_$inl18$x = v_res;
  const main = v_$cps$$df$handleErrorIO$0(
    v_$cps$$df$andThenIO$4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v_$inl18$x[1]];
          }
          case 4: {
            return [5, v_$inl18$x[1]];
          }
        }
      })(v_$inl18$x),
      [22]
