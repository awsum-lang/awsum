...
case.arm.4.56:
  ...
  %t60 = call ptr @__showUInt32(ptr %t59)
...
case.arm.4.76:
  ...
  %t80 = call ptr @v_maxUInt32()
  %t81 = call ptr @v_maxUInt32()
  %t82 = call ptr @__addUInt32(ptr %t80, ptr %t81)
  %t83 = getelementptr ptr, ptr %t82, i32 0
  %t84 = load ptr, ptr %t83
  %t85 = ptrtoint ptr %t84 to i64
  switch i64 %t85, label %case.default.86 [ i64 3, label %case.arm.3.88 i64 4, label %case.arm.4.91 ]
case.arm.3.88:
  %t90 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.1, i64 12), ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
  br label %case.end.3.89
case.end.3.89:
  br label %case.join.87
case.arm.4.91:
  %t93 = getelementptr ptr, ptr %t82, i32 1
  %t94 = load ptr, ptr %t93
  call void @__inc_ref(ptr %t94)
  %t95 = call ptr @__showUInt32(ptr %t94)
  %t96 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.3, i64 12), ptr %t95)
...
case.default.86:
  unreachable
case.join.87:
  %t97 = phi ptr [ %t90, %case.end.3.89 ], [ %t96, %case.end.4.92 ]
...
case.arm.4.111:
  ...
  %t115 = call ptr @v_minUInt32()
  %t116 = call ptr @v_minUInt32()
  %t117 = call ptr @__addUInt32(ptr %t115, ptr %t116)
  %t118 = getelementptr ptr, ptr %t117, i32 0
  %t119 = load ptr, ptr %t118
  %t120 = ptrtoint ptr %t119 to i64
  switch i64 %t120, label %case.default.121 [ i64 3, label %case.arm.3.123 i64 4, label %case.arm.4.126 ]
case.arm.3.123:
  %t125 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.1, i64 12), ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
  br label %case.end.3.124
case.end.3.124:
  br label %case.join.122
case.arm.4.126:
  %t128 = getelementptr ptr, ptr %t117, i32 1
...
case.default.121:
  unreachable
case.join.122:
  %t132 = phi ptr [ %t125, %case.end.3.124 ], [ %t131, %case.end.4.127 ]
...
case.arm.4.146:
  ...
  %t150 = call ptr @v_maxUInt32()
  %t151 = call ptr @__alloc(i64 4, i32 0)
  store i32 1, ptr %t151
  %t152 = call ptr @__addUInt32(ptr %t150, ptr %t151)
...
case.arm.4.161:
  ...
  %t165 = call ptr @__showUInt32(ptr %t164)
...
case.arm.4.235:
  ...
  call void @__inc_ref(ptr %t238)
  call void @__inc_ref(ptr %t114)
  %t239 = call ptr @__concat(ptr %t238, ptr %t114)
...
case.arm.4.271:
  ...
  call void @__inc_ref(ptr %t274)
  call void @__inc_ref(ptr %t149)
  %t275 = call ptr @__concat(ptr %t274, ptr %t149)
...
case.default.136:
  unreachable
case.join.137:
  %t320 = phi ptr [ %t142, %case.end.3.139 ], [ %t319, %case.end.4.147 ]
...
case.default.101:
  unreachable
case.join.102:
  %t321 = phi ptr [ %t107, %case.end.3.104 ], [ %t320, %case.end.4.112 ]
