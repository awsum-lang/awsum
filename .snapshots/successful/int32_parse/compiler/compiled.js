...
(() => {
  ...
  const v__inl3_r = __parseInt32("42");
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
      ...
      case 4: {
        const v_a = s[1];
        const v__inl6_r = __parseInt32("-42");
        {
          const __s = (s => {
            switch (s[0]) {
              case 3: {
                        ...
                        case 4: {
                          ...
                          const v__inl15_r = __parseInt32("-2147483648");
                          {
                            ...
                            switch (__s[0]) {
                              ...
                              case 4: {
                                const v_e = __s[1];
                                const v__inl18_r = __parseInt32("2147483648");
                                {
                                  const __s = (s => {
                                    switch (s[0]) {
                                      case 3: {
  ...
  const v__inl39_x = v_res;
  const main = v__cps__df_handleErrorIO_0(
    v__cps__df_andThenIO_4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v__inl39_x[1]];
          }
          case 4: {
            return [5, v__inl39_x[1]];
          }
        }
      })(v__inl39_x),
      [22]
