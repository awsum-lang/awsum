...
function __parseInt32(s){ if (!/^-?[0-9]+$/.test(s)) return [3, [17]]; const n = Number(s); if (n < -2147483648 || n > 2147483647) return [3, [17]]; return [4, n | 0]; }
