...
const v__cps__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterStdin_2__lift_2__lift_3 = (v__args, v__k) => {
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
...
const v__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterStdin_2__lift_2__lift_3 = (v__args) => {
