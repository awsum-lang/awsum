...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    (local $__drop_tmp i32)
    (call $v__let_13 (call $v__df_bindEither_0 (call $v_opA))))
  ...
  (func $v__let_13 (param $v_chained i32) (result i32)
    (local $__con_0 i32)
    (local $v___pa0 i32)
    (local $v__a i32)
    (local $v__b i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (block (result i32) (local.set $__scrut (local.get $v_chained)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___pa0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___pa0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___pa0)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 2252990199)) (then (local.set $v__a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__a)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 131)) (local.get $__con_0))) (call $__free_recursive (local.get $v__a)) (local.get $__drop_tmp))) (else (local.set $v__b (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__b)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 155)) (local.get $__con_0))) (call $__free_recursive (local.get $v__b)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v___pa0)) (local.get $__drop_tmp))) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_n)) (block (result i32) (local.set $__drop_tmp (call $__concat (i32.const 179) (call $__show_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))) (call $__free_recursive (local.get $v_n)) (local.get $__drop_tmp)))))))
