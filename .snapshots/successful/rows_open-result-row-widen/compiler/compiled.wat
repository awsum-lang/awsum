...
(module
  ...
  (data (i32.const 84) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00Z")
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v_zeroOr $v_describe)
  ...
  (func $v_zeroOr (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
