...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [1 x i8]} { i32 0, i32 0, i32 0, i32 1, i32 1, [1 x i8] c"Z" }
...
define internal ptr @v_zeroOr(ptr %v__n) {
  %t0 = call ptr @__alloc(i64 16, i32 1)
  %t1 = inttoptr i64 3 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @__alloc(i64 16, i32 1)
  %t4 = inttoptr i64 751576878 to ptr
...
define internal ptr @v_called() {
  %t0 = call ptr @__alloc(i64 4, i32 0)
  store i32 9, ptr %t0
  %t1 = call ptr @v_zeroOr(ptr %t0)
  ret ptr %t1
}
...
case.arm.3.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 751576878, label %case.arm.751576878.11 ]
case.arm.751576878.11:
