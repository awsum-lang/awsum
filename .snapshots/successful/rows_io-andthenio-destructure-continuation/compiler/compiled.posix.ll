...
case.join.5:
  ...
  %t26 = call ptr @v__cps__df__rowmono_1_andThenIO_8(ptr %t22, ptr %t23)
  %t27 = call ptr @__alloc(i64 8, i32 0)
  %t28 = inttoptr i64 21 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @v__cps__df__rowmono_0_andThenIO_4(ptr %t26, ptr %t27)
  %t31 = call ptr @__alloc(i64 8, i32 0)
  %t32 = inttoptr i64 19 to ptr
  %t33 = getelementptr ptr, ptr %t31, i32 0
  store ptr %t32, ptr %t33
  %t34 = call ptr @v__cps__df_handleErrorIO_0(ptr %t30, ptr %t31)
  ret ptr %t34
}
...
tco.case.arm.5.11:
  ...
  %t27 = call ptr @v__apply__df__rowmono_0_andThenIO_4(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.28:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t29 = call ptr @v__apply__df__rowmono_0_andThenIO_4(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.42 i64 7, label %tco.case.arm.7.44 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  %t14 = getelementptr ptr, ptr %t13, i32 1
  %t15 = load ptr, ptr %t14
  call void @__inc_ref(ptr %t15)
  %t16 = getelementptr ptr, ptr %t13, i32 2
  %t17 = load ptr, ptr %t16
  call void @__inc_ref(ptr %t17)
  %t18 = call ptr @__addInt32(ptr %t15, ptr %t17)
...
case.arm.3.24:
  ...
  %t29 = getelementptr ptr, ptr %t18, i32 1
  %t30 = load ptr, ptr %t29
  call void @__inc_ref(ptr %t30)
  %t31 = getelementptr ptr, ptr %t26, i32 1
...
case.arm.4.32:
  ...
  %t37 = getelementptr ptr, ptr %t18, i32 1
  %t38 = load ptr, ptr %t37
  call void @__inc_ref(ptr %t38)
  %t39 = getelementptr ptr, ptr %t34, i32 1
  store ptr %t38, ptr %t39
...
case.default.22:
  unreachable
case.join.23:
  %t40 = phi ptr [ %t26, %case.end.3.25 ], [ %t34, %case.end.4.33 ]
  call void @__free_recursive(ptr %t18)
  call void @__free_recursive(ptr %t13)
  %t41 = call ptr @v__apply__df__rowmono_1_andThenIO_8(ptr %t6, ptr %t40)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.42:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t43 = call ptr @v__apply__df__rowmono_1_andThenIO_8(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
