...
case.arm.1454647603.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 9, label %case.arm.9.11 i64 10, label %case.arm.10.16 ]
case.arm.9.11:
...
case.arm.10.16:
  ...
  switch i64 %t21, label %case.default.22 [ i64 796142685, label %case.arm.796142685.23 ]
case.arm.796142685.23:
  ...
  switch i64 %t28, label %case.default.29 [ i64 1, label %case.arm.1.30 i64 2, label %case.arm.2.35 ]
case.arm.1.30:
