...
@.str.5 = private unnamed_addr constant {i32, i32, [7 x i8]} { i32 7, i32 7, [7 x i8] c"String " }
@.str.6 = private unnamed_addr constant {i32, i32, [6 x i8]} { i32 6, i32 6, [6 x i8] c"Int32 " }
...
define internal ptr @v_whatsThat(ptr %v_x) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 1454647603, label %case.arm.1454647603.5 i64 1615808600, label %case.arm.1615808600.59 i64 2711245919, label %case.arm.2711245919.64 ]
...
case.arm.1.20:
  ...
  switch i64 %t26, label %case.default.27 [ i64 796142685, label %case.arm.796142685.29 i64 1759602215, label %case.arm.1759602215.51 ]
...
case.arm.1759602215.51:
  %t53 = getelementptr ptr, ptr %t23, i32 1
  %t54 = load ptr, ptr %t53
  %t55 = call ptr @v_showUnit(ptr %t54)
  %t56 = call ptr @__concat(ptr @.str.4, ptr %t55)
...
case.default.27:
  unreachable
case.join.28:
  %t57 = phi ptr [%t50, %case.end.796142685.30], [%t56, %case.end.1759602215.52]
...
case.default.12:
  unreachable
case.join.13:
  %t58 = phi ptr [%t16, %case.end.0.15], [%t57, %case.end.1.21]
  br label %case.end.1454647603.6
case.end.1454647603.6:
  br label %case.join.4
case.arm.1615808600.59:
  %t61 = getelementptr ptr, ptr %v_x, i32 1
  %t62 = load ptr, ptr %t61
  %t63 = call ptr @__concat(ptr @.str.5, ptr %t62)
  br label %case.end.1615808600.60
case.end.1615808600.60:
  br label %case.join.4
case.arm.2711245919.64:
  %t66 = getelementptr ptr, ptr %v_x, i32 1
  %t67 = load ptr, ptr %t66
  %t68 = call ptr @__showInt32(ptr %t67)
  %t69 = call ptr @__concat(ptr @.str.6, ptr %t68)
  br label %case.end.2711245919.65
case.end.2711245919.65:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t70 = phi ptr [%t58, %case.end.1454647603.6], [%t63, %case.end.1615808600.60], [%t69, %case.end.2711245919.65]
  ret ptr %t70
}
