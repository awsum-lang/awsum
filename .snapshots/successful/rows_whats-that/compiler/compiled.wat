...
(module
  ...
  (func $v_whatsThat (param $v_x i32) (result i32)
    ...
    (local $v_u i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1454647603)) (then (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v___rw)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (i32.const 70)) (local.get $__con_0))) (else (local.set $v___pa0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v___pa0)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 796142685)) (then (local.set $v_b (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v_b)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (i32.const 78)) (local.get $__con_0))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (i32.const 88)) (local.get $__con_0)))))) (else (local.set $v_u (i32.load offset=4 (local.get $__scrut))) (call $__concat (i32.const 99) (call $v_showUnit (local.get $v_u)))))))))) (else (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1615808600)) (then (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (call $__concat (i32.const 105) (local.get $v_s))) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (call $__concat (i32.const 113) (call $__show_i32 (local.get $v_n)))))))))
