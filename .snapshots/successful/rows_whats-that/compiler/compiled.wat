...
(module
  ...
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v_whatsThat $v__let_7)
  ...
  (func $v_main (result i32)
    ...
    (local $__con_2 i32)
    (local $__con_3 i32)
    (call $v__let_7 (call $v_whatsThat (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1454647603)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 10)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc (i32.const 8))) (i32.const 796142685)) (i32.store offset=4 (local.get $__con_2) (block (result i32) (i32.store (local.tee $__con_3 (call $__alloc (i32.const 4))) (i32.const 1)) (local.get $__con_3))) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0)))))
