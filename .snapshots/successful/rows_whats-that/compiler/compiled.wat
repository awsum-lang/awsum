...
(module
  ...
  (global $heap (mut i32) (i32.const 205))
  ...
  (data (i32.const 111) "\00\00\00\00\00\00\00\00\00\00\00\00\09\00\00\00\09\00\00\00Just True")
  ...
  (table 4 funcref)
  (elem (i32.const 0) $v_runIO $v_whatsThat $v__lift_12 $v__let_13)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_whatsThat (param $v_x i32) (result i32)
    (local $__con_0 i32)
    (local $v___pa0 i32)
    (local $v___rw i32)
    (local $v_b i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___rw)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___rw)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 10)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 96)) (local.get $__con_0))) (else (local.set $v___pa0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___pa0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___pa0)) (local.set $v_b (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v_b)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 123)) (local.get $__con_0))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 152)) (local.get $__con_0)))))) (call $__free_recursive (local.get $v_b)) (local.get $__drop_tmp)))) (call $__free_recursive (local.get $v___pa0)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v___rw)) (local.get $__drop_tmp))))
  ...
  (func $v_main (result i32)
    ...
    (local $__con_2 i32)
    (local $__drop_tmp i32)
    (call $v__let_13 (call $v_whatsThat (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 1454647603)) (i32.store offset=4 (local.get $__con_0) (call $v__lift_12 (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 11)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 1)) (local.get $__con_2))) (local.get $__con_1)))) (local.get $__con_0)))))
