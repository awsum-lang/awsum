...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_countDown (param $v_n i32) (result i32)
    ...
    (local $__drop_tmp i32)
    (local $__k0 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (call $__eq_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $__box_i32 (i32.const 0)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1)) (then (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_n)) (local.get $__drop_tmp))) (else (block (result i32) (local.set $__scrut (call $__predInt32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_e)) (call $__free_recursive (local.get $v_n)) (local.get $__drop_tmp))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_m)) (local.set $__k0 (local.get $v_m)) (call $__inc_ref (local.get $__k0)) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v_m)) (local.set $v_n (local.get $__k0)) (br $tco_top)))))))))
