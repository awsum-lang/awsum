...
(module
  ...
  (data (i32.const 84) "\00\00\00\00\00\00\00\00\00\00\00\00\04\00\00\00\04\00\00\00done")
  (table 2 funcref)
  (elem (i32.const 0) $v_runIO $v_f_q)
  ...
  (func $v_c_q (result i32)
    i32.const 96)

  (func $v_f_q (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
