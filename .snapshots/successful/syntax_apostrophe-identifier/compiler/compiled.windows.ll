...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [4 x i8]} { i32 0, i32 0, i32 0, i32 4, i32 4, [4 x i8] c"done" }
...
define internal ptr @v_c_q() {
  ret ptr getelementptr inbounds (i8, ptr @.str.0, i64 12)
}

define internal ptr @v_f_q(ptr %v_n) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.2.13:
  call void @__inc_ref(ptr %t4)
  %t14 = call ptr @__predInt32(ptr %t4)
  %t15 = getelementptr ptr, ptr %t14, i32 0
  %t16 = load ptr, ptr %t15
  %t17 = ptrtoint ptr %t16 to i64
  switch i64 %t17, label %tco.case.default.18 [ i64 3, label %tco.case.arm.3.19 i64 4, label %tco.case.arm.4.21 ]
tco.case.arm.3.19:
  %t20 = call ptr @v_c_q()
