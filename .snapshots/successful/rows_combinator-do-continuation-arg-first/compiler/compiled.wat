...
(module
  ...
  (table 5 funcref)
  (elem (i32.const 0) $v_pureEither $v_runIO $v_describe $v__lam_13 $v__df__rowmono_0_andThenEither_0)
  ...
  (func $v__df__rowmono_0_andThenEither_0 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
