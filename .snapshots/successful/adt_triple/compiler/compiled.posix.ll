...
@.str.1 = private unnamed_addr constant {i32, i32, [3 x i8]} { i32 3, i32 3, [3 x i8] c"two" }
@.str.2 = private unnamed_addr constant {i32, i32, [5 x i8]} { i32 5, i32 5, [5 x i8] c"three" }
...
define internal ptr @v_main() {
  ...
  store ptr @.str.1, ptr %t4
  %t5 = getelementptr ptr, ptr %t0, i32 3
  store ptr @.str.2, ptr %t5
...
define internal ptr @v_h0(ptr %v_a, ptr %v_b, ptr %v_c) {
  %t0 = call ptr @__concat(ptr %v_a, ptr @.str.3)
...
case.arm.4.14:
  ...
  %t18 = call ptr @__concat(ptr %t17, ptr %v_b)
...
case.arm.4.32:
  ...
  %t36 = call ptr @__concat(ptr %t35, ptr @.str.3)
...
case.arm.4.50:
  ...
  %t54 = call ptr @__concat(ptr %t53, ptr %v_c)
