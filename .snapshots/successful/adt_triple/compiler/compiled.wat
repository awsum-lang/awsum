...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (call $v_showTriple (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 16) (i32.const 3))) (i32.const 22)) (i32.store offset=4 (local.get $__con_0) (i32.const 96)) (i32.store offset=8 (local.get $__con_0) (i32.const 119)) (i32.store offset=12 (local.get $__con_0) (i32.const 142)) (local.get $__con_0)))))
