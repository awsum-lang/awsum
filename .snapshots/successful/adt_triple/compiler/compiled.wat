...
(module
  ...
  (data (i32.const 72) "\03\00\00\00\03\00\00\00one")
  (data (i32.const 83) "\03\00\00\00\03\00\00\00two")
  (data (i32.const 94) "\05\00\00\00\05\00\00\00three")
  (data (i32.const 107) "\01\00\00\00\01\00\00\00 ")
  (data (i32.const 116) "\0f\00\00\00\0f\00\00\00STRING_TOO_LONG")
  (table 4 funcref)
  ...
  (func $v_showTriple (param $v_t i32) (result i32)
    ...
    (local $v_c i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_t)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (local.set $v_c (i32.load offset=12 (local.get $__scrut))) (call $v_h0 (local.get $v_a) (local.get $v_b) (local.get $v_c))))

  (func $v_main (result i32)
    (local $__con_0 i32)
    (call $v__let_7 (call $v_showTriple (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 16))) (i32.const 19)) (i32.store offset=4 (local.get $__con_0) (i32.const 72)) (i32.store offset=8 (local.get $__con_0) (i32.const 83)) (i32.store offset=12 (local.get $__con_0) (i32.const 94)) (local.get $__con_0)))))
  ...
  (func $v_h0 (param $v_a i32) (param $v_b i32) (param $v_c i32) (result i32)
    ...
    (local $v_s2 i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $__concat (local.get $v_a) (i32.const 107))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_19_3 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_19_3)) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__concat (local.get $v_s0) (local.get $v_b))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_20_3 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_20_3)) (local.get $__con_0))) (else (local.set $v_s1 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__concat (local.get $v_s1) (i32.const 107))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_21_3 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_21_3)) (local.get $__con_0))) (else (local.set $v_s2 (i32.load offset=4 (local.get $__scrut))) (call $__concat (local.get $v_s2) (local.get $v_c))))))))))))
