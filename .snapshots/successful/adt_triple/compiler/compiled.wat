...
(module
  ...
  (global $heap (mut i32) (i32.const 211))
  ...
  (data (i32.const 84) "\00\00\00\00\00\00\00\00\00\00\00\00\03\00\00\00\03\00\00\00one")
  (data (i32.const 107) "\00\00\00\00\00\00\00\00\00\00\00\00\03\00\00\00\03\00\00\00two")
  (data (i32.const 130) "\00\00\00\00\00\00\00\00\00\00\00\00\05\00\00\00\05\00\00\00three")
  (data (i32.const 155) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00 ")
  (data (i32.const 176) "\00\00\00\00\00\00\00\00\00\00\00\00\0f\00\00\00\0f\00\00\00STRING_TOO_LONG")
  (table 4 funcref)
  (elem (i32.const 0) $v_runIO $v_showTriple $v_h0 $v__let_12)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_showTriple (param $v_t i32) (result i32)
    (local $v_a i32)
    (local $v_b i32)
    (local $v_c i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_t)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (local.set $v_c (i32.load offset=12 (local.get $__scrut))) (call $__inc_ref (local.get $v_c)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__drop_tmp (call $v_h0 (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_b)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_c)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__free_recursive (local.get $v_c)) (local.get $__drop_tmp))) (call $__free_recursive (local.get $v_b)) (local.get $__drop_tmp))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))

  (func $v_main (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (call $v_showTriple (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 16) (i32.const 3))) (i32.const 20)) (i32.store offset=4 (local.get $__con_0) (i32.const 96)) (i32.store offset=8 (local.get $__con_0) (i32.const 119)) (i32.store offset=12 (local.get $__con_0) (i32.const 142)) (local.get $__con_0)))))

  (func $v_h0 (param $v_a i32) (param $v_b i32) (param $v_c i32) (result i32)
    (local $__con_0 i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 167))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_19_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_19_3)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_19_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_19_3)) (local.get $__drop_tmp))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_b)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_20_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_20_3)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_20_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_20_3)) (local.get $__drop_tmp))) (else (local.set $v_s1 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s1)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s1)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 167))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_21_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_21_3)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_21_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_21_3)) (local.get $__drop_tmp))) (else (local.set $v_s2 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s2)) (block (result i32) (local.set $__drop_tmp (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s2)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_c)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__free_recursive (local.get $v_s2)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_s1)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_s0)) (local.get $__drop_tmp))))))
