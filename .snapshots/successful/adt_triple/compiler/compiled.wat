...
(module
  ...
  (func $v_main (result i32)
    (local $__con_0 i32)
    (call $v__let_7 (call $v_showTriple (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 16))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (i32.const 72)) (i32.store offset=8 (local.get $__con_0) (i32.const 83)) (i32.store offset=12 (local.get $__con_0) (i32.const 94)) (local.get $__con_0)))))
