...
define internal ptr @v_res() {
  ...
  %t8 = call ptr @__concat(ptr %t7, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
...
case.arm.4.42:
  ...
  call void @__inc_ref(ptr %t45)
  %t46 = call ptr @__concat(ptr %t45, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
...
case.arm.4.60:
  ...
  call void @__inc_ref(ptr %t63)
  %t64 = getelementptr ptr, ptr %t0, i32 3
...
case.default.50:
  unreachable
case.join.51:
  %t67 = phi ptr [ %t56, %case.end.3.53 ], [ %t66, %case.end.4.61 ]
...
case.default.32:
  unreachable
case.join.33:
  %t68 = phi ptr [ %t38, %case.end.3.35 ], [ %t67, %case.end.4.43 ]
...
case.default.12:
  unreachable
case.join.13:
  %t69 = phi ptr [ %t18, %case.end.3.15 ], [ %t68, %case.end.4.23 ]
