...
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"left-bool" }
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [10 x i8]} { i32 0, i32 0, i32 0, i32 10, i32 10, [10 x i8] c"right-bool" }
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.37 i64 7, label %tco.case.arm.7.39 i64 8, label %tco.case.arm.8.64 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  ...
  switch i64 %t19, label %case.default.20 [ i64 13, label %case.arm.13.22 i64 14, label %case.arm.14.24 ]
case.arm.13.22:
  br label %case.end.13.23
case.end.13.23:
  br label %case.join.21
case.arm.14.24:
  br label %case.end.14.25
case.end.14.25:
  br label %case.join.21
case.default.20:
  unreachable
case.join.21:
  %t26 = phi ptr [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.13.23 ], [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.14.25 ]
  call void @__free_recursive(ptr %t16)
  %t27 = getelementptr ptr, ptr %t12, i32 1
  ...
  %t35 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t28, ptr %t35
  %t36 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$5(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.37:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t38 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$5(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.7.39:
  ...
  %t50 = getelementptr i8, ptr %t5, i64 -8
...
reuse.copy.54:
  ...
  store ptr %t41, ptr %t62
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.57
reuse.copy.end.57:
  br label %reuse.join.55
reuse.join.55:
  %t63 = phi ptr [ %t5, %reuse.in_place.end.56 ], [ %t58, %reuse.copy.end.57 ]
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.64:
  ...
  %t75 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$5(ptr %t6, ptr %t67)
