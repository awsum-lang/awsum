...
(module
  ...
  (data (i32.const 84) "\00\00\00\00\00\00\00\00\00\00\00\00\06\00\00\00\06\00\00\00RESULT")
  (data (i32.const 110) "\00\00\00\00\00\00\00\00\00\00\00\00\07\00\00\00\07\00\00\00ignored")
  (table 3 funcref)
  (elem (i32.const 0) $v_const $v_runIO $v_partial)
  ...
  (func $v_partial (param i32) (result i32)
    (local i32)
    (local i32)
    block (result i32)
      i32.const 96
