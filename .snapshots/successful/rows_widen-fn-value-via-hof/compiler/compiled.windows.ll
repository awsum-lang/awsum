...
define internal ptr @v_main() {
  ...
  store ptr %t8, ptr %t9
  %t10 = call ptr @v_$cps$$df$$rowmono$2$andThenIO$4(ptr %t0, ptr %t7)
...
define internal ptr @v_$cps$$df$$rowmono$2$andThenIO$4(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.59 i64 7, label %tco.case.arm.7.61 i64 8, label %tco.case.arm.8.86 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  ...
  %t16 = inttoptr i64 796142685 to ptr
  ...
  switch i64 %t22, label %case.default.23 [ i64 13, label %case.arm.13.25 i64 14, label %case.arm.14.30 ]
case.arm.13.25:
  %t27 = call ptr @__alloc(i64 8, i32 0)
  %t28 = inttoptr i64 1 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  br label %case.end.13.26
case.end.13.26:
  br label %case.join.24
case.arm.14.30:
  %t32 = call ptr @__alloc(i64 8, i32 0)
  %t33 = inttoptr i64 2 to ptr
  %t34 = getelementptr ptr, ptr %t32, i32 0
  store ptr %t33, ptr %t34
  br label %case.end.14.31
case.end.14.31:
  br label %case.join.24
case.default.23:
  unreachable
case.join.24:
  %t35 = phi ptr [ %t27, %case.end.13.26 ], [ %t32, %case.end.14.31 ]
  call void @__free_recursive(ptr %t19)
  ...
  switch i64 %t41, label %case.default.42 [ i64 1, label %case.arm.1.44 i64 2, label %case.arm.2.46 ]
case.arm.1.44:
  br label %case.end.1.45
case.end.1.45:
  br label %case.join.43
case.arm.2.46:
  br label %case.end.2.47
case.end.2.47:
  br label %case.join.43
case.default.42:
  unreachable
case.join.43:
  %t48 = phi ptr [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.1.45 ], [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.2.47 ]
  call void @__free_recursive(ptr %t38)
  call void @__free_recursive(ptr %t15)
  %t49 = getelementptr ptr, ptr %t12, i32 1
  ...
  %t57 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t50, ptr %t57
  %t58 = call ptr @v_$apply$$df$$rowmono$2$andThenIO$4(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.59:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t60 = call ptr @v_$apply$$df$$rowmono$2$andThenIO$4(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.7.61:
  ...
  %t72 = getelementptr i8, ptr %t5, i64 -8
  %t73 = load i32, ptr %t72
  %t74 = icmp eq i32 %t73, 1
  br i1 %t74, label %reuse.in_place.75, label %reuse.copy.76
reuse.in_place.75:
  %t66 = getelementptr ptr, ptr %t5, i32 2
  %t67 = load ptr, ptr %t66
  call void @__free_recursive(ptr %t67)
  %t70 = inttoptr i64 24 to ptr
  %t71 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t70, ptr %t71
  call void @__inc_ref(ptr %t6)
  %t68 = getelementptr ptr, ptr %t5, i32 1
  store ptr %t6, ptr %t68
  %t69 = getelementptr ptr, ptr %t5, i32 2
  store ptr %t63, ptr %t69
  br label %reuse.in_place.end.78
reuse.in_place.end.78:
  br label %reuse.join.77
reuse.copy.76:
  ...
  store ptr %t6, ptr %t83
  call void @__inc_ref(ptr %t63)
  %t84 = getelementptr ptr, ptr %t80, i32 2
  store ptr %t63, ptr %t84
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.79
reuse.copy.end.79:
  br label %reuse.join.77
reuse.join.77:
  %t85 = phi ptr [ %t5, %reuse.in_place.end.78 ], [ %t80, %reuse.copy.end.79 ]
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$df$$rowmono$2$andThenIO$4(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.26.12:
  ...
  %t17 = getelementptr ptr, ptr %t15, i32 0
  store ptr %t16, ptr %t17
  %t18 = call ptr @v_$cps$$df$$rowmono$2$andThenIO$4(ptr %t6, ptr %t15)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  store ptr %t14, ptr %t3
