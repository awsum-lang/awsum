...
(() => {
  ...
  const v_$cps$$df$handleErrorIO$0 = (v_io, v_$k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 8: {
          const v_cont = v_io[1];
          return v_$apply$$df$handleErrorIO$0(v_$k, [8, [16, v_cont]]);
        }
      }
    }
  };

  const v_$apply$$df$$rowmono$2$andThenIO$4 = (v_$k, v_$x) => {
    while (true) {
      switch (v_$k[0]) {
        case 23: {
          return v_$x;
  ...
  const v_$cps$$df$$rowmono$2$andThenIO$4 = (v_io, v_$k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          const v_$inl8$r = [
          ...
          return v_$apply$$df$$rowmono$2$andThenIO$4(
            v_$k,
            [
              7,
              (s => {
        ...
        case 6: {
          return v_$apply$$df$$rowmono$2$andThenIO$4(v_$k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
        ...
        case 8: {
          const v_cont = v_io[1];
          return v_$apply$$df$$rowmono$2$andThenIO$4(v_$k, [8, [15, v_cont]]);
        }
      }
    }
  };
  ...
  const v_$apply$$scc$$apply1__$df$$lam$14$5__$df$$lam$9$1 = (v_$k, v_$x) => {
    while (true) {
      switch (v_$k[0]) {
        ...
        case 26: {
          v_$k = v_$k[1];
          v_$x = v_$cps$$df$$rowmono$2$andThenIO$4(v_$x, [23]);
          continue;
        }
        case 27: {
          v_$k = v_$k[1];
          v_$x = v_$cps$$df$handleErrorIO$0(v_$x, [21]);
          continue;
        }
      }
    }
  ...
  const v_runIO = v_io => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 7: {
          const v_$inl11$eff = __print(v_io[1]);
          v_io = v_io[2];
          continue;
        }
        case 8: {
          const __t0 = (() => {
            const v_$inl12$$arg0 = __getArgs();
            return v_$cps$$scc$$apply1__$df$$lam$14$5__$df$$lam$9$1(
              [18, v_io[1], v_$inl12$$arg0],
              [25]
            );
          })();
          v_io = __t0;
  ...
  const main = v_$cps$$df$handleErrorIO$0(
    v_$cps$$df$$rowmono$2$andThenIO$4([8, [17]], [23]),
    [21]
  );
