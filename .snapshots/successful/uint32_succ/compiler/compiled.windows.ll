...
define internal ptr @v_res() {
  ...
  switch i64 %t4, label %case.default.5 [ i64 3, label %case.arm.3.7 i64 4, label %case.arm.4.10 ]
case.arm.3.7:
  %t9 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
  br label %case.end.3.8
case.end.3.8:
  br label %case.join.6
case.arm.4.10:
  %t12 = getelementptr ptr, ptr %t1, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  %t14 = call ptr @__showUInt32(ptr %t13)
  %t15 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.2, i64 12), ptr %t14)
  br label %case.end.4.11
case.end.4.11:
  br label %case.join.6
case.default.5:
  unreachable
case.join.6:
  %t16 = phi ptr [ %t9, %case.end.3.8 ], [ %t15, %case.end.4.11 ]
...
case.arm.4.30:
  %t32 = getelementptr ptr, ptr %t16, i32 1
  ...
  %t39 = getelementptr ptr, ptr %t34, i32 0
  %t40 = load ptr, ptr %t39
  %t41 = ptrtoint ptr %t40 to i64
  switch i64 %t41, label %case.default.42 [ i64 3, label %case.arm.3.44 i64 4, label %case.arm.4.47 ]
case.arm.3.44:
  %t46 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
  br label %case.end.3.45
case.end.3.45:
  br label %case.join.43
case.arm.4.47:
  %t49 = getelementptr ptr, ptr %t34, i32 1
  %t50 = load ptr, ptr %t49
  call void @__inc_ref(ptr %t50)
  %t51 = call ptr @__showUInt32(ptr %t50)
  %t52 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.2, i64 12), ptr %t51)
...
case.default.42:
  unreachable
case.join.43:
  %t53 = phi ptr [ %t46, %case.end.3.45 ], [ %t52, %case.end.4.48 ]
  %t54 = getelementptr ptr, ptr %t53, i32 0
  %t55 = load ptr, ptr %t54
  %t56 = ptrtoint ptr %t55 to i64
  switch i64 %t56, label %case.default.57 [ i64 3, label %case.arm.3.59 i64 4, label %case.arm.4.67 ]
case.arm.3.59:
...
case.arm.4.67:
  %t69 = getelementptr ptr, ptr %t53, i32 1
  ...
  store i32 -2147483648, ptr %t74
  %t75 = getelementptr ptr, ptr %t71, i32 1
  store ptr %t74, ptr %t75
  %t76 = getelementptr ptr, ptr %t71, i32 0
  %t77 = load ptr, ptr %t76
  %t78 = ptrtoint ptr %t77 to i64
  switch i64 %t78, label %case.default.79 [ i64 3, label %case.arm.3.81 i64 4, label %case.arm.4.84 ]
case.arm.3.81:
  %t83 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
  br label %case.end.3.82
case.end.3.82:
  br label %case.join.80
case.arm.4.84:
  %t86 = getelementptr ptr, ptr %t71, i32 1
...
case.default.79:
  unreachable
case.join.80:
  %t90 = phi ptr [ %t83, %case.end.3.82 ], [ %t89, %case.end.4.85 ]
...
case.arm.4.104:
  ...
  %t108 = call ptr @v_minUInt32()
  %t109 = call ptr @__succUInt32(ptr %t108)
...
case.arm.4.138:
  ...
  call void @__inc_ref(ptr %t33)
  %t142 = call ptr @__concat(ptr %t33, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
...
case.arm.4.156:
  ...
  call void @__inc_ref(ptr %t159)
  call void @__inc_ref(ptr %t70)
  %t160 = call ptr @__concat(ptr %t159, ptr %t70)
...
case.arm.4.174:
  ...
  call void @__inc_ref(ptr %t177)
  %t178 = call ptr @__concat(ptr %t177, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
  %t179 = getelementptr ptr, ptr %t178, i32 0
  %t180 = load ptr, ptr %t179
  %t181 = ptrtoint ptr %t180 to i64
  switch i64 %t181, label %case.default.182 [ i64 3, label %case.arm.3.184 i64 4, label %case.arm.4.192 ]
case.arm.3.184:
...
case.arm.4.228:
  %t230 = getelementptr ptr, ptr %t214, i32 1
  %t231 = load ptr, ptr %t230
  call void @__inc_ref(ptr %t231)
  call void @__inc_ref(ptr %t231)
  call void @__inc_ref(ptr %t141)
  %t232 = call ptr @__concat(ptr %t231, ptr %t141)
...
case.default.218:
  unreachable
case.join.219:
  %t233 = phi ptr [ %t224, %case.end.3.221 ], [ %t232, %case.end.4.229 ]
  call void @__free_recursive(ptr %t214)
  br label %case.end.4.211
case.end.4.211:
  br label %case.join.201
case.default.200:
  unreachable
case.join.201:
  %t234 = phi ptr [ %t206, %case.end.3.203 ], [ %t233, %case.end.4.211 ]
...
case.default.182:
  unreachable
case.join.183:
  %t235 = phi ptr [ %t188, %case.end.3.185 ], [ %t234, %case.end.4.193 ]
...
case.default.164:
  unreachable
case.join.165:
  %t236 = phi ptr [ %t170, %case.end.3.167 ], [ %t235, %case.end.4.175 ]
...
case.default.146:
  unreachable
case.join.147:
  %t237 = phi ptr [ %t152, %case.end.3.149 ], [ %t236, %case.end.4.157 ]
...
case.default.128:
  unreachable
case.join.129:
  %t238 = phi ptr [ %t134, %case.end.3.131 ], [ %t237, %case.end.4.139 ]
...
case.default.94:
  unreachable
case.join.95:
  %t239 = phi ptr [ %t100, %case.end.3.97 ], [ %t238, %case.end.4.105 ]
  call void @__free_recursive(ptr %t90)
  call void @__free_recursive(ptr %t71)
  br label %case.end.4.68
case.end.4.68:
  br label %case.join.58
case.default.57:
  unreachable
case.join.58:
  %t240 = phi ptr [ %t63, %case.end.3.60 ], [ %t239, %case.end.4.68 ]
...
case.default.20:
  unreachable
case.join.21:
  %t241 = phi ptr [ %t26, %case.end.3.23 ], [ %t240, %case.end.4.31 ]
