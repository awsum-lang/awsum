...
(() => {
  ...
  const v_runIO = v_io => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 7: {
          const v_$inl6$eff = __print(v_io[1]);
          v_io = v_io[2];
          continue;
        }
      }
  ...
  const v_$inl13$pair = [24, "hello", "world"];
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
        ...
        const v_$inl8$s0 = s[1];
        {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              ...
              {
                const __s = __concat(v_$inl10$s1, v_$inl13$pair[2]);
                switch (__s[0]) {
                  case 3: {
