...
(module
  ...
  (global $heap (mut i32) (i32.const 233))
  ...
  (data (i32.const 148) "\00\00\00\00\00\00\00\00\00\00\00\00\05\00\00\00\05\00\00\00hello")
  (data (i32.const 173) "\00\00\00\00\00\00\00\00\00\00\00\00\05\00\00\00\05\00\00\00world")
  (data (i32.const 198) "\00\00\00\00\00\00\00\00\00\00\00\00\0f\00\00\00\0f\00\00\00STRING_TOO_LONG")
  (table 4 funcref)
  (elem (i32.const 0) $v_runIO $v_showPair $v_showPairBody $v__let_12)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_showPair (param $v_pair i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_pair)) (local.set $v_first (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_first)) (local.set $v_second (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_second)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__drop_tmp (call $v_showPairBody (block (result i32) (local.set $__inc_tmp (local.get $v_first)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_second)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__free_recursive (local.get $v_second)) (local.get $__drop_tmp))) (call $__free_recursive (local.get $v_first)) (local.get $__drop_tmp))))
  ...
  (func $v_showPairBody (param $v_first i32) (param $v_second i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (call $__concat (i32.const 96) (block (result i32) (local.set $__inc_tmp (local.get $v_first)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_12_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_12_3)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_12_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_12_3)) (local.get $__drop_tmp))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 117))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_13_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_13_3)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_13_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_13_3)) (local.get $__drop_tmp))) (else (local.set $v_s1 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s1)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s1)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_second)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_14_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_14_3)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_14_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_14_3)) (local.get $__drop_tmp))) (else (local.set $v_s2 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s2)) (block (result i32) (local.set $__drop_tmp (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s2)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 139))) (call $__free_recursive (local.get $v_s2)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_s1)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_s0)) (local.get $__drop_tmp))))))

  (func $v_main (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (call $v_showPair (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 20)) (i32.store offset=4 (local.get $__con_0) (i32.const 160)) (i32.store offset=8 (local.get $__con_0) (i32.const 185)) (local.get $__con_0)))))
