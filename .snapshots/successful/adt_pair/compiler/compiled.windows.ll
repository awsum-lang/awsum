...
@.str.4 = private unnamed_addr constant {i32, i32, [5 x i8]} { i32 5, i32 5, [5 x i8] c"world" }
...
case.default.3:
  unreachable
case.join.4:
  %t12 = phi ptr [%t11, %case.end.19.6]
  ret ptr %t12
}

define internal ptr @v_showPairBody(ptr %v_first, ptr %v_second) {
  %t0 = call ptr @__concat(ptr @.str.0, ptr %v_first)
...
case.arm.4.14:
  ...
  %t18 = call ptr @__concat(ptr %t17, ptr @.str.1)
...
case.arm.4.32:
  ...
  %t36 = call ptr @__concat(ptr %t35, ptr %v_second)
...
case.arm.4.50:
  ...
  %t54 = call ptr @__concat(ptr %t53, ptr @.str.2)
...
define internal ptr @v_main() {
  ...
  store ptr @.str.3, ptr %t3
  %t4 = getelementptr ptr, ptr %t0, i32 2
  store ptr @.str.4, ptr %t4
