...
define internal ptr @v_res() {
  ...
  %t7 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.2, i64 12), ptr %t6)
  %t8 = getelementptr ptr, ptr %t7, i32 0
  %t9 = load ptr, ptr %t8
  %t10 = ptrtoint ptr %t9 to i64
  switch i64 %t10, label %case.default.11 [ i64 3, label %case.arm.3.13 i64 4, label %case.arm.4.21 ]
case.arm.3.13:
...
case.arm.4.21:
  %t23 = getelementptr ptr, ptr %t7, i32 1
  %t24 = load ptr, ptr %t23
  call void @__inc_ref(ptr %t24)
  call void @__inc_ref(ptr %t24)
  %t25 = call ptr @__concat(ptr %t24, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
...
case.arm.4.39:
  ...
  call void @__inc_ref(ptr %t42)
  %t43 = getelementptr ptr, ptr %t0, i32 2
  %t44 = load ptr, ptr %t43
  call void @__inc_ref(ptr %t44)
  %t45 = call ptr @__concat(ptr %t42, ptr %t44)
...
case.arm.4.59:
  ...
  call void @__inc_ref(ptr %t62)
  %t63 = call ptr @__concat(ptr %t62, ptr getelementptr inbounds (i8, ptr @.str.4, i64 12))
...
case.default.49:
  unreachable
case.join.50:
  %t64 = phi ptr [ %t55, %case.end.3.52 ], [ %t63, %case.end.4.60 ]
...
case.default.29:
  unreachable
case.join.30:
  %t65 = phi ptr [ %t35, %case.end.3.32 ], [ %t64, %case.end.4.40 ]
...
case.default.11:
  unreachable
case.join.12:
  %t66 = phi ptr [ %t17, %case.end.3.14 ], [ %t65, %case.end.4.22 ]
