...
define internal ptr @v_showPairBody(ptr %v_first, ptr %v_second) {
  ...
  %t4 = call ptr @__concat(ptr %t3, ptr %v_first)
...
case.arm.1.19:
  ...
  %t26 = getelementptr [3 x i8], ptr @.str.1, i64 0, i64 0
...
case.arm.1.42:
  ...
  %t49 = call ptr @__concat(ptr %t45, ptr %v_second)
...
case.arm.1.64:
  ...
  %t71 = getelementptr [2 x i8], ptr @.str.2, i64 0, i64 0
