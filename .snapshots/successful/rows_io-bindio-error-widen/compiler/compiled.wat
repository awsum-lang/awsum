...
(module
  ...
  (func $v_step (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
  ...
  (func $v__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1__lift_14 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
