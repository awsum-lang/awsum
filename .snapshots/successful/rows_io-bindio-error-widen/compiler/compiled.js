...
(() => {
  ...
  const v__cps__lift_13 = (v___input, v__k) => {
    while (true) {
      switch (v___input[0]) {
        ...
        case 8: {
          const v___f0 = v___input[1];
          return v__apply__lift_13(v__k, [8, [28, v___f0]]);
        }
      }
    }
  };
  ...
  const v__apply__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1__lift_14 = (
    ...
    while (true) {
      switch (v__k[0]) {
        ...
        case 40: {
          v__k = v__k[1];
          v__x = v__cps__df_handleErrorIO_4(v__x, [37]);
          continue;
        }
        case 41: {
          v__k = v__k[1];
          v__x = v__cps__df__rowmono_0_bindIO_0(v__x, [35]);
          continue;
        }
        case 42: {
          v__k = v__k[1];
          v__x = v__cps__lift_13(v__x, [33]);
          continue;
        }
      }
    }
  ...
  const v__cps__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1__lift_14 = (
    v__args,
    v__k
  ) => {
    while (true) {
      switch (v__args[0]) {
        case 29: {
          ...
          switch (v__cl[0]) {
            ...
            case 27: {
              return v__apply__scc__apply1__df__lam_9_5__df__rowmono_1_bindIOAfterArgs_1__lift_14(
                v__k,
                (s => {
                  switch (s[0]) {
                    case 3: {
  ...
  const v_combined = v__cps__df__rowmono_0_bindIO_0([8, [27]], [35]);

  const main = v__cps__df_handleErrorIO_4(v_combined, [37]);
