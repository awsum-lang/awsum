...
(() => {
    ...
    while (true) {
      switch (v_____input[0]) {
        ...
        case 6: {
          ...
          return v_$apply$$lift$13(v_$k, [6, [718021640, v_____f0]]);
        }
        case 7: {
          const v_____f0 = v_____input[1];
          const v_____f1 = v_____input[2];
          v_$k = [34, v_$k, v_____f0];
          v_____input = v_____f1;
          continue;
        }
        case 8: {
          const v_____f0 = v_____input[1];
          return v_$apply$$lift$13(v_$k, [8, [28, v_____f0]]);
        }
      }
    }
  };
  ...
  const v_$cps$$df$$rowmono$0$bindIO$0 = (v_io, v_$k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v_$apply$$df$$rowmono$0$bindIO$0(
            v_$k,
            v_$cps$$lift$13([6, [24]], [33])
          );
        }
        case 6: {
  ...
  const v_$apply$$scc$$apply1__$df$$lam$9$5__$df$$rowmono$1$bindIOAfterArgs$1__$lift$14 = (
    v_$k,
    v_$x
  ) => {
    while (true) {
      switch (v_$k[0]) {
        ...
        case 40: {
          v_$k = v_$k[1];
          v_$x = v_$cps$$df$handleErrorIO$4(v_$x, [37]);
          continue;
        }
        case 41: {
          v_$k = v_$k[1];
          v_$x = v_$cps$$df$$rowmono$0$bindIO$0(v_$x, [35]);
          continue;
        }
        case 42: {
          v_$k = v_$k[1];
          v_$x = v_$cps$$lift$13(v_$x, [33]);
          continue;
        }
      }
    }
  ...
  const v_$cps$$scc$$apply1__$df$$lam$9$5__$df$$rowmono$1$bindIOAfterArgs$1__$lift$14 = (
    v_$args,
    v_$k
  ) => {
    while (true) {
      switch (v_$args[0]) {
        case 29: {
          ...
          switch (v_$cl[0]) {
            ...
            case 27: {
              return v_$apply$$scc$$apply1__$df$$lam$9$5__$df$$rowmono$1$bindIOAfterArgs$1__$lift$14(
                v_$k,
                (s => {
                  switch (s[0]) {
                    case 3: {
      ...
      switch (v_io[0]) {
        ...
        case 8: {
          const __t0 = (() => {
            ...
            return v_$cps$$scc$$apply1__$df$$lam$9$5__$df$$rowmono$1$bindIOAfterArgs$1__$lift$14(
              [29, v_io[1], v_$inl6$$arg0],
              [39]
            );
          })();
          v_io = __t0;
  ...
  const v_combined = v_$cps$$df$$rowmono$0$bindIO$0([8, [27]], [35]);

  const main = v_$cps$$df$handleErrorIO$4(v_combined, [37]);
