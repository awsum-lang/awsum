...
define internal ptr @v_step(ptr %v__a) {
...
define internal ptr @v_combined() {
  ...
  store ptr %t3, ptr %t6
  %t7 = call ptr @v__df__rowmono_0_bindIO_0(ptr %t0)
  ret ptr %t7
}

define internal ptr @v_handler(ptr %v_e) {
  %t0 = getelementptr ptr, ptr %v_e, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 502975519, label %case.arm.502975519.4 i64 589989748, label %case.arm.589989748.19 i64 718021640, label %case.arm.718021640.34 ]
...
case.arm.589989748.19:
  ...
  call void @__free_recursive(ptr %v_e)
  ret ptr %t22
case.arm.718021640.34:
  %t35 = getelementptr ptr, ptr %v_e, i32 1
...
tco.case.arm.6.19:
  ...
  %t26 = inttoptr i64 718021640 to ptr
...
define internal ptr @v__df__rowmono_0_bindIO_0(ptr %v_io) {
  call void @__inc_ref(ptr %v_io)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 47 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__df__rowmono_0_bindIO_0(ptr %v_io, ptr %t0)
...
tco.case.arm.6.17:
  ...
  %t24 = call ptr @v__apply__df__rowmono_0_bindIO_0(ptr %t6, ptr %t20)
...
tco.case.arm.8.48:
  ...
  %t59 = call ptr @v__apply__df__rowmono_0_bindIO_0(ptr %t6, ptr %t51)
...
tco.case.arm.9.60:
  ...
  %t71 = call ptr @v__apply__df__rowmono_0_bindIO_0(ptr %t6, ptr %t63)
...
tco.case.arm.10.72:
  ...
  %t83 = call ptr @v__apply__df__rowmono_0_bindIO_0(ptr %t6, ptr %t75)
...
tco.case.arm.6.19:
  ...
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t21)
  %t22 = call ptr @v_handler(ptr %t21)
...
tco.case.arm.35.11:
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 25, label %tco.case.arm.25.20 i64 26, label %tco.case.arm.26.40 i64 27, label %tco.case.arm.27.60 i64 28, label %tco.case.arm.28.80 i64 29, label %tco.case.arm.29.100 i64 30, label %tco.case.arm.30.120 i64 31, label %tco.case.arm.31.140 i64 32, label %tco.case.arm.32.143 i64 33, label %tco.case.arm.33.163 i64 34, label %tco.case.arm.34.183 ]
tco.case.arm.25.20:
...
tco.case.arm.52.12:
  ...
  call void @__inc_ref(ptr %t14)
  call void @__inc_ref(ptr %t6)
  %t15 = call ptr @v__df_handleErrorIO_4(ptr %t6)
  call void @__inc_ref(ptr %t14)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t14)
...
tco.case.arm.53.16:
  ...
  call void @__inc_ref(ptr %t6)
  %t19 = call ptr @v__df_handleErrorIO_4(ptr %t6)
  call void @__inc_ref(ptr %t18)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
tco.case.arm.54.20:
  ...
  call void @__inc_ref(ptr %t22)
  call void @__inc_ref(ptr %t6)
  %t23 = call ptr @v__df_handleErrorIO_4(ptr %t6)
  call void @__inc_ref(ptr %t22)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t22)
...
tco.case.arm.55.24:
  ...
  call void @__inc_ref(ptr %t26)
  call void @__inc_ref(ptr %t6)
  %t27 = call ptr @v__df__rowmono_0_bindIO_0(ptr %t6)
  call void @__inc_ref(ptr %t26)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
tco.case.arm.56.28:
  ...
  call void @__inc_ref(ptr %t30)
  call void @__inc_ref(ptr %t6)
  %t31 = call ptr @v__df__rowmono_0_bindIO_0(ptr %t6)
  call void @__inc_ref(ptr %t30)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t30)
...
tco.case.arm.57.32:
  ...
  call void @__inc_ref(ptr %t6)
  %t35 = call ptr @v__df__rowmono_0_bindIO_0(ptr %t6)
  call void @__inc_ref(ptr %t34)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
