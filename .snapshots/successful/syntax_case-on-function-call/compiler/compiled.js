...
function main(v__input){
    return (v__let_2)(((s) => { switch(s[0]) { case 0: { const v_e = s[1]; return [0, v_e]; } case 1: { const v___p0 = s[1]; return ((s) => { switch(s[0]) { case 0: { const v_v = s[1]; return [1, v_v]; } case 1: { return [1, "nothing"]; } } })(v___p0); } } })((v_search)("hello")));
}
