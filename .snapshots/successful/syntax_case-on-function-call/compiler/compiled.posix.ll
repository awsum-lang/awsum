...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [6 x i8]} { i32 0, i32 0, i32 0, i32 6, i32 6, [6 x i8] c"found:" }
...
define internal ptr @v_search(ptr %v_key) {
  call void @__inc_ref(ptr %v_key)
  %t0 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr %v_key)
...
case.arm.3.5:
  ...
  call void @__free_recursive(ptr %v_key)
  ret ptr %t8
case.arm.4.12:
...
define internal ptr @v_main() {
  %t0 = call ptr @v_search(ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
  %t1 = getelementptr ptr, ptr %t0, i32 0
  %t2 = load ptr, ptr %t1
  %t3 = ptrtoint ptr %t2 to i64
...
case.arm.4.14:
  ...
  %t19 = load ptr, ptr %t18
  %t20 = ptrtoint ptr %t19 to i64
  switch i64 %t20, label %case.default.21 [ i64 24, label %case.arm.24.23 ]
case.arm.24.23:
  ...
  br label %case.end.24.24
case.end.24.24:
  br label %case.join.22
case.default.21:
  unreachable
case.join.22:
  %t31 = phi ptr [ %t27, %case.end.24.24 ]
...
case.default.4:
  unreachable
case.join.5:
  %t32 = phi ptr [ %t10, %case.end.3.7 ], [ %t31, %case.end.4.15 ]
  call void @__free_recursive(ptr %t0)
  %t33 = call ptr @v__let_18(ptr %t32)
  ret ptr %t33
}
