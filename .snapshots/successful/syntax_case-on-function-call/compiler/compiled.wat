...
(module
  ...
  (func $v_search (param $v_key i32) (result i32)
    ...
    (local $v_found i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $__concat (i32.const 65) (local.get $v_key))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__do_e_8_3 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_8_3)) (local.get $__con_0))) (else (local.set $v_found (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_1) (local.get $v_found)) (local.get $__con_1))) (local.get $__con_0))))))
