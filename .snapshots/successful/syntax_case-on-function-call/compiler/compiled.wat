...
(module
  ...
  (global $heap (mut i32) (i32.const 170))
  ...
  (data (i32.const 84) "\00\00\00\00\00\00\00\00\00\00\00\00\06\00\00\00\06\00\00\00found:")
  (data (i32.const 110) "\00\00\00\00\00\00\00\00\00\00\00\00\05\00\00\00\05\00\00\00hello")
  (data (i32.const 135) "\00\00\00\00\00\00\00\00\00\00\00\00\0f\00\00\00\0f\00\00\00STRING_TOO_LONG")
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v_search $v__let_12)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_search (param $v_key i32) (result i32)
    (local $__con_0 i32)
    (local $__con_1 i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (call $__concat (i32.const 96) (block (result i32) (local.set $__inc_tmp (local.get $v_key)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_8_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_8_3)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_8_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_8_3)) (local.get $__drop_tmp))) (else (local.set $v_found (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_found)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 20)) (i32.store offset=4 (local.get $__con_1) (local.get $v_found)) (call $__inc_ref (i32.load offset=4 (local.get $__con_1))) (local.get $__con_1))) (local.get $__con_0))) (call $__free_recursive (local.get $v_found)) (local.get $__drop_tmp))))))
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (block (result i32) (local.set $__scrut (call $v_search (i32.const 122))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__scrut (local.get $v___p0)) (local.set $v_v (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_v)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (local.get $v_v)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))))))))
