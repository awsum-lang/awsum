...
define internal ptr @v_main() {
  ...
  switch i64 %t16, label %case.default.17 [ i64 25, label %case.arm.25.19 ]
case.arm.25.19:
...
case.default.28:
  unreachable
case.join.29:
  %t34 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.1.31 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.2.33 ]
...
case.default.17:
  unreachable
case.join.18:
  %t35 = phi ptr [ %t34, %case.end.25.20 ]
