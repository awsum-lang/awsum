...
const v_render = ((s) => { switch(s[0]) { case 3: { const v__do_e_6 = s[1]; return [3, v__do_e_6]; } case 4: { const v_r01 = s[1]; return ((s) => { switch(s[0]) { case 3: { const v__do_e_5 = s[1]; return [3, v__do_e_5]; } case 4: { const v_r02 = s[1]; return ((s) => { switch(s[0]) { case 3: { const v__do_e_4 = s[1]; return [3, v__do_e_4]; } case 4: { const v_r03 = s[1]; return ((s) => { switch(s[0]) { case 3: { const v__do_e_3 = s[1]; return [3, v__do_e_3]; } case 4: { const v_r04 = s[1]; return (v_appendTagged)(v_r04, "remappedY", (v_showABC)(v_remappedY)); } } })((v_appendTagged)(v_r03, "remappedX", (v_showABC)(v_remappedX))); } } })((v_appendTagged)(v_r02, "mappedOk", (v_showAB)(v_mappedOk))); } } })((v_appendTagged)(v_r01, "mappedB", (v_showAB)(v_mappedB))); } } })((v_tagged)("mappedA", (v_showAB)(v_mappedA)));

const v__cps__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_18__lift_19__lift_2__lift_20__lift_24__lift_25__lift_26__lift_3__lift_4 = (v__args, v__k) => {
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
          ...
          const v__arg0 = __s[2];
          {
            ...
            switch (__s[0]) {
              ...
              case 43: {
                ...
                const __t0 = (v__args[0] = 59, v__args[1] = v__cap43_0, v__args[2] = v__arg0, v__args);
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
        ...
        case 45: {
          ...
          const __t0 = (v__args[0] = 44, v__args[1] = v_cont, v__args[2] = v_result, v__args);
          const __t1 = [71, v__k];
          v__args = __t0;
          v__k = __t1;
          continue;
        ...
        case 47: {
          const v_cont = __s[1];
          const v_bytes = __s[2];
          const __t0 = (v__args[0] = 44, v__args[1] = v_cont, v__args[2] = v_bytes, v__args);
          const __t1 = [73, v__k];
          v__args = __t0;
          v__k = __t1;
          continue;
        ...
        case 51: {
          const v___f = __s[1];
          const v___arg = __s[2];
          const __t0 = (v__args[0] = 44, v__args[1] = v___f, v__args[2] = v___arg, v__args);
          const __t1 = [77, v__k];
          v__args = __t0;
          v__k = __t1;
          continue;
...
const v__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_18__lift_19__lift_2__lift_20__lift_24__lift_25__lift_26__lift_3__lift_4 = (v__args) => {
    return (v__cps__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_18__lift_19__lift_2__lift_20__lift_24__lift_25__lift_26__lift_3__lift_4)(v__args, [70]);
};
...
const v__apply1 = (v__cl, v__arg0) => {
    return (v__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_18__lift_19__lift_2__lift_20__lift_24__lift_25__lift_26__lift_3__lift_4)([44, v__cl, v__arg0]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        case 5: {
          const v___f0 = __s[1];
          return (v__apply__lift_23)(v__k, [5, v___f0]);
        }
        case 6: {
          const v___f0 = __s[1];
          return (v__apply__lift_23)(v__k, [6, v___f0]);
        }
        case 7: {
          const v___f0 = __s[1];
          const v___f1 = __s[2];
          const __t0 = v___f1;
          const __t1 = (v___input[0] = 65, v___input[1] = v__k, v___input[2] = v___f0, v___input);
          v___input = __t0;
          v__k = __t1;
          continue;
        }
        case 8: {
          const v___f0 = __s[1];
          return (v__apply__lift_23)(v__k, [8, [39, v___f0]]);
        }
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_23)(v__k, [9, [40, v___f0]]);
        }
        case 10: {
          const v___f0 = __s[1];
          return (v__apply__lift_23)(v__k, [10, [41, v___f0]]);
        }
      }
    }
  }
...
const v__lift_23 = (v___input) => {
    return (v__cps__lift_23)(v___input, [64]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 7: {
          ...
          const v___f1 = __s[2];
          const __t0 = v___f1;
          const __t1 = (v___input[0] = 63, v___input[1] = v__k, v___input[2] = v___f0, v___input);
          v___input = __t0;
          v__k = __t1;
          continue;
        }
        case 8: {
          const v___f0 = __s[1];
          return (v__apply__lift_17)(v__k, [8, [35, v___f0]]);
        }
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_17)(v__k, [9, [36, v___f0]]);
        }
        case 10: {
          const v___f0 = __s[1];
          return (v__apply__lift_17)(v__k, [10, [38, v___f0]]);
        }
      }
    }
  }
...
const v__lift_17 = (v___input) => {
    return (v__cps__lift_17)(v___input, [62]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 8: {
          const v___f0 = __s[1];
          return (v__apply__lift_1)(v__k, [8, [37, v___f0]]);
        }
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_1)(v__k, [9, [42, v___f0]]);
        }
        case 10: {
          const v___f0 = __s[1];
          return (v__apply__lift_1)(v__k, [10, [43, v___f0]]);
        }
      }
    }
  }
...
const v__lift_1 = (v___input) => {
    return (v__cps__lift_1)(v___input, [60]);
};
...
const v__df_handleErrorIO_3 = (v_io) => {
    return (v__cps__df_handleErrorIO_3)(v_io, [66]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        case 5: {
          const v_a = __s[1];
          return (v__apply__df_andThenIO_7)(v__k, (v__lift_1)((v__bi_IO_Stdout_print)(v_a)));
        }
        case 6: {
          const v_e = __s[1];
...
const v__df_andThenIO_7 = (v_io) => {
    return (v__cps__df_andThenIO_7)(v_io, [68]);
};

const main = (v__df_handleErrorIO_3)((v__df_andThenIO_7)((v__lift_23)((v_eitherToIO)(v_render))));
