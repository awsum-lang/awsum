...
const v_leftY = [3, [3640903312, [24]]];

const v_leftX = [3, [3657680931, [23]]];

const v_leftSrc = [3, [22]];
...
const v__cps__scc__apply1__df__lam_10_4__df__lam_11_5__df__lam_4_7__df__lam_5_8__lift_13__lift_14__lift_16__lift_17__lift_2__lift_3 = (v__args, v__k) => {
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
          ...
          const v__arg0 = __s[2];
          {
            ...
            switch (__s[0]) {
              ...
              case 36: {
                ...
                const __t0 = (v__args[0] = 47, v__args[1] = v__cap36_0, v__args[2] = v__arg0, v__args);
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
...
const v__scc__apply1__df__lam_10_4__df__lam_11_5__df__lam_4_7__df__lam_5_8__lift_13__lift_14__lift_16__lift_17__lift_2__lift_3 = (v__args) => {
    return (v__cps__scc__apply1__df__lam_10_4__df__lam_11_5__df__lam_4_7__df__lam_5_8__lift_13__lift_14__lift_16__lift_17__lift_2__lift_3)(v__args, [58]);
};
...
const v__apply1 = (v__cl, v__arg0) => {
    return (v__scc__apply1__df__lam_10_4__df__lam_11_5__df__lam_4_7__df__lam_5_8__lift_13__lift_14__lift_16__lift_17__lift_2__lift_3)([37, v__cl, v__arg0]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        case 5: {
          const v___f0 = __s[1];
          return (v__apply__lift_15)(v__k, [5, v___f0]);
        }
        case 6: {
          const v___f0 = __s[1];
          return (v__apply__lift_15)(v__k, [6, v___f0]);
        }
        case 7: {
          const v___f0 = __s[1];
          const v___f1 = __s[2];
          const __t0 = v___f1;
          const __t1 = (v___input[0] = 53, v___input[1] = v__k, v___input[2] = v___f0, v___input);
          v___input = __t0;
          v__k = __t1;
          continue;
        }
        case 8: {
          const v___f0 = __s[1];
          return (v__apply__lift_15)(v__k, [8, [33, v___f0]]);
        }
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_15)(v__k, [9, [34, v___f0]]);
        }
      }
    }
  }
...
const v__lift_15 = (v___input) => {
    return (v__cps__lift_15)(v___input, [52]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 7: {
          ...
          const v___f1 = __s[2];
          const __t0 = v___f1;
          const __t1 = (v___input[0] = 51, v___input[1] = v__k, v___input[2] = v___f0, v___input);
          v___input = __t0;
          v__k = __t1;
          continue;
        }
        case 8: {
          const v___f0 = __s[1];
          return (v__apply__lift_12)(v__k, [8, [31, v___f0]]);
        }
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_12)(v__k, [9, [32, v___f0]]);
        }
      }
    }
  }
...
const v__lift_12 = (v___input) => {
    return (v__cps__lift_12)(v___input, [50]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 8: {
          const v_cont = __s[1];
          return (v__apply__df_handleErrorIO_3)(v__k, [8, [27, v_cont]]);
        }
        case 9: {
          const v_cont = __s[1];
          return (v__apply__df_handleErrorIO_3)(v__k, [9, [28, v_cont]]);
        }
      }
    }
  }
...
const v__df_handleErrorIO_3 = (v_io) => {
    return (v__cps__df_handleErrorIO_3)(v_io, [54]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        case 5: {
          const v_a = __s[1];
          return (v__apply__df_andThenIO_6)(v__k, (v__lift_1)((v__bi_IO_Stdout_print)(v_a)));
        }
        case 6: {
          const v_e = __s[1];
        ...
        case 8: {
          const v_cont = __s[1];
          return (v__apply__df_andThenIO_6)(v__k, [8, [29, v_cont]]);
        }
        case 9: {
          const v_cont = __s[1];
          return (v__apply__df_andThenIO_6)(v__k, [9, [30, v_cont]]);
        }
      }
    }
  }
...
const v__df_andThenIO_6 = (v_io) => {
    return (v__cps__df_andThenIO_6)(v_io, [56]);
};

const main = (v__df_handleErrorIO_3)((v__df_andThenIO_6)((v__lift_15)((v_eitherToIO)(v_render))));
