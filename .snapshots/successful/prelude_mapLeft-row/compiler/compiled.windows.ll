...
define internal ptr @v_main() {
  ...
  %t2 = call ptr @v__lift_23(ptr %t1)
  %t3 = call ptr @v__df_andThenIO_7(ptr %t2)
...
define internal ptr @v__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_18__lift_19__lift_2__lift_20__lift_24__lift_25__lift_26__lift_3__lift_4(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 70 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_18__lift_19__lift_2__lift_20__lift_24__lift_25__lift_26__lift_3__lift_4(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_18__lift_19__lift_2__lift_20__lift_24__lift_25__lift_26__lift_3__lift_4(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 44, label %tco.case.arm.44.11 i64 45, label %tco.case.arm.45.320 i64 46, label %tco.case.arm.46.343 i64 47, label %tco.case.arm.47.366 i64 48, label %tco.case.arm.48.389 i64 49, label %tco.case.arm.49.412 i64 50, label %tco.case.arm.50.435 i64 51, label %tco.case.arm.51.458 i64 52, label %tco.case.arm.52.481 i64 53, label %tco.case.arm.53.504 i64 54, label %tco.case.arm.54.527 i64 55, label %tco.case.arm.55.550 i64 56, label %tco.case.arm.56.573 i64 57, label %tco.case.arm.57.596 i64 58, label %tco.case.arm.58.619 i64 59, label %tco.case.arm.59.642 ]
tco.case.arm.44.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_18__lift_19__lift_2__lift_20__lift_24__lift_25__lift_26__lift_3__lift_4(ptr %t0)
