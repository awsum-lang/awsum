...
define internal ptr @v_main() {
  ...
  %t2 = call ptr @v__df_andThenIO_7(ptr %t1)
  %t3 = call ptr @v__df_handleErrorIO_3(ptr %t2)
  ret ptr %t3
}
...
tco.case.arm.10.71:
  ...
  %t82 = call ptr @v__apply__df_handleErrorIO_3(ptr %t6, ptr %t74)
...
define internal ptr @v__df_andThenIO_7(ptr %v_io) {
  call void @__inc_ref(ptr %v_io)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 52 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__df_andThenIO_7(ptr %v_io, ptr %t0)
  call void @__free_recursive(ptr %v_io)
  ret ptr %t3
}

define internal ptr @v__cps__df_andThenIO_7(ptr %v_io, ptr %v__k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.5.11:
  ...
  %t16 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.17:
  ...
  %t24 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t20)
  call void @__free_recursive(ptr %t19)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.48:
  ...
  %t59 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t51)
...
tco.case.arm.9.60:
  ...
  %t71 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t63)
  call void @__free_recursive(ptr %t62)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.10.72:
  ...
  %t83 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t75)
...
define internal ptr @v__apply__df_andThenIO_7(ptr %v__k, ptr %v__x) {
entry:
  %t3 = alloca ptr
  store ptr %v__k, ptr %t3
  %t4 = alloca ptr
...
define internal ptr @v__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_2__lift_3__lift_4(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 54 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_2__lift_3__lift_4(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_2__lift_3__lift_4(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 38, label %tco.case.arm.38.11 i64 39, label %tco.case.arm.39.200 i64 40, label %tco.case.arm.40.223 i64 41, label %tco.case.arm.41.246 i64 42, label %tco.case.arm.42.269 i64 43, label %tco.case.arm.43.292 i64 44, label %tco.case.arm.44.315 i64 45, label %tco.case.arm.45.338 i64 46, label %tco.case.arm.46.361 i64 47, label %tco.case.arm.47.384 ]
tco.case.arm.38.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %tco.case.default.19 [ i64 29, label %tco.case.arm.29.20 i64 30, label %tco.case.arm.30.40 i64 31, label %tco.case.arm.31.60 i64 32, label %tco.case.arm.32.80 i64 33, label %tco.case.arm.33.100 i64 34, label %tco.case.arm.34.120 i64 35, label %tco.case.arm.35.140 i64 36, label %tco.case.arm.36.160 i64 37, label %tco.case.arm.37.180 ]
tco.case.arm.29.20:
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_14_4__df__lam_15_5__df__lam_16_6__df__lam_5_8__df__lam_6_9__df__lam_7_10__lift_2__lift_3__lift_4(ptr %t0)
