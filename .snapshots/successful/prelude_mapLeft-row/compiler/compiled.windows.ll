...
define internal ptr @v_render() {
  %v__inl56_scrut.jslot = alloca ptr
  %v__inl58_scrut.jslot = alloca ptr
  %v__inl60_scrut.jslot = alloca ptr
...
join.case.arm.4.85:
  ...
  call void @__free_recursive(ptr %t72)
  store ptr %t88, ptr %v__inl56_scrut.jslot
  br label %join.44
join.case.default.76:
  unreachable
join.44:
  %t89 = load ptr, ptr %v__inl56_scrut.jslot
...
join.case.arm.4.140:
  ...
  call void @__free_recursive(ptr %t127)
  store ptr %t145, ptr %v__inl58_scrut.jslot
  br label %join.99
join.case.default.131:
  unreachable
join.99:
  %t146 = load ptr, ptr %v__inl58_scrut.jslot
...
join.case.arm.4.197:
  ...
  call void @__free_recursive(ptr %t184)
  store ptr %t202, ptr %v__inl60_scrut.jslot
  br label %join.156
join.case.default.188:
  unreachable
join.156:
  %t203 = load ptr, ptr %v__inl60_scrut.jslot
...
case.join.5:
  ...
  %t25 = getelementptr ptr, ptr %t23, i32 0
  store ptr %t24, ptr %t25
  %t26 = call ptr @v__cps__df_andThenIO_7(ptr %t22, ptr %t23)
  %t27 = call ptr @__alloc(i64 8, i32 0)
  %t28 = inttoptr i64 29 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @v__cps__df_handleErrorIO_3(ptr %t26, ptr %t27)
  ret ptr %t30
}
...
tco.case.arm.5.11:
  ...
  %t12 = call ptr @v__apply__df_handleErrorIO_3(ptr %t6, ptr %t5)
...
tco.case.arm.6.13:
  ...
  %t26 = call ptr @v__apply__df_handleErrorIO_3(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.5.11:
  ...
  store ptr %t18, ptr %t25
  %t26 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t26, ptr %t2
  br label %tco.exit.1
tco.case.arm.6.27:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t28 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
