...
tco.case.arm.5.11:
  ...
  %t15 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.16:
  ...
  %t23 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t19)
...
tco.case.arm.8.47:
  ...
  %t57 = getelementptr ptr, ptr %t50, i32 1
  store ptr %t53, ptr %t57
  %t58 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t50)
  call void @__free_recursive(ptr %t49)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t58, ptr %t2
...
tco.case.arm.9.59:
  ...
  %t69 = getelementptr ptr, ptr %t62, i32 1
  store ptr %t65, ptr %t69
  %t70 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t62)
  call void @__free_recursive(ptr %t61)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t70, ptr %t2
...
tco.case.arm.10.71:
  ...
  %t81 = getelementptr ptr, ptr %t74, i32 1
  store ptr %t77, ptr %t81
  %t82 = call ptr @v__apply__df_andThenIO_7(ptr %t6, ptr %t74)
  call void @__free_recursive(ptr %t73)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t82, ptr %t2
...
define internal ptr @v__scc__apply1__df__lam_0_8__df__lam_1_9__df__lam_10_5__df__lam_11_6__df__lam_2_10__df__lam_9_4(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 46 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_0_8__df__lam_1_9__df__lam_10_5__df__lam_11_6__df__lam_2_10__df__lam_9_4(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_0_8__df__lam_1_9__df__lam_10_5__df__lam_11_6__df__lam_2_10__df__lam_9_4(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 35, label %tco.case.arm.35.11 i64 36, label %tco.case.arm.36.140 i64 37, label %tco.case.arm.37.163 i64 38, label %tco.case.arm.38.186 i64 39, label %tco.case.arm.39.209 i64 40, label %tco.case.arm.40.232 i64 41, label %tco.case.arm.41.255 ]
tco.case.arm.35.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %tco.case.default.19 [ i64 29, label %tco.case.arm.29.20 i64 30, label %tco.case.arm.30.40 i64 31, label %tco.case.arm.31.60 i64 32, label %tco.case.arm.32.80 i64 33, label %tco.case.arm.33.100 i64 34, label %tco.case.arm.34.120 ]
tco.case.arm.29.20:
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_0_8__df__lam_1_9__df__lam_10_5__df__lam_11_6__df__lam_2_10__df__lam_9_4(ptr %t0)
