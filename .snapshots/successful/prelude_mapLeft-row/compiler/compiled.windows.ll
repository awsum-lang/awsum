...
define internal ptr @v_mappedA() {
  ...
  switch i64 %t3, label %case.default.4 [ i64 3, label %case.arm.3.6 i64 4, label %case.arm.4.19 ]
case.arm.3.6:
...
case.default.4:
  unreachable
case.join.5:
  %t21 = phi ptr [ %t8, %case.end.3.7 ], [ %t0, %case.end.4.20 ]
...
define internal ptr @v_remappedX() {
  ...
  %t2 = load ptr, ptr %t1
  %t3 = ptrtoint ptr %t2 to i64
  switch i64 %t3, label %case.default.4 [ i64 3, label %case.arm.3.6 i64 4, label %case.arm.4.38 ]
case.arm.3.6:
  %t8 = call ptr @__alloc(i64 16, i32 1)
  %t9 = inttoptr i64 3 to ptr
  %t10 = getelementptr ptr, ptr %t8, i32 0
  ...
  switch i64 %t15, label %case.default.16 [ i64 3640903312, label %case.arm.3640903312.18 i64 3657680931, label %case.arm.3657680931.27 ]
case.arm.3640903312.18:
  %t20 = call ptr @__alloc(i64 16, i32 1)
  %t21 = inttoptr i64 2269767818 to ptr
  ...
  br label %case.end.3640903312.19
case.end.3640903312.19:
  br label %case.join.17
case.arm.3657680931.27:
  %t29 = call ptr @__alloc(i64 16, i32 1)
  %t30 = inttoptr i64 2252990199 to ptr
  ...
  br label %case.end.3657680931.28
case.end.3657680931.28:
  br label %case.join.17
case.default.16:
  unreachable
case.join.17:
  %t36 = phi ptr [ %t20, %case.end.3640903312.19 ], [ %t29, %case.end.3657680931.28 ]
...
case.default.4:
  unreachable
case.join.5:
  %t40 = phi ptr [ %t8, %case.end.3.7 ], [ %t0, %case.end.4.39 ]
  call void @__free_recursive(ptr %t0)
  ret ptr %t40
}
...
define internal ptr @v_render() {
  %v_$inl56$scrut.jslot = alloca ptr
  %v_$inl58$scrut.jslot = alloca ptr
  %v_$inl60$scrut.jslot = alloca ptr
...
case.default.13:
  unreachable
case.join.14:
  %t19 = phi ptr [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.2252990199.16 ], [ getelementptr inbounds (i8, ptr @.str.4, i64 12), %case.end.2269767818.18 ]
...
case.join.5:
  ...
  call void @__free_recursive(ptr %t0)
  %t26 = call ptr @v_tagged(ptr getelementptr inbounds (i8, ptr @.str.2, i64 12), ptr %t25)
...
case.default.59:
  unreachable
case.join.60:
  %t65 = phi ptr [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.2252990199.62 ], [ getelementptr inbounds (i8, ptr @.str.4, i64 12), %case.end.2269767818.64 ]
...
case.join.51:
  ...
  %t72 = call ptr @v_tagged(ptr getelementptr inbounds (i8, ptr @.str.8, i64 12), ptr %t71)
...
join.case.arm.4.85:
  ...
  call void @__free_recursive(ptr %t72)
  store ptr %t88, ptr %v_$inl56$scrut.jslot
  br label %join.44
join.case.default.76:
  unreachable
join.44:
  %t89 = load ptr, ptr %v_$inl56$scrut.jslot
...
case.default.114:
  unreachable
case.join.115:
  %t120 = phi ptr [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.2252990199.117 ], [ getelementptr inbounds (i8, ptr @.str.4, i64 12), %case.end.2269767818.119 ]
...
case.join.106:
  ...
  %t127 = call ptr @v_tagged(ptr getelementptr inbounds (i8, ptr @.str.7, i64 12), ptr %t126)
...
join.case.arm.4.140:
  ...
  call void @__free_recursive(ptr %t127)
  store ptr %t145, ptr %v_$inl58$scrut.jslot
  br label %join.99
join.case.default.131:
  unreachable
join.99:
  %t146 = load ptr, ptr %v_$inl58$scrut.jslot
...
case.arm.4.154:
  %t158 = call ptr @v_remappedX()
  %t159 = getelementptr ptr, ptr %t158, i32 0
  %t160 = load ptr, ptr %t159
  %t161 = ptrtoint ptr %t160 to i64
  switch i64 %t161, label %case.default.162 [ i64 3, label %case.arm.3.164 i64 4, label %case.arm.4.178 ]
case.arm.3.164:
  ...
  switch i64 %t170, label %case.default.171 [ i64 2252990199, label %case.arm.2252990199.173 i64 2269767818, label %case.arm.2269767818.175 ]
case.arm.2252990199.173:
  br label %case.end.2252990199.174
case.end.2252990199.174:
  br label %case.join.172
case.arm.2269767818.175:
  br label %case.end.2269767818.176
case.end.2269767818.176:
  br label %case.join.172
case.default.171:
  unreachable
case.join.172:
  %t177 = phi ptr [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.2252990199.174 ], [ getelementptr inbounds (i8, ptr @.str.4, i64 12), %case.end.2269767818.176 ]
  call void @__free_recursive(ptr %t167)
  br label %case.end.3.165
case.end.3.165:
  br label %case.join.163
case.arm.4.178:
  %t180 = getelementptr ptr, ptr %t158, i32 1
  %t181 = load ptr, ptr %t180
  call void @__inc_ref(ptr %t181)
  %t182 = call ptr @__showInt32(ptr %t181)
...
case.default.162:
  unreachable
case.join.163:
  %t183 = phi ptr [ %t177, %case.end.3.165 ], [ %t182, %case.end.4.179 ]
  call void @__free_recursive(ptr %t158)
  %t184 = call ptr @v_tagged(ptr getelementptr inbounds (i8, ptr @.str.6, i64 12), ptr %t183)
  %t185 = getelementptr ptr, ptr %t184, i32 0
  %t186 = load ptr, ptr %t185
  %t187 = ptrtoint ptr %t186 to i64
  switch i64 %t187, label %join.case.default.188 [ i64 3, label %join.case.arm.3.189 i64 4, label %join.case.arm.4.197 ]
join.case.arm.3.189:
  ...
  br label %join.val.196
join.val.196:
  br label %join.after.157
join.case.arm.4.197:
  %t198 = getelementptr ptr, ptr %t184, i32 1
  %t199 = load ptr, ptr %t198
  call void @__inc_ref(ptr %t199)
  %t200 = getelementptr ptr, ptr %t146, i32 1
  %t201 = load ptr, ptr %t200
  call void @__inc_ref(ptr %t201)
  call void @__inc_ref(ptr %t199)
  %t202 = call ptr @__concat(ptr %t201, ptr %t199)
  call void @__free_recursive(ptr %t199)
  call void @__free_recursive(ptr %t184)
  store ptr %t202, ptr %v_$inl60$scrut.jslot
  br label %join.156
join.case.default.188:
  unreachable
join.156:
  %t203 = load ptr, ptr %v_$inl60$scrut.jslot
  %t204 = getelementptr ptr, ptr %t203, i32 0
  %t205 = load ptr, ptr %t204
  %t206 = ptrtoint ptr %t205 to i64
  switch i64 %t206, label %case.default.207 [ i64 3, label %case.arm.3.209 i64 4, label %case.arm.4.211 ]
case.arm.3.209:
...
case.arm.4.211:
  %t213 = call ptr @v_remappedY()
  %t214 = getelementptr ptr, ptr %t213, i32 0
  %t215 = load ptr, ptr %t214
  %t216 = ptrtoint ptr %t215 to i64
  switch i64 %t216, label %case.default.217 [ i64 3, label %case.arm.3.219 i64 4, label %case.arm.4.233 ]
case.arm.3.219:
  ...
  switch i64 %t225, label %case.default.226 [ i64 2252990199, label %case.arm.2252990199.228 i64 2269767818, label %case.arm.2269767818.230 ]
case.arm.2252990199.228:
  br label %case.end.2252990199.229
case.end.2252990199.229:
  br label %case.join.227
case.arm.2269767818.230:
  br label %case.end.2269767818.231
case.end.2269767818.231:
  br label %case.join.227
case.default.226:
  unreachable
case.join.227:
  %t232 = phi ptr [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.2252990199.229 ], [ getelementptr inbounds (i8, ptr @.str.4, i64 12), %case.end.2269767818.231 ]
  call void @__free_recursive(ptr %t222)
  br label %case.end.3.220
case.end.3.220:
  br label %case.join.218
case.arm.4.233:
  %t235 = getelementptr ptr, ptr %t213, i32 1
  %t236 = load ptr, ptr %t235
  call void @__inc_ref(ptr %t236)
  %t237 = call ptr @__showInt32(ptr %t236)
  br label %case.end.4.234
case.end.4.234:
  br label %case.join.218
case.default.217:
  unreachable
case.join.218:
  %t238 = phi ptr [ %t232, %case.end.3.220 ], [ %t237, %case.end.4.234 ]
  call void @__free_recursive(ptr %t213)
  %t239 = call ptr @v_tagged(ptr getelementptr inbounds (i8, ptr @.str.5, i64 12), ptr %t238)
...
case.arm.4.253:
  ...
  %t257 = getelementptr ptr, ptr %t203, i32 1
  %t258 = load ptr, ptr %t257
  call void @__inc_ref(ptr %t258)
  call void @__inc_ref(ptr %t256)
  %t259 = call ptr @__concat(ptr %t258, ptr %t256)
...
case.default.243:
  unreachable
case.join.244:
  %t260 = phi ptr [ %t249, %case.end.3.246 ], [ %t259, %case.end.4.254 ]
...
case.default.207:
  unreachable
case.join.208:
  %t261 = phi ptr [ %t203, %case.end.3.210 ], [ %t260, %case.end.4.212 ]
  call void @__free_recursive(ptr %t203)
  br label %join.end.262
join.end.262:
  br label %join.after.157
join.after.157:
  %t263 = phi ptr [ %t192, %join.val.196 ], [ %t261, %join.end.262 ]
...
case.default.150:
  unreachable
case.join.151:
  %t264 = phi ptr [ %t146, %case.end.3.153 ], [ %t263, %case.end.4.155 ]
  call void @__free_recursive(ptr %t146)
  br label %join.end.265
join.end.265:
  br label %join.after.100
join.after.100:
  %t266 = phi ptr [ %t135, %join.val.139 ], [ %t264, %join.end.265 ]
...
case.default.93:
  unreachable
case.join.94:
  %t267 = phi ptr [ %t89, %case.end.3.96 ], [ %t266, %case.end.4.98 ]
  call void @__free_recursive(ptr %t89)
  br label %join.end.268
join.end.268:
  br label %join.after.45
join.after.45:
  %t269 = phi ptr [ %t80, %join.val.84 ], [ %t267, %join.end.268 ]
...
case.default.30:
  unreachable
case.join.31:
  %t270 = phi ptr [ %t36, %case.end.3.33 ], [ %t269, %case.end.4.41 ]
...
case.join.5:
  ...
  %t25 = getelementptr ptr, ptr %t23, i32 0
  store ptr %t24, ptr %t25
  %t26 = call ptr @v_$cps$$df$andThenIO$7(ptr %t22, ptr %t23)
  %t27 = call ptr @__alloc(i64 8, i32 0)
  %t28 = inttoptr i64 29 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @v_$cps$$df$handleErrorIO$3(ptr %t26, ptr %t27)
  ret ptr %t30
}

define internal ptr @v_$cps$$df$handleErrorIO$3(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.5.11:
  ...
  %t12 = call ptr @v_$apply$$df$handleErrorIO$3(ptr %t6, ptr %t5)
...
tco.case.arm.6.13:
  ...
  %t26 = call ptr @v_$apply$$df$handleErrorIO$3(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$df$handleErrorIO$3(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
...
define internal ptr @v_$cps$$df$andThenIO$7(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.5.11:
  ...
  store ptr %t18, ptr %t25
  %t26 = call ptr @v_$apply$$df$andThenIO$7(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t26, ptr %t2
  br label %tco.exit.1
tco.case.arm.6.27:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t28 = call ptr @v_$apply$$df$andThenIO$7(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$df$andThenIO$7(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
