...
@.str.4 = private unnamed_addr constant {i32, i32, i32, i32, i32, [7 x i8]} { i32 0, i32 0, i32 0, i32 7, i32 7, [7 x i8] c"mappedA" }
@.str.5 = private unnamed_addr constant {i32, i32, i32, i32, i32, [7 x i8]} { i32 0, i32 0, i32 0, i32 7, i32 7, [7 x i8] c"mappedB" }
@.str.6 = private unnamed_addr constant {i32, i32, i32, i32, i32, [8 x i8]} { i32 0, i32 0, i32 0, i32 8, i32 8, [8 x i8] c"mappedOk" }
@.str.7 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"remappedX" }
@.str.8 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"remappedY" }
...
define internal ptr @v_rightSrc() {
  %t0 = call ptr @__alloc(i64 16, i32 1)
...
define internal ptr @v_leftX() {
  %t0 = call ptr @__alloc(i64 16, i32 1)
  %t1 = inttoptr i64 3 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @__alloc(i64 16, i32 1)
  %t4 = inttoptr i64 3657680931 to ptr
  %t5 = getelementptr ptr, ptr %t3, i32 0
  store ptr %t4, ptr %t5
  %t6 = call ptr @__alloc(i64 8, i32 0)
  %t7 = inttoptr i64 23 to ptr
...
define internal ptr @v_leftY() {
  %t0 = call ptr @__alloc(i64 16, i32 1)
  %t1 = inttoptr i64 3 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @__alloc(i64 16, i32 1)
  %t4 = inttoptr i64 3640903312 to ptr
  %t5 = getelementptr ptr, ptr %t3, i32 0
  store ptr %t4, ptr %t5
  %t6 = call ptr @__alloc(i64 8, i32 0)
...
define internal ptr @v_remappedX() {
  %t0 = call ptr @v_leftX()
  %t1 = call ptr @v__df_mapLeft_2(ptr %t0)
  ret ptr %t1
}
...
define internal ptr @v_showABC(ptr %v_e) {
  %t0 = getelementptr ptr, ptr %v_e, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 3, label %case.arm.3.4 i64 4, label %case.arm.4.17 ]
...
define internal ptr @v_render() {
  ...
  %t2 = call ptr @v_tagged(ptr getelementptr inbounds (i8, ptr @.str.4, i64 12), ptr %t1)
...
case.arm.4.16:
  ...
  call void @__inc_ref(ptr %t19)
  call void @__inc_ref(ptr %t19)
  %t20 = call ptr @v_mappedB()
  %t21 = call ptr @v_showAB(ptr %t20)
  %t22 = call ptr @v_appendTagged(ptr %t19, ptr getelementptr inbounds (i8, ptr @.str.5, i64 12), ptr %t21)
...
case.arm.4.36:
  ...
  call void @__inc_ref(ptr %t39)
  %t40 = call ptr @v_mappedOk()
  %t41 = call ptr @v_showAB(ptr %t40)
  %t42 = call ptr @v_appendTagged(ptr %t39, ptr getelementptr inbounds (i8, ptr @.str.6, i64 12), ptr %t41)
...
case.arm.4.56:
  ...
  call void @__inc_ref(ptr %t59)
  %t60 = call ptr @v_remappedX()
  %t61 = call ptr @v_showABC(ptr %t60)
  %t62 = call ptr @v_appendTagged(ptr %t59, ptr getelementptr inbounds (i8, ptr @.str.7, i64 12), ptr %t61)
...
case.arm.4.76:
  ...
  call void @__inc_ref(ptr %t79)
  %t80 = call ptr @v_remappedY()
  %t81 = call ptr @v_showABC(ptr %t80)
  %t82 = call ptr @v_appendTagged(ptr %t79, ptr getelementptr inbounds (i8, ptr @.str.8, i64 12), ptr %t81)
...
case.default.66:
  unreachable
case.join.67:
  %t83 = phi ptr [%t72, %case.end.3.69], [%t82, %case.end.4.77]
...
case.default.46:
  unreachable
case.join.47:
  %t84 = phi ptr [%t52, %case.end.3.49], [%t83, %case.end.4.57]
...
case.default.26:
  unreachable
case.join.27:
  %t85 = phi ptr [%t32, %case.end.3.29], [%t84, %case.end.4.37]
  call void @__free_recursive(ptr %t22)
...
case.default.6:
  unreachable
case.join.7:
  %t86 = phi ptr [%t12, %case.end.3.9], [%t85, %case.end.4.17]
...
case.arm.18.4:
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.9, i64 12), ptr %t8
...
define internal ptr @v_main() {
  ...
  %t2 = call ptr @v__lift_15(ptr %t1)
  %t3 = call ptr @v__df_andThenIO_6(ptr %t2)
  %t4 = call ptr @v__df_handleErrorIO_3(ptr %t3)
  ret ptr %t4
}
...
tco.case.arm.5.11:
  ...
  %t17 = getelementptr ptr, ptr %t14, i32 1
  store ptr %t13, ptr %t17
  %t18 = call ptr @v__apply__lift_15(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t18, ptr %t2
...
tco.case.arm.6.19:
  ...
  %t25 = getelementptr ptr, ptr %t22, i32 1
  store ptr %t21, ptr %t25
  %t26 = call ptr @v__apply__lift_15(ptr %t6, ptr %t22)
  call void @__free_recursive(ptr %t21)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t26, ptr %t2
...
tco.case.arm.8.50:
  ...
  %t60 = getelementptr ptr, ptr %t53, i32 1
  store ptr %t56, ptr %t60
  %t61 = call ptr @v__apply__lift_15(ptr %t6, ptr %t53)
  call void @__free_recursive(ptr %t52)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t61, ptr %t2
...
tco.case.arm.9.62:
  ...
  %t72 = getelementptr ptr, ptr %t65, i32 1
  store ptr %t68, ptr %t72
  %t73 = call ptr @v__apply__lift_15(ptr %t6, ptr %t65)
  call void @__free_recursive(ptr %t64)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t73, ptr %t2
...
define internal ptr @v__df_mapLeft_0(ptr %v_x) {
  %t0 = getelementptr ptr, ptr %v_x, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
...
define internal ptr @v__df_mapLeft_1(ptr %v_x) {
  %t0 = getelementptr ptr, ptr %v_x, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 3, label %case.arm.3.4 i64 4, label %case.arm.4.12 ]
...
define internal ptr @v__df_mapLeft_2(ptr %v_x) {
  %t0 = getelementptr ptr, ptr %v_x, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 3, label %case.arm.3.4 i64 4, label %case.arm.4.12 ]
...
define internal ptr @v__scc__apply1__df__lam_10_4__df__lam_11_5__df__lam_4_7__df__lam_5_8__lift_13__lift_14__lift_16__lift_17__lift_2__lift_3(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 58 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_10_4__df__lam_11_5__df__lam_4_7__df__lam_5_8__lift_13__lift_14__lift_16__lift_17__lift_2__lift_3(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_10_4__df__lam_11_5__df__lam_4_7__df__lam_5_8__lift_13__lift_14__lift_16__lift_17__lift_2__lift_3(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 37, label %tco.case.arm.37.11 i64 38, label %tco.case.arm.38.220 i64 39, label %tco.case.arm.39.243 i64 40, label %tco.case.arm.40.266 i64 41, label %tco.case.arm.41.289 i64 42, label %tco.case.arm.42.312 i64 43, label %tco.case.arm.43.335 i64 44, label %tco.case.arm.44.358 i64 45, label %tco.case.arm.45.381 i64 46, label %tco.case.arm.46.404 i64 47, label %tco.case.arm.47.427 ]
tco.case.arm.37.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %tco.case.default.19 [ i64 27, label %tco.case.arm.27.20 i64 28, label %tco.case.arm.28.40 i64 29, label %tco.case.arm.29.60 i64 30, label %tco.case.arm.30.80 i64 31, label %tco.case.arm.31.100 i64 32, label %tco.case.arm.32.120 i64 33, label %tco.case.arm.33.140 i64 34, label %tco.case.arm.34.160 i64 35, label %tco.case.arm.35.180 i64 36, label %tco.case.arm.36.200 ]
tco.case.arm.27.20:
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_10_4__df__lam_11_5__df__lam_4_7__df__lam_5_8__lift_13__lift_14__lift_16__lift_17__lift_2__lift_3(ptr %t0)
