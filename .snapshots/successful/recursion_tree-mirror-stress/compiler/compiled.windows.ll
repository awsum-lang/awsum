...
tco.loop.0:
  ...
  %t6 = load ptr, ptr %t5
  %t7 = ptrtoint ptr %t6 to i64
  switch i64 %t7, label %tco.case.default.8 [ i64 27, label %tco.case.arm.27.9 i64 28, label %tco.case.arm.28.85 ]
tco.case.arm.27.9:
  %t10 = getelementptr ptr, ptr %t4, i32 1
  %t11 = load ptr, ptr %t10
  call void @__inc_ref(ptr %t11)
  ...
  switch i64 %t16, label %tco.case.default.17 [ i64 24, label %tco.case.arm.24.18 i64 26, label %tco.case.arm.26.19 i64 25, label %tco.case.arm.25.52 ]
tco.case.arm.24.18:
