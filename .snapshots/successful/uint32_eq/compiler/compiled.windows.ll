...
define internal ptr @v_main(ptr %v__input) {
  ...
  %t4 = call ptr @v_minUInt32()
  %t5 = call ptr @__eqUInt32(ptr %t3, ptr %t4)
  %t6 = call ptr @v_render(ptr %t5)
  %t7 = call ptr @v_maxUInt32()
  %t8 = call ptr @v_maxUInt32()
  %t9 = call ptr @__eqUInt32(ptr %t7, ptr %t8)
...
case.arm.1.26:
  ...
  %t33 = call ptr @v_maxUInt32()
  %t34 = call ptr @v_minUInt32()
  %t35 = call ptr @__eqUInt32(ptr %t33, ptr %t34)
...
case.arm.1.52:
  ...
  store i32 -2147483648, ptr %t59
  %t60 = call ptr @malloc(i64 4)
  store i32 -2147483648, ptr %t60
  %t61 = call ptr @__eqUInt32(ptr %t59, ptr %t60)
  ...
  %t65 = getelementptr ptr, ptr %t56, i32 0
  %t66 = load ptr, ptr %t65
  %t67 = ptrtoint ptr %t66 to i64
  switch i64 %t67, label %case.default.68 [ i64 0, label %case.arm.0.70 i64 1, label %case.arm.1.78 ]
case.arm.0.70:
...
case.arm.1.78:
  %t80 = getelementptr ptr, ptr %t56, i32 1
  ...
  store i32 2147483647, ptr %t86
  %t87 = call ptr @__eqUInt32(ptr %t85, ptr %t86)
  %t88 = call ptr @v_render(ptr %t87)
  %t89 = call ptr @__concat(ptr %t81, ptr %t88)
...
case.default.68:
  unreachable
case.join.69:
  %t91 = phi ptr [%t74, %case.end.0.71], [%t82, %case.end.1.79]
...
case.default.42:
  unreachable
case.join.43:
  %t92 = phi ptr [%t48, %case.end.0.45], [%t91, %case.end.1.53]
...
case.default.16:
  unreachable
case.join.17:
  %t93 = phi ptr [%t22, %case.end.0.19], [%t92, %case.end.1.27]
  %t94 = call ptr @v__let_2(ptr %t93)
  ret ptr %t94
}
