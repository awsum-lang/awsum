...
function main(v__input){
    return (v__let_2)(((s) => { switch(s[0]) { case 0: { const v__do_e_12_9 = s[1]; return [0, v__do_e_12_9]; } case 1: { const v_s0 = s[1]; return ((s) => { switch(s[0]) { case 0: { const v__do_e_13_9 = s[1]; return [0, v__do_e_13_9]; } case 1: { const v_s1 = s[1]; return ((s) => { switch(s[0]) { case 0: { const v__do_e_14_9 = s[1]; return [0, v__do_e_14_9]; } case 1: { const v_s2 = s[1]; return [1, (v_s2 + (v_render)(__eqUInt32((2147483648 >>> 0), (2147483647 >>> 0))))]; } } })([1, (v_s1 + (v_render)(__eqUInt32((2147483648 >>> 0), (2147483648 >>> 0))))]); } } })([1, (v_s0 + (v_render)(__eqUInt32(v_maxUInt32, v_minUInt32)))]); } } })([1, ((v_render)(__eqUInt32(v_minUInt32, v_minUInt32)) + (v_render)(__eqUInt32(v_maxUInt32, v_maxUInt32)))]));
}
