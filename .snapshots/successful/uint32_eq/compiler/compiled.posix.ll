...
case.default.6:
  unreachable
case.join.7:
  %t12 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.1.9 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.2.11 ]
  call void @__free_recursive(ptr %t2)
  %t13 = call ptr @v_maxUInt32()
  %t14 = call ptr @v_maxUInt32()
  %t15 = call ptr @__eqUInt32(ptr %t13, ptr %t14)
  %t16 = getelementptr ptr, ptr %t15, i32 0
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %case.default.19 [ i64 1, label %case.arm.1.21 i64 2, label %case.arm.2.23 ]
case.arm.1.21:
  br label %case.end.1.22
case.end.1.22:
  br label %case.join.20
case.arm.2.23:
  br label %case.end.2.24
case.end.2.24:
  br label %case.join.20
case.default.19:
  unreachable
case.join.20:
  %t25 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.1.22 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.2.24 ]
  call void @__free_recursive(ptr %t15)
  %t26 = call ptr @__concat(ptr %t12, ptr %t25)
...
case.arm.4.40:
  ...
  call void @__inc_ref(ptr %t43)
  %t44 = call ptr @v_maxUInt32()
  %t45 = call ptr @v_minUInt32()
  %t46 = call ptr @__eqUInt32(ptr %t44, ptr %t45)
...
case.default.50:
  unreachable
case.join.51:
  %t56 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.1.53 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.2.55 ]
  call void @__free_recursive(ptr %t46)
  %t57 = call ptr @__concat(ptr %t43, ptr %t56)
...
case.arm.4.71:
  ...
  call void @__inc_ref(ptr %t74)
  %t75 = call ptr @__concat(ptr %t74, ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
...
case.arm.4.89:
  ...
  call void @__inc_ref(ptr %t92)
  %t93 = call ptr @__concat(ptr %t92, ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
...
case.default.79:
  unreachable
case.join.80:
  %t94 = phi ptr [ %t85, %case.end.3.82 ], [ %t93, %case.end.4.90 ]
...
case.default.61:
  unreachable
case.join.62:
  %t95 = phi ptr [ %t67, %case.end.3.64 ], [ %t94, %case.end.4.72 ]
...
case.default.30:
  unreachable
case.join.31:
  %t96 = phi ptr [ %t36, %case.end.3.33 ], [ %t95, %case.end.4.41 ]
