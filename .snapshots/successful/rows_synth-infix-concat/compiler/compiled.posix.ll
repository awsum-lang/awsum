...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [16 x i8]} { i32 0, i32 0, i32 0, i32 16, i32 16, [16 x i8] c"0123456789abcdef" }
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [15 x i8]} { i32 0, i32 0, i32 0, i32 15, i32 15, [15 x i8] c"string-too-long" }
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"underflow" }
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [4 x i8]} { i32 0, i32 0, i32 0, i32 4, i32 4, [4 x i8] c"done" }
...
define internal ptr @v_double(ptr %v_n, ptr %v_s) {
entry:
  %t3 = alloca ptr
  store ptr %v_n, ptr %t3
  %t4 = alloca ptr
  store ptr %v_s, ptr %t4
  %t2 = alloca ptr
  br label %tco.loop.0
tco.loop.0:
  %t5 = load ptr, ptr %t3
...
tco.case.arm.3.24:
  ...
  %t31 = inttoptr i64 3768445577 to ptr
...
define internal ptr @v_main() {
  ...
  store i32 24, ptr %t0
  %t1 = call ptr @v_double(ptr %t0, ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
  %t2 = getelementptr ptr, ptr %t1, i32 0
  %t3 = load ptr, ptr %t2
  %t4 = ptrtoint ptr %t3 to i64
  switch i64 %t4, label %case.default.5 [ i64 3, label %case.arm.3.7 i64 4, label %case.arm.4.49 ]
case.arm.3.7:
  ...
  switch i64 %t13, label %case.default.14 [ i64 589989748, label %case.arm.589989748.16 i64 3768445577, label %case.arm.3768445577.32 ]
case.arm.589989748.16:
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.1, i64 12), ptr %t23
...
case.arm.3768445577.32:
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.2, i64 12), ptr %t39
  ...
  br label %case.end.3768445577.33
case.end.3768445577.33:
  br label %case.join.15
case.default.14:
  unreachable
case.join.15:
...
case.arm.4.49:
  %t51 = getelementptr ptr, ptr %t1, i32 1
