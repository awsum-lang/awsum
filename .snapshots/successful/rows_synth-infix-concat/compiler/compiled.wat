...
(module
  ...
  (table 2 funcref)
  (elem (i32.const 0) $v_runIO $v_double)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_double (param $v_n i32) (param $v_s i32) (result i32)
    (local $__con_0 i32)
    (local $__con_1 i32)
    (local $v_m i32)
    (local $v_s2 i32)
    ...
    (local $__k0 i32)
    (local $__k1 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (call $__eq_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $__box_i32 (i32.const 0)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1)) (then (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (local.get $v_s)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v_s)) (local.get $__drop_tmp))) (else (block (result i32) (local.set $__scrut (call $__predInt32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_ue (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_ue)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3768445577)) (i32.store offset=4 (local.get $__con_1) (local.get $v_ue)) (call $__inc_ref (i32.load offset=4 (local.get $__con_1))) (local.get $__con_1))) (local.get $__con_0))) (call $__free_recursive (local.get $v_ue)) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v_s)) (local.get $__drop_tmp))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_m)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_s)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_se (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_se)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 589989748)) (i32.store offset=4 (local.get $__con_1) (local.get $v_se)) (call $__inc_ref (i32.load offset=4 (local.get $__con_1))) (local.get $__con_1))) (local.get $__con_0))) (call $__free_recursive (local.get $v_se)) (call $__free_recursive (local.get $v_m)) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v_s)) (local.get $__drop_tmp))) (else (local.set $v_s2 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s2)) (local.set $__k0 (local.get $v_m)) (local.set $__k1 (local.get $v_s2)) (call $__inc_ref (local.get $__k0)) (call $__inc_ref (local.get $__k1)) (call $__free_recursive (local.get $v_s)) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v_s2)) (call $__free_recursive (local.get $v_m)) (local.set $v_n (local.get $__k0)) (local.set $v_s (local.get $__k1)) (br $tco_top))))))))))))
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (call $v_double (call $__box_i32 (i32.const 24)) (i32.const 96))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__scrut (local.get $v_e)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 589989748)) (then (local.set $v__t (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__t)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (i32.const 132)) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0))) (else (local.set $v__u (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__u)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (i32.const 167)) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0)))))) (else (local.set $v__s (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__s)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (i32.const 196)) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0))))))
