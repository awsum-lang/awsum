...
define ptr @v_showToken(ptr %v_token) {
  %t0 = getelementptr ptr, ptr %v_token, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 0, label %case.arm.0.5 i64 1, label %case.arm.1.11 i64 2, label %case.arm.2.17 i64 3, label %case.arm.3.20 ]
case.arm.0.5:
...
case.end.2.18:
  br label %case.join.4
case.arm.3.20:
  %t22 = getelementptr [6 x i8], ptr @.str.3, i64 0, i64 0
...
case.default.3:
  unreachable
case.join.4:
  %t23 = phi ptr [%t10, %case.end.0.6], [%t16, %case.end.1.12], [%t19, %case.end.2.18], [%t22, %case.end.3.21]
  ret ptr %t23
}
...
define ptr @v_main(ptr %v__input) {
  ...
  %t20 = call ptr @v_showToken(ptr %t15)
  %t21 = call ptr @__concat(ptr %t14, ptr %t20)
  ...
  %t27 = call ptr @v_showToken(ptr %t24)
  %t28 = call ptr @__concat(ptr %t23, ptr %t27)
  %t29 = call ptr @__print(ptr %t28)
  ret ptr %t29
}

define ptr @v__con_Number(ptr %v__x0) {
  %t0 = call ptr @malloc(i64 16)
...
define ptr @v__con_Word(ptr %v__x0) {
  %t0 = call ptr @malloc(i64 16)
  %t1 = inttoptr i64 0 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
