...
(module
  ...
  (data (i32.const 163) "\00\00\00\00\00\00\00\00\00\00\00\00\09\00\00\00\09\00\00\00hold-true")
  (data (i32.const 192) "\00\00\00\00\00\00\00\00\00\00\00\00\0a\00\00\00\0a\00\00\00hold-false")
  (table 4 funcref)
  (elem (i32.const 0) $v_runIO $v_$cps$$df$handleErrorIO$4 $v_$apply$$df$handleErrorIO$4 $v_$scc$$apply$$scc$$apply1__$df$$lam$17$9__$df$$lam$$x$1823383003)
  ...
  (func $v_$scc$$apply$$scc$$apply1__$df$$lam$17$9__$df$$lam$$x$1823383003 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
