...
define internal ptr @v_describe(ptr %v_r) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 3, label %case.arm.3.4 i64 4, label %case.arm.4.14 ]
case.arm.3.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 348914022, label %case.arm.348914022.11 ]
