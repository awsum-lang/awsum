...
(module
  ...
  (data (i32.const 72) "\05\00\00\00\05\00\00\00Done!")
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v_advanceStep $v_main)
  ...
  (func $v_advanceStep (param $v_x i32) (result i32)
    (local $__scrut i32)
    (local $__k0 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 4))) (i32.const 1)) (local.get $__con_0))) (local.set $v_x (local.get $__k0)) (br $tco_top)) (else (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1)) (then (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 4))) (i32.const 2)) (local.get $__con_0))) (local.set $v_x (local.get $__k0)) (br $tco_top)) (else (i32.const 72))))))))

  (func $v_main (param $v__input i32) (result i32)
    (local $__con_0 i32)
    (local $__con_1 i32)
    (local $__con_2 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 2)) (i32.store offset=4 (local.get $__con_0) (call $v_advanceStep (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 4))) (i32.const 0)) (local.get $__con_1)))) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc (i32.const 4))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0)))
