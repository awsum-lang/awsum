...
define internal ptr @v_main() {
  ...
  %t2 = call ptr @v_minUInt8()
  %t3 = call ptr @__showUInt8(ptr %t2)
...
join.case.arm.4.23:
  ...
  call void @__inc_ref(ptr %t25)
  %t26 = call ptr @__alloc(i64 1, i32 0)
  store i8 42, ptr %t26
  %t27 = call ptr @__showUInt8(ptr %t26)
...
case.arm.4.60:
  ...
  %t65 = call ptr @__showUInt8(ptr %t64)
...
case.arm.4.98:
  ...
  call void @__inc_ref(ptr %t101)
  %t102 = call ptr @v_maxUInt8()
  %t103 = call ptr @__showUInt8(ptr %t102)
...
case.default.88:
  unreachable
case.join.89:
  %t105 = phi ptr [ %t94, %case.end.3.91 ], [ %t104, %case.end.4.99 ]
...
case.default.70:
  unreachable
case.join.71:
  %t106 = phi ptr [ %t76, %case.end.3.73 ], [ %t105, %case.end.4.81 ]
...
case.default.50:
  unreachable
case.join.51:
  %t107 = phi ptr [ %t56, %case.end.3.53 ], [ %t106, %case.end.4.61 ]
...
case.default.32:
  unreachable
case.join.33:
  %t108 = phi ptr [ %t38, %case.end.3.35 ], [ %t107, %case.end.4.43 ]
  call void @__free_recursive(ptr %t28)
  call void @__free_recursive(ptr %t4)
  store ptr %t108, ptr %v__inl4_scrut.jslot
  br label %join.0
join.case.default.8:
  unreachable
join.0:
  %t109 = load ptr, ptr %v__inl4_scrut.jslot
  %t110 = getelementptr ptr, ptr %t109, i32 0
  %t111 = load ptr, ptr %t110
  %t112 = ptrtoint ptr %t111 to i64
  switch i64 %t112, label %case.default.113 [ i64 3, label %case.arm.3.115 i64 4, label %case.arm.4.129 ]
case.arm.3.115:
  %t117 = call ptr @__alloc(i64 24, i32 2)
  %t118 = inttoptr i64 7 to ptr
  %t119 = getelementptr ptr, ptr %t117, i32 0
  store ptr %t118, ptr %t119
  %t120 = getelementptr ptr, ptr %t117, i32 1
  store ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr %t120
  %t121 = call ptr @__alloc(i64 16, i32 1)
  %t122 = inttoptr i64 5 to ptr
...
case.arm.4.129:
  ...
  store ptr %t140, ptr %t143
  %t144 = getelementptr ptr, ptr %t131, i32 2
...
case.default.113:
  unreachable
case.join.114:
  %t145 = phi ptr [ %t117, %case.end.3.116 ], [ %t131, %case.end.4.130 ]
  call void @__free_recursive(ptr %t109)
  br label %join.end.146
join.end.146:
  br label %join.after.1
join.after.1:
  %t147 = phi ptr [ %t10, %join.val.22 ], [ %t145, %join.end.146 ]
  ret ptr %t147
}
