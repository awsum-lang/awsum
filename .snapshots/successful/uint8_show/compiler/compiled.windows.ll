...
case.default.82:
  unreachable
case.join.83:
  %t99 = phi ptr [%t88, %case.end.0.85], [%t98, %case.end.1.93]
...
case.default.64:
  unreachable
case.join.65:
  %t100 = phi ptr [%t70, %case.end.0.67], [%t99, %case.end.1.75]
...
case.default.44:
  unreachable
case.join.45:
  %t101 = phi ptr [%t50, %case.end.0.47], [%t100, %case.end.1.55]
...
case.default.26:
  unreachable
case.join.27:
  %t102 = phi ptr [%t32, %case.end.0.29], [%t101, %case.end.1.37]
...
case.default.6:
  unreachable
case.join.7:
  %t103 = phi ptr [%t12, %case.end.0.9], [%t102, %case.end.1.17]
