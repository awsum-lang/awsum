...
define internal ptr @v_main(ptr %v__input) {
  ...
  %t4 = call ptr @__showUInt8(ptr %t3)
...
case.arm.1.21:
  ...
  store i8 42, ptr %t28
  %t29 = call ptr @__showUInt8(ptr %t28)
...
case.arm.1.68:
  ...
  %t75 = call ptr @malloc(i64 1)
  store i8 200, ptr %t75
  %t76 = call ptr @__showUInt8(ptr %t75)
...
case.arm.1.115:
  ...
  %t122 = call ptr @v_maxUInt8()
  %t123 = call ptr @__showUInt8(ptr %t122)
...
case.default.105:
  unreachable
case.join.106:
  %t126 = phi ptr [%t111, %case.end.0.108], [%t119, %case.end.1.116]
...
case.default.82:
  unreachable
case.join.83:
  %t127 = phi ptr [%t88, %case.end.0.85], [%t126, %case.end.1.93]
...
case.default.58:
  unreachable
case.join.59:
  %t128 = phi ptr [%t64, %case.end.0.61], [%t127, %case.end.1.69]
...
case.default.35:
  unreachable
case.join.36:
  %t129 = phi ptr [%t41, %case.end.0.38], [%t128, %case.end.1.46]
...
case.default.11:
  unreachable
case.join.12:
  %t130 = phi ptr [%t17, %case.end.0.14], [%t129, %case.end.1.22]
  %t131 = call ptr @v__let_2(ptr %t130)
  ret ptr %t131
}
