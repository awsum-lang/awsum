...
case.arm.4.16:
  ...
  call void @__inc_ref(ptr %t19)
  %t20 = call ptr @__alloc(i64 1, i32 0)
  store i8 42, ptr %t20
  %t21 = call ptr @__showUInt8(ptr %t20)
...
case.arm.4.54:
  ...
  call void @__inc_ref(ptr %t57)
  %t58 = call ptr @__alloc(i64 1, i32 0)
  store i8 200, ptr %t58
  %t59 = call ptr @__showUInt8(ptr %t58)
...
case.default.82:
  unreachable
case.join.83:
  %t99 = phi ptr [ %t88, %case.end.3.85 ], [ %t98, %case.end.4.93 ]
...
case.default.64:
  unreachable
case.join.65:
  %t100 = phi ptr [ %t70, %case.end.3.67 ], [ %t99, %case.end.4.75 ]
...
case.default.44:
  unreachable
case.join.45:
  %t101 = phi ptr [ %t50, %case.end.3.47 ], [ %t100, %case.end.4.55 ]
...
case.default.26:
  unreachable
case.join.27:
  %t102 = phi ptr [ %t32, %case.end.3.29 ], [ %t101, %case.end.4.37 ]
...
case.default.6:
  unreachable
case.join.7:
  %t103 = phi ptr [ %t12, %case.end.3.9 ], [ %t102, %case.end.4.17 ]
