...
(module
  ...
  (func $v_main (param $v__input i32) (result i32)
    (call $__print (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__show_i32 (call $v_minUInt8)) (i32.const 65)) (call $__show_i32 (call $__box_i32 (i32.const 42)))) (i32.const 65)) (call $__show_i32 (call $__box_i32 (i32.const 200)))) (i32.const 65)) (call $__show_i32 (call $v_maxUInt8)))))
