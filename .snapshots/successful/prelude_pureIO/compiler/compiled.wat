...
(module
  ...
  (func $v__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterStdin_2__lift_2__lift_3 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
  ...
  (func $v__cps__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterStdin_2__lift_2__lift_3 (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
