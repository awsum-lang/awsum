...
const v__cps__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinString_2__lift_2__lift_3__lift_4 = (v__args, v__k) => {
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
...
const v__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinString_2__lift_2__lift_3__lift_4 = (v__args) => {
    return (v__cps__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinString_2__lift_2__lift_3__lift_4)(v__args, [28]);
};
...
const v__apply1 = (v__cl, v__arg0) => {
    return (v__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinString_2__lift_2__lift_3__lift_4)([17, v__cl, v__arg0]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 10: {
          const v___f0 = __s[1];
          return (v__apply__lift_1)(v__k, [10, [16, v___f0]]);
        }
      }
    }
  }
...
const v__df_bindIO_0 = (v_io) => {
    return (v__cps__df_bindIO_0)(v_io, [26]);
};
