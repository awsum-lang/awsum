...
function v_unwrap(v_r){
  return ((s) => { switch(s[0]) { case 0: { const v___p0 = s[1]; return ((s) => { switch(s[0]) { case 0: { const v___p0_p0 = s[1]; return ((s) => { switch(s[0]) { case 0: { const v_value = s[1]; return v_value; } case 1: { const v_value = s[1]; return v_value; } } })(v___p0_p0); } case 1: { const v___p0_p0 = s[1]; return ((s) => { switch(s[0]) { case 0: { const v_value = s[1]; return v_value; } case 1: { const v_value = s[1]; return v_value; } } })(v___p0_p0); } } })(v___p0); } case 1: { const v___p0 = s[1]; return ((s) => { switch(s[0]) { case 0: { const v___p0_p0 = s[1]; return ((s) => { switch(s[0]) { case 0: { const v_value = s[1]; return v_value; } case 1: { const v_value = s[1]; return v_value; } } })(v___p0_p0); } case 1: { const v___p0_p0 = s[1]; return ((s) => { switch(s[0]) { case 0: { const v_value = s[1]; return v_value; } case 1: { const v_value = s[1]; return v_value; } } })(v___p0_p0); } } })(v___p0); } } })(v_r);
}
