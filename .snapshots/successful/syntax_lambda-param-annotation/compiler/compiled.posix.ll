...
define internal ptr @v_res() {
  ...
  call void @__inc_ref(ptr %t0)
  %t1 = call ptr @__addInt32(ptr %t0, ptr %t0)
  call void @__free_recursive(ptr %t0)
  %t2 = getelementptr ptr, ptr %t1, i32 0
  %t3 = load ptr, ptr %t2
  %t4 = ptrtoint ptr %t3 to i64
  switch i64 %t4, label %case.default.5 [ i64 3, label %case.arm.3.7 i64 4, label %case.arm.4.9 ]
case.arm.3.7:
...
case.default.5:
  unreachable
case.join.6:
  %t18 = phi ptr [ %t1, %case.end.3.8 ], [ %t11, %case.end.4.10 ]
...
case.join.5:
  ...
  %t24 = inttoptr i64 21 to ptr
  %t25 = getelementptr ptr, ptr %t23, i32 0
  store ptr %t24, ptr %t25
  %t26 = call ptr @v__cps__df__rowmono_0_andThenIO_6(ptr %t22, ptr %t23)
  %t27 = call ptr @__alloc(i64 8, i32 0)
  %t28 = inttoptr i64 19 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @v__cps__df_handleErrorIO_2(ptr %t26, ptr %t27)
  ret ptr %t30
}
...
tco.case.arm.5.11:
  ...
  %t12 = call ptr @v__apply__df_handleErrorIO_2(ptr %t6, ptr %t5)
...
case.join.20:
  ...
  call void @__free_recursive(ptr %t15)
  %t50 = call ptr @v__apply__df_handleErrorIO_2(ptr %t6, ptr %t49)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v__cps__df__rowmono_0_andThenIO_6(ptr %v_io, ptr %v__k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.5.11:
  ...
  %t26 = call ptr @v__apply__df__rowmono_0_andThenIO_6(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.27:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t28 = call ptr @v__apply__df__rowmono_0_andThenIO_6(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v__apply__df__rowmono_0_andThenIO_6(ptr %v__k, ptr %v__x) {
entry:
  %t3 = alloca ptr
  store ptr %v__k, ptr %t3
  %t4 = alloca ptr
