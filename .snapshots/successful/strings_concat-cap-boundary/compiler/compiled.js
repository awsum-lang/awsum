...
function __predUInt32(x){ return x === 0 ? [3, [17]] : [4, ((x - 1) >>> 0)]; }
        ...
        case 8: {
          ...
          const v__df_andThenEither_0_cap0_0 = __s[2];
          {
            ...
            switch (__s[0]) {
              case 3: {
                const v_e = __s[1];
                return (v__apply__scc__df_andThenEither_0__lam_23_build)(v__k, [3, v_e]);
              }
              case 4: {
                const v_a = __s[1];
        ...
        case 10: {
          ...
          const v_acc = __s[2];
          {
            ...
            switch (__s[0]) {
              case 3: {
                const v___w0 = __s[1];
                return (v__apply__scc__df_andThenEither_0__lam_23_build)(v__k, [4, v_acc]);
              }
              case 4: {
                const v_m = __s[1];
                const __t0 = (v__args[0] = 8, v__args[1] = (v__lift_21)(__concat(v_acc, v_acc)), v__args[2] = v_m, v__args);
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
