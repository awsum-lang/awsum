...
(module
  ...
  (global $heap (mut i32) (i32.const 274))
  ...
  (data (i32.const 126) "\00\00\00\00\00\00\00\00\00\00\00\00\03\00\00\00\03\00\00\00abc")
  (data (i32.const 149) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00a")
  (data (i32.const 170) "\00\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\02\00\00\00ab")
  (data (i32.const 192) "\00\00\00\00\00\00\00\00\00\00\00\00\03\00\00\00\03\00\00\00abd")
  (data (i32.const 215) "\00\00\00\00\00\00\00\00\00\00\00\00\04\00\00\00\02\00\00\00\f0\9f\94\a5")
  (data (i32.const 239) "\00\00\00\00\00\00\00\00\00\00\00\00\0f\00\00\00\0f\00\00\00STRING_TOO_LONG")
  (table 3 funcref)
...
;;     at block + 12 and we want to write at block + 8).
    ...
    (if (i32.eq (local.get $ba) (local.get $bb))
      (then
        (local.set $eq (call $__memcmp
          ...
          (local.get $ba)))
        (if (local.get $eq)
          (then (i32.store (local.get $cell) (i32.const 1)))
          (else (i32.store (local.get $cell) (i32.const 2)))))
      (else
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (block (result i32) (local.set $__scrut (call $__concat (call $v_render (call $__eqString (i32.const 76) (i32.const 76))) (call $v_render (call $__eqString (i32.const 138) (i32.const 138))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_2 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_2)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_2)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_render (call $__eqString (i32.const 161) (i32.const 182))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_1 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_1)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_1)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s1 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s1)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s1)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_render (call $__eqString (i32.const 138) (i32.const 204))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_0)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_0)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s2 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s2)) (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s2)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_render (call $__eqString (i32.const 227) (i32.const 227)))))))))))))))
