...
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [0 x i8]} { i32 0, i32 0, i32 0, i32 0, i32 0, [0 x i8] zeroinitializer }
...
define internal ptr @v_main() {
  %t0 = call ptr @__eqString(ptr getelementptr inbounds (i8, ptr @.str.2, i64 12), ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
  %t1 = call ptr @v_render(ptr %t0)
  %t2 = call ptr @__eqString(ptr getelementptr inbounds (i8, ptr @.str.3, i64 12), ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
  %t3 = call ptr @v_render(ptr %t2)
  %t4 = call ptr @__concat(ptr %t1, ptr %t3)
  %t5 = getelementptr ptr, ptr %t4, i32 0
  %t6 = load ptr, ptr %t5
  %t7 = ptrtoint ptr %t6 to i64
...
case.arm.4.18:
  ...
  call void @__inc_ref(ptr %t21)
  %t22 = call ptr @__eqString(ptr getelementptr inbounds (i8, ptr @.str.4, i64 12), ptr getelementptr inbounds (i8, ptr @.str.5, i64 12))
  %t23 = call ptr @v_render(ptr %t22)
  %t24 = call ptr @__concat(ptr %t21, ptr %t23)
...
case.arm.4.38:
  ...
  call void @__inc_ref(ptr %t41)
  %t42 = call ptr @__eqString(ptr getelementptr inbounds (i8, ptr @.str.3, i64 12), ptr getelementptr inbounds (i8, ptr @.str.6, i64 12))
  %t43 = call ptr @v_render(ptr %t42)
  %t44 = call ptr @__concat(ptr %t41, ptr %t43)
...
case.arm.4.58:
  ...
  call void @__inc_ref(ptr %t61)
  %t62 = call ptr @__eqString(ptr getelementptr inbounds (i8, ptr @.str.7, i64 12), ptr getelementptr inbounds (i8, ptr @.str.7, i64 12))
  %t63 = call ptr @v_render(ptr %t62)
  %t64 = call ptr @__concat(ptr %t61, ptr %t63)
...
case.default.48:
  unreachable
case.join.49:
  %t65 = phi ptr [%t54, %case.end.3.51], [%t64, %case.end.4.59]
...
case.default.28:
  unreachable
case.join.29:
  %t66 = phi ptr [%t34, %case.end.3.31], [%t65, %case.end.4.39]
...
case.default.8:
  unreachable
case.join.9:
  %t67 = phi ptr [%t14, %case.end.3.11], [%t66, %case.end.4.19]
  call void @__free_recursive(ptr %t4)
  %t68 = call ptr @v__let_12(ptr %t67)
  ret ptr %t68
}
...
case.arm.3.4:
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.8, i64 12), ptr %t10
