...
case.default.15:
  unreachable
case.join.16:
  %t21 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.1.18 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.2.20 ]
  ...
  %t30 = getelementptr ptr, ptr %t0, i32 2
