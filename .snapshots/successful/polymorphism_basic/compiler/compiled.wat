...
(module
  ...
  (table 7 funcref)
  (elem (i32.const 0) $v_const $v_runIO $v_main $v_identity $v_appendX $v_appendY $v__let_2)
  ...
  (func $v_main (param $v__input i32) (result i32)
    ...
    (local $v_ax i32)
    (local $__scrut i32)
    (call $v__let_2 (block (result i32) (local.set $__scrut (call $v_appendX (call $v_const (i32.const 65) (i32.const 67)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__do_e_7_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_7_9)) (local.get $__con_0))) (else (local.set $v_ax (i32.load offset=4 (local.get $__scrut))) (call $v_identity (call $v_appendY (local.get $v_ax))))))))
  ...
  (func $v_appendX (param $v_s i32) (result i32)
    (local $__con_0 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (local.get $v_s) (i32.const 69))) (local.get $__con_0)))

  (func $v_appendY (param $v_s i32) (result i32)
    (local $__con_0 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (local.get $v_s) (i32.const 71))) (local.get $__con_0)))
