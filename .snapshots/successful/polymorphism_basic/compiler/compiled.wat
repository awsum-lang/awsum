...
(module
  ...
  (data (i32.const 90) "\01\00\00\00\01\00\00\00x")
  (data (i32.const 99) "\01\00\00\00\01\00\00\00y")
  ...
  (func $v_main (result i32)
    ...
    (local $v_ax i32)
    (local $__scrut i32)
    (call $v__let_7 (block (result i32) (local.set $__scrut (call $v_appendX (call $v_const (i32.const 72) (i32.const 81)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_7_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_7_9)) (local.get $__con_0))) (else (local.set $v_ax (i32.load offset=4 (local.get $__scrut))) (call $v_identity (call $v_appendY (local.get $v_ax))))))))

  (func $v_identity (param $v_x i32) (result i32)
    (local.get $v_x))

  (func $v_appendX (param $v_s i32) (result i32)
    (call $__concat (local.get $v_s) (i32.const 90)))

  (func $v_appendY (param $v_s i32) (result i32)
    (call $__concat (local.get $v_s) (i32.const 99)))
