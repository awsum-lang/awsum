...
@.str.2 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"x" }
@.str.3 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"y" }
...
define internal ptr @v_main(ptr %v__input) {
  %t0 = call ptr @v_const(ptr @.str.0, ptr @.str.1)
...
define internal ptr @v_appendX(ptr %v_s) {
  %t0 = call ptr @__concat(ptr %v_s, ptr @.str.2)
  ret ptr %t0
}

define internal ptr @v_appendY(ptr %v_s) {
  %t0 = call ptr @__concat(ptr %v_s, ptr @.str.3)
  ret ptr %t0
}
