...
define internal ptr @v_main() {
  %t0 = call ptr @v_const(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
  %t1 = call ptr @v_appendX(ptr %t0)
...
case.arm.4.15:
  ...
  call void @__inc_ref(ptr %t18)
  %t19 = call ptr @v_appendY(ptr %t18)
  %t20 = call ptr @v_identity(ptr %t19)
...
define internal ptr @v_appendX(ptr %v_s) {
  ...
  %t0 = call ptr @__concat(ptr %v_s, ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
...
define internal ptr @v_appendY(ptr %v_s) {
  call void @__inc_ref(ptr %v_s)
  %t0 = call ptr @__concat(ptr %v_s, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
  call void @__free_recursive(ptr %v_s)
  ret ptr %t0
}
