...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [3 x i8]} { i32 0, i32 0, i32 0, i32 3, i32 3, [3 x i8] c"abc" }
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [4 x i8]} { i32 0, i32 0, i32 0, i32 4, i32 4, [4 x i8] c"len3" }
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [5 x i8]} { i32 0, i32 0, i32 0, i32 5, i32 5, [5 x i8] c"other" }
...
define internal ptr @v_main() {
  ...
  store ptr %t1, ptr %t2
  call void @__inc_ref(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
  %t5 = call ptr @__lengthUtf8Bytes(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
  ...
  switch i64 %t10, label %join.case.default.11 [ i64 1, label %join.case.arm.1.12 i64 2, label %join.case.arm.2.14 ]
join.case.arm.1.12:
  call void @__free_recursive(ptr %t7)
  br label %join.val.13
join.val.13:
  br label %join.after.4
join.case.arm.2.14:
  call void @__inc_ref(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
  %t15 = call ptr @__lengthUtf8Bytes(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
...
case.default.22:
  unreachable
case.join.23:
  %t28 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.1.25 ], [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.2.27 ]
  call void @__free_recursive(ptr %t18)
  br label %join.end.29
join.end.29:
  br label %join.after.4
join.after.4:
  %t30 = phi ptr [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %join.val.13 ], [ %t28, %join.end.29 ]
  call void @__free_recursive(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
