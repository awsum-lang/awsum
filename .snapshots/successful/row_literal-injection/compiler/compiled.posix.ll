...
define internal ptr @v_main() {
  ...
  %t16 = call ptr @v__lift_16(ptr %t0)
  %t17 = call ptr @v__df_andThenIO_12(ptr %t16)
  %t18 = call ptr @v__df_andThenIO_9(ptr %t17)
  %t19 = call ptr @v__df_andThenIO_6(ptr %t18)
  %t20 = call ptr @v__df_andThenIO_3(ptr %t19)
...
define internal ptr @v__scc__apply1__df__lam_4_1__df__lam_4_10__df__lam_4_13__df__lam_4_4__df__lam_4_7__df__lam_5_11__df__lam_5_14__df__lam_5_2__df__lam_5_5__df__lam_5_8__lift_17__lift_18__lift_2__lift_3(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 53 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_4_1__df__lam_4_10__df__lam_4_13__df__lam_4_4__df__lam_4_7__df__lam_5_11__df__lam_5_14__df__lam_5_2__df__lam_5_5__df__lam_5_8__lift_17__lift_18__lift_2__lift_3(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_4_1__df__lam_4_10__df__lam_4_13__df__lam_4_4__df__lam_4_7__df__lam_5_11__df__lam_5_14__df__lam_5_2__df__lam_5_5__df__lam_5_8__lift_17__lift_18__lift_2__lift_3(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 24, label %tco.case.arm.24.11 i64 25, label %tco.case.arm.25.300 i64 26, label %tco.case.arm.26.323 i64 27, label %tco.case.arm.27.346 i64 28, label %tco.case.arm.28.369 i64 29, label %tco.case.arm.29.392 i64 30, label %tco.case.arm.30.415 i64 31, label %tco.case.arm.31.438 i64 32, label %tco.case.arm.32.461 i64 33, label %tco.case.arm.33.484 i64 34, label %tco.case.arm.34.507 i64 35, label %tco.case.arm.35.530 i64 36, label %tco.case.arm.36.553 i64 37, label %tco.case.arm.37.576 i64 38, label %tco.case.arm.38.599 ]
tco.case.arm.24.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 10, label %tco.case.arm.10.20 i64 11, label %tco.case.arm.11.40 i64 12, label %tco.case.arm.12.60 i64 13, label %tco.case.arm.13.80 i64 14, label %tco.case.arm.14.100 i64 15, label %tco.case.arm.15.120 i64 16, label %tco.case.arm.16.140 i64 17, label %tco.case.arm.17.160 i64 18, label %tco.case.arm.18.180 i64 19, label %tco.case.arm.19.200 i64 20, label %tco.case.arm.20.220 i64 21, label %tco.case.arm.21.240 i64 22, label %tco.case.arm.22.260 i64 23, label %tco.case.arm.23.280 ]
tco.case.arm.10.20:
...
tco.case.default.19:
  unreachable
tco.case.arm.25.300:
  %t301 = getelementptr ptr, ptr %t5, i32 1
  %t302 = load ptr, ptr %t301
  %t303 = getelementptr ptr, ptr %t5, i32 2
...
reuse.in_place.308:
  %t311 = inttoptr i64 24 to ptr
  %t312 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t311, ptr %t312
  br label %reuse.join.310
reuse.copy.309:
  %t313 = call ptr @__alloc(i64 24, i32 2)
  %t314 = inttoptr i64 24 to ptr
  %t315 = getelementptr ptr, ptr %t313, i32 0
  store ptr %t314, ptr %t315
  call void @__inc_ref(ptr %t302)
  %t316 = getelementptr ptr, ptr %t313, i32 1
  store ptr %t302, ptr %t316
  call void @__inc_ref(ptr %t304)
  %t317 = getelementptr ptr, ptr %t313, i32 2
  store ptr %t304, ptr %t317
  call void @__free_recursive(ptr %t5)
  br label %reuse.join.310
reuse.join.310:
  %t318 = phi ptr [ %t5, %reuse.in_place.308 ], [ %t313, %reuse.copy.309 ]
  %t319 = call ptr @__alloc(i64 16, i32 1)
  %t320 = inttoptr i64 54 to ptr
  %t321 = getelementptr ptr, ptr %t319, i32 0
  store ptr %t320, ptr %t321
  call void @__inc_ref(ptr %t6)
  %t322 = getelementptr ptr, ptr %t319, i32 1
  store ptr %t6, ptr %t322
  call void @__free_recursive(ptr %t6)
  store ptr %t318, ptr %t3
  store ptr %t319, ptr %t4
  br label %tco.loop.0
tco.case.arm.26.323:
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_4_1__df__lam_4_10__df__lam_4_13__df__lam_4_4__df__lam_4_7__df__lam_5_11__df__lam_5_14__df__lam_5_2__df__lam_5_5__df__lam_5_8__lift_17__lift_18__lift_2__lift_3(ptr %t0)
