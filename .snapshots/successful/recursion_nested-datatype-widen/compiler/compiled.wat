...
(module
  ...
  (table 4 funcref)
  (elem (i32.const 0) $v_runIO $v_$cps$$df$handleErrorIO$2 $v_$apply$$df$handleErrorIO$2 $v_$scc$$apply$$scc$$apply1__$df$$lam$14$7__$df$$lam$$x$2574563281)
  ...
  (func $v_$scc$$apply$$scc$$apply1__$df$$lam$14$7__$df$$lam$$x$2574563281 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
