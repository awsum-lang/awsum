...
(() => {
  ...
  const v_$scc$$apply$$scc$$apply1__$df$$lam$14$7__$df$$lam$9$3__$df$$map$Nest$0__$df$$map$Nest$1__$df$$rowmono$0$andThenIO$6__$map$Maybe__run2__$cps$$scc$$apply1__$df$$lam$14$7__$df$$lam$9$3__$df$$map$Nest$0__$df$$map$Nest$1__$df$$rowmono$0$andThenIO$6__$map$Maybe__run2 = v_$args$1 => {
    while (true) {
      switch (v_$args$1[0]) {
        case 50: {
        ...
        case 51: {
          ...
          switch (v_$args[0]) {
            ...
            case 34: {
              ...
              switch (v_$mapin[0]) {
                case 24: {
                  ...
                  v_$args$1 = [
                    51,
                    (v_$args$1[0] = 35, v_$args$1[1] = v_$mx$0, v_$args$1[2] = [
                      29
                    ], v_$args$1),
                    [44, v_$k]
                  ];
            ...
            case 35: {
              const v_$mapin = v_$args[1];
              const v_$df$$map$Nest$1$cap0$0 = v_$args[2];
              switch (v_$mapin[0]) {
                case 24: {
                  const v_$mx$0 = v_$mapin[1];
                  v_$args$1 = (v_$args$1[0] = 51, v_$args$1[1] = (v_$args[0] = 35, v_$args[1] = v_$mx$0, v_$args[2] = [
                    30,
                    v_$df$$map$Nest$1$cap0$0
                  ], v_$args), v_$args$1[2] = [45, v_$k], v_$args$1);
                  continue;
                }
                case 25: {
                  const v_$mx$0 = v_$mapin[1];
                  v_$args$1 = (v_$args$1[0] = 51, v_$args$1[1] = (v_$args[0] = 37, v_$args[1] = v_$args[2], v_$args[2] = v_$mx$0, v_$args), v_$args$1[2] = [
                    46,
                    v_$k
                  ], v_$args$1);
                  continue;
              ...
              switch (v_io[0]) {
                ...
                case 7: {
                  v_$args$1 = [
                    ...
                    (v_$args$1[0] = 47, v_$args$1[1] = v_$args$1[2], v_$args$1[2] = v_io[1], v_$args$1)
                  ];
                  continue;
                }
                case 8: {
            ...
            case 37: {
              ...
              switch (v_$mapin[0]) {
                ...
                case 12: {
                  v_$args$1 = (v_$args$1[0] = 51, v_$args$1[1] = (v_$args[0] = 31, v_$args[2] = v_$mapin[1], v_$args), v_$args$1[2] = [
                    48,
                    v_$k
                  ], v_$args$1);
                  continue;
      ...
      switch (v_io[0]) {
        ...
        case 8: {
          const __t0 = (() => {
            ...
            return v_$scc$$apply$$scc$$apply1__$df$$lam$14$7__$df$$lam$9$3__$df$$map$Nest$0__$df$$map$Nest$1__$df$$rowmono$0$andThenIO$6__$map$Maybe__run2__$cps$$scc$$apply1__$df$$lam$14$7__$df$$lam$9$3__$df$$map$Nest$0__$df$$map$Nest$1__$df$$rowmono$0$andThenIO$6__$map$Maybe__run2(
  ...
  const main = v_$cps$$df$handleErrorIO$2(
    v_$scc$$apply$$scc$$apply1__$df$$lam$14$7__$df$$lam$9$3__$df$$map$Nest$0__$df$$map$Nest$1__$df$$rowmono$0$andThenIO$6__$map$Maybe__run2__$cps$$scc$$apply1__$df$$lam$14$7__$df$$lam$9$3__$df$$map$Nest$0__$df$$map$Nest$1__$df$$rowmono$0$andThenIO$6__$map$Maybe__run2(
      [51, [36, [8, [28]]], [41]]
    ),
    [39]
  );
