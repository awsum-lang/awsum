...
(() => {
  ...
  const v_$scc$$apply$$scc$$apply1__$df$$lam$14$7__$df$$lam$$x$2574563281 = v_$args$1 => {
    while (true) {
      switch (v_$args$1[0]) {
        case 50: {
      ...
      switch (v_io[0]) {
        ...
        case 8: {
          const __t0 = (() => {
            ...
            return v_$scc$$apply$$scc$$apply1__$df$$lam$14$7__$df$$lam$$x$2574563281(
  ...
  const main = v_$cps$$df$handleErrorIO$2(
    v_$scc$$apply$$scc$$apply1__$df$$lam$14$7__$df$$lam$$x$2574563281(
      [51, [36, [8, [28]]], [41]]
    ),
    [39]
  );
