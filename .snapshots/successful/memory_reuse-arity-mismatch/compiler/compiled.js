...
(() => {
  ...
  const v_$inl1$t = v_mkBig(3 | 0);
  const v_$inl4$p = [25, v_$inl1$t[1], v_$inl1$t[2]];
  const v_$inl7$x = (s => {
    switch (s[0]) {
      case 3: {
        const v_$inl2$$do__e__0 = s[1];
        return [3, v_$inl2$$do__e__0];
      }
      case 4: {
        const v_$inl3$s1 = s[1];
        return __concat(v_$inl3$s1, String(v_$inl4$p[2]));
      }
    }
  })(__concat(String(v_$inl4$p[1]), ","));
