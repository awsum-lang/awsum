...
define internal ptr @v_mkBig(ptr %v_n) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.1.11:
  %t12 = call ptr @__alloc(i64 32, i32 3)
  ...
  store i32 8, ptr %t17
  %t18 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t17, ptr %t18
  %t19 = call ptr @__alloc(i64 4, i32 0)
  store i32 9, ptr %t19
  %t20 = getelementptr ptr, ptr %t12, i32 3
...
tco.case.arm.3.27:
  %t28 = call ptr @__alloc(i64 32, i32 3)
  ...
  store i32 8, ptr %t33
  %t34 = getelementptr ptr, ptr %t28, i32 2
  store ptr %t33, ptr %t34
  %t35 = call ptr @__alloc(i64 4, i32 0)
  store i32 9, ptr %t35
  %t36 = getelementptr ptr, ptr %t28, i32 3
...
define internal ptr @v_main() {
  ...
  store i32 3, ptr %t0
  %t1 = call ptr @v_mkBig(ptr %t0)
  %t2 = call ptr @__alloc(i64 24, i32 2)
  %t3 = inttoptr i64 25 to ptr
  %t4 = getelementptr ptr, ptr %t2, i32 0
  store ptr %t3, ptr %t4
  %t5 = getelementptr ptr, ptr %t1, i32 1
  %t6 = load ptr, ptr %t5
  call void @__inc_ref(ptr %t6)
  %t7 = getelementptr ptr, ptr %t2, i32 1
  store ptr %t6, ptr %t7
  %t8 = getelementptr ptr, ptr %t1, i32 2
  %t9 = load ptr, ptr %t8
  call void @__inc_ref(ptr %t9)
  %t10 = getelementptr ptr, ptr %t2, i32 2
  store ptr %t9, ptr %t10
  call void @__free_recursive(ptr %t1)
  %t11 = getelementptr ptr, ptr %t2, i32 1
  %t12 = load ptr, ptr %t11
  call void @__inc_ref(ptr %t12)
  %t13 = call ptr @__showInt32(ptr %t12)
  %t14 = call ptr @__concat(ptr %t13, ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
...
case.arm.4.28:
  ...
  call void @__inc_ref(ptr %t31)
  %t32 = getelementptr ptr, ptr %t2, i32 2
  %t33 = load ptr, ptr %t32
  call void @__inc_ref(ptr %t33)
  %t34 = call ptr @__showInt32(ptr %t33)
  %t35 = call ptr @__concat(ptr %t31, ptr %t34)
...
case.default.18:
  unreachable
case.join.19:
  %t36 = phi ptr [ %t24, %case.end.3.21 ], [ %t35, %case.end.4.29 ]
...
case.arm.3.42:
  ...
  %t47 = getelementptr ptr, ptr %t36, i32 1
...
case.arm.4.50:
  ...
  %t55 = getelementptr ptr, ptr %t36, i32 1
...
case.join.41:
  ...
  %t62 = call ptr @v__cps__df_andThenIO_4(ptr %t58, ptr %t59)
  %t63 = call ptr @__alloc(i64 8, i32 0)
  %t64 = inttoptr i64 26 to ptr
  %t65 = getelementptr ptr, ptr %t63, i32 0
  store ptr %t64, ptr %t65
  %t66 = call ptr @v__cps__df_handleErrorIO_0(ptr %t62, ptr %t63)
  ret ptr %t66
}
