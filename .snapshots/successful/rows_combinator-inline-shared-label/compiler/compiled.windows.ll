...
define internal ptr @v_cShared() {
  ...
  %t4 = inttoptr i64 348914022 to ptr
...
case.arm.3.9:
  ...
  switch i64 %t15, label %case.default.16 [ i64 348914022, label %case.arm.348914022.18 ]
case.arm.348914022.18:
  br label %case.end.348914022.19
case.end.348914022.19:
  br label %case.join.17
case.default.16:
  unreachable
case.join.17:
  %t20 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.348914022.19 ]
