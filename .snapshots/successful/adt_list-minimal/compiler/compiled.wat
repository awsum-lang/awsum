...
(module
  ...
  (func $v_main (result i32)
    ...
    (local $__con_2 i32)
    (local $__con_3 i32)
    (call $v__let_7 (call $v_show (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (i32.const 72)) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 12))) (i32.const 0)) (i32.store offset=4 (local.get $__con_1) (i32.const 81)) (i32.store offset=8 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc (i32.const 12))) (i32.const 0)) (i32.store offset=4 (local.get $__con_2) (i32.const 90)) (i32.store offset=8 (local.get $__con_2) (block (result i32) (i32.store (local.tee $__con_3 (call $__alloc (i32.const 4))) (i32.const 1)) (local.get $__con_3))) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0)))))
  ...
  (func $v__cps__scc_show_showCons (param $v__args i32) (param $v__k i32) (result i32)
    ...
    (local $__k0 i32)
    (local $__k1 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (local.get $v__args)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v_xs (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v_xs)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v_h (i32.load offset=4 (local.get $__scrut))) (local.set $v_t (i32.load offset=8 (local.get $__scrut))) (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (local.get $v_h)) (i32.store offset=8 (local.get $__con_0) (local.get $v_t)) (local.get $__con_0))) (local.set $__k1 (local.get $v__k)) (local.set $v__args (local.get $__k0)) (local.set $v__k (local.get $__k1)) (br $tco_top)) (else (call $v__apply__scc_show_showCons (local.get $v__k) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (i32.const 64)) (local.get $__con_0))))))) (else (local.set $v_h (i32.load offset=4 (local.get $__scrut))) (local.set $v_t (i32.load offset=8 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__concat (local.get $v_h) (i32.const 122))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__do_e_13_3 (i32.load offset=4 (local.get $__scrut))) (call $v__apply__scc_show_showCons (local.get $v__k) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_13_3)) (local.get $__con_0)))) (else (local.set $v_hc (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v_t)) (local.get $__con_0))) (local.set $__k1 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (local.get $v__k)) (i32.store offset=8 (local.get $__con_0) (local.get $v_hc)) (local.get $__con_0))) (local.set $v__args (local.get $__k0)) (local.set $v__k (local.get $__k1)) (br $tco_top)))))))))
