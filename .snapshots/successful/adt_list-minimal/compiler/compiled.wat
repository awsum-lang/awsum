...
(module
  ...
  (table 9 funcref)
  (elem (i32.const 0) $v_runIO $v__lift_15 $v__cps__lift_15 $v__apply__lift_15 $v__let_16 $v__scc_show_showCons $v__cps__scc_show_showCons $v__apply__scc_show_showCons $v_show)
