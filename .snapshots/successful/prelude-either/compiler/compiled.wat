...
(module
  ...
  (data (i32.const 84) ", \00")
  (data (i32.const 87) "good\00")
  (table 2 funcref)
  ...
  (func $v_unwrap (export "v_unwrap") (param $v_r i32) (result i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (call $__concat (i32.const 65) (i32.load offset=4 (local.get $__scrut)))) (else (call $__concat (i32.const 72) (i32.load offset=4 (local.get $__scrut)))))))
