...
(() => {
  ...
  const v_predU32Underflow = "U";

  const v_mulU8Overflow = "O";

  const v_mulU32Overflow = "O";

  const v_addU8Ok = String(255 & 0xFF);

  const v_addU32Ok = String(4294967295 >>> 0);
  ...
  const v__cps__df_andThenIO_36 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v__apply__df_andThenIO_36(v__k, [7, ";", [5, [0]]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v__cps__df_andThenIO_24 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v__apply__df_andThenIO_24(v__k, [7, v_addU8Ok, [5, [0]]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v__cps__df_andThenIO_0 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v__apply__df_andThenIO_0(v__k, [7, v_addU32Ok, [5, [0]]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
