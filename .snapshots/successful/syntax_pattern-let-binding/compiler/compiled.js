...
(() => {
  ...
  const v_$inl3$n = 5 | 0;
  const v_$inl10$pair = (s => {
    switch (s[0]) {
      case 3: {
        return [15, v_$inl3$n, v_$inl3$n];
      }
      case 4: {
        const v_$inl2$d = s[1];
        return [15, v_$inl3$n, v_$inl2$d];
      }
    }
  })(__mulInt32(v_$inl3$n, 2 | 0));
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
        const v_$inl4$$do__e__2 = s[1];
        return [3, v_$inl4$$do__e__2];
      }
      case 4: {
        const v_$inl5$s0 = s[1];
        {
          const __s = __concat(v_$inl5$s0, ", ");
          switch (__s[0]) {
            case 3: {
              const v_$inl6$$do__e__1 = __s[1];
              return [3, v_$inl6$$do__e__1];
            }
            case 4: {
              const v_$inl7$s1 = __s[1];
              {
                const __s = __concat(v_$inl7$s1, String(v_$inl10$pair[2]));
                switch (__s[0]) {
                  case 3: {
                    const v_$inl8$$do__e__0 = __s[1];
                    return [3, v_$inl8$$do__e__0];
                  }
                  case 4: {
                    const v_$inl9$s2 = __s[1];
                    return __concat(v_$inl9$s2, "]");
                  }
                }
              }
            }
  ...
  })(__concat("[", String(v_$inl10$pair[1])));
