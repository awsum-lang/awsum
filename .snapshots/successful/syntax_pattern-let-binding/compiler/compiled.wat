...
(module
  ...
  (global $heap (mut i32) (i32.const 88))
  (data (i32.const 64) "\00")
  (data (i32.const 65) "[\00")
  (data (i32.const 67) ", \00")
  (data (i32.const 70) "]\00")
  (data (i32.const 72) "STRING_TOO_LONG\00")
  (table 5 funcref)
  (elem (i32.const 0) $v_runIO $v_threeAndDouble $v_show $v_main $v__let_2)
  ...
  (func $v_threeAndDouble (param $v_n i32) (result i32)
    ...
    (local $v_d i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $__mulInt32 (local.get $v_n) (call $__box_i32 (i32.const 2)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v_n)) (i32.store offset=8 (local.get $__con_0) (local.get $v_n)) (local.get $__con_0))) (else (local.set $v_d (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v_n)) (i32.store offset=8 (local.get $__con_0) (local.get $v_d)) (local.get $__con_0))))))
  ...
  (func $v_show (param $v_pair i32) (result i32)
    ...
    (local $v_s2 i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_pair)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (block (result i32) (local.set $__scrut (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (i32.const 65) (call $__show_i32 (local.get $v_a)))) (local.get $__con_0))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__do_e_13_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_13_9)) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (local.get $v_s0) (i32.const 67))) (local.get $__con_0))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__do_e_14_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_14_9)) (local.get $__con_0))) (else (local.set $v_s1 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (local.get $v_s1) (call $__show_i32 (local.get $v_b)))) (local.get $__con_0))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__do_e_15_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_15_9)) (local.get $__con_0))) (else (local.set $v_s2 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (local.get $v_s2) (i32.const 70))) (local.get $__con_0)))))))))))))

  (func $v_main (param $v__input i32) (result i32)
    (call $v__let_2 (call $v_show (call $v_threeAndDouble (call $__box_i32 (i32.const 5))))))
