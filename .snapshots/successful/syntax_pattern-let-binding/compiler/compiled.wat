...
(module
  ...
  (table 3 funcref)
  (elem (i32.const 0) $v_threeAndDouble $v_show $v_main)
  ...
  (func $v_show (param $v_pair i32) (result i32)
    ...
    (local $v_b i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_pair)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (call $__concat (call $__concat (call $__concat (call $__concat (i32.const 65) (call $__show_i32 (local.get $v_a))) (i32.const 67)) (call $__show_i32 (local.get $v_b))) (i32.const 70))))

  (func $v_main (param $v__input i32) (result i32)
    (call $__print (call $v_show (call $v_threeAndDouble (call $__box_i32 (i32.const 5))))))
