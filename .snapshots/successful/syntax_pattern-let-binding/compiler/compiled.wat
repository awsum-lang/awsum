...
(module
  ...
  (table 4 funcref)
  (elem (i32.const 0) $v_threeAndDouble $v_show $v_main $v__let_1)
  ...
  (func $v_main (param $v__input i32) (result i32)
    (call $v__let_1 (call $v_show (call $v_threeAndDouble (call $__box_i32 (i32.const 5))))))

  (func $v__let_1 (param $v_res i32) (result i32)
    (local $v___w0 i32)
    (local $v_s i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_res)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__print (i32.const 72))) (else (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (call $__print (local.get $v_s))))))
