...
(module
  ...
  (global $heap (mut i32) (i32.const 123))
  (data (i32.const 64) "\00\00\00\00\00\00\00\00")
  (data (i32.const 72) "\01\00\00\00\01\00\00\00[")
  (data (i32.const 81) "\02\00\00\00\02\00\00\00, ")
  (data (i32.const 91) "\01\00\00\00\01\00\00\00]")
  (data (i32.const 100) "\0f\00\00\00\0f\00\00\00STRING_TOO_LONG")
  (table 4 funcref)
  ...
  (func $v_threeAndDouble (param $v_n i32) (result i32)
    ...
    (local $v_d i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $__mulInt32 (local.get $v_n) (call $__box_i32 (i32.const 2)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 11)) (i32.store offset=4 (local.get $__con_0) (local.get $v_n)) (i32.store offset=8 (local.get $__con_0) (local.get $v_n)) (local.get $__con_0))) (else (local.set $v_d (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 11)) (i32.store offset=4 (local.get $__con_0) (local.get $v_n)) (i32.store offset=8 (local.get $__con_0) (local.get $v_d)) (local.get $__con_0))))))
  ...
  (func $v_show (param $v_pair i32) (result i32)
    ...
    (local $v_s2 i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_pair)) (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__concat (i32.const 72) (call $__show_i32 (local.get $v_a)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_13_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_13_9)) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__concat (local.get $v_s0) (i32.const 81))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_14_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_14_9)) (local.get $__con_0))) (else (local.set $v_s1 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__concat (local.get $v_s1) (call $__show_i32 (local.get $v_b)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_15_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_15_9)) (local.get $__con_0))) (else (local.set $v_s2 (i32.load offset=4 (local.get $__scrut))) (call $__concat (local.get $v_s2) (i32.const 91)))))))))))))
