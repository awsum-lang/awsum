...
case.join.7:
  ...
  %t28 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr %t27)
...
case.arm.4.60:
  ...
  call void @__inc_ref(ptr %t63)
  %t64 = getelementptr ptr, ptr %t24, i32 2
  %t65 = load ptr, ptr %t64
  call void @__inc_ref(ptr %t65)
  %t66 = call ptr @__showInt32(ptr %t65)
  %t67 = call ptr @__concat(ptr %t63, ptr %t66)
...
case.arm.4.81:
  ...
  call void @__inc_ref(ptr %t84)
  %t85 = call ptr @__concat(ptr %t84, ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
...
case.default.50:
  unreachable
case.join.51:
  %t87 = phi ptr [ %t56, %case.end.3.53 ], [ %t86, %case.end.4.61 ]
...
case.default.32:
  unreachable
case.join.33:
  %t88 = phi ptr [ %t38, %case.end.3.35 ], [ %t87, %case.end.4.43 ]
