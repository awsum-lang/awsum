...
case.default.53:
  unreachable
case.join.54:
  %t68 = phi ptr [%t59, %case.end.0.56], [%t67, %case.end.1.64]
...
case.default.34:
  unreachable
case.join.35:
  %t69 = phi ptr [%t40, %case.end.0.37], [%t68, %case.end.1.45]
...
case.default.16:
  unreachable
case.join.17:
  %t70 = phi ptr [%t22, %case.end.0.19], [%t69, %case.end.1.27]
