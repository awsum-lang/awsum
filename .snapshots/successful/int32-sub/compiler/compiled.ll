...
define internal ptr @v_main(ptr %v__input) {
  ...
  store i32 -50, ptr %t7
  %t8 = call ptr @__subInt32(ptr %t6, ptr %t7)
  ...
  store i32 -1, ptr %t14
  %t15 = call ptr @__subInt32(ptr %t13, ptr %t14)
  ...
  store i32 1, ptr %t21
  %t22 = call ptr @__subInt32(ptr %t20, ptr %t21)
  ...
  %t27 = call ptr @malloc(i64 4)
  store i32 0, ptr %t27
  %t28 = call ptr @v_minInt32()
  %t29 = call ptr @__subInt32(ptr %t27, ptr %t28)
