...
(module
  ...
  (table 4 funcref)
  (elem (i32.const 0) $v_showUnderflowError $v_showOverflowError $v_render $v_main)
  ...
  (func $v_main (param $v__input i32) (result i32)
    (call $__print (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $v_render (call $__subInt32 (call $__box_i32 (i32.const 100)) (call $__box_i32 (i32.const 23)))) (i32.const 105)) (call $v_render (call $__subInt32 (call $__box_i32 (i32.const 100)) (call $__box_i32 (i32.const -50))))) (i32.const 105)) (call $v_render (call $__subInt32 (call $v_maxInt32) (call $__box_i32 (i32.const -1))))) (i32.const 105)) (call $v_render (call $__subInt32 (call $v_minInt32) (call $__box_i32 (i32.const 1))))) (i32.const 105)) (call $v_render (call $__subInt32 (call $__box_i32 (i32.const 0)) (call $v_minInt32))))))
