...
(module
  ...
  (data (i32.const 65) "Underflow\00")
  (data (i32.const 75) "Overflow\00")
  (data (i32.const 84) "err: \00")
  (data (i32.const 90) "ok: \00")
  (data (i32.const 95) ", \00")
  (table 3 funcref)
  (elem (i32.const 0) $v_showArithError $v_render $v_main)
  ...
  (func $v_showArithError (export "v_showArithError") (param $v_e i32) (result i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_e)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (i32.const 65)) (else (i32.const 75)))))

  (func $v_render (export "v_render") (param $v_r i32) (result i32)
    (local $v_e i32)
    (local $v_v i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__concat (i32.const 84) (call $v_showArithError (local.get $v_e)))) (else (local.set $v_v (i32.load offset=4 (local.get $__scrut))) (call $__concat (i32.const 90) (call $__show_i32 (local.get $v_v)))))))

  (func $v_minInt32 (export "v_minInt32") (result i32)
    (call $__box_i32 (i32.const -2147483648)))

  (func $v_main (export "v_main") (param $v__input i32) (result i32)
    (call $__print (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $__concat (call $v_render (call $__mulInt32 (call $__box_i32 (i32.const 6)) (call $__box_i32 (i32.const 7)))) (i32.const 95)) (call $v_render (call $__mulInt32 (call $__box_i32 (i32.const -6)) (call $__box_i32 (i32.const 7))))) (i32.const 95)) (call $v_render (call $__mulInt32 (call $__box_i32 (i32.const 100000)) (call $__box_i32 (i32.const 100000))))) (i32.const 95)) (call $v_render (call $__mulInt32 (call $__box_i32 (i32.const -100000)) (call $__box_i32 (i32.const 100000))))) (i32.const 95)) (call $v_render (call $__mulInt32 (call $v_minInt32) (call $__box_i32 (i32.const -1))))) (i32.const 95)) (call $v_render (call $__mulInt32 (call $v_minInt32) (call $__box_i32 (i32.const 1)))))))
