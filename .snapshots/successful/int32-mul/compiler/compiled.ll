...
define internal ptr @v_showArithError(ptr %v_e) {
...
define internal ptr @v_main(ptr %v__input) {
  ...
  store i32 7, ptr %t7
  %t8 = call ptr @__mulInt32(ptr %t6, ptr %t7)
  ...
  %t13 = call ptr @malloc(i64 4)
  store i32 100000, ptr %t13
  %t14 = call ptr @malloc(i64 4)
  store i32 100000, ptr %t14
  %t15 = call ptr @__mulInt32(ptr %t13, ptr %t14)
  ...
  store i32 -100000, ptr %t20
  %t21 = call ptr @malloc(i64 4)
  store i32 100000, ptr %t21
  %t22 = call ptr @__mulInt32(ptr %t20, ptr %t21)
