...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_countWithBox (param $v_b i32) (param $v_n i32) (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__cps_countWithBox (block (result i32) (local.set $__inc_tmp (local.get $v_b)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 24)) (local.get $__con_0))))
  ...
  (func $v__apply_countWithBox (param $v__k i32) (param $v__x i32) (result i32)
    ...
    (local $__k0 i32)
    (local $__k1 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (local.get $v__k)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 24)) (then (block (result i32) (local.set $__drop_tmp (local.get $v__x)) (call $__free_recursive (local.get $v__k)) (local.get $__drop_tmp))) (else (local.set $v__pk_25 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__pk_25)) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (block (result i32) (local.set $__scrut (local.get $v__x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (local.set $__k0 (local.get $v__pk_25)) (local.set $__k1 (if (result i32) (i32.eq (i32.load (i32.sub (local.get $v__x) (i32.const 8))) (i32.const 1)) (then (block (result i32) (call $__free_recursive (i32.load offset=4 (local.get $v__x))) (i32.store (local.get $v__x) (i32.const 3)) (i32.store offset=4 (local.get $v__x) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $v__x))) (local.get $v__x))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (call $__free_recursive (local.get $v__x)) (local.get $__con_0))))) (call $__inc_ref (local.get $__k0)) (call $__free_recursive (local.get $v__k)) (call $__free_recursive (local.get $v_e)) (call $__free_recursive (local.get $v_b)) (call $__free_recursive (local.get $v__pk_25)) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top)) (else (local.set $v_v (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_v)) (block (result i32) (local.set $__scrut (local.get $v_b)) (local.set $v_f (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_f)) (local.set $__k0 (local.get $v__pk_25)) (local.set $__k1 (if (result i32) (i32.eq (i32.load (i32.sub (local.get $v__x) (i32.const 8))) (i32.const 1)) (then (block (result i32) (call $__free_recursive (i32.load offset=4 (local.get $v__x))) (i32.store (local.get $v__x) (i32.const 4)) (i32.store offset=4 (local.get $v__x) (call $v__apply1 (block (result i32) (local.set $__inc_tmp (local.get $v_f)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_v)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (local.get $v__x))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $v__apply1 (block (result i32) (local.set $__inc_tmp (local.get $v_f)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_v)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__free_recursive (local.get $v__x)) (local.get $__con_0))))) (call $__inc_ref (local.get $__k0)) (call $__free_recursive (local.get $v__k)) (call $__free_recursive (local.get $v_f)) (call $__free_recursive (local.get $v_v)) (call $__free_recursive (local.get $v_b)) (call $__free_recursive (local.get $v__pk_25)) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top))))))))))
