...
(module
  ...
  (func $v_countWithBox (param $v_b i32) (param $v_n i32) (result i32)
    (local $__con_0 i32)
    (call $v__cps_countWithBox (local.get $v_b) (local.get $v_n) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 4))) (i32.const 21)) (local.get $__con_0))))
  ...
  (func $v__cps_countWithBox (param $v_b i32) (param $v_n i32) (param $v__k i32) (result i32)
    ...
    (local $__k1 i32)
    (local $__k2 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (call $__eq_i32 (local.get $v_n) (call $__box_i32 (i32.const 0)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1)) (then (call $v__apply_countWithBox (local.get $v__k) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 0))) (local.get $__con_0)))) (else (block (result i32) (local.set $__scrut (call $__predInt32 (local.get $v_n))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $v__apply_countWithBox (local.get $v__k) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (local.get $__con_0)))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (local.get $v_b)) (local.set $__k1 (local.get $v_m)) (local.set $__k2 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 22)) (i32.store offset=4 (local.get $__con_0) (local.get $v__k)) (i32.store offset=8 (local.get $__con_0) (local.get $v_b)) (local.get $__con_0))) (local.set $v_b (local.get $__k0)) (local.set $v_n (local.get $__k1)) (local.set $v__k (local.get $__k2)) (br $tco_top)))))))))
  ...
  (func $v__apply_countWithBox (param $v__k i32) (param $v__x i32) (result i32)
    ...
    (local $__k0 i32)
    (local $__k1 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (local.get $v__k)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 21)) (then (local.get $v__x)) (else (local.set $v__pk_22 (i32.load offset=4 (local.get $__scrut))) (local.set $v_b (i32.load offset=8 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v__x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (local.get $v__pk_22)) (local.set $__k1 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (local.get $__con_0))) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top)) (else (local.set $v_v (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v_b)) (local.set $v_f (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (local.get $v__pk_22)) (local.set $__k1 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $v__apply1 (local.get $v_f) (local.get $v_v))) (local.get $__con_0))) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top))))))))))
