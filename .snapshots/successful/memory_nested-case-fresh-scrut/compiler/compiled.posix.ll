...
@.str.4 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"UNDERFLOW" }
@.str.5 = private unnamed_addr constant {i32, i32, i32, i32, i32, [6 x i8]} { i32 0, i32 0, i32 0, i32 6, i32 6, [6 x i8] c"NO_ARG" }
...
tco.case.arm.8.18:
  ...
  %t28 = inttoptr i64 43 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @v_$cps$$scc$$apply1__$df$$lam$15$13__$df$$lam$18$5__$df$$lam$9$1__$df$$lam$9$9(ptr %t20, ptr %t27)
...
define internal ptr @v_dispatch(ptr %v_n) {
  ...
  switch i64 %t4, label %case.default.5 [ i64 1, label %case.arm.1.6 i64 2, label %case.arm.2.8 ]
case.arm.1.6:
...
case.arm.2.8:
  ...
  store i32 1, ptr %t9
  %t10 = call ptr @__eqInt32(ptr %v_n, ptr %t9)
  %t11 = getelementptr ptr, ptr %t10, i32 0
  %t12 = load ptr, ptr %t11
  %t13 = ptrtoint ptr %t12 to i64
  switch i64 %t13, label %case.default.14 [ i64 1, label %case.arm.1.15 i64 2, label %case.arm.2.17 ]
case.arm.1.15:
...
case.arm.2.17:
  ...
  store i32 2, ptr %t18
  %t19 = call ptr @__eqInt32(ptr %v_n, ptr %t18)
  %t20 = getelementptr ptr, ptr %t19, i32 0
  %t21 = load ptr, ptr %t20
  %t22 = ptrtoint ptr %t21 to i64
  switch i64 %t22, label %case.default.23 [ i64 1, label %case.arm.1.24 i64 2, label %case.arm.2.26 ]
case.arm.1.24:
  call void @__free_recursive(ptr %t19)
  %t25 = call ptr @__alloc(i64 4, i32 0)
  store i32 20, ptr %t25
  call void @__free_recursive(ptr %v_n)
  ret ptr %t25
case.arm.2.26:
  call void @__free_recursive(ptr %t19)
  ...
  store i32 3, ptr %t27
  %t28 = call ptr @__eqInt32(ptr %v_n, ptr %t27)
  %t29 = getelementptr ptr, ptr %t28, i32 0
  %t30 = load ptr, ptr %t29
  %t31 = ptrtoint ptr %t30 to i64
  switch i64 %t31, label %case.default.32 [ i64 1, label %case.arm.1.33 i64 2, label %case.arm.2.35 ]
case.arm.1.33:
  call void @__free_recursive(ptr %t28)
  %t34 = call ptr @__alloc(i64 4, i32 0)
  store i32 30, ptr %t34
  call void @__free_recursive(ptr %v_n)
  ret ptr %t34
case.arm.2.35:
  call void @__free_recursive(ptr %t28)
  ...
  store i32 4, ptr %t36
  %t37 = call ptr @__eqInt32(ptr %v_n, ptr %t36)
  %t38 = getelementptr ptr, ptr %t37, i32 0
  %t39 = load ptr, ptr %t38
  %t40 = ptrtoint ptr %t39 to i64
  switch i64 %t40, label %case.default.41 [ i64 1, label %case.arm.1.42 i64 2, label %case.arm.2.44 ]
case.arm.1.42:
  call void @__free_recursive(ptr %t37)
  %t43 = call ptr @__alloc(i64 4, i32 0)
  store i32 40, ptr %t43
  call void @__free_recursive(ptr %v_n)
  ret ptr %t43
case.arm.2.44:
  call void @__free_recursive(ptr %t37)
  ...
  store i32 5, ptr %t45
  %t46 = call ptr @__eqInt32(ptr %v_n, ptr %t45)
  %t47 = getelementptr ptr, ptr %t46, i32 0
  %t48 = load ptr, ptr %t47
  %t49 = ptrtoint ptr %t48 to i64
  switch i64 %t49, label %case.default.50 [ i64 1, label %case.arm.1.51 i64 2, label %case.arm.2.53 ]
case.arm.1.51:
  call void @__free_recursive(ptr %t46)
  %t52 = call ptr @__alloc(i64 4, i32 0)
  store i32 50, ptr %t52
  call void @__free_recursive(ptr %v_n)
  ret ptr %t52
case.arm.2.53:
  call void @__free_recursive(ptr %t46)
  call void @__inc_ref(ptr %v_n)
  %t54 = call ptr @__alloc(i64 4, i32 0)
  store i32 6, ptr %t54
  %t55 = call ptr @__eqInt32(ptr %v_n, ptr %t54)
  %t56 = getelementptr ptr, ptr %t55, i32 0
  %t57 = load ptr, ptr %t56
  %t58 = ptrtoint ptr %t57 to i64
  switch i64 %t58, label %case.default.59 [ i64 1, label %case.arm.1.60 i64 2, label %case.arm.2.62 ]
case.arm.1.60:
  call void @__free_recursive(ptr %t55)
  %t61 = call ptr @__alloc(i64 4, i32 0)
  store i32 60, ptr %t61
  call void @__free_recursive(ptr %v_n)
  ret ptr %t61
case.arm.2.62:
  call void @__free_recursive(ptr %t55)
...
case.arm.2.71:
  ...
  store i32 8, ptr %t72
  %t73 = call ptr @__eqInt32(ptr %v_n, ptr %t72)
  %t74 = getelementptr ptr, ptr %t73, i32 0
  %t75 = load ptr, ptr %t74
  %t76 = ptrtoint ptr %t75 to i64
  switch i64 %t76, label %case.default.77 [ i64 1, label %case.arm.1.78 i64 2, label %case.arm.2.80 ]
case.arm.1.78:
  call void @__free_recursive(ptr %t73)
  %t79 = call ptr @__alloc(i64 4, i32 0)
  store i32 80, ptr %t79
  call void @__free_recursive(ptr %v_n)
  ret ptr %t79
case.arm.2.80:
  call void @__free_recursive(ptr %t73)
  call void @__inc_ref(ptr %v_n)
  %t81 = call ptr @__alloc(i64 4, i32 0)
  store i32 9, ptr %t81
  %t82 = call ptr @__eqInt32(ptr %v_n, ptr %t81)
  %t83 = getelementptr ptr, ptr %t82, i32 0
  %t84 = load ptr, ptr %t83
  %t85 = ptrtoint ptr %t84 to i64
  switch i64 %t85, label %case.default.86 [ i64 1, label %case.arm.1.87 i64 2, label %case.arm.2.89 ]
case.arm.1.87:
  call void @__free_recursive(ptr %t82)
  %t88 = call ptr @__alloc(i64 4, i32 0)
  store i32 90, ptr %t88
  call void @__free_recursive(ptr %v_n)
  ret ptr %t88
case.arm.2.89:
  call void @__free_recursive(ptr %t82)
  %t90 = call ptr @__alloc(i64 4, i32 0)
  store i32 999, ptr %t90
  call void @__free_recursive(ptr %v_n)
  ret ptr %t90
case.default.86:
  unreachable
...
define internal ptr @v_main() {
  ...
  store ptr %t8, ptr %t9
  %t10 = call ptr @v_$cps$$df$$rowmono$1$andThenIO$4(ptr %t0, ptr %t7)
  %t11 = call ptr @__alloc(i64 8, i32 0)
  %t12 = inttoptr i64 35 to ptr
  %t13 = getelementptr ptr, ptr %t11, i32 0
  store ptr %t12, ptr %t13
  %t14 = call ptr @v_$cps$$df$handleErrorIO$0(ptr %t10, ptr %t11)
  ret ptr %t14
}
...
tco.case.arm.8.76:
  ...
  %t87 = call ptr @v_$apply$$df$handleErrorIO$0(ptr %t6, ptr %t79)
...
define internal ptr @v_$cps$$df$$rowmono$1$andThenIO$4(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.94 i64 7, label %tco.case.arm.7.96 i64 8, label %tco.case.arm.8.121 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
...
case.arm.14.32:
  %t34 = getelementptr ptr, ptr %t13, i32 1
  ...
  switch i64 %t39, label %case.default.40 [ i64 3, label %case.arm.3.42 i64 4, label %case.arm.4.54 ]
case.arm.3.42:
  ...
  %t50 = inttoptr i64 2448244154 to ptr
...
case.arm.4.54:
  ...
  call void @__inc_ref(ptr %t57)
  %t58 = call ptr @v_dispatch(ptr %t57)
  call void @__inc_ref(ptr %t57)
  %t59 = call ptr @v_dispatch(ptr %t57)
  %t60 = call ptr @__addInt32(ptr %t58, ptr %t59)
  call void @__free_recursive(ptr %t57)
...
case.default.40:
  unreachable
case.join.41:
  %t61 = phi ptr [ %t46, %case.end.3.43 ], [ %t60, %case.end.4.55 ]
...
case.default.17:
  unreachable
case.join.18:
  %t62 = phi ptr [ %t21, %case.end.13.20 ], [ %t61, %case.end.14.33 ]
...
case.arm.3.68:
  ...
  %t71 = inttoptr i64 6 to ptr
  %t72 = getelementptr ptr, ptr %t70, i32 0
  store ptr %t71, ptr %t72
  %t73 = getelementptr ptr, ptr %t62, i32 1
...
case.default.66:
  unreachable
case.join.67:
  %t84 = phi ptr [ %t70, %case.end.3.69 ], [ %t78, %case.end.4.77 ]
  %t85 = call ptr @__alloc(i64 8, i32 0)
  %t86 = inttoptr i64 41 to ptr
  %t87 = getelementptr ptr, ptr %t85, i32 0
  store ptr %t86, ptr %t87
  %t88 = call ptr @v_$cps$$df$$rowmono$0$andThenIO$12(ptr %t84, ptr %t85)
  %t89 = call ptr @__alloc(i64 8, i32 0)
  %t90 = inttoptr i64 39 to ptr
  %t91 = getelementptr ptr, ptr %t89, i32 0
  store ptr %t90, ptr %t91
  %t92 = call ptr @v_$cps$$df$handleErrorIO$8(ptr %t88, ptr %t89)
  call void @__free_recursive(ptr %t62)
  call void @__free_recursive(ptr %t13)
  %t93 = call ptr @v_$apply$$df$$rowmono$1$andThenIO$4(ptr %t6, ptr %t92)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.94:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t95 = call ptr @v_$apply$$df$$rowmono$1$andThenIO$4(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t95, ptr %t2
  br label %tco.exit.1
tco.case.arm.7.96:
  %t97 = getelementptr ptr, ptr %t5, i32 1
  %t98 = load ptr, ptr %t97
  %t99 = getelementptr ptr, ptr %t5, i32 2
  %t100 = load ptr, ptr %t99
  call void @__inc_ref(ptr %t100)
  %t107 = getelementptr i8, ptr %t5, i64 -8
  %t108 = load i32, ptr %t107
  %t109 = icmp eq i32 %t108, 1
  br i1 %t109, label %reuse.in_place.110, label %reuse.copy.111
reuse.in_place.110:
  %t101 = getelementptr ptr, ptr %t5, i32 2
  %t102 = load ptr, ptr %t101
  call void @__free_recursive(ptr %t102)
  %t105 = inttoptr i64 38 to ptr
  %t106 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t105, ptr %t106
  call void @__inc_ref(ptr %t6)
  %t103 = getelementptr ptr, ptr %t5, i32 1
  store ptr %t6, ptr %t103
  %t104 = getelementptr ptr, ptr %t5, i32 2
  store ptr %t98, ptr %t104
  br label %reuse.in_place.end.113
reuse.in_place.end.113:
  br label %reuse.join.112
reuse.copy.111:
  %t115 = call ptr @__alloc(i64 24, i32 2)
  %t116 = inttoptr i64 38 to ptr
  %t117 = getelementptr ptr, ptr %t115, i32 0
  store ptr %t116, ptr %t117
  call void @__inc_ref(ptr %t6)
  %t118 = getelementptr ptr, ptr %t115, i32 1
  store ptr %t6, ptr %t118
  call void @__inc_ref(ptr %t98)
  %t119 = getelementptr ptr, ptr %t115, i32 2
  store ptr %t98, ptr %t119
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.114
reuse.copy.end.114:
  br label %reuse.join.112
reuse.join.112:
  %t120 = phi ptr [ %t5, %reuse.in_place.end.113 ], [ %t115, %reuse.copy.end.114 ]
  call void @__free_recursive(ptr %t6)
  store ptr %t100, ptr %t3
  store ptr %t120, ptr %t4
  br label %tco.loop.0
tco.case.arm.8.121:
  ...
  %t125 = inttoptr i64 8 to ptr
  %t126 = getelementptr ptr, ptr %t124, i32 0
  store ptr %t125, ptr %t126
  %t127 = call ptr @__alloc(i64 16, i32 1)
  %t128 = inttoptr i64 26 to ptr
  %t129 = getelementptr ptr, ptr %t127, i32 0
  store ptr %t128, ptr %t129
  call void @__inc_ref(ptr %t123)
  %t130 = getelementptr ptr, ptr %t127, i32 1
  store ptr %t123, ptr %t130
  %t131 = getelementptr ptr, ptr %t124, i32 1
  store ptr %t127, ptr %t131
  %t132 = call ptr @v_$apply$$df$$rowmono$1$andThenIO$4(ptr %t6, ptr %t124)
  call void @__free_recursive(ptr %t123)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t132, ptr %t2
  br label %tco.exit.1
tco.case.default.10:
  unreachable
tco.exit.1:
  %t133 = load ptr, ptr %t2
  ret ptr %t133
}

define internal ptr @v_$apply$$df$$rowmono$1$andThenIO$4(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
define internal ptr @v_$cps$$df$handleErrorIO$8(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t12 = call ptr @v_$apply$$df$handleErrorIO$8(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t12, ptr %t2
  br label %tco.exit.1
tco.case.arm.6.13:
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %case.default.19 [ i64 882564211, label %case.arm.882564211.21 i64 2448244154, label %case.arm.2448244154.35 i64 3768445577, label %case.arm.3768445577.49 i64 3864168810, label %case.arm.3864168810.63 ]
case.arm.882564211.21:
  ...
  store ptr %t24, ptr %t25
  %t26 = getelementptr ptr, ptr %t23, i32 1
  store ptr getelementptr inbounds (i8, ptr @.str.2, i64 12), ptr %t26
  %t27 = call ptr @__alloc(i64 16, i32 1)
  %t28 = inttoptr i64 5 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
...
case.arm.2448244154.35:
  ...
  %t48 = getelementptr ptr, ptr %t37, i32 2
  store ptr %t41, ptr %t48
  br label %case.end.2448244154.36
case.end.2448244154.36:
  br label %case.join.20
case.arm.3768445577.49:
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.4, i64 12), ptr %t54
  ...
  br label %case.end.3768445577.50
case.end.3768445577.50:
  br label %case.join.20
...
case.default.19:
  unreachable
case.join.20:
  %t77 = phi ptr [ %t23, %case.end.882564211.22 ], [ %t37, %case.end.2448244154.36 ], [ %t51, %case.end.3768445577.50 ], [ %t65, %case.end.3864168810.64 ]
  call void @__free_recursive(ptr %t15)
  %t78 = call ptr @v_$apply$$df$handleErrorIO$8(ptr %t6, ptr %t77)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.104:
  ...
  %t115 = call ptr @v_$apply$$df$handleErrorIO$8(ptr %t6, ptr %t107)
...
define internal ptr @v_$apply$$df$handleErrorIO$8(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.28 i64 7, label %tco.case.arm.7.30 i64 8, label %tco.case.arm.8.55 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  ...
  store ptr %t19, ptr %t26
  %t27 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$12(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.28:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t29 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$12(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.55:
  ...
  %t65 = getelementptr ptr, ptr %t58, i32 1
  store ptr %t61, ptr %t65
  %t66 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$12(ptr %t6, ptr %t58)
  call void @__free_recursive(ptr %t57)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$cps$$scc$$apply1__$df$$lam$15$13__$df$$lam$18$5__$df$$lam$9$1__$df$$lam$9$9(ptr %v_$args, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 30, label %tco.case.arm.30.11 i64 31, label %tco.case.arm.31.76 i64 32, label %tco.case.arm.32.87 i64 33, label %tco.case.arm.33.98 i64 34, label %tco.case.arm.34.109 ]
tco.case.arm.30.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %tco.case.default.19 [ i64 25, label %tco.case.arm.25.20 i64 26, label %tco.case.arm.26.28 i64 27, label %tco.case.arm.27.36 i64 28, label %tco.case.arm.28.44 i64 29, label %tco.case.arm.29.52 ]
tco.case.arm.25.20:
...
tco.case.arm.29.52:
  call void @__inc_ref(ptr %t6)
  %t53 = getelementptr ptr, ptr %t15, i32 0
...
case.arm.4.66:
  ...
  %t69 = inttoptr i64 5 to ptr
  %t70 = getelementptr ptr, ptr %t68, i32 0
  store ptr %t69, ptr %t70
  %t71 = getelementptr ptr, ptr %t15, i32 1
...
case.default.56:
  unreachable
case.join.57:
  %t74 = phi ptr [ %t60, %case.end.3.59 ], [ %t68, %case.end.4.67 ]
  %t75 = call ptr @v_$apply$$scc$$apply1__$df$$lam$15$13__$df$$lam$18$5__$df$$lam$9$1__$df$$lam$9$9(ptr %t6, ptr %t74)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.31.76:
  ...
  %t82 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t81, ptr %t82
  %t83 = call ptr @__alloc(i64 16, i32 1)
  %t84 = inttoptr i64 44 to ptr
  ...
  br label %tco.loop.0
tco.case.arm.32.87:
  %t88 = getelementptr ptr, ptr %t5, i32 1
  %t89 = load ptr, ptr %t88
  %t90 = getelementptr ptr, ptr %t5, i32 2
...
define internal ptr @v_$apply$$scc$$apply1__$df$$lam$15$13__$df$$lam$18$5__$df$$lam$9$1__$df$$lam$9$9(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 43, label %tco.case.arm.43.11 i64 44, label %tco.case.arm.44.12 i64 45, label %tco.case.arm.45.19 i64 46, label %tco.case.arm.46.26 i64 47, label %tco.case.arm.47.33 ]
tco.case.arm.43.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
tco.case.arm.44.12:
  ...
  %t18 = call ptr @v_$cps$$df$$rowmono$0$andThenIO$12(ptr %t6, ptr %t15)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  store ptr %t14, ptr %t3
...
tco.case.arm.45.19:
  ...
  %t24 = getelementptr ptr, ptr %t22, i32 0
  store ptr %t23, ptr %t24
  %t25 = call ptr @v_$cps$$df$$rowmono$1$andThenIO$4(ptr %t6, ptr %t22)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
tco.case.arm.46.26:
  ...
  %t30 = inttoptr i64 35 to ptr
  %t31 = getelementptr ptr, ptr %t29, i32 0
  store ptr %t30, ptr %t31
  %t32 = call ptr @v_$cps$$df$handleErrorIO$0(ptr %t6, ptr %t29)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
tco.case.arm.47.33:
  ...
  %t37 = inttoptr i64 39 to ptr
  %t38 = getelementptr ptr, ptr %t36, i32 0
  store ptr %t37, ptr %t38
  %t39 = call ptr @v_$cps$$df$handleErrorIO$8(ptr %t6, ptr %t36)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
