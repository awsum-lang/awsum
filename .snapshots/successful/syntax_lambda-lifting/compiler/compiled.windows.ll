...
case.arm.1.15:
  ...
  %t21 = getelementptr [4 x i8], ptr @.str.3, i64 0, i64 0
...
case.arm.1.36:
  ...
  %t40 = call ptr @__concat(ptr %t39, ptr %t18)
...
case.default.26:
  unreachable
case.join.27:
  %t41 = phi ptr [%t32, %case.end.0.29], [%t40, %case.end.1.37]
...
case.default.5:
  unreachable
case.join.6:
  %t42 = phi ptr [%t11, %case.end.0.8], [%t41, %case.end.1.16]
  %t43 = call ptr @v__let_3(ptr %t42)
  ret ptr %t43
}
