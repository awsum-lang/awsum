...
const main = (v__let_8)(((s) => { switch(s[0]) { case 0: { const v__do_e_37_9 = s[1]; return [0, v__do_e_37_9]; } case 1: { const v_d = s[1]; return ((s) => { switch(s[0]) { case 0: { const v__do_e_38_9 = s[1]; return [0, v__do_e_38_9]; } case 1: { const v_s0 = s[1]; return __concat(v_s0, v_d); } } })(__concat(String(v_inc42), " / ")); } } })((v_describe)(v_g)));
