...
case.arm.2269767818.23:
  ...
  switch i64 %t28, label %case.default.29 [ i64 20, label %case.arm.20.30 ]
case.arm.20.30:
...
case.join.6:
  ...
  %t42 = call ptr @v__let_8(ptr %t41)
  ret ptr %t42
}

define internal ptr @v__lam_7(ptr %v_n) {
  ret ptr %v_n
}
