...
(module
  ...
  (global $heap (mut i32) (i32.const 213))
  ...
  (data (i32.const 132) "\00\00\00\00\00\00\00\00\00\00\00\00\03\00\00\00\03\00\00\00Ok ")
  ...
  (table 7 funcref)
  (elem (i32.const 0) $v_pureEither $v_runIO $v_op2WithA $v_describe $v__lam_7 $v__let_8 $v__df_apply_0)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_op1 (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 1))) (local.get $__con_0)))

  (func $v_op2WithA (param $v_n i32) (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (local.get $v_n)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0)))
  ...
  (func $v_g (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (call $v_op1)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_23_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_23_3)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 2252990199)) (i32.store offset=4 (local.get $__con_1) (local.get $v__do_e_23_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_1))) (local.get $__con_1))) (local.get $__con_0))) (else (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (block (result i32) (local.set $__scrut (call $v_op2WithA (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_24_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_24_3)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 2269767818)) (i32.store offset=4 (local.get $__con_1) (local.get $v__do_e_24_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_1))) (local.get $__con_1))) (local.get $__con_0))) (else (local.set $v_b (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (call $v_pureEither (block (result i32) (local.set $__inc_tmp (local.get $v_b)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))))))))
  ...
  (func $v_describe (param $v_r i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v_e)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 2252990199)) (then (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___rw)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___rw)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 96)) (local.get $__con_0)))) (call $__free_recursive (local.get $v___rw)) (local.get $__drop_tmp))) (else (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___rw)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___rw)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 120)) (local.get $__con_0)))) (call $__free_recursive (local.get $v___rw)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_e)) (local.get $__drop_tmp))) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_n)) (block (result i32) (local.set $__drop_tmp (call $__concat (i32.const 144) (call $__show_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))) (call $__free_recursive (local.get $v_n)) (local.get $__drop_tmp))))))
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_8 (block (result i32) (local.set $__scrut (call $v_describe (block (result i32) (local.set $__inc_tmp (call $v_g)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_37_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_37_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_37_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_d (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_d)) (block (result i32) (local.set $__scrut (call $__concat (call $__show_i32 (block (result i32) (local.set $__inc_tmp (call $v_inc42)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))) (i32.const 167))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_38_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_38_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_38_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_d)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))))))))))

  (func $v__lam_7 (param $v_n i32) (result i32)
    (local $__drop_tmp i32)
    (local.get $v_n))
