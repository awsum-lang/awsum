...
(module
  ...
  (table 8 funcref)
  (elem (i32.const 0) $v_pureEither $v_runIO $v_op2WithA $v_describe $v__lam_18 $v__lift_19 $v__let_20 $v__df_apply_0)
  ...
  (func $v_op2WithA (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
  ...
  (func $v__df_apply_0 (param i32) (result i32)
    (local i32)
    (local i32)
    block (result i32)
      local.get 0
