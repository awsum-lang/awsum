...
(module
  ...
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v_say $v_main)
  ...
  (func $v_main (param $v_inputArg i32) (result i32)
    ...
    (local $v_input i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_inputArg)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 2)) (i32.store offset=4 (local.get $__con_0) (i32.const 72)) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc (i32.const 4))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0))) (else (local.set $v_input (i32.load offset=4 (local.get $__scrut))) (call $v_say (local.get $v_input))))))
