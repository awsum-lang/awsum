...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 28, label %tco.case.arm.28.11 i64 29, label %tco.case.arm.29.263 i64 30, label %tco.case.arm.30.286 i64 31, label %tco.case.arm.31.309 i64 32, label %tco.case.arm.32.332 i64 33, label %tco.case.arm.33.355 i64 34, label %tco.case.arm.34.378 i64 35, label %tco.case.arm.35.401 i64 36, label %tco.case.arm.36.424 i64 37, label %tco.case.arm.37.447 i64 38, label %tco.case.arm.38.470 i64 39, label %tco.case.arm.39.493 i64 40, label %tco.case.arm.40.516 ]
tco.case.arm.28.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 49, label %tco.case.arm.49.11 i64 50, label %tco.case.arm.50.12 i64 51, label %tco.case.arm.51.16 i64 52, label %tco.case.arm.52.20 i64 53, label %tco.case.arm.53.24 i64 54, label %tco.case.arm.54.29 i64 55, label %tco.case.arm.55.34 i64 56, label %tco.case.arm.56.39 i64 57, label %tco.case.arm.57.43 i64 58, label %tco.case.arm.58.47 i64 59, label %tco.case.arm.59.51 i64 60, label %tco.case.arm.60.55 i64 61, label %tco.case.arm.61.59 ]
tco.case.arm.49.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
