...
define internal ptr @v_main() {
  ...
  store ptr %t3, ptr %t6
  %t7 = call ptr @v__df__rowspec_15_3(ptr %t0)
...
define internal ptr @v__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_22_4__df__lam_23_5__lift_17__lift_18__lift_20__lift_21(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 40 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_22_4__df__lam_23_5__lift_17__lift_18__lift_20__lift_21(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_22_4__df__lam_23_5__lift_17__lift_18__lift_20__lift_21(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 23, label %tco.case.arm.23.11 i64 24, label %tco.case.arm.24.183 i64 25, label %tco.case.arm.25.206 i64 26, label %tco.case.arm.26.229 i64 27, label %tco.case.arm.27.252 i64 28, label %tco.case.arm.28.275 i64 29, label %tco.case.arm.29.298 i64 30, label %tco.case.arm.30.321 i64 31, label %tco.case.arm.31.344 ]
tco.case.arm.23.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 14, label %tco.case.arm.14.20 i64 15, label %tco.case.arm.15.40 i64 16, label %tco.case.arm.16.60 i64 17, label %tco.case.arm.17.80 i64 18, label %tco.case.arm.18.100 i64 19, label %tco.case.arm.19.103 i64 20, label %tco.case.arm.20.123 i64 21, label %tco.case.arm.21.143 i64 22, label %tco.case.arm.22.163 ]
tco.case.arm.14.20:
...
tco.case.arm.18.100:
  ...
  %t102 = call ptr @v__apply__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_22_4__df__lam_23_5__lift_17__lift_18__lift_20__lift_21(ptr %t6, ptr %t101)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v__apply__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_22_4__df__lam_23_5__lift_17__lift_18__lift_20__lift_21(ptr %v__k, ptr %v__x) {
entry:
  %t3 = alloca ptr
  store ptr %v__k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 40, label %tco.case.arm.40.11 i64 41, label %tco.case.arm.41.12 i64 42, label %tco.case.arm.42.16 i64 43, label %tco.case.arm.43.20 i64 44, label %tco.case.arm.44.25 i64 45, label %tco.case.arm.45.30 i64 46, label %tco.case.arm.46.34 i64 47, label %tco.case.arm.47.38 i64 48, label %tco.case.arm.48.42 ]
tco.case.arm.40.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
...
tco.case.arm.45.30:
  ...
  call void @__inc_ref(ptr %t6)
  %t33 = call ptr @v__lift_16(ptr %t6)
  call void @__inc_ref(ptr %t32)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
tco.case.arm.46.34:
  ...
  call void @__inc_ref(ptr %t6)
  %t37 = call ptr @v__lift_16(ptr %t6)
  call void @__inc_ref(ptr %t36)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t36)
...
tco.case.arm.47.38:
  ...
  call void @__inc_ref(ptr %t6)
  %t41 = call ptr @v__lift_19(ptr %t6)
  call void @__inc_ref(ptr %t40)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
tco.case.arm.48.42:
  ...
  call void @__inc_ref(ptr %t6)
  %t45 = call ptr @v__lift_19(ptr %t6)
  call void @__inc_ref(ptr %t44)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_22_4__df__lam_23_5__lift_17__lift_18__lift_20__lift_21(ptr %t0)
