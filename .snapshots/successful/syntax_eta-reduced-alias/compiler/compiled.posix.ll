...
define internal ptr @v__scc__apply1__df__lam_13_5__df__lam_9_1(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 25 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_13_5__df__lam_9_1(ptr %v__args, ptr %t0)
...
tco.case.arm.17.60:
  ...
  %t62 = call ptr @v__apply__scc__apply1__df__lam_13_5__df__lam_9_1(ptr %t6, ptr %t61)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_13_5__df__lam_9_1(ptr %t0)
