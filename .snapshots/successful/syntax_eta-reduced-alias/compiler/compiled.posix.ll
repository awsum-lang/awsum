...
@.str.0 = private unnamed_addr constant [12 x i8] c"INPUT_ERROR\00"
...
case.arm.0.5:
  ...
  %t12 = getelementptr [12 x i8], ptr @.str.0, i64 0, i64 0
...
case.arm.1.22:
  %t24 = getelementptr ptr, ptr %v_inputArg, i32 1
  %t25 = load ptr, ptr %t24
  %t26 = call ptr @v_say(ptr %t25)
...
case.default.3:
  unreachable
case.join.4:
  %t27 = phi ptr [%t9, %case.end.0.6], [%t26, %case.end.1.23]
  ret ptr %t27
}
