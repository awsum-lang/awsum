...
case.arm.14.33:
  ...
  %t47 = getelementptr ptr, ptr %t41, i32 1
  store ptr %t44, ptr %t47
  %t48 = getelementptr ptr, ptr %t35, i32 2
  store ptr %t41, ptr %t48
...
case.default.17:
  unreachable
case.join.18:
  %t49 = phi ptr [ %t21, %case.end.13.20 ], [ %t35, %case.end.14.34 ]
  call void @__free_recursive(ptr %t13)
  %t50 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$4(ptr %t6, ptr %t49)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t50, ptr %t2
  br label %tco.exit.1
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 24, label %tco.case.arm.24.11 i64 25, label %tco.case.arm.25.60 i64 26, label %tco.case.arm.26.71 ]
tco.case.arm.24.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %tco.case.default.19 [ i64 21, label %tco.case.arm.21.20 i64 22, label %tco.case.arm.22.28 i64 23, label %tco.case.arm.23.36 ]
tco.case.arm.21.20:
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 31, label %tco.case.arm.31.11 i64 32, label %tco.case.arm.32.12 i64 33, label %tco.case.arm.33.19 ]
tco.case.arm.31.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
