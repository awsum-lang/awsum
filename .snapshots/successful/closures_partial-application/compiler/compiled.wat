...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_wrap (param $v_s i32) (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 19)) (i32.store offset=4 (local.get $__con_0) (local.get $v_s)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0)))
  ...
  (func $v__apply1 (param $v__cl i32) (param $v__arg0 i32) (result i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v__cl)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 20)) (then (call $v_unwrap (block (result i32) (local.set $__inc_tmp (local.get $v__arg0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (else (call $v_wrap (block (result i32) (local.set $__inc_tmp (local.get $v__arg0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))))))
