...
(module
  ...
  (func $v_wrap (param $v_s i32) (result i32)
    (local $__con_0 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 19)) (i32.store offset=4 (local.get $__con_0) (local.get $v_s)) (local.get $__con_0)))
  ...
  (func $v_main (result i32)
    ...
    (local $__con_1 i32)
    (local $__con_2 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (call $v__df_apply_0 (i32.const 72) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 4))) (i32.const 20)) (local.get $__con_1)) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 4))) (i32.const 21)) (local.get $__con_1)))) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc (i32.const 4))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0)))
  ...
  (func $v__apply1 (param $v__cl i32) (param $v__arg0 i32) (result i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v__cl)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 20)) (then (call $v_unwrap (local.get $v__arg0))) (else (call $v_wrap (local.get $v__arg0))))))
