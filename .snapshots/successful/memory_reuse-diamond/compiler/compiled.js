...
(() => {
            ...
            [
              ...
              (s => {
                switch (s[0]) {
                  ...
                  case 25: {
                    const v_$inl15$t2 = v_$df$andThenIO$0$cap0$0[3];
                    switch (v_$inl15$t2[0]) {
                      case 24: {
                        return "L";
                      }
                      case 25: {
                        return v_$inl15$t2[2];
                      }
                    }
                  }
                }
  ...
  const v_$inl27$s = v_mk2(2 | 0, [24]);
  const v_$inl23$t2 = v_sumLeft(v_$inl27$s, [24]);
