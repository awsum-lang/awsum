...
(() => {
            ...
            const v_t = __s[2];
            {
              ...
              switch (__s[0]) {
                ...
                case 2711245919: {
                  const v_n = __s[1];
                  const __t0 = v_t;
                  const __t1 = (v_xs[0] = 47, v_xs[1] = v__k, v_xs[2] = v_n, v_xs);
                  v_xs = __t0;
                  v__k = __t1;
                  continue;
                }
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          ...
          case 9: {
            const v___f0 = __s[1];
            return v__apply__lift_1(v__k, [9, [28, v___f0]]);
          }
          case 10: {
            const v___f0 = __s[1];
            return v__apply__lift_1(v__k, [10, [29, v___f0]]);
          }
        }
      }
    }
  ...
  const v__lift_1 = (v___input) => {
    return v__cps__lift_1(v___input, [50]);
  };
