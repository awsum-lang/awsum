...
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [3 x i8]} { i32 0, i32 0, i32 0, i32 3, i32 3, [3 x i8] c"int" }
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [4 x i8]} { i32 0, i32 0, i32 0, i32 4, i32 4, [4 x i8] c"deep" }
...
tco.case.arm.8.18:
  ...
  %t28 = inttoptr i64 38 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @v_$cps$$scc$$apply1__$df$$lam$14$5__$df$$lam$9$1(ptr %t20, ptr %t27)
...
define internal ptr @v_$cps$walk(ptr %v_c, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  switch i64 %t9, label %tco.case.default.10 [ i64 24, label %tco.case.arm.24.11 i64 25, label %tco.case.arm.25.14 ]
tco.case.arm.24.11:
  call void @__inc_ref(ptr %t6)
  %t12 = call ptr @__alloc(i64 4, i32 0)
  store i32 0, ptr %t12
  %t13 = call ptr @v_$apply$walk(ptr %t6, ptr %t12)
...
tco.case.arm.25.14:
  ...
  switch i64 %t19, label %tco.case.default.20 [ i64 2108399875, label %tco.case.arm.2108399875.21 i64 2711245919, label %tco.case.arm.2711245919.42 ]
tco.case.arm.2108399875.21:
...
reuse.copy.33:
  ...
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.36
reuse.copy.end.36:
  br label %reuse.join.34
reuse.join.34:
  %t41 = phi ptr [ %t5, %reuse.in_place.end.35 ], [ %t37, %reuse.copy.end.36 ]
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t16)
  store ptr %t23, ptr %t3
  store ptr %t41, ptr %t4
  br label %tco.loop.0
tco.case.arm.2711245919.42:
  call void @__inc_ref(ptr %t6)
  %t43 = getelementptr ptr, ptr %t16, i32 1
  %t44 = load ptr, ptr %t43
  call void @__inc_ref(ptr %t44)
  %t45 = call ptr @v_$apply$walk(ptr %t6, ptr %t44)
  call void @__free_recursive(ptr %t16)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$walk(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
...
entry:
  ...
  %t4 = alloca ptr
  store ptr %v_$k, ptr %t4
  %v_$inl13$scrut.jslot = alloca ptr
  %t2 = alloca ptr
  br label %tco.loop.0
tco.loop.0:
  %t5 = load ptr, ptr %t3
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.121 i64 7, label %tco.case.arm.7.123 i64 8, label %tco.case.arm.8.148 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
...
case.arm.12.46:
  ...
  call void @__inc_ref(ptr %t49)
  %t50 = call ptr @__eqString(ptr %t49, ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
  %t51 = getelementptr ptr, ptr %t50, i32 0
  %t52 = load ptr, ptr %t51
  %t53 = ptrtoint ptr %t52 to i64
  switch i64 %t53, label %case.default.54 [ i64 1, label %case.arm.1.56 i64 2, label %case.arm.2.67 ]
case.arm.1.56:
  %t58 = call ptr @__alloc(i64 16, i32 1)
  %t59 = inttoptr i64 25 to ptr
  %t60 = getelementptr ptr, ptr %t58, i32 0
  store ptr %t59, ptr %t60
  %t61 = call ptr @__alloc(i64 16, i32 1)
  %t62 = inttoptr i64 2711245919 to ptr
  ...
  store ptr %t61, ptr %t66
  br label %case.end.1.57
case.end.1.57:
  br label %case.join.55
case.arm.2.67:
  call void @__inc_ref(ptr %t49)
  %t69 = call ptr @__eqString(ptr %t49, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
  %t70 = getelementptr ptr, ptr %t69, i32 0
  %t71 = load ptr, ptr %t70
  %t72 = ptrtoint ptr %t71 to i64
  switch i64 %t72, label %case.default.73 [ i64 1, label %case.arm.1.75 i64 2, label %case.arm.2.96 ]
case.arm.1.75:
...
join.after.18:
  ...
  %t119 = getelementptr ptr, ptr %t14, i32 2
  store ptr %t112, ptr %t119
  call void @__free_recursive(ptr %t13)
  %t120 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$4(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t120, ptr %t2
  br label %tco.exit.1
tco.case.arm.6.121:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t122 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$4(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t122, ptr %t2
  br label %tco.exit.1
tco.case.arm.7.123:
...
reuse.in_place.137:
  %t128 = getelementptr ptr, ptr %t5, i32 2
  %t129 = load ptr, ptr %t128
  call void @__free_recursive(ptr %t129)
  %t132 = inttoptr i64 37 to ptr
  %t133 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t132, ptr %t133
  call void @__inc_ref(ptr %t6)
  %t130 = getelementptr ptr, ptr %t5, i32 1
  store ptr %t6, ptr %t130
  %t131 = getelementptr ptr, ptr %t5, i32 2
  store ptr %t125, ptr %t131
  br label %reuse.in_place.end.140
reuse.in_place.end.140:
...
reuse.copy.138:
  ...
  store ptr %t125, ptr %t146
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.141
reuse.copy.end.141:
  br label %reuse.join.139
reuse.join.139:
  %t147 = phi ptr [ %t5, %reuse.in_place.end.140 ], [ %t142, %reuse.copy.end.141 ]
  call void @__free_recursive(ptr %t6)
  store ptr %t127, ptr %t3
  store ptr %t147, ptr %t4
  br label %tco.loop.0
tco.case.arm.8.148:
...
define internal ptr @v_$cps$$scc$$apply1__$df$$lam$14$5__$df$$lam$9$1(ptr %v_$args, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 29, label %tco.case.arm.29.11 i64 30, label %tco.case.arm.30.60 i64 31, label %tco.case.arm.31.71 ]
tco.case.arm.29.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %tco.case.default.19 [ i64 26, label %tco.case.arm.26.20 i64 27, label %tco.case.arm.27.28 i64 28, label %tco.case.arm.28.36 ]
tco.case.arm.26.20:
...
case.join.41:
  ...
  %t59 = call ptr @v_$apply$$scc$$apply1__$df$$lam$14$5__$df$$lam$9$1(ptr %t6, ptr %t58)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$scc$$apply1__$df$$lam$14$5__$df$$lam$9$1(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 38, label %tco.case.arm.38.11 i64 39, label %tco.case.arm.39.12 i64 40, label %tco.case.arm.40.19 ]
tco.case.arm.38.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
