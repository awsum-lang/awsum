...
(module
  ...
  (global $heap (mut i32) (i32.const 210))
  ...
  (data (i32.const 163) "\00\00\00\00\00\00\00\00\00\00\00\00\03\00\00\00\03\00\00\00int")
  (data (i32.const 186) "\00\00\00\00\00\00\00\00\00\00\00\00\04\00\00\00\04\00\00\00deep")
  (table 9 funcref)
  (elem (i32.const 0) $v_runIO $v_$cps$walk $v_$apply$walk $v_$cps$$df$handleErrorIO$0 $v_$apply$$df$handleErrorIO$0 $v_$cps$$df$$rowmono$0$andThenIO$4 $v_$apply$$df$$rowmono$0$andThenIO$4 $v_$cps$$scc$$apply1__$df$$lam$14$5__$df$$lam$9$1 $v_$apply$$scc$$apply1__$df$$lam$14$5__$df$$lam$9$1)
  ...
  (func $v_$cps$walk (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v_$apply$walk (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
