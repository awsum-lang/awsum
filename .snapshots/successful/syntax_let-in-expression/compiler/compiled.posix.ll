...
define internal ptr @v_pad(ptr %v_s) {
  %t0 = call ptr @__concat(ptr @.str.0, ptr %v_s)
...
case.default.22:
  unreachable
case.join.23:
  %t37 = phi ptr [%t28, %case.end.0.25], [%t36, %case.end.1.33]
...
case.arm.1.14:
  %t16 = getelementptr ptr, ptr %t0, i32 1
  %t17 = load ptr, ptr %t16
  %t18 = call ptr @__concat(ptr @.str.3, ptr %t17)
  %t19 = getelementptr ptr, ptr %t18, i32 0
  %t20 = load ptr, ptr %t19
  %t21 = ptrtoint ptr %t20 to i64
  switch i64 %t21, label %case.default.22 [ i64 0, label %case.arm.0.24 i64 1, label %case.arm.1.32 ]
...
case.arm.1.32:
  %t34 = getelementptr ptr, ptr %t18, i32 1
  %t35 = load ptr, ptr %t34
  %t36 = call ptr @__concat(ptr %t35, ptr @.str.4)
  br label %case.end.1.33
case.end.1.33:
  br label %case.join.23
case.default.22:
