...
case.arm.1.15:
  ...
  %t19 = getelementptr [2 x i8], ptr @.str.1, i64 0, i64 0
...
case.arm.1.34:
  ...
  %t38 = call ptr @__concat(ptr %t37, ptr %t37)
...
case.default.24:
  unreachable
case.join.25:
  %t39 = phi ptr [%t30, %case.end.0.27], [%t38, %case.end.1.35]
...
case.arm.1.15:
  %t17 = getelementptr ptr, ptr %t1, i32 1
  %t18 = load ptr, ptr %t17
  %t19 = getelementptr [2 x i8], ptr @.str.3, i64 0, i64 0
  %t20 = call ptr @__concat(ptr %t19, ptr %t18)
  %t21 = getelementptr ptr, ptr %t20, i32 0
  %t22 = load ptr, ptr %t21
  %t23 = ptrtoint ptr %t22 to i64
  switch i64 %t23, label %case.default.24 [ i64 0, label %case.arm.0.26 i64 1, label %case.arm.1.34 ]
...
case.arm.1.34:
  %t36 = getelementptr ptr, ptr %t20, i32 1
  %t37 = load ptr, ptr %t36
  %t38 = getelementptr [2 x i8], ptr @.str.4, i64 0, i64 0
