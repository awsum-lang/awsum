  ...
  const v_$inl9$res = (() => {
    ...
    $join10: {
      ...
      switch (__s[0]) {
        ...
        case 4: {
          const v_$inl4$p = __s[1];
          v_$inl11$scrut = (s => {
            switch (s[0]) {
              case 3: {
                const v_$inl5$$do__e__0 = s[1];
                return [3, v_$inl5$$do__e__0];
              }
              case 4: {
                const v_$inl6$q = s[1];
                return __concat(v_$inl6$q, v_$inl6$q);
              }
            }
          })(__concat(v_$inl4$p, "]"));
          break $join10;
    ...
    switch (v_$inl11$scrut[0]) {
      case 3: {
        return v_$inl11$scrut;
      }
      case 4: {
        {
          const __s = __concat("<", v_$inl11$scrut[1]);
          switch (__s[0]) {
            case 3: {
  ...
  const main = v_$cps$$df$handleErrorIO$0(
    v_$cps$$df$andThenIO$4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v_$inl9$res[1]];
          }
          case 4: {
            return [5, v_$inl9$res[1]];
          }
        }
      })(v_$inl9$res),
      [22]
