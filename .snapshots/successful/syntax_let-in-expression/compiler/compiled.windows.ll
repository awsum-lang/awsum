...
define internal ptr @v_pad(ptr %v_s) {
  ...
  %t0 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr %v_s)
...
case.arm.4.27:
  ...
  call void @__inc_ref(ptr %t29)
  call void @__inc_ref(ptr %t29)
  %t30 = call ptr @__concat(ptr %t29, ptr %t29)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t0)
...
define internal ptr @v_main() {
  %t0 = call ptr @v_pad(ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
  %t1 = getelementptr ptr, ptr %t0, i32 0
  %t2 = load ptr, ptr %t1
  %t3 = ptrtoint ptr %t2 to i64
...
case.arm.4.14:
  ...
  call void @__inc_ref(ptr %t17)
  %t18 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.3, i64 12), ptr %t17)
...
case.arm.4.32:
  ...
  call void @__inc_ref(ptr %t35)
  %t36 = call ptr @__concat(ptr %t35, ptr getelementptr inbounds (i8, ptr @.str.4, i64 12))
...
case.default.4:
  unreachable
case.join.5:
  %t38 = phi ptr [ %t10, %case.end.3.7 ], [ %t37, %case.end.4.15 ]
  call void @__free_recursive(ptr %t0)
  %t39 = call ptr @v__let_23(ptr %t38)
  ret ptr %t39
}
