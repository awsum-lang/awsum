...
define internal ptr @v_main() {
  %v_$inl11$scrut.jslot = alloca ptr
...
case.join.23:
  ...
  call void @__free_recursive(ptr %t2)
  store ptr %t37, ptr %v_$inl11$scrut.jslot
  br label %join.0
join.case.default.6:
  unreachable
join.0:
  %t38 = load ptr, ptr %v_$inl11$scrut.jslot
