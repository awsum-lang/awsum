...
case.default.50:
  unreachable
case.join.51:
  %t69 = phi ptr [%t56, %case.end.0.53], [%t68, %case.end.1.61]
...
case.default.31:
  unreachable
case.join.32:
  %t70 = phi ptr [%t37, %case.end.0.34], [%t69, %case.end.1.42]
...
case.default.9:
  unreachable
case.join.10:
  %t71 = phi ptr [%t15, %case.end.0.12], [%t70, %case.end.1.20]
  %t72 = call ptr @v__let_2(ptr %t71)
  ret ptr %t72
}
