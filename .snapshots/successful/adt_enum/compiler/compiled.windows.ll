...
case.default.48:
  unreachable
case.join.49:
  %t67 = phi ptr [%t54, %case.end.0.51], [%t66, %case.end.1.59]
...
case.default.30:
  unreachable
case.join.31:
  %t68 = phi ptr [%t36, %case.end.0.33], [%t67, %case.end.1.41]
...
case.default.8:
  unreachable
case.join.9:
  %t69 = phi ptr [%t14, %case.end.0.11], [%t68, %case.end.1.19]
  %t70 = call ptr @v__let_2(ptr %t69)
  ret ptr %t70
}
