...
@.str.2 = private unnamed_addr constant {i32, i32, [4 x i8]} { i32 4, i32 4, [4 x i8] c"Blue" }
...
define internal ptr @v_show(ptr %v_c) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.5 i64 20, label %case.arm.20.7 i64 21, label %case.arm.21.9 ]
case.arm.19.5:
...
case.end.20.8:
  br label %case.join.4
case.arm.21.9:
  br label %case.end.21.10
case.end.21.10:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t11 = phi ptr [@.str.0, %case.end.19.6], [@.str.1, %case.end.20.8], [@.str.2, %case.end.21.10]
  ret ptr %t11
}
...
define internal ptr @v_main() {
  ...
  %t4 = call ptr @__concat(ptr %t3, ptr @.str.3)
  %t5 = getelementptr ptr, ptr %t4, i32 0
  %t6 = load ptr, ptr %t5
  %t7 = ptrtoint ptr %t6 to i64
...
case.arm.4.18:
  ...
  %t26 = call ptr @__concat(ptr %t21, ptr %t25)
...
case.arm.4.40:
  ...
  %t44 = call ptr @__concat(ptr %t43, ptr @.str.3)
...
case.default.48:
  unreachable
case.join.49:
  %t67 = phi ptr [%t54, %case.end.3.51], [%t66, %case.end.4.59]
...
case.default.30:
  unreachable
case.join.31:
  %t68 = phi ptr [%t36, %case.end.3.33], [%t67, %case.end.4.41]
...
case.default.8:
  unreachable
case.join.9:
  %t69 = phi ptr [%t14, %case.end.3.11], [%t68, %case.end.4.19]
  %t70 = call ptr @v__let_7(ptr %t69)
  ret ptr %t70
}
