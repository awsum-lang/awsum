...
@.str.0 = private unnamed_addr constant {i32, i32, [4 x i8]} { i32 4, i32 4, [4 x i8] c"sum=" }
@.str.1 = private unnamed_addr constant {i32, i32, [4 x i8]} { i32 4, i32 4, [4 x i8] c"FAIL" }
...
case.arm.4.14:
  ...
  %t19 = call ptr @__concat(ptr @.str.0, ptr %t18)
