        ...
        const v_s0 = s[1];
        {
          const __s = __concat(
            ...
            (s => {
              switch (s[0]) {
                case 24: {
                  const v_$inl3$____p0 = s[1];
                  return v_$inl3$____p0[1];
                }
                case 25: {
                  const v_$inl4$____p0 = s[1];
                  return v_$inl4$____p0[1];
                }
              }
            })([24, [25, "2"]])
          );
                    ...
                    const v_s2 = __s[1];
                    {
                      const __s = __concat(
                        ...
                        (s => {
                          switch (s[0]) {
                            case 24: {
                              const v_$inl5$____p0 = s[1];
                              return v_$inl5$____p0[1];
                            }
                            case 25: {
                              const v_$inl6$____p0 = s[1];
                              return v_$inl6$____p0[1];
                            }
                          }
                        })([25, [24, "3"]])
                      );
                                ...
                                return __concat(
                                  ...
                                  (s => {
                                    switch (s[0]) {
                                      ...
                                      case 25: {
                                        const v_$inl8$____p0 = s[1];
                                        return v_$inl8$____p0[1];
                                      }
                                    }
                                  })([25, [25, "4"]])
                                );
    ...
    __concat(
      (s => {
        switch (s[0]) {
          ...
          case 25: {
            const v_$inl2$____p0 = s[1];
            return v_$inl2$____p0[1];
          }
        }
      })([24, [24, "1"]]),
      ","
