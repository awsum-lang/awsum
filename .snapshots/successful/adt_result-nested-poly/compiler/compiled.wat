...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_unwrap (param $v_r i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 20)) (then (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___p0)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 20)) (then (local.set $v_value (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_value)) (block (result i32) (local.set $__drop_tmp (local.get $v_value)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_value)) (local.get $__drop_tmp))) (else (local.set $v_value (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_value)) (block (result i32) (local.set $__drop_tmp (local.get $v_value)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_value)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v___p0)) (local.get $__drop_tmp))) (else (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___p0)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 20)) (then (local.set $v_value (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_value)) (block (result i32) (local.set $__drop_tmp (local.get $v_value)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_value)) (local.get $__drop_tmp))) (else (local.set $v_value (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_value)) (block (result i32) (local.set $__drop_tmp (local.get $v_value)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_value)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v___p0)) (local.get $__drop_tmp))))))
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (block (result i32) (local.set $__scrut (call $__concat (call $v_unwrap (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 20)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 20)) (i32.store offset=4 (local.get $__con_1) (i32.const 96)) (local.get $__con_1))) (local.get $__con_0))) (i32.const 117))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_17_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_17_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_17_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_unwrap (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 20)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 21)) (i32.store offset=4 (local.get $__con_1) (i32.const 138)) (local.get $__con_1))) (local.get $__con_0))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_18_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_18_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_18_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s1 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s1)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s1)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 117))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_19_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_19_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_19_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s2 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s2)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s2)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_unwrap (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 21)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 20)) (i32.store offset=4 (local.get $__con_1) (i32.const 159)) (local.get $__con_1))) (local.get $__con_0))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_20_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_20_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_20_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s3)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s3)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 117))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_21_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_21_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_21_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s4 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s4)) (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s4)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_unwrap (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 21)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 21)) (i32.store offset=4 (local.get $__con_1) (i32.const 180)) (local.get $__con_1))) (local.get $__con_0)))))))))))))))))))))
