...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_unwrap (param $v_r i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 19)) (then (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___p0)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 19)) (then (local.set $v_value (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_value)) (block (result i32) (local.set $__drop_tmp (local.get $v_value)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_value)) (local.get $__drop_tmp))) (else (local.set $v_value (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_value)) (block (result i32) (local.set $__drop_tmp (local.get $v_value)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_value)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v___p0)) (local.get $__drop_tmp))) (else (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___p0)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 19)) (then (local.set $v_value (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_value)) (block (result i32) (local.set $__drop_tmp (local.get $v_value)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_value)) (local.get $__drop_tmp))) (else (local.set $v_value (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_value)) (block (result i32) (local.set $__drop_tmp (local.get $v_value)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_value)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v___p0)) (local.get $__drop_tmp))))))
