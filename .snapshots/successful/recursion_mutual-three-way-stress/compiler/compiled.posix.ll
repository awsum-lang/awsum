...
@.str.1 = private unnamed_addr constant {i32, i32, [6 x i8]} { i32 6, i32 6, [6 x i8] c"left: " }
@.str.2 = private unnamed_addr constant {i32, i32, [7 x i8]} { i32 7, i32 7, [7 x i8] c"right: " }
...
tco.loop.0:
  ...
  %t6 = load ptr, ptr %t5
  %t7 = ptrtoint ptr %t6 to i64
  switch i64 %t7, label %tco.case.default.8 [ i64 8, label %tco.case.arm.8.9 i64 9, label %tco.case.arm.9.44 i64 10, label %tco.case.arm.10.79 ]
tco.case.arm.8.9:
  %t10 = getelementptr ptr, ptr %t4, i32 1
  %t11 = load ptr, ptr %t10
...
tco.case.arm.9.44:
  ...
  switch i64 %t51, label %tco.case.default.52 [ i64 1, label %tco.case.arm.1.53 i64 2, label %tco.case.arm.2.59 ]
tco.case.arm.1.53:
...
tco.case.arm.2.59:
  ...
  switch i64 %t63, label %tco.case.default.64 [ i64 3, label %tco.case.arm.3.65 i64 4, label %tco.case.arm.4.72 ]
tco.case.arm.3.65:
...
tco.case.arm.10.79:
  ...
  switch i64 %t86, label %tco.case.default.87 [ i64 1, label %tco.case.arm.1.88 i64 2, label %tco.case.arm.2.94 ]
tco.case.arm.1.88:
  %t89 = call ptr @malloc(i64 16)
  %t90 = inttoptr i64 4 to ptr
...
tco.case.arm.2.94:
  ...
  switch i64 %t98, label %tco.case.default.99 [ i64 3, label %tco.case.arm.3.100 i64 4, label %tco.case.arm.4.107 ]
tco.case.arm.3.100:
