...
define internal ptr @v_unwrap(ptr %v_r) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.4 i64 20, label %case.arm.20.17 ]
case.arm.19.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 19, label %case.arm.19.11 i64 20, label %case.arm.20.14 ]
case.arm.19.11:
...
case.arm.20.17:
  ...
  switch i64 %t22, label %case.default.23 [ i64 19, label %case.arm.19.24 i64 20, label %case.arm.20.27 ]
case.arm.19.24:
