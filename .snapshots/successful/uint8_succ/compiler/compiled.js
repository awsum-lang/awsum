...
(() => {
  ...
  const __succUInt8 = x => x === 255 ? [3, [18]] : [4, x + 1 & 0xFF];
  ...
  const v_$inl3$r = __succUInt8(v_maxUInt8);
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
      ...
      case 4: {
        ...
        const v_$inl6$r = [4, 255 & 0xFF];
        {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v_$inl9$r = __succUInt8(v_minUInt8);
              {
                const __s = (s => {
                  switch (s[0]) {
                    case 3: {
  ...
  const v_$inl12$x = v_res;
  const main = v_$cps$$df$handleErrorIO$0(
    v_$cps$$df$andThenIO$4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v_$inl12$x[1]];
          }
          case 4: {
            return [5, v_$inl12$x[1]];
          }
        }
      })(v_$inl12$x),
      [22]
