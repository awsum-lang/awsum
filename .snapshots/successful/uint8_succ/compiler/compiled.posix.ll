...
case.arm.1.16:
  ...
  store i8 254, ptr %t20
  %t21 = call ptr @__succUInt8(ptr %t20)
...
case.arm.1.56:
  ...
  %t60 = getelementptr [3 x i8], ptr @.str.3, i64 0, i64 0
...
case.arm.1.93:
  ...
  %t97 = getelementptr [3 x i8], ptr @.str.3, i64 0, i64 0
...
case.join.7:
  ...
  %t123 = call ptr @v__let_2(ptr %t122)
  ret ptr %t123
}
