...
(module
  ...
  (func $v_main (param $v__input i32) (result i32)
    (call $__print (call $__concat (call $__concat (call $__concat (call $__concat (call $v_render (call $__succUInt8 (call $v_maxUInt8))) (i32.const 95)) (call $v_render (call $__succUInt8 (call $__box_i32 (i32.const 254))))) (i32.const 95)) (call $v_render (call $__succUInt8 (call $v_minUInt8))))))
