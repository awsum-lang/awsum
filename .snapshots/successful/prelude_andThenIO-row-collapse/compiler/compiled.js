...
(() => {
  ...
  const v_observeA = (v_io) => {
    return v__df_handleErrorIO_56(
      v__df_andThenIO_60(v__lift_67(v__df_mapIO_64(v_io)))
    );
  };
  ...
  const v_observeStr = (v_io) => {
    return v__df_handleErrorIO_72(
      v__df_andThenIO_60(v__lift_75(v__df_mapIO_64(v_io)))
    );
  };

  const v_observeTwo = (v_io) => {
    return v__df_handleErrorIO_68(
      v__df_andThenIO_60(v__lift_71(v__df_mapIO_64(v_io)))
    );
  };
        ...
        switch (__s[0]) {
          case 5: {
            ...
            return v__apply__df_andThenIO_112(
              v__k,
              v__lift_1(v__lam_128(v__df_andThenIO_112_cap0_0, v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
          ...
          case 8: {
            ...
            return v__apply__df_andThenIO_112(
              v__k,
              [8, [76, v_cont, v__df_andThenIO_112_cap0_0]]
            );
          }
          case 9: {
            const v_cont = __s[1];
            return v__apply__df_andThenIO_112(
              v__k,
              [9, [113, v_cont, v__df_andThenIO_112_cap0_0]]
            );
          }
          case 10: {
            const v_cont = __s[1];
            return v__apply__df_andThenIO_112(
              v__k,
              [10, [150, v_cont, v__df_andThenIO_112_cap0_0]]
            );
          }
        }
      }
  ...
  const v_line = (v_label, v_act) => {
    return v__df_andThenIO_108(
      v__df_andThenIO_112(
        v__df_andThenIO_116(v__lift_130([7, v_label, [5, [0]]])),
        v_act
      )
    );
  };
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_91_88(
              v__k,
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_79_80(
              v__k,
              v__lift_80(v__bi_IO_Stdout_print(v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_59_48(
              v__k,
              v__lift_60(v_kSFailIO(v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_47_52(
              v__k,
              v__lift_48(v_kAFailIO(v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
  ...
  const v_wE3 = v__df__rowspec_47_52(
    v__lift_52(v__df__rowspec_59_44(v_seedTIO))
  );
  ...
  const v_wE1 = v__df__rowspec_47_40(
    v__lift_52(v__df__rowspec_59_44(v_seedFirstIO))
  );

  const v_wE2str = v__df__rowspec_47_40(
    v__lift_52(v__df__rowspec_59_48(v_seedTIO))
  );

  const v_wOk = v__df__rowspec_47_40(
    v__lift_52(v__df__rowspec_59_44(v_seedTIO))
  );
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_39_32(
              v__k,
              v__lift_40(v_kAFailIO(v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_31_24(
              v__k,
              v__lift_32(v_kBFailIO(v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_23_16(
              v__k,
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_115_104(
              v__k,
              v__lift_116(v__bi_IO_Stdout_print(v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
  ...
  const v_observeThree = (v_io) => {
    return v__df_handleErrorIO_100(
      v__df__rowspec_115_104(v__lift_120(v__df_mapIO_64(v_io)))
    );
  };
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_103_96(
              v__k,
              v__lift_104(v__bi_IO_Stdout_print(v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
