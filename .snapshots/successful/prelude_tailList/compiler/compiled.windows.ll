...
@.str.8 = private unnamed_addr constant {i32, i32, i32, i32, i32, [1 x i8]} { i32 0, i32 0, i32 0, i32 1, i32 1, [1 x i8] c"c" }
...
define internal ptr @v_tailList(ptr %v_xs) {
...
define internal ptr @v_showList(ptr %v_xs) {
  call void @__inc_ref(ptr %v_xs)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 14 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps_showList(ptr %v_xs, ptr %t0)
  call void @__free_recursive(ptr %v_xs)
  ret ptr %t3
}
...
tco.loop.0:
  ...
  switch i64 %t9, label %tco.case.default.10 [ i64 12, label %tco.case.arm.12.11 i64 13, label %tco.case.arm.13.17 ]
tco.case.arm.12.11:
...
tco.case.arm.4.37:
  ...
  call void @__inc_ref(ptr %t16)
  %t40 = call ptr @__concat(ptr %t16, ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
  %t41 = getelementptr ptr, ptr %t40, i32 0
  %t42 = load ptr, ptr %t41
  %t43 = ptrtoint ptr %t42 to i64
  switch i64 %t43, label %tco.case.default.44 [ i64 3, label %tco.case.arm.3.45 i64 4, label %tco.case.arm.4.64 ]
tco.case.arm.3.45:
...
reuse.join.53:
  ...
  br label %tco.loop.0
tco.case.arm.4.64:
  %t65 = getelementptr ptr, ptr %t40, i32 1
  %t66 = load ptr, ptr %t65
  call void @__inc_ref(ptr %t66)
  call void @__inc_ref(ptr %t66)
  call void @__inc_ref(ptr %t39)
  %t67 = call ptr @__concat(ptr %t66, ptr %t39)
  call void @__inc_ref(ptr %t14)
  call void @__free_recursive(ptr %t40)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
define internal ptr @v_show(ptr %v_m) {
...
case.arm.11.9:
  ...
  call void @__inc_ref(ptr %t11)
  call void @__inc_ref(ptr %t11)
  %t12 = call ptr @v_showList(ptr %t11)
  %t13 = getelementptr ptr, ptr %t12, i32 0
  %t14 = load ptr, ptr %t13
  %t15 = ptrtoint ptr %t14 to i64
  switch i64 %t15, label %case.default.16 [ i64 3, label %case.arm.3.17 i64 4, label %case.arm.4.24 ]
case.arm.3.17:
...
case.arm.4.24:
  ...
  call void @__inc_ref(ptr %t26)
  %t27 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.3, i64 12), ptr %t26)
  call void @__free_recursive(ptr %t12)
...
define internal ptr @v_main() {
  ...
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__lift_16(ptr %t0)
  %t4 = call ptr @v_tailList(ptr %t3)
  %t5 = call ptr @v__let_19(ptr %t4)
  ret ptr %t5
}
...
tco.case.arm.12.11:
  ...
  %t14 = getelementptr ptr, ptr %t12, i32 0
  store ptr %t13, ptr %t14
  %t15 = call ptr @v__apply__lift_16(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v__let_17(ptr %v_noElems, ptr %v_single, ptr %v_multi) {
...
case.arm.4.14:
  ...
  %t18 = call ptr @v_show(ptr %v_single)
...
case.arm.4.32:
  ...
  call void @__inc_ref(ptr %v_multi)
  %t36 = call ptr @v_show(ptr %v_multi)
...
case.arm.4.50:
  ...
  call void @__inc_ref(ptr %t17)
  %t54 = call ptr @__concat(ptr %t17, ptr getelementptr inbounds (i8, ptr @.str.5, i64 12))
...
case.arm.4.86:
  ...
  call void @__inc_ref(ptr %t89)
  %t90 = call ptr @__concat(ptr %t89, ptr getelementptr inbounds (i8, ptr @.str.5, i64 12))
...
case.join.5:
  ...
  %t115 = call ptr @v__let_15(ptr %t114)
...
define internal ptr @v__let_18(ptr %v_noElems, ptr %v_single) {
  call void @__inc_ref(ptr %v_noElems)
  call void @__inc_ref(ptr %v_single)
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.6, i64 12), ptr %t3
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.7, i64 12), ptr %t7
  %t8 = call ptr @__alloc(i64 24, i32 2)
  %t9 = inttoptr i64 13 to ptr
  %t10 = getelementptr ptr, ptr %t8, i32 0
  store ptr %t9, ptr %t10
  %t11 = getelementptr ptr, ptr %t8, i32 1
  store ptr getelementptr inbounds (i8, ptr @.str.8, i64 12), ptr %t11
  %t12 = call ptr @__alloc(i64 8, i32 0)
  %t13 = inttoptr i64 12 to ptr
  %t14 = getelementptr ptr, ptr %t12, i32 0
  store ptr %t13, ptr %t14
  %t15 = call ptr @v__lift_16(ptr %t12)
  ...
  %t19 = call ptr @v_tailList(ptr %t0)
  %t20 = call ptr @v__let_17(ptr %v_noElems, ptr %v_single, ptr %t19)
  call void @__free_recursive(ptr %v_noElems)
  call void @__free_recursive(ptr %v_single)
  ret ptr %t20
}

define internal ptr @v__let_19(ptr %v_noElems) {
  call void @__inc_ref(ptr %v_noElems)
  %t0 = call ptr @__alloc(i64 24, i32 2)
  %t1 = inttoptr i64 13 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  ...
  %t6 = getelementptr ptr, ptr %t4, i32 0
  store ptr %t5, ptr %t6
  %t7 = call ptr @v__lift_16(ptr %t4)
  %t8 = getelementptr ptr, ptr %t0, i32 2
  store ptr %t7, ptr %t8
  %t9 = call ptr @v_tailList(ptr %t0)
  %t10 = call ptr @v__let_18(ptr %v_noElems, ptr %t9)
  call void @__free_recursive(ptr %v_noElems)
  ret ptr %t10
}
