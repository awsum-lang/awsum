...
define internal ptr @v_main() {
  ...
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__lift_13(ptr %t0)
  %t4 = call ptr @v_tailList(ptr %t3)
  %t5 = call ptr @v__let_16(ptr %t4)
  ret ptr %t5
}
...
tco.case.arm.12.11:
  ...
  %t14 = getelementptr ptr, ptr %t12, i32 0
  store ptr %t13, ptr %t14
  %t15 = call ptr @v__apply__lift_13(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
case.join.5:
  ...
  %t115 = call ptr @v__let_12(ptr %t114)
...
define internal ptr @v__let_15(ptr %v_noElems, ptr %v_single) {
  ...
  %t14 = getelementptr ptr, ptr %t12, i32 0
  store ptr %t13, ptr %t14
  %t15 = call ptr @v__lift_13(ptr %t12)
  ...
  %t20 = call ptr @v__let_14(ptr %v_noElems, ptr %v_single, ptr %t19)
  call void @__free_recursive(ptr %v_noElems)
  call void @__free_recursive(ptr %v_single)
  ret ptr %t20
}
...
define internal ptr @v__let_16(ptr %v_noElems) {
  ...
  %t6 = getelementptr ptr, ptr %t4, i32 0
  store ptr %t5, ptr %t6
  %t7 = call ptr @v__lift_13(ptr %t4)
  %t8 = getelementptr ptr, ptr %t0, i32 2
  store ptr %t7, ptr %t8
  %t9 = call ptr @v_tailList(ptr %t0)
  %t10 = call ptr @v__let_15(ptr %v_noElems, ptr %t9)
  call void @__free_recursive(ptr %v_noElems)
  ret ptr %t10
}
