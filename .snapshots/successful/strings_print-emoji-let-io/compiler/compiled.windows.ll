...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [4 x i8]} { i32 0, i32 0, i32 0, i32 4, i32 2, [4 x i8] c"\F0\9F\92\A9" }
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [4 x i8]} { i32 0, i32 0, i32 0, i32 4, i32 2, [4 x i8] c"\F0\9F\94\A5" }
...
define internal ptr @v_main() {
  ...
  %t12 = call ptr @v__let_12(ptr %t0)
  ret ptr %t12
}

define internal ptr @v__let_12(ptr %v_unit) {
  %t0 = call ptr @__alloc(i64 24, i32 2)
  %t1 = inttoptr i64 7 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  ...
  %t11 = getelementptr ptr, ptr %t0, i32 2
  store ptr %t4, ptr %t11
  call void @__free_recursive(ptr %v_unit)
  ret ptr %t0
}
