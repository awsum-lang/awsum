...
@.str.0 = private unnamed_addr constant {i32, i32, [4 x i8]} { i32 4, i32 2, [4 x i8] c"\F0\9F\92\A9" }
@.str.1 = private unnamed_addr constant {i32, i32, [4 x i8]} { i32 4, i32 2, [4 x i8] c"\F0\9F\94\A5" }
...
define internal ptr @v_main(ptr %v__input) {
  ...
  %t12 = call ptr @v__let_2(ptr %t0)
  ret ptr %t12
}

define internal ptr @v__let_2(ptr %v_unit) {
  %t0 = call ptr @malloc(i64 24)
  %t1 = inttoptr i64 2 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
