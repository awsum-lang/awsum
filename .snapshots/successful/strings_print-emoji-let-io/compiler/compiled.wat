...
(module
  ...
  (data (i32.const 72) "\04\00\00\00\02\00\00\00\f0\9f\92\a9")
  (data (i32.const 84) "\04\00\00\00\02\00\00\00\f0\9f\94\a5")
  (table 2 funcref)
  ...
  (func $v_main (result i32)
    ...
    (local $__con_1 i32)
    (local $__con_2 i32)
    (call $v__let_7 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (i32.const 72)) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc (i32.const 4))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0))))

  (func $v__let_7 (param $v_unit i32) (result i32)
    (local $__con_0 i32)
    (local $__con_1 i32)
    (local $__con_2 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (i32.const 84)) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc (i32.const 4))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0)))
