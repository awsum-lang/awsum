...
(module
  ...
  (func $v_main (param $v__input i32) (result i32)
    (local $__con_0 i32)
    (call $__print (call $__concat (call $__concat (call $v_unwrap (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (i32.const 65)) (local.get $__con_0))) (i32.const 67)) (call $v_unwrap (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (i32.const 69)) (local.get $__con_0))))))
