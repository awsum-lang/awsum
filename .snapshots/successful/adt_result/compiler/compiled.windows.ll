...
case.arm.1.21:
  ...
  %t28 = getelementptr [2 x i8], ptr @.str.2, i64 0, i64 0
  %t29 = getelementptr ptr, ptr %t25, i32 1
  store ptr %t28, ptr %t29
  %t30 = call ptr @v_unwrap(ptr %t25)
  %t31 = call ptr @__concat(ptr %t24, ptr %t30)
...
case.default.11:
  unreachable
case.join.12:
  %t32 = phi ptr [%t17, %case.end.0.14], [%t31, %case.end.1.22]
  %t33 = call ptr @v__let_2(ptr %t32)
  ret ptr %t33
}
