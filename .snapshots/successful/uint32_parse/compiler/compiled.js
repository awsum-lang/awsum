...
(() => {
  ...
  const v__inl3_r = __parseUInt32("0");
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
      ...
      case 4: {
        const v_a = s[1];
        const v__inl6_r = __parseUInt32("4294967295");
        {
          const __s = (s => {
            switch (s[0]) {
              case 3: {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v__inl9_r = __parseUInt32("4294967296");
              {
                const __s = (s => {
                  switch (s[0]) {
                    case 3: {
                ...
                switch (__s[0]) {
                  ...
                  case 4: {
                    const v_c = __s[1];
                    const v__inl12_r = __parseUInt32("-1");
                    {
                      const __s = (s => {
                        switch (s[0]) {
                          case 3: {
                      ...
                      switch (__s[0]) {
                        ...
                        case 4: {
                          const v_d = __s[1];
                          const v__inl15_r = __parseUInt32("");
                          {
                            const __s = (s => {
                              switch (s[0]) {
                                case 3: {
                                ...
                                case 4: {
                                  return __concat("ok:", String(v__inl15_r[1]));
                                }
                              }
                            })(v__inl15_r);
                            switch (__s[0]) {
                              ...
                              case 4: {
                                const v_e = __s[1];
                                const v__inl18_r = __parseUInt32("abc");
                                {
                                  const __s = (s => {
                                    switch (s[0]) {
                                      case 3: {
                                  ...
                                  switch (__s[0]) {
                                    ...
                                    case 4: {
                                      const v_f = __s[1];
                                      const v__inl21_r = __parseUInt32(" 5");
                                      {
                                        const __s = (s => {
                                          switch (s[0]) {
                                            case 3: {
                                        ...
                                        switch (__s[0]) {
                                          ...
                                          case 4: {
                                            const v_g = __s[1];
                                            const v__inl24_r = __parseUInt32(
                                              "12a"
                                            );
                                            {
                                              const __s = (s => {
                                              ...
                                              switch (__s[0]) {
                                                ...
                                                case 4: {
                                                  const v_h = __s[1];
                                                  const v__inl27_r = __parseUInt32(
                                                    "2147483648"
                                                  );
                                                  {
                                                    const __s = (s => {
  ...
  const v__inl30_x = v_res;
  const main = v__cps__df_handleErrorIO_0(
    v__cps__df_andThenIO_4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v__inl30_x[1]];
          }
          case 4: {
            return [5, v__inl30_x[1]];
          }
        }
      })(v__inl30_x),
      [22]
