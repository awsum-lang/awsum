...
function __parseUInt32(s){ if (!/^[0-9]+$/.test(s)) return [3, [20]]; const n = Number(s); if (n > 4294967295) return [3, [20]]; return [4, (n >>> 0)]; }
