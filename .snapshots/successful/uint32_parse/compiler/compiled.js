...
(() => {
  ...
  const v_$inl3$r = __parseUInt32("0");
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
      ...
      case 4: {
        const v_a = s[1];
        const v_$inl6$r = __parseUInt32("4294967295");
        {
          const __s = (s => {
            switch (s[0]) {
              case 3: {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v_$inl9$r = __parseUInt32("4294967296");
              {
                const __s = (s => {
                  switch (s[0]) {
                    case 3: {
                ...
                switch (__s[0]) {
                  ...
                  case 4: {
                    const v_c = __s[1];
                    const v_$inl12$r = __parseUInt32("-1");
                    {
                      const __s = (s => {
                        switch (s[0]) {
                          case 3: {
                      ...
                      switch (__s[0]) {
                        ...
                        case 4: {
                          const v_d = __s[1];
                          const v_$inl15$r = __parseUInt32("");
                          {
                            const __s = (s => {
                              switch (s[0]) {
                                case 3: {
                            ...
                            switch (__s[0]) {
                              ...
                              case 4: {
                                const v_e = __s[1];
                                const v_$inl18$r = __parseUInt32("abc");
                                {
                                  const __s = (s => {
                                    switch (s[0]) {
                                      case 3: {
                                  ...
                                  switch (__s[0]) {
                                    ...
                                    case 4: {
                                      const v_f = __s[1];
                                      const v_$inl21$r = __parseUInt32(" 5");
                                      {
                                        const __s = (s => {
                                          switch (s[0]) {
                                            case 3: {
                                        ...
                                        switch (__s[0]) {
                                          ...
                                          case 4: {
                                            const v_g = __s[1];
                                            const v_$inl24$r = __parseUInt32(
                                              "12a"
                                            );
                                            {
                                              const __s = (s => {
                                              ...
                                              switch (__s[0]) {
                                                ...
                                                case 4: {
                                                  const v_h = __s[1];
                                                  const v_$inl27$r = __parseUInt32(
                                                    "2147483648"
                                                  );
                                                  {
                                                    const __s = (s => {
  ...
  const v_$inl30$x = v_res;
  const main = v_$cps$$df$handleErrorIO$0(
    v_$cps$$df$andThenIO$4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v_$inl30$x[1]];
          }
          case 4: {
            return [5, v_$inl30$x[1]];
          }
        }
      })(v_$inl30$x),
      [22]
