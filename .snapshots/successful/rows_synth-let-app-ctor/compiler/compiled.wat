...
(module
  ...
  (data (i32.const 81) "\05\00\00\00\05\00\00\00world")
  (data (i32.const 94) "\01\00\00\00\01\00\00\00n")
  (table 3 funcref)
  ...
  (func $v_main (result i32)
    (local $__con_0 i32)
    (call $v__let_7 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 10)) (i32.store offset=4 (local.get $__con_0) (i32.const 81)) (local.get $__con_0))))
