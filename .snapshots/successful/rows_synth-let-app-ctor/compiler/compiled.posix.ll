...
@.str.1 = private unnamed_addr constant {i32, i32, [5 x i8]} { i32 5, i32 5, [5 x i8] c"world" }
...
define internal ptr @v_main() {
  ...
  %t4 = call ptr @v__let_7(ptr %t0)
  ret ptr %t4
}

define internal ptr @v__let_7(ptr %v_m) {
  %t0 = getelementptr ptr, ptr %v_m, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 9, label %case.arm.9.5 i64 10, label %case.arm.10.19 ]
case.arm.9.5:
...
case.end.9.6:
  br label %case.join.4
case.arm.10.19:
  %t21 = getelementptr ptr, ptr %v_m, i32 1
  ...
  %t27 = inttoptr i64 1615808600 to ptr
  %t28 = getelementptr ptr, ptr %t26, i32 0
  store ptr %t27, ptr %t28
  %t29 = getelementptr ptr, ptr %t26, i32 1
  store ptr %t22, ptr %t29
  %t30 = call ptr @v_dispatch(ptr %t26)
  ...
  %t39 = getelementptr ptr, ptr %t23, i32 2
  store ptr %t32, ptr %t39
  br label %case.end.10.20
case.end.10.20:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t40 = phi ptr [%t7, %case.end.9.6], [%t23, %case.end.10.20]
  ret ptr %t40
}
