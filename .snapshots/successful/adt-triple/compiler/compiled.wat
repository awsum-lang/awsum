...
(module
  ...
  (global $heap (mut i32) (i32.const 81))
  (data (i32.const 64) "\00")
  (data (i32.const 65) " \00")
  (data (i32.const 67) "one\00")
  (data (i32.const 71) "two\00")
  (data (i32.const 75) "three\00")
  (table 3 funcref)
  (elem (i32.const 0) $v_showTriple $v_main $v__con_Triple)
  ...
  (func $v_showTriple (export "v_showTriple") (param $v_t i32) (result i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_t)) (call $__concat (call $__concat (call $__concat (call $__concat (i32.load offset=4 (local.get $__scrut)) (i32.const 65)) (i32.load offset=8 (local.get $__scrut))) (i32.const 65)) (i32.load offset=12 (local.get $__scrut)))))

  (func $v_main (export "v_main") (param $v_input i32) (result i32)
    (local $__con_0 i32)
    (call $__print (call $v_showTriple (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 16))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (i32.const 67)) (i32.store offset=8 (local.get $__con_0) (i32.const 71)) (i32.store offset=12 (local.get $__con_0) (i32.const 75)) (local.get $__con_0)))))

  (func $v__con_Triple (export "v__con_Triple") (param $v__x0 i32) (param $v__x1 i32) (param $v__x2 i32) (result i32)
    (local $__con_0 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 16))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v__x0)) (i32.store offset=8 (local.get $__con_0) (local.get $v__x1)) (i32.store offset=12 (local.get $__con_0) (local.get $v__x2)) (local.get $__con_0)))
