...
define ptr @v_main(ptr %v__input) {
  ...
  store ptr %t1, ptr %t2
  %t3 = getelementptr [4 x i8], ptr @.str.1, i64 0, i64 0
  %t4 = getelementptr ptr, ptr %t0, i32 1
  store ptr %t3, ptr %t4
  %t5 = getelementptr [4 x i8], ptr @.str.2, i64 0, i64 0
  %t6 = getelementptr ptr, ptr %t0, i32 2
  store ptr %t5, ptr %t6
  %t7 = getelementptr [6 x i8], ptr @.str.3, i64 0, i64 0
