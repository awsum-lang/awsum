...
(module
  ...
  (func $v_countDown (export "v_countDown") (param $v_n i32) (result i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $__predUInt8 (local.get $v_n))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (call $__show_i32 (local.get $v_n))) (else (call $__concat (call $__concat (call $__show_i32 (local.get $v_n)) (i32.const 65)) (call $v_countDown (i32.load offset=4 (local.get $__scrut))))))))

  (func $v_main (export "v_main") (param $v__input i32) (result i32)
    (call $__print (call $v_countDown (call $__box_i32 (i32.const 255)))))
