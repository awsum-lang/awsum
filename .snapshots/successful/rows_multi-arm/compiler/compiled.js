...
(() => {
  ...
  const v_res = (s => {
        ...
        const v_$inl7$____input = [12, [0]];
        {
          const __s = (s => {
            switch (s[0]) {
              ...
              case 12: {
                const v_$inl8$____pa0 = s[1];
                switch (v_$inl8$____pa0[0]) {
                  case 796142685: {
                    {
                      const __s = v_$inl8$____pa0[1];
                      switch (__s[0]) {
                        case 1: {
                          return [4, "Just True"];
                        }
            ...
            (s => {
              switch (s[0]) {
                ...
                case 12: {
                  return [12, [1759602215, v_$inl7$____input[1]]];
                }
              }
            })(v_$inl7$____input)
          );
    ...
    (s => {
      switch (s[0]) {
        ...
        case 12: {
          const v_$inl3$____pa0 = s[1];
          switch (v_$inl3$____pa0[0]) {
            case 796142685: {
              {
                const __s = v_$inl3$____pa0[1];
                switch (__s[0]) {
                  case 1: {
                    return [4, "Just True"];
                  }
  ...
  const v_$inl16$x = v_res;
  const main = v_$cps$$df$handleErrorIO$0(
    v_$cps$$df$andThenIO$4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v_$inl16$x[1]];
          }
          case 4: {
            return [5, v_$inl16$x[1]];
          }
        }
      })(v_$inl16$x),
      [22]
