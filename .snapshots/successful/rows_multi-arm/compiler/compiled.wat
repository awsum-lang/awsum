...
(module
  ...
  (table 7 funcref)
  (elem (i32.const 0) $v_showUnit $v_runIO $v_whatsInside $v__lift_7 $v__lift_8 $v__lift_9 $v__let_10)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_whatsInside (param $v_x i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 9)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 120)) (local.get $__con_0))) (else (local.set $v___pa0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___pa0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___pa0)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 796142685)) (then (local.set $v_b (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v_b)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 147)) (local.get $__con_0))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 176)) (local.get $__con_0)))))) (call $__free_recursive (local.get $v_b)) (local.get $__drop_tmp))) (else (local.set $v_u (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_u)) (block (result i32) (local.set $__drop_tmp (call $__concat (i32.const 206) (call $v_showUnit (block (result i32) (local.set $__inc_tmp (local.get $v_u)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))) (call $__free_recursive (local.get $v_u)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v___pa0)) (local.get $__drop_tmp))))))
  ...
  (func $v__lift_9 (param $v___input i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v___input)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 9)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 9)) (local.get $__con_0))) (else (local.set $v___f0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___f0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 10)) (i32.store offset=4 (local.get $__con_0) (local.get $v___f0)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v___f0)) (local.get $__drop_tmp))))))
