...
define internal ptr @v_spin(ptr %v_n, ptr %v_p) {
entry:
  %t3 = alloca ptr
  store ptr %v_n, ptr %t3
  %t4 = alloca ptr
  store ptr %v_p, ptr %t4
  %t2 = alloca ptr
  br label %tco.loop.0
tco.loop.0:
  %t5 = load ptr, ptr %t3
...
tco.case.arm.4.21:
  ...
  switch i64 %t26, label %tco.case.default.27 [ i64 24, label %tco.case.arm.24.28 ]
tco.case.arm.24.28:
...
define internal ptr @v_main() {
  ...
  %t9 = getelementptr ptr, ptr %t4, i32 1
  store ptr %t8, ptr %t9
  %t10 = getelementptr ptr, ptr %t4, i32 2
  store ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr %t10
  %t11 = call ptr @v_spin(ptr %t3, ptr %t4)
  %t12 = getelementptr ptr, ptr %t11, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  %t14 = getelementptr ptr, ptr %t11, i32 2
  ...
  switch i64 %t19, label %case.default.20 [ i64 3, label %case.arm.3.22 i64 4, label %case.arm.4.24 ]
case.arm.3.22:
...
case.default.20:
  unreachable
case.join.21:
  %t28 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.3.23 ], [ %t27, %case.end.4.25 ]
  ...
  %t41 = call ptr @v_$cps$$df$andThenIO$0(ptr %t0, ptr %t38)
  ret ptr %t41
}
...
tco.case.arm.5.11:
  ...
  switch i64 %t31, label %case.default.32 [ i64 3, label %case.arm.3.34 i64 4, label %case.arm.4.36 ]
case.arm.3.34:
...
case.default.32:
  unreachable
case.join.33:
  %t40 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.3.35 ], [ %t39, %case.end.4.37 ]
  ...
  %t50 = call ptr @v_$apply$$df$andThenIO$0(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
