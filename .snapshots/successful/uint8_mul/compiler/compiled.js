                      ...
                      return (s => {
                        switch (s[0]) {
                          ...
                          case 4: {
                            ...
                            })(v_render(__mulUInt8(1 & 0xFF, 200 & 0xFF)));
                          }
                        }
                      })(v_render(__mulUInt8(v_minUInt8, 200 & 0xFF)));
                    }
                  }
                })(v_render(__mulUInt8(v_maxUInt8, v_maxUInt8)));
              }
            }
          })(v_render(__mulUInt8(16 & 0xFF, 16 & 0xFF)));
        }
      }
    })(v_render(__mulUInt8(15 & 0xFF, 17 & 0xFF)))
  );
