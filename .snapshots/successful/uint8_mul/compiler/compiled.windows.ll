...
case.arm.4.72:
  ...
  %t78 = call ptr @__mulUInt8(ptr %t76, ptr %t77)
...
case.arm.4.107:
  ...
  %t112 = call ptr @__alloc(i64 1, i32 0)
  store i8 200, ptr %t112
  %t113 = call ptr @__mulUInt8(ptr %t111, ptr %t112)
...
case.arm.4.142:
  ...
  %t149 = call ptr @__alloc(i64 1, i32 0)
  store i8 200, ptr %t149
...
case.arm.4.159:
  ...
  %t163 = call ptr @__showUInt8(ptr %t162)
...
case.arm.4.233:
  ...
  call void @__inc_ref(ptr %t236)
  call void @__inc_ref(ptr %t110)
  %t237 = call ptr @__concat(ptr %t236, ptr %t110)
  %t238 = getelementptr ptr, ptr %t237, i32 0
  %t239 = load ptr, ptr %t238
  %t240 = ptrtoint ptr %t239 to i64
  switch i64 %t240, label %case.default.241 [ i64 3, label %case.arm.3.243 i64 4, label %case.arm.4.251 ]
case.arm.3.243:
  %t245 = getelementptr ptr, ptr %t237, i32 1
  %t246 = load ptr, ptr %t245
  call void @__inc_ref(ptr %t246)
  %t247 = call ptr @__alloc(i64 16, i32 1)
  %t248 = inttoptr i64 3 to ptr
  %t249 = getelementptr ptr, ptr %t247, i32 0
  store ptr %t248, ptr %t249
  call void @__inc_ref(ptr %t246)
  %t250 = getelementptr ptr, ptr %t247, i32 1
  store ptr %t246, ptr %t250
  br label %case.end.3.244
case.end.3.244:
  br label %case.join.242
case.arm.4.251:
  %t253 = getelementptr ptr, ptr %t237, i32 1
  %t254 = load ptr, ptr %t253
  call void @__inc_ref(ptr %t254)
  call void @__inc_ref(ptr %t254)
  %t255 = call ptr @__concat(ptr %t254, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
  %t256 = getelementptr ptr, ptr %t255, i32 0
  %t257 = load ptr, ptr %t256
  %t258 = ptrtoint ptr %t257 to i64
  switch i64 %t258, label %case.default.259 [ i64 3, label %case.arm.3.261 i64 4, label %case.arm.4.269 ]
case.arm.3.261:
...
case.arm.4.287:
  ...
  call void @__inc_ref(ptr %t290)
  %t291 = call ptr @__concat(ptr %t290, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
  %t292 = getelementptr ptr, ptr %t291, i32 0
  %t293 = load ptr, ptr %t292
  %t294 = ptrtoint ptr %t293 to i64
  switch i64 %t294, label %case.default.295 [ i64 3, label %case.arm.3.297 i64 4, label %case.arm.4.305 ]
case.arm.3.297:
  %t299 = getelementptr ptr, ptr %t291, i32 1
  %t300 = load ptr, ptr %t299
  call void @__inc_ref(ptr %t300)
  %t301 = call ptr @__alloc(i64 16, i32 1)
  %t302 = inttoptr i64 3 to ptr
  %t303 = getelementptr ptr, ptr %t301, i32 0
  store ptr %t302, ptr %t303
  call void @__inc_ref(ptr %t300)
  %t304 = getelementptr ptr, ptr %t301, i32 1
  store ptr %t300, ptr %t304
  br label %case.end.3.298
case.end.3.298:
  br label %case.join.296
case.arm.4.305:
  %t307 = getelementptr ptr, ptr %t291, i32 1
  %t308 = load ptr, ptr %t307
  call void @__inc_ref(ptr %t308)
  call void @__inc_ref(ptr %t308)
  call void @__inc_ref(ptr %t182)
  %t309 = call ptr @__concat(ptr %t308, ptr %t182)
  br label %case.end.4.306
case.end.4.306:
  br label %case.join.296
case.default.295:
  unreachable
case.join.296:
  %t310 = phi ptr [ %t301, %case.end.3.298 ], [ %t309, %case.end.4.306 ]
  call void @__free_recursive(ptr %t291)
  br label %case.end.4.288
case.end.4.288:
  br label %case.join.278
case.default.277:
  unreachable
case.join.278:
  %t311 = phi ptr [ %t283, %case.end.3.280 ], [ %t310, %case.end.4.288 ]
...
case.default.259:
  unreachable
case.join.260:
  %t312 = phi ptr [ %t265, %case.end.3.262 ], [ %t311, %case.end.4.270 ]
  call void @__free_recursive(ptr %t255)
  br label %case.end.4.252
case.end.4.252:
  br label %case.join.242
case.default.241:
  unreachable
case.join.242:
  %t313 = phi ptr [ %t247, %case.end.3.244 ], [ %t312, %case.end.4.252 ]
...
case.default.223:
  unreachable
case.join.224:
  %t314 = phi ptr [ %t229, %case.end.3.226 ], [ %t313, %case.end.4.234 ]
  call void @__free_recursive(ptr %t219)
  br label %case.end.4.216
case.end.4.216:
  br label %case.join.206
case.default.205:
  unreachable
case.join.206:
  %t315 = phi ptr [ %t211, %case.end.3.208 ], [ %t314, %case.end.4.216 ]
  call void @__free_recursive(ptr %t201)
  br label %case.end.4.198
case.end.4.198:
  br label %case.join.188
case.default.187:
  unreachable
case.join.188:
  %t316 = phi ptr [ %t193, %case.end.3.190 ], [ %t315, %case.end.4.198 ]
...
case.default.169:
  unreachable
case.join.170:
  %t317 = phi ptr [ %t175, %case.end.3.172 ], [ %t316, %case.end.4.180 ]
...
case.default.97:
  unreachable
case.join.98:
  %t319 = phi ptr [ %t103, %case.end.3.100 ], [ %t318, %case.end.4.108 ]
...
case.default.62:
  unreachable
case.join.63:
  %t320 = phi ptr [ %t68, %case.end.3.65 ], [ %t319, %case.end.4.73 ]
...
case.default.23:
  unreachable
case.join.24:
  %t321 = phi ptr [ %t29, %case.end.3.26 ], [ %t320, %case.end.4.34 ]
