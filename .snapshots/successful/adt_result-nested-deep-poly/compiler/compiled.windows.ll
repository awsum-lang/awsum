...
define internal ptr @v_unwrap(ptr %v_r) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.4 i64 20, label %case.arm.20.37 ]
case.arm.19.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 19, label %case.arm.19.11 i64 20, label %case.arm.20.24 ]
case.arm.19.11:
  ...
  switch i64 %t16, label %case.default.17 [ i64 19, label %case.arm.19.18 i64 20, label %case.arm.20.21 ]
case.arm.19.18:
...
case.arm.20.24:
  ...
  switch i64 %t29, label %case.default.30 [ i64 19, label %case.arm.19.31 i64 20, label %case.arm.20.34 ]
case.arm.19.31:
...
case.arm.20.37:
  ...
  switch i64 %t42, label %case.default.43 [ i64 19, label %case.arm.19.44 i64 20, label %case.arm.20.57 ]
case.arm.19.44:
  ...
  switch i64 %t49, label %case.default.50 [ i64 19, label %case.arm.19.51 i64 20, label %case.arm.20.54 ]
case.arm.19.51:
...
case.arm.20.57:
  ...
  switch i64 %t62, label %case.default.63 [ i64 19, label %case.arm.19.64 i64 20, label %case.arm.20.67 ]
case.arm.19.64:
