    ...
    while (true) {
      switch (v__args[0]) {
        case 36: {
          ...
          switch (v__k[0]) {
            ...
            case 31: {
              ...
              v__args = (v__args[0] = 36, v__args[1] = v__pk_31, v__args[2] = (v__k[0] = 25, v__k[1] = v__k[2], v__k[2] = v__k[3], v__k[3] = v__x, v__k), v__args);
              continue;
            }
            case 30: {
              const v_l = v__k[2];
              v__args = (v__args[0] = 37, v__args[1] = v_l, v__args[2] = (v__k[0] = 31, v__k[2] = v__x, v__k), v__args);
              continue;
            }
          }
        }
        case 37: {
          ...
          switch (v_t[0]) {
            case 24: {
              v__args = (v__args[0] = 36, v__args[2] = v__args[1], v__args[1] = v__k, v__args);
              continue;
            }
            case 25: {
              v__args = (v__args[0] = 37, v__args[1] = v_t[3], v__args[2] = [
                30,
                v__k,
                v_t[1],
                v_t[2]
          ...
          case 2: {
            {
              ...
              switch (__s[0]) {
                ...
                case 4: {
                  const v_m = __s[1];
                  v_times = v_m;
                  v_t = v__scc__apply_mirror__cps_mirror([37, v_t, [29]]);
                  continue;
                }
              }
            }
