...
(module
  ...
  (table 10 funcref)
  (elem (i32.const 0) $v_runIO $v_buildLeft $v_buildRight $v_mirrorN $v__cps__df_handleErrorIO_0 $v__apply__df_handleErrorIO_0 $v__cps__df_andThenIO_4 $v__apply__df_andThenIO_4 $v__scc_deepestLeftA_deepestLeftB_deepestLeftC $v__scc__apply_mirror__cps_mirror)
