...
(() => {
  ...
  const v_res = (s => {
    switch (s[0]) {
      ...
      case 4: {
        const v_a = s[1];
        const v_$inl6$r = __subUInt32(v_maxUInt32, v_minUInt32);
        {
          const __s = (s => {
            switch (s[0]) {
              case 3: {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v_$inl9$r = __subUInt32(v_minUInt32, 1 >>> 0);
              {
                const __s = (s => {
                  switch (s[0]) {
                    case 3: {
