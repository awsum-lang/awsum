...
define internal ptr @v_main(ptr %v__input) {
  ...
  store i32 5, ptr %t1
  %t2 = call ptr @__subUInt32(ptr %t0, ptr %t1)
...
case.arm.1.17:
  ...
  %t21 = call ptr @v_maxUInt32()
  %t22 = call ptr @v_minUInt32()
  %t23 = call ptr @__subUInt32(ptr %t21, ptr %t22)
...
case.arm.1.38:
  ...
  %t42 = call ptr @v_minUInt32()
  %t43 = call ptr @malloc(i64 4)
  store i32 1, ptr %t43
  %t44 = call ptr @__subUInt32(ptr %t42, ptr %t43)
...
case.arm.1.59:
  ...
  %t65 = call ptr @__subUInt32(ptr %t63, ptr %t64)
...
case.arm.1.80:
  ...
  store i32 -2147483648, ptr %t84
  %t85 = call ptr @malloc(i64 4)
  store i32 2147483647, ptr %t85
  %t86 = call ptr @__subUInt32(ptr %t84, ptr %t85)
...
case.arm.1.101:
  ...
  %t105 = getelementptr [3 x i8], ptr @.str.3, i64 0, i64 0
...
case.arm.1.138:
  ...
  %t142 = getelementptr [3 x i8], ptr @.str.3, i64 0, i64 0
...
case.arm.1.175:
  ...
  %t179 = getelementptr [3 x i8], ptr @.str.3, i64 0, i64 0
...
case.arm.1.212:
  ...
  %t216 = getelementptr [3 x i8], ptr @.str.3, i64 0, i64 0
