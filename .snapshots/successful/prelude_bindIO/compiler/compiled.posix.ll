...
define internal ptr @v_main() {
  ...
  %t13 = inttoptr i64 8 to ptr
  %t14 = getelementptr ptr, ptr %t12, i32 0
  store ptr %t13, ptr %t14
  %t15 = call ptr @v_$cps$$df$bindIO$0(ptr %t0, ptr %t12)
  ret ptr %t15
}
...
tco.loop.0:
  ...
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 7, label %tco.case.arm.7.29 ]
tco.case.arm.5.11:
  ...
  %t27 = call ptr @v_$cps$$df$bindIO$4(ptr %t12, ptr %t24)
  %t28 = call ptr @v_$apply$$df$bindIO$0(ptr %t6, ptr %t27)
...
tco.case.arm.5.11:
  ...
  %t23 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t16, ptr %t23
  %t24 = call ptr @v_$apply$$df$bindIO$4(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
