...
define internal ptr @v_main() {
  ...
  %t15 = call ptr @v__cps__df_bindIO_0(ptr %t0, ptr %t12)
  ret ptr %t15
}
...
tco.case.arm.5.11:
  ...
  %t27 = call ptr @v__cps__df_bindIO_4(ptr %t12, ptr %t24)
  %t28 = call ptr @v__apply__df_bindIO_0(ptr %t6, ptr %t27)
...
tco.case.arm.5.11:
  ...
  %t23 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t16, ptr %t23
  %t24 = call ptr @v__apply__df_bindIO_4(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
