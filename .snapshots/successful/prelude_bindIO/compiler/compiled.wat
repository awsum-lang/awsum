...
(module
  ...
  (table 10 funcref)
  (elem (i32.const 0) $v_runIO $v_emit $v__lam_13 $v__lam_14 $v__df_bindIO_0 $v__cps__df_bindIO_0 $v__apply__df_bindIO_0 $v__df_bindIO_4 $v__cps__df_bindIO_4 $v__apply__df_bindIO_4)
