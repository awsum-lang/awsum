...
define internal ptr @v__lam_19(ptr %v__u) {
  ...
  %t1 = call ptr @v__lift_15(ptr %t0)
  %t2 = call ptr @v__df_bindIO_3(ptr %t1)
...
define internal ptr @v__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterArgs_4__df_bindIOAfterStdin_2__df_bindIOAfterStdin_5__lift_16__lift_17__lift_2__lift_3(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 35 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterArgs_4__df_bindIOAfterStdin_2__df_bindIOAfterStdin_5__lift_16__lift_17__lift_2__lift_3(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterArgs_4__df_bindIOAfterStdin_2__df_bindIOAfterStdin_5__lift_16__lift_17__lift_2__lift_3(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 18, label %tco.case.arm.18.11 i64 19, label %tco.case.arm.19.180 i64 20, label %tco.case.arm.20.203 i64 21, label %tco.case.arm.21.226 i64 22, label %tco.case.arm.22.249 i64 23, label %tco.case.arm.23.272 i64 24, label %tco.case.arm.24.295 i64 25, label %tco.case.arm.25.318 i64 26, label %tco.case.arm.26.341 ]
tco.case.arm.18.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 10, label %tco.case.arm.10.20 i64 11, label %tco.case.arm.11.40 i64 12, label %tco.case.arm.12.60 i64 13, label %tco.case.arm.13.80 i64 14, label %tco.case.arm.14.100 i64 15, label %tco.case.arm.15.120 i64 16, label %tco.case.arm.16.140 i64 17, label %tco.case.arm.17.160 ]
tco.case.arm.10.20:
...
tco.case.default.19:
  unreachable
tco.case.arm.19.180:
  %t181 = getelementptr ptr, ptr %t5, i32 1
  %t182 = load ptr, ptr %t181
  %t183 = getelementptr ptr, ptr %t5, i32 2
...
reuse.in_place.188:
  %t191 = inttoptr i64 18 to ptr
  %t192 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t191, ptr %t192
  br label %reuse.join.190
reuse.copy.189:
  %t193 = call ptr @__alloc(i64 24, i32 2)
  %t194 = inttoptr i64 18 to ptr
  ...
  store ptr %t182, ptr %t196
  call void @__inc_ref(ptr %t184)
  %t197 = getelementptr ptr, ptr %t193, i32 2
  store ptr %t184, ptr %t197
  call void @__free_recursive(ptr %t5)
  br label %reuse.join.190
reuse.join.190:
  %t198 = phi ptr [ %t5, %reuse.in_place.188 ], [ %t193, %reuse.copy.189 ]
  %t199 = call ptr @__alloc(i64 16, i32 1)
  %t200 = inttoptr i64 36 to ptr
  %t201 = getelementptr ptr, ptr %t199, i32 0
  store ptr %t200, ptr %t201
  call void @__inc_ref(ptr %t6)
  %t202 = getelementptr ptr, ptr %t199, i32 1
  store ptr %t6, ptr %t202
  call void @__free_recursive(ptr %t6)
  store ptr %t198, ptr %t3
  store ptr %t199, ptr %t4
  br label %tco.loop.0
tco.case.arm.20.203:
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterArgs_4__df_bindIOAfterStdin_2__df_bindIOAfterStdin_5__lift_16__lift_17__lift_2__lift_3(ptr %t0)
