...
const v__lam_27 = (v__v) => {
    return (v_emit)("c");
};

const v__cps__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterArgs_5__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinBytes_7__df_bindIOAfterStdinString_2__df_bindIOAfterStdinString_6__lift_2__lift_24__lift_25__lift_26__lift_3__lift_4 = (v__args, v__k) => {
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
...
const v__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterArgs_5__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinBytes_7__df_bindIOAfterStdinString_2__df_bindIOAfterStdinString_6__lift_2__lift_24__lift_25__lift_26__lift_3__lift_4 = (v__args) => {
    return (v__cps__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterArgs_5__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinBytes_7__df_bindIOAfterStdinString_2__df_bindIOAfterStdinString_6__lift_2__lift_24__lift_25__lift_26__lift_3__lift_4)(v__args, [44]);
};

const v__apply1 = (v__cl, v__arg0) => {
    return (v__scc__apply1__df_bindIOAfterArgs_1__df_bindIOAfterArgs_5__df_bindIOAfterStdinBytes_3__df_bindIOAfterStdinBytes_7__df_bindIOAfterStdinString_2__df_bindIOAfterStdinString_6__lift_2__lift_24__lift_25__lift_26__lift_3__lift_4)([23, v__cl, v__arg0]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 8: {
          const v___f0 = __s[1];
          return (v__apply__lift_23)(v__k, [8, [18, v___f0]]);
        }
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_23)(v__k, [9, [19, v___f0]]);
        }
        case 10: {
          const v___f0 = __s[1];
          return (v__apply__lift_23)(v__k, [10, [20, v___f0]]);
        }
      }
    }
  }
...
const v__lift_23 = (v___input) => {
    return (v__cps__lift_23)(v___input, [38]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_1)(v__k, [9, [21, v___f0]]);
        }
        case 10: {
          const v___f0 = __s[1];
          return (v__apply__lift_1)(v__k, [10, [22, v___f0]]);
        }
      }
    }
  }
...
const v__lift_1 = (v___input) => {
    return (v__cps__lift_1)(v___input, [36]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        case 5: {
          const v_a = __s[1];
          return (v__apply__df_bindIO_4)(v__k, (v__lift_1)((v__lam_27)(v_a)));
        }
        case 6: {
          const v_e = __s[1];
...
const v__df_bindIO_4 = (v_io) => {
    return (v__cps__df_bindIO_4)(v_io, [42]);
};

const v__lam_28 = (v__u) => {
    return (v__df_bindIO_4)((v__lift_23)((v_emit)("b")));
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        case 5: {
          const v_a = __s[1];
          return (v__apply__df_bindIO_0)(v__k, (v__lift_1)((v__lam_28)(v_a)));
        }
        case 6: {
          const v_e = __s[1];
...
const v__df_bindIO_0 = (v_io) => {
    return (v__cps__df_bindIO_0)(v_io, [40]);
};

const main = (v__df_bindIO_0)((v__lift_23)((v_emit)("a")));
