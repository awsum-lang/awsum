...
case.arm.1.22:
  ...
  %t26 = call ptr @v_maxUInt8()
  %t27 = call ptr @v_minUInt8()
  %t28 = call ptr @__eqUInt8(ptr %t26, ptr %t27)
...
case.arm.1.44:
  ...
  %t48 = call ptr @malloc(i64 1)
  store i8 128, ptr %t48
  %t49 = call ptr @malloc(i64 1)
  store i8 127, ptr %t49
  %t50 = call ptr @__eqUInt8(ptr %t48, ptr %t49)
...
case.default.34:
  unreachable
case.join.35:
  %t53 = phi ptr [%t40, %case.end.0.37], [%t52, %case.end.1.45]
...
case.default.12:
  unreachable
case.join.13:
  %t54 = phi ptr [%t18, %case.end.0.15], [%t53, %case.end.1.23]
  %t55 = call ptr @v__let_7(ptr %t54)
  ret ptr %t55
}
