...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (block (result i32) (local.set $__scrut (call $__concat (call $v_render (call $__eq_i32 (call $v_minUInt8) (call $v_minUInt8))) (call $v_render (call $__eq_i32 (call $v_maxUInt8) (call $v_maxUInt8))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_1 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_1)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_1)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_render (call $__eq_i32 (call $v_maxUInt8) (call $v_minUInt8))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_0)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_0)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s1 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s1)) (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s1)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_render (call $__eq_i32 (call $__box_i32 (i32.const 128)) (call $__box_i32 (i32.const 127)))))))))))))
