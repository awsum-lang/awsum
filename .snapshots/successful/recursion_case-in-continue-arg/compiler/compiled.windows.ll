...
define internal ptr @v_go(ptr %v_n, ptr %v_flag) {
entry:
  %t3 = alloca ptr
  store ptr %v_n, ptr %t3
  %t4 = alloca ptr
  store ptr %v_flag, ptr %t4
  %t2 = alloca ptr
  br label %tco.loop.0
tco.loop.0:
  %t5 = load ptr, ptr %t3
...
tco.case.arm.1.13:
  %t14 = getelementptr ptr, ptr %t6, i32 0
  %t15 = load ptr, ptr %t14
  %t16 = ptrtoint ptr %t15 to i64
  switch i64 %t16, label %tco.case.default.17 [ i64 1, label %tco.case.arm.1.18 i64 2, label %tco.case.arm.2.19 ]
tco.case.arm.1.18:
...
tco.case.arm.2.20:
  ...
  switch i64 %t24, label %tco.case.default.25 [ i64 3, label %tco.case.arm.3.26 i64 4, label %tco.case.arm.4.27 ]
tco.case.arm.3.26:
  ...
  br label %tco.exit.1
tco.case.arm.4.27:
  %t28 = getelementptr ptr, ptr %t21, i32 1
  %t29 = load ptr, ptr %t28
  call void @__inc_ref(ptr %t29)
  %t30 = getelementptr ptr, ptr %t6, i32 0
...
define internal ptr @v_main() {
  ...
  store ptr %t5, ptr %t6
  %t7 = call ptr @v_go(ptr %t3, ptr %t4)
