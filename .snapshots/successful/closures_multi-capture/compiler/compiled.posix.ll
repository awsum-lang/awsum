...
case.arm.1.16:
  ...
  %t19 = load ptr, ptr %t18
  %t20 = call ptr @__showInt32(ptr %v_b)
...
define internal ptr @v__lam_2(ptr %v_a, ptr %v_b, ptr %v__n) {
...
define internal ptr @v__df_apply_0(ptr %v_x, ptr %v__df_apply_0_cap0_0, ptr %v__df_apply_0_cap0_1) {
  %t0 = call ptr @v__lam_2(ptr %v__df_apply_0_cap0_0, ptr %v__df_apply_0_cap0_1, ptr %v_x)
  ret ptr %t0
}
