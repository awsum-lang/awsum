...
(module
  ...
  (table 6 funcref)
  (elem (i32.const 0) $v_runIO $v_both $v_bothBody $v__lam_23 $v__let_24 $v__df_apply_0)
  ...
  (func $v_both (param i32 i32) (result i32)
    (local i32)
    (local i32)
    block (result i32)
      call 16
  ...
  (func $v_bothBody (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v__lam_23 (param i32 i32 i32) (result i32)
    (local i32)
    (local i32)
    block (result i32)
      local.get 0
  ...
  (func $v__df_apply_0 (param i32 i32 i32) (result i32)
    (local i32)
    (local i32)
    block (result i32)
      local.get 1
