...
(module
  ...
  (table 6 funcref)
  (elem (i32.const 0) $v_runIO $v_both $v_bothBody $v__lam_7 $v__let_8 $v__df_apply_0)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    (local $__drop_tmp i32)
    (call $v__let_8 (call $v_both (call $__box_i32 (i32.const 11)) (call $__box_i32 (i32.const 22)))))

  (func $v__lam_7 (param $v_a i32) (param $v_b i32) (param $v__n i32) (result i32)
    (local $__drop_tmp i32)
