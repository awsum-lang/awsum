...
(module
  ...
  (table 7 funcref)
  (elem (i32.const 0) $v_runIO $v_both $v_bothBody $v_main $v__lam_2 $v__let_3 $v__df_apply_0)
  ...
  (func $v_bothBody (param $v_a i32) (param $v_b i32) (result i32)
    ...
    (local $v_s0 i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $__concat (call $__show_i32 (local.get $v_a)) (i32.const 72))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__do_e_15_3 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_15_3)) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__concat (local.get $v_s0) (call $__show_i32 (local.get $v_b)))))))

  (func $v_main (param $v__input i32) (result i32)
    (call $v__let_3 (call $v_both (call $__box_i32 (i32.const 11)) (call $__box_i32 (i32.const 22)))))

  (func $v__lam_2 (param $v_a i32) (param $v_b i32) (param $v__n i32) (result i32)
  ...
  (func $v__df_apply_0 (param $v_x i32) (param $v__df_apply_0_cap0_0 i32) (param $v__df_apply_0_cap0_1 i32) (result i32)
    (call $v__lam_2 (local.get $v__df_apply_0_cap0_0) (local.get $v__df_apply_0_cap0_1) (local.get $v_x)))
