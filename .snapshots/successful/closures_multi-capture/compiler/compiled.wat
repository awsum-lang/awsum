...
(module
  ...
  (func $v_bothBody (param $v_a i32) (param $v_b i32) (result i32)
    ...
    (local $v_s0 i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $__concat (call $__show_i32 (local.get $v_a)) (i32.const 72))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_15_3 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_15_3)) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__concat (local.get $v_s0) (call $__show_i32 (local.get $v_b)))))))
