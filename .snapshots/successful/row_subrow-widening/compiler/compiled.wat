...
(module
  ...
  (table 12 funcref)
  (elem (i32.const 0) $v_runIO $v_sub $v_wide $v_d3 $v__lam_13 $v__lam_14 $v__df_andThenIO_0 $v__cps__df_andThenIO_0 $v__apply__df_andThenIO_0 $v__df_andThenIO_4 $v__cps__df_andThenIO_4 $v__apply__df_andThenIO_4)
