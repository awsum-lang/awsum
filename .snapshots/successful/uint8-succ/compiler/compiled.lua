...
function M.__succUInt8(x) if x == 255 then return {0, {0}} else return {1, x + 1} end end
...
function M.main(v__input)
  return M.__print(table.concat({(M.v_render)(M.__succUInt8(255)), ", ", (M.v_render)(M.__succUInt8(254)), ", ", (M.v_render)(M.__succUInt8(0))}))
end
