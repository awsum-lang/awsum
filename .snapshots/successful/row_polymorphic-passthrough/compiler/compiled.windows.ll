...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [4 x i8]} { i32 0, i32 0, i32 0, i32 4, i32 4, [4 x i8] c"poly" }
...
define internal ptr @v_myId(ptr %v_x) {
  ret ptr %v_x
}

define internal ptr @v_myFirst(ptr %v_x, ptr %v__y) {
...
define internal ptr @v_w() {
  %t0 = call ptr @v_v()
  %t1 = call ptr @v_myId(ptr %t0)
  ret ptr %t1
}

define internal ptr @v_z() {
  %t0 = call ptr @v_v()
  %t1 = call ptr @__alloc(i64 8, i32 0)
  %t2 = inttoptr i64 1 to ptr
  %t3 = getelementptr ptr, ptr %t1, i32 0
  store ptr %t2, ptr %t3
  %t4 = call ptr @v_myFirst(ptr %t0, ptr %t1)
  ret ptr %t4
}
...
define internal ptr @v__scc__apply1__df__lam_5_1__df__lam_6_2__df__lam_7_3__lift_2__lift_25__lift_26__lift_27__lift_3__lift_4(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 36 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_5_1__df__lam_6_2__df__lam_7_3__lift_2__lift_25__lift_26__lift_27__lift_3__lift_4(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_5_1__df__lam_6_2__df__lam_7_3__lift_2__lift_25__lift_26__lift_27__lift_3__lift_4(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_5_1__df__lam_6_2__df__lam_7_3__lift_2__lift_25__lift_26__lift_27__lift_3__lift_4(ptr %t0)
