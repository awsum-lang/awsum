...
define internal ptr @v_c1() {
  %t0 = call ptr @v_oa()
  %t1 = call ptr @v_ob()
  %t2 = call ptr @v__df__rowspec_23_0(ptr %t0, ptr %t1)
  ret ptr %t2
}

define internal ptr @v_c2() {
  %t0 = call ptr @v_oa()
  %t1 = call ptr @v__df__rowspec_25_1(ptr %t0)
  ret ptr %t1
}

define internal ptr @v_de(ptr %v_x) {
...
case.arm.3.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 332136403, label %case.arm.332136403.11 i64 348914022, label %case.arm.348914022.14 ]
case.arm.332136403.11:
...
case.default.10:
  unreachable
case.arm.4.17:
  %t18 = getelementptr ptr, ptr %v_x, i32 1
  %t19 = load ptr, ptr %t18
...
define internal ptr @v_main() {
  ...
  %t14 = call ptr @v__lift_28(ptr %t0)
  %t15 = call ptr @v__df_andThenIO_2(ptr %t14)
  ret ptr %t15
}
...
case.arm.3.4:
  ...
  %t11 = inttoptr i64 348914022 to ptr
...
define internal ptr @v__lam_26(ptr %v__n) {
  %t0 = call ptr @v_ob()
...
define internal ptr @v__df__rowspec_23_0(ptr %v_x, ptr %v__df__rowspec_23_0_cap1_0) {
  %t0 = getelementptr ptr, ptr %v_x, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 3, label %case.arm.3.4 i64 4, label %case.arm.4.15 ]
case.arm.3.4:
  ...
  store ptr %t8, ptr %t9
  %t10 = call ptr @__alloc(i64 16, i32 1)
  %t11 = inttoptr i64 332136403 to ptr
  %t12 = getelementptr ptr, ptr %t10, i32 0
  store ptr %t11, ptr %t12
  call void @__inc_ref(ptr %t6)
  %t13 = getelementptr ptr, ptr %t10, i32 1
  ...
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %v_x)
  call void @__free_recursive(ptr %v__df__rowspec_23_0_cap1_0)
  ret ptr %t7
case.arm.4.15:
  %t16 = getelementptr ptr, ptr %v_x, i32 1
  %t17 = load ptr, ptr %t16
  call void @__inc_ref(ptr %t17)
  call void @__inc_ref(ptr %v__df__rowspec_23_0_cap1_0)
  call void @__inc_ref(ptr %t17)
  %t18 = call ptr @v_const(ptr %v__df__rowspec_23_0_cap1_0, ptr %t17)
...
define internal ptr @v__df__rowspec_25_1(ptr %v_x) {
  %t0 = getelementptr ptr, ptr %v_x, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 3, label %case.arm.3.4 i64 4, label %case.arm.4.15 ]
...
case.arm.4.15:
  ...
  call void @__inc_ref(ptr %t17)
  call void @__inc_ref(ptr %t17)
  %t18 = call ptr @v__lam_26(ptr %t17)
  %t19 = call ptr @v__lift_24(ptr %t18)
  call void @__free_recursive(ptr %t17)
  call void @__free_recursive(ptr %v_x)
  ret ptr %t19
...
tco.case.arm.8.48:
  ...
  %t59 = call ptr @v__apply__df_andThenIO_2(ptr %t6, ptr %t51)
...
tco.case.arm.9.60:
  ...
  %t71 = call ptr @v__apply__df_andThenIO_2(ptr %t6, ptr %t63)
...
tco.case.arm.10.72:
  ...
  %t83 = call ptr @v__apply__df_andThenIO_2(ptr %t6, ptr %t75)
...
define internal ptr @v__scc__apply1__df__lam_5_3__df__lam_6_4__df__lam_7_5__lift_2__lift_29__lift_3__lift_30__lift_31__lift_4(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 50 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_5_3__df__lam_6_4__df__lam_7_5__lift_2__lift_29__lift_3__lift_30__lift_31__lift_4(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_5_3__df__lam_6_4__df__lam_7_5__lift_2__lift_29__lift_3__lift_30__lift_31__lift_4(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 34, label %tco.case.arm.34.11 i64 35, label %tco.case.arm.35.200 i64 36, label %tco.case.arm.36.223 i64 37, label %tco.case.arm.37.246 i64 38, label %tco.case.arm.38.269 i64 39, label %tco.case.arm.39.292 i64 40, label %tco.case.arm.40.315 i64 41, label %tco.case.arm.41.338 i64 42, label %tco.case.arm.42.361 i64 43, label %tco.case.arm.43.384 ]
tco.case.arm.34.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 25, label %tco.case.arm.25.20 i64 26, label %tco.case.arm.26.40 i64 27, label %tco.case.arm.27.60 i64 28, label %tco.case.arm.28.80 i64 29, label %tco.case.arm.29.100 i64 30, label %tco.case.arm.30.120 i64 31, label %tco.case.arm.31.140 i64 32, label %tco.case.arm.32.160 i64 33, label %tco.case.arm.33.180 ]
tco.case.arm.25.20:
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_5_3__df__lam_6_4__df__lam_7_5__lift_2__lift_29__lift_3__lift_30__lift_31__lift_4(ptr %t0)
