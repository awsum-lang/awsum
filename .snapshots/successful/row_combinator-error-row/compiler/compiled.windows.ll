...
define internal ptr @v_c1() {
  ...
  %t4 = inttoptr i64 332136403 to ptr
...
case.arm.3.9:
  ...
  switch i64 %t15, label %case.default.16 [ i64 332136403, label %case.arm.332136403.18 ]
...
case.default.16:
  unreachable
case.join.17:
  %t20 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.332136403.19 ]
...
case.default.7:
  unreachable
case.join.8:
  %t26 = phi ptr [ %t20, %case.end.3.10 ], [ %t25, %case.end.4.22 ]
  ...
  %t39 = call ptr @v_$cps$$df$andThenIO$2(ptr %t0, ptr %t36)
  ret ptr %t39
}

define internal ptr @v_$cps$$df$andThenIO$2(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.5.11:
  ...
  switch i64 %t18, label %case.default.19 [ i64 3, label %case.arm.3.21 i64 4, label %case.arm.4.33 ]
case.arm.3.21:
  ...
  switch i64 %t27, label %case.default.28 [ i64 332136403, label %case.arm.332136403.30 ]
case.arm.332136403.30:
  br label %case.end.332136403.31
case.end.332136403.31:
  br label %case.join.29
case.default.28:
  unreachable
case.join.29:
  %t32 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.332136403.31 ]
...
case.default.19:
  unreachable
case.join.20:
  %t38 = phi ptr [ %t32, %case.end.3.22 ], [ %t37, %case.end.4.34 ]
  call void @__free_recursive(ptr %t15)
  ...
  %t48 = call ptr @v_$apply$$df$andThenIO$2(ptr %t6, ptr %t12)
...
define internal ptr @v_$apply$$df$andThenIO$2(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
