...
define internal ptr @v__lam_13(ptr %v__n) {
  %t0 = call ptr @v_ob()
...
tco.case.arm.5.11:
  ...
  %t15 = call ptr @v__apply__df_andThenIO_2(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t13)
...
tco.case.arm.6.16:
  ...
  %t23 = call ptr @v__apply__df_andThenIO_2(ptr %t6, ptr %t19)
...
tco.case.arm.8.47:
  ...
  %t58 = call ptr @v__apply__df_andThenIO_2(ptr %t6, ptr %t50)
...
tco.case.arm.9.59:
  ...
  %t70 = call ptr @v__apply__df_andThenIO_2(ptr %t6, ptr %t62)
...
tco.case.arm.10.71:
  ...
  %t82 = call ptr @v__apply__df_andThenIO_2(ptr %t6, ptr %t74)
...
define internal ptr @v__scc__apply1__df__lam_0_3__df__lam_1_4__df__lam_2_5(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 34 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_0_3__df__lam_1_4__df__lam_2_5(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_0_3__df__lam_1_4__df__lam_2_5(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 28, label %tco.case.arm.28.11 i64 29, label %tco.case.arm.29.80 i64 30, label %tco.case.arm.30.103 i64 31, label %tco.case.arm.31.126 ]
tco.case.arm.28.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_0_3__df__lam_1_4__df__lam_2_5(ptr %t0)
