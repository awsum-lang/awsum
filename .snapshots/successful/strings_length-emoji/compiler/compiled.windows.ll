...
define internal ptr @v_check(ptr %v_expected, ptr %v_actual, ptr %v_label) {
  ...
  switch i64 %t3, label %case.default.4 [ i64 0, label %case.arm.0.6 i64 1, label %case.arm.1.9 ]
case.arm.0.6:
...
case.default.71:
  unreachable
case.join.72:
  %t86 = phi ptr [%t77, %case.end.0.74], [%t85, %case.end.1.82]
...
case.default.52:
  unreachable
case.join.53:
  %t87 = phi ptr [%t58, %case.end.0.55], [%t86, %case.end.1.63]
...
case.default.34:
  unreachable
case.join.35:
  %t88 = phi ptr [%t40, %case.end.0.37], [%t87, %case.end.1.45]
...
case.default.15:
  unreachable
case.join.16:
  %t89 = phi ptr [%t21, %case.end.0.18], [%t88, %case.end.1.26]
...
case.default.4:
  unreachable
case.join.5:
  %t90 = phi ptr [%t8, %case.end.0.7], [%t89, %case.end.1.10]
  ret ptr %t90
}
