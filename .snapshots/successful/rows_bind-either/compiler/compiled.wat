...
(module
  ...
  (data (i32.const 107) "\0f\00\00\00\0f\00\00\00STRING_TOO_LONG")
  (table 7 funcref)
  ...
  (func $v_opB (param $v__n i32) (result i32)
    (local $__con_0 i32)
    (local $__con_1 i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 4))) (i32.const 20)) (local.get $__con_1))) (local.get $__con_0)))
  ...
  (func $v_run (param $v_x i32) (result i32)
    ...
    (local $v_a i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $v_opA (local.get $v_x))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_19_3 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 2252990199)) (i32.store offset=4 (local.get $__con_1) (local.get $v__do_e_19_3)) (local.get $__con_1))) (local.get $__con_0))) (else (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $v__lift_7 (call $v_opB (local.get $v_a)))))))
  ...
  (func $v__lift_7 (param $v___input i32) (result i32)
    ...
    (local $v___f0 i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v___input)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___f0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 2269767818)) (i32.store offset=4 (local.get $__con_1) (local.get $v___f0)) (local.get $__con_1))) (local.get $__con_0))) (else (local.set $v___f0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (local.get $v___f0)) (local.get $__con_0))))))
