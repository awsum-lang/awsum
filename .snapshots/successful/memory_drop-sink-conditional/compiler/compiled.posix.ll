...
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [1 x i8]} { i32 0, i32 0, i32 0, i32 1, i32 1, [1 x i8] c"p" }
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [1 x i8]} { i32 0, i32 0, i32 0, i32 1, i32 1, [1 x i8] c"q" }
@.str.4 = private unnamed_addr constant {i32, i32, i32, i32, i32, [8 x i8]} { i32 0, i32 0, i32 0, i32 8, i32 8, [8 x i8] c"UNPAIRED" }
...
@.str.6 = private unnamed_addr constant {i32, i32, i32, i32, i32, [4 x i8]} { i32 0, i32 0, i32 0, i32 4, i32 4, [4 x i8] c"skip" }
...
define internal ptr @v_build(ptr %v_n) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.2.21:
  ...
  switch i64 %t25, label %tco.case.default.26 [ i64 3, label %tco.case.arm.3.27 i64 4, label %tco.case.arm.4.37 ]
tco.case.arm.3.27:
  %t28 = call ptr @__alloc(i64 16, i32 1)
  %t29 = inttoptr i64 25 to ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.51 i64 7, label %tco.case.arm.7.53 i64 8, label %tco.case.arm.8.78 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  ...
  store i32 1, ptr %t15
  %t16 = call ptr @v_build(ptr %t15)
  %t17 = getelementptr ptr, ptr %t16, i32 0
  %t18 = load ptr, ptr %t17
  %t19 = ptrtoint ptr %t18 to i64
  switch i64 %t19, label %case.default.20 [ i64 25, label %case.arm.25.22 ]
case.arm.25.22:
  ...
  switch i64 %t30, label %case.default.31 [ i64 13, label %case.arm.13.33 i64 14, label %case.arm.14.37 ]
case.arm.13.33:
  %t35 = getelementptr ptr, ptr %t25, i32 1
  %t36 = load ptr, ptr %t35
  call void @__inc_ref(ptr %t36)
  br label %case.end.13.34
case.end.13.34:
  br label %case.join.32
case.arm.14.37:
  br label %case.end.14.38
case.end.14.38:
  br label %case.join.32
case.default.31:
  unreachable
case.join.32:
  %t39 = phi ptr [ %t36, %case.end.13.34 ], [ getelementptr inbounds (i8, ptr @.str.6, i64 12), %case.end.14.38 ]
  call void @__free_recursive(ptr %t27)
  call void @__free_recursive(ptr %t25)
  br label %case.end.25.23
case.end.25.23:
  br label %case.join.21
case.default.20:
  unreachable
case.join.21:
  %t40 = phi ptr [ %t39, %case.end.25.23 ]
  ...
  %t50 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$4(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t50, ptr %t2
  br label %tco.exit.1
tco.case.arm.6.51:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t52 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$4(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.78:
  ...
  %t89 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$4(ptr %t6, ptr %t81)
