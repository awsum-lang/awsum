...
case.arm.4.58:
  ...
  %t63 = call ptr @v__lift_18(ptr %t62)
...
case.default.44:
  unreachable
case.join.45:
  %t64 = phi ptr [ %t50, %case.end.3.47 ], [ %t63, %case.end.4.59 ]
...
case.default.26:
  unreachable
case.join.27:
  %t65 = phi ptr [ %t32, %case.end.3.29 ], [ %t64, %case.end.4.37 ]
...
case.default.4:
  unreachable
case.join.5:
  %t66 = phi ptr [ %t10, %case.end.3.7 ], [ %t65, %case.end.4.19 ]
