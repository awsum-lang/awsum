...
define internal ptr @v_main() {
  ...
  %t11 = call ptr @v_revInto2(ptr %t4, ptr %t8)
...
case.arm.25.19:
  ...
  switch i64 %t25, label %case.default.26 [ i64 24, label %case.arm.24.28 i64 25, label %case.arm.25.30 ]
case.arm.24.28:
  br label %case.end.24.29
case.end.24.29:
  br label %case.join.27
case.arm.25.30:
  %t32 = getelementptr ptr, ptr %t22, i32 1
  %t33 = load ptr, ptr %t32
  call void @__inc_ref(ptr %t33)
  br label %case.end.25.31
case.end.25.31:
  br label %case.join.27
case.default.26:
  unreachable
case.join.27:
  %t34 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.24.29 ], [ %t33, %case.end.25.31 ]
...
case.default.15:
  unreachable
case.join.16:
  %t35 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.24.18 ], [ %t34, %case.end.25.20 ]
  call void @__free_recursive(ptr %t11)
  %t36 = getelementptr ptr, ptr %t4, i32 0
  %t37 = load ptr, ptr %t36
  %t38 = ptrtoint ptr %t37 to i64
  switch i64 %t38, label %case.default.39 [ i64 24, label %case.arm.24.41 i64 25, label %case.arm.25.43 ]
case.arm.24.41:
  br label %case.end.24.42
case.end.24.42:
  br label %case.join.40
case.arm.25.43:
  %t45 = getelementptr ptr, ptr %t4, i32 2
  %t46 = load ptr, ptr %t45
  call void @__inc_ref(ptr %t46)
  %t47 = getelementptr ptr, ptr %t46, i32 0
  %t48 = load ptr, ptr %t47
  %t49 = ptrtoint ptr %t48 to i64
  switch i64 %t49, label %case.default.50 [ i64 24, label %case.arm.24.52 i64 25, label %case.arm.25.54 ]
case.arm.24.52:
  br label %case.end.24.53
case.end.24.53:
...
case.default.50:
  unreachable
case.join.51:
  %t58 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.24.53 ], [ %t57, %case.end.25.55 ]
  br label %case.end.25.44
case.end.25.44:
  br label %case.join.40
case.default.39:
  unreachable
case.join.40:
  %t59 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.24.42 ], [ %t58, %case.end.25.44 ]
  %t60 = call ptr @__concat(ptr %t35, ptr %t59)
  %t61 = getelementptr ptr, ptr %t60, i32 0
  %t62 = load ptr, ptr %t61
  %t63 = ptrtoint ptr %t62 to i64
  switch i64 %t63, label %case.default.64 [ i64 3, label %case.arm.3.66 i64 4, label %case.arm.4.68 ]
case.arm.3.66:
  br label %case.end.3.67
case.end.3.67:
  br label %case.join.65
case.arm.4.68:
  %t70 = getelementptr ptr, ptr %t60, i32 1
...
case.default.64:
  unreachable
case.join.65:
  %t72 = phi ptr [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.3.67 ], [ %t71, %case.end.4.69 ]
  ...
  %t80 = getelementptr ptr, ptr %t74, i32 1
  store ptr %t77, ptr %t80
  %t81 = getelementptr ptr, ptr %t5, i32 2
