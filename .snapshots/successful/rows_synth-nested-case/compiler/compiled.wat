...
(module
  ...
  (data (i32.const 105) "\00\00\00\00\00\00\00\00\00\00\00\00\03\00\00\00\03\00\00\00yes")
  (data (i32.const 128) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00n")
  (table 2 funcref)
  (elem (i32.const 0) $v_runIO $v_dispatch)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_dispatch (param $v_x i32) (result i32)
    (local $v__s i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (local.set $v__s (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__s)) (block (result i32) (local.set $__drop_tmp (i32.const 96)) (call $__free_recursive (local.get $v__s)) (local.get $__drop_tmp))))
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (block (result i32) (local.set $__scrut (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 1)) (local.get $__con_0))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 11)) (i32.store offset=4 (local.get $__con_0) (i32.const 117)) (local.get $__con_0))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 10)) (local.get $__con_0)))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 10)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (i32.const 140)) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0))) (else (local.set $v_x (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_x)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (call $v_dispatch (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 1615808600)) (i32.store offset=4 (local.get $__con_1) (local.get $v_x)) (call $__inc_ref (i32.load offset=4 (local.get $__con_1))) (local.get $__con_1)))) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0))))))
