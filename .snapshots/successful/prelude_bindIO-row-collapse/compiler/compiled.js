...
(() => {
  ...
  const v__cps__lift_54 = (v___input, v__k) => {
    while (true) {
      switch (v___input[0]) {
        case 5: {
          return v__apply__lift_54(v__k, v___input);
        }
        case 6: {
  ...
  const v__cps__lift_50 = (v___input, v__k) => {
    while (true) {
      switch (v___input[0]) {
        case 5: {
          return v__apply__lift_50(v__k, v___input);
        }
        case 6: {
          const v___f0 = v___input[1];
  ...
  const v__cps__lift_46 = (v___input, v__k) => {
    while (true) {
      switch (v___input[0]) {
        case 5: {
          return v__apply__lift_46(v__k, v___input);
        }
        case 6: {
          const v___f0 = v___input[1];
  ...
  const v__cps__lift_42 = (v___input, v__k) => {
    while (true) {
      switch (v___input[0]) {
        case 5: {
          return v__apply__lift_42(v__k, v___input);
        }
        case 6: {
          const v___f0 = v___input[1];
  ...
  const v__cps__df_bindIO_8 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v__apply__df_bindIO_8(v__k, [5, v_io[1]]);
        }
        case 6: {
          return v__apply__df_bindIO_8(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_nevRightE1 = v__cps__df_bindIO_8(v_seedLeftAIO, [42]);

  const v_nevRightOk = v__cps__df_bindIO_8(v_seedAIO, [42]);

  const v_pureNever = v__cps__df_bindIO_8(v_seedNeverIO, [42]);
  ...
  const v__cps__df_bindIO_4 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v__apply__df_bindIO_4(v__k, [6, [24]]);
        }
        case 6: {
          return v__apply__df_bindIO_4(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_idemE1 = v__cps__df_bindIO_4(v_seedLeftAIO, [40]);

  const v_idemE2 = v__cps__df_bindIO_4(v_seedAIO, [40]);

  const v_nevFail = v__cps__df_bindIO_4(v_seedNeverIO, [40]);
  ...
  const v__cps__df_bindIO_36 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v__apply__df_bindIO_36(v__k, [6, [27]]);
        }
        case 6: {
          return v__apply__df_bindIO_36(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_idem2First = v__cps__df_bindIO_36(v_seedFirstIO, [56]);

  const v_idem2Second = v__cps__df_bindIO_36(v_seedTIO, [56]);
  ...
  const v__cps__df_bindIO_20 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v__apply__df_bindIO_20(v__k, [6, "kS"]);
        }
        case 6: {
          return v__apply__df_bindIO_20(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_strIdem = v__cps__df_bindIO_20(v_seedSIO, [48]);
  ...
  const v__cps__df_bindIO_0 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v__apply__df_bindIO_0(v__k, [5, v_io[1]]);
        }
        case 6: {
          return v__apply__df_bindIO_0(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_nevOk = v__cps__df_bindIO_0(v_seedNeverIO, [38]);
      ...
      switch (v_io[0]) {
        case 5: {
          return v__apply__df__rowmono_8_bindIO_32(
            v__k,
            v__cps__lift_46([6, [24]], [32])
          );
        }
        case 6: {
          const v_e = v_io[1];
          return v__apply__df__rowmono_8_bindIO_32(v__k, [6, [925038822, v_e]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_twoE2 = v__cps__df__rowmono_8_bindIO_32(v_seedTIO, [54]);
      ...
      switch (v_io[0]) {
        case 5: {
          return v__apply__df__rowmono_8_bindIO_28(
            v__k,
            v__cps__lift_46([5, v_io[1]], [32])
          );
        }
        case 6: {
          const v_e = v_io[1];
          return v__apply__df__rowmono_8_bindIO_28(v__k, [6, [925038822, v_e]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_twoFirst = v__cps__df__rowmono_8_bindIO_28(v_seedFirstIO, [52]);

  const v_twoOk = v__cps__df__rowmono_8_bindIO_28(v_seedTIO, [52]);

  const v_twoSecond = v__cps__df__rowmono_8_bindIO_28(v_seedSecondIO, [52]);
  ...
  const v_abE1 = v__cps__df__rowmono_4_bindIO_24(v_seedLeftAIO, [50]);

  const v_abE2 = v__cps__df__rowmono_4_bindIO_24(v_seedAIO, [50]);
  ...
  const v__cps__df__rowmono_23_andThenIO_104 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 6: {
          return v__apply__df__rowmono_23_andThenIO_104(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v__cps__df__rowmono_22_andThenIO_96 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 6: {
          return v__apply__df__rowmono_22_andThenIO_96(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
            ...
            v__cps__df_andThenIO_108(
              v__cps__df_andThenIO_112(
                ...
                v__cps__df_handleErrorIO_92(
                  v__cps__df__rowmono_22_andThenIO_96(
  ...
  const v__cps__df__rowmono_21_andThenIO_88 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 6: {
          return v__apply__df__rowmono_21_andThenIO_88(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
            ...
            v__cps__df_andThenIO_108(
              v__cps__df_andThenIO_112(
                ...
                v__cps__df_handleErrorIO_84(
                  v__cps__df__rowmono_21_andThenIO_88(
  ...
  const v__cps__df__rowmono_20_andThenIO_80 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 6: {
          return v__apply__df__rowmono_20_andThenIO_80(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
      ...
      switch (v_io[0]) {
        case 5: {
          return v__apply__df__rowmono_12_bindIO_52(
            v__k,
            v__cps__lift_50([6, [24]], [34])
          );
        }
        case 6: {
          return v__apply__df__rowmono_12_bindIO_52(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_wE3 = v__cps__df__rowmono_12_bindIO_52(
    v__cps__df__rowmono_16_bindIO_44(v_seedTIO, [60]),
    [64]
  );
            ...
            v__cps__df_andThenIO_108(
              v__cps__df_andThenIO_112(
                ...
                v__cps__df_handleErrorIO_100(
                  v__cps__df__rowmono_23_andThenIO_104(
      ...
      switch (v_io[0]) {
        case 5: {
          return v__apply__df__rowmono_12_bindIO_40(
            v__k,
            v__cps__lift_50([5, v_io[1]], [34])
          );
        }
        case 6: {
          return v__apply__df__rowmono_12_bindIO_40(v__k, v_io);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_wE1 = v__cps__df__rowmono_12_bindIO_40(
    v__cps__df__rowmono_16_bindIO_44(v_seedFirstIO, [60]),
    [58]
  );
  ...
  const v_wE2str = v__cps__df__rowmono_12_bindIO_40(
    v__cps__df__rowmono_16_bindIO_48(v_seedTIO, [62]),
    [58]
  );
  ...
  const v_wOk = v__cps__df__rowmono_12_bindIO_40(
    v__cps__df__rowmono_16_bindIO_44(v_seedTIO, [60]),
    [58]
  );
  ...
  const v_strE2 = v__cps__df__rowmono_0_bindIO_16(v_seedSIO, [46]);
            ...
            v__cps__df_andThenIO_108(
              v__cps__df_andThenIO_112(
                ...
                v__cps__df_handleErrorIO_76(
                  v__cps__df__rowmono_20_andThenIO_80(
  ...
  const v_strE1 = v__cps__df__rowmono_0_bindIO_12(v_seedLeftSIO, [44]);
  ...
  const v_strOk = v__cps__df__rowmono_0_bindIO_12(v_seedSIO, [44]);
