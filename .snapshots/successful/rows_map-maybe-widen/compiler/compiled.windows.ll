...
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"just-bool" }
...
tco.case.arm.8.18:
  ...
  %t30 = call ptr @v_$cps$$scc$$apply1__$df$$lam$13$6__$df$$lam$9$2(ptr %t20, ptr %t27)
...
define internal ptr @v_main() {
  ...
  store ptr %t8, ptr %t9
  %t10 = call ptr @v_$cps$$df$$rowmono$0$andThenIO$5(ptr %t0, ptr %t7)
  %t11 = call ptr @__alloc(i64 8, i32 0)
  %t12 = inttoptr i64 21 to ptr
  %t13 = getelementptr ptr, ptr %t11, i32 0
  store ptr %t12, ptr %t13
  %t14 = call ptr @v_$cps$$df$handleErrorIO$1(ptr %t10, ptr %t11)
  ret ptr %t14
}
...
case.join.20:
  ...
  call void @__free_recursive(ptr %t15)
  %t50 = call ptr @v_$apply$$df$handleErrorIO$1(ptr %t6, ptr %t49)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.76:
  ...
  %t87 = call ptr @v_$apply$$df$handleErrorIO$1(ptr %t6, ptr %t79)
...
define internal ptr @v_$cps$$df$$rowmono$0$andThenIO$5(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
  store ptr %v_$k, ptr %t4
  %v_$inl15$scrut.jslot = alloca ptr
  %t2 = alloca ptr
  br label %tco.loop.0
tco.loop.0:
  %t5 = load ptr, ptr %t3
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.69 i64 7, label %tco.case.arm.7.71 i64 8, label %tco.case.arm.8.96 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  ...
  switch i64 %t19, label %case.default.20 [ i64 13, label %case.arm.13.22 i64 14, label %case.arm.14.27 ]
case.arm.13.22:
  %t24 = call ptr @__alloc(i64 8, i32 0)
  %t25 = inttoptr i64 11 to ptr
...
case.arm.14.27:
  ...
  br label %case.end.14.28
case.end.14.28:
  br label %case.join.21
case.default.20:
  unreachable
case.join.21:
  %t36 = phi ptr [ %t24, %case.end.13.23 ], [ %t29, %case.end.14.28 ]
  call void @__free_recursive(ptr %t16)
  %t39 = getelementptr ptr, ptr %t36, i32 0
  %t40 = load ptr, ptr %t39
  %t41 = ptrtoint ptr %t40 to i64
  switch i64 %t41, label %join.case.default.42 [ i64 11, label %join.case.arm.11.43 i64 12, label %join.case.arm.12.44 ]
join.case.arm.11.43:
  call void @__inc_ref(ptr %t36)
  store ptr %t36, ptr %v_$inl15$scrut.jslot
  br label %join.37
join.case.arm.12.44:
  br label %join.val.45
join.val.45:
  br label %join.after.38
join.case.default.42:
  unreachable
join.37:
  %t46 = load ptr, ptr %v_$inl15$scrut.jslot
  %t47 = getelementptr ptr, ptr %t46, i32 0
  %t48 = load ptr, ptr %t47
  %t49 = ptrtoint ptr %t48 to i64
  switch i64 %t49, label %case.default.50 [ i64 11, label %case.arm.11.52 i64 12, label %case.arm.12.54 ]
case.arm.11.52:
  br label %case.end.11.53
case.end.11.53:
  br label %case.join.51
case.arm.12.54:
  br label %case.end.12.55
case.end.12.55:
  br label %case.join.51
case.default.50:
  unreachable
case.join.51:
  %t56 = phi ptr [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.11.53 ], [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.12.55 ]
  call void @__free_recursive(ptr %t46)
  br label %join.end.57
join.end.57:
  br label %join.after.38
join.after.38:
  %t58 = phi ptr [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %join.val.45 ], [ %t56, %join.end.57 ]
  ...
  %t68 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$5(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.69:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t70 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$5(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$df$$rowmono$0$andThenIO$5(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
define internal ptr @v_$cps$$scc$$apply1__$df$$lam$13$6__$df$$lam$9$2(ptr %v_$args, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
case.join.41:
  ...
  %t59 = call ptr @v_$apply$$scc$$apply1__$df$$lam$13$6__$df$$lam$9$2(ptr %t6, ptr %t58)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$scc$$apply1__$df$$lam$13$6__$df$$lam$9$2(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.26.12:
  ...
  %t18 = call ptr @v_$cps$$df$$rowmono$0$andThenIO$5(ptr %t6, ptr %t15)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  store ptr %t14, ptr %t3
...
tco.case.arm.27.19:
  ...
  %t25 = call ptr @v_$cps$$df$handleErrorIO$1(ptr %t6, ptr %t22)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
