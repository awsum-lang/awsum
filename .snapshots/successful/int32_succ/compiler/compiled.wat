...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_7 (block (result i32) (local.set $__scrut (call $v_render (call $__succInt32 (call $__box_i32 (i32.const 42))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_12_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_12_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_12_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (block (result i32) (local.set $__scrut (call $v_render (call $__succInt32 (block (result i32) (local.set $__inc_tmp (call $v_maxInt32)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_13_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_13_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_13_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_b (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 183))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_14_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_14_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_14_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_b)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))))))))))))
