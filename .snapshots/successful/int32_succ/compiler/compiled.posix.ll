...
case.arm.1.36:
  ...
  %t40 = call ptr @__concat(ptr %t19, ptr @.str.3)
...
case.default.44:
  unreachable
case.join.45:
  %t59 = phi ptr [%t50, %case.end.0.47], [%t58, %case.end.1.55]
...
case.default.26:
  unreachable
case.join.27:
  %t60 = phi ptr [%t32, %case.end.0.29], [%t59, %case.end.1.37]
...
case.default.6:
  unreachable
case.join.7:
  %t61 = phi ptr [%t12, %case.end.0.9], [%t60, %case.end.1.17]
  %t62 = call ptr @v__let_2(ptr %t61)
  ret ptr %t62
}
