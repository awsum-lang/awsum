...
(() => {
  ...
  const v__cps__lift_19 = (v___input, v__k) => {
    while (true) {
      switch (v___input[0]) {
        case 5: {
          return v__apply__lift_19(v__k, v___input);
        }
        case 6: {
  ...
  const v__cps__df_handleErrorIO_0 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 6: {
          return v__apply__df_handleErrorIO_0(v__k, [7, "err", [5, [0]]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
            ...
            v__cps__lift_19(
              (v__inl4_x_u1 =>
                (s => {
                  switch (s[0]) {
                    case 3: {
                      return [6, v__inl4_x_u1[1]];
                    }
                    case 4: {
                      return [5, v__inl4_x_u1[1]];
                    }
                  }
                })(v__inl4_x_u1))(__succInt32(v_io[1])),
              [8]
            )
          );
        }
      ...
      v__cps__df__rowmono_1_andThenIO_8(
        (v__inl9_x_u1 =>
          (s => {
            switch (s[0]) {
              case 3: {
                return [6, v__inl9_x_u1[1]];
              }
              case 4: {
                return [5, v__inl9_x_u1[1]];
              }
            }
          })(v__inl9_x_u1))([4, 6 | 0]),
        [14]
