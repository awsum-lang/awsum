...
(module
  ...
  (func $v_main (export "v_main") (param $v_input i32) (result i32)
    (local $__con i32)
    (call $__print (call $__concat (call $__concat (call $__concat (call $__concat (call $v_show (block (result i32) (i32.store (local.tee $__con (call $__alloc (i32.const 4))) (i32.const 0)) (local.get $__con))) (i32.const 80)) (call $v_show (block (result i32) (i32.store (local.tee $__con (call $__alloc (i32.const 4))) (i32.const 1)) (local.get $__con)))) (i32.const 80)) (call $v_show (block (result i32) (i32.store (local.tee $__con (call $__alloc (i32.const 4))) (i32.const 2)) (local.get $__con))))))
