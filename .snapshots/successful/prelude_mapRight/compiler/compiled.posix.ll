...
define internal ptr @v__let_7(ptr %v_msg) {
...
define internal ptr @v__let_9(ptr %v_mappedOk, ptr %v_mappedBad) {
...
case.default.12:
  unreachable
case.join.13:
  %t20 = phi ptr [%t16, %case.end.19.15]
...
case.arm.4.11:
  ...
  store ptr %t15, ptr %t16
  call void @__inc_ref(ptr %t13)
  %t17 = call ptr @v__lam_10(ptr %t13)
