...
(module
  ...
  (data (i32.const 119) "\00\00\00\00\00\00\00\00\00\00\00\00\06\00\00\00\06\00\00\00ok-Err")
  (data (i32.const 145) "\00\00\00\00\00\00\00\00\00\00\00\00\09\00\00\00\09\00\00\00ok-Right ")
  (data (i32.const 174) "\00\00\00\00\00\00\00\00\00\00\00\00\09\00\00\00\09\00\00\00bad-Right")
  (table 8 funcref)
  (elem (i32.const 0) $v_runIO $v__let_7 $v__lam_8 $v__let_9 $v__lam_10 $v__let_11 $v__df_mapRight_0 $v__df_mapRight_1)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_ok (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 10))) (local.get $__con_0)))

  (func $v_bad (result i32)
    (local $__con_0 i32)
    (local $__con_1 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 19)) (local.get $__con_1))) (local.get $__con_0)))

  (func $v_main (result i32)
    (local $__drop_tmp i32)
    (call $v__let_11 (call $v__df_mapRight_0 (block (result i32) (local.set $__inc_tmp (call $v_ok)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))))
  ...
  (func $v__let_9 (param $v_mappedOk i32) (param $v_mappedBad i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_7 (block (result i32) (local.set $__scrut (local.get $v_mappedOk)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___p0)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 131)) (local.get $__con_0)))) (call $__free_recursive (local.get $v___p0)) (local.get $__drop_tmp))) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_n)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v_mappedBad)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___p0)) (call $__concat (i32.const 157) (call $__show_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))))) (call $__free_recursive (local.get $v___p0)) (local.get $__drop_tmp))) (else (local.set $v__m (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__m)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 186)) (local.get $__con_0))) (call $__free_recursive (local.get $v__m)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_n)) (local.get $__drop_tmp)))))))

  (func $v__lam_10 (param $v_n i32) (result i32)
    (local $__drop_tmp i32)
    (local.get $v_n))

  (func $v__let_11 (param $v_mappedOk i32) (result i32)
    (local $__drop_tmp i32)
    (call $v__let_9 (block (result i32) (local.set $__inc_tmp (local.get $v_mappedOk)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v__df_mapRight_1 (block (result i32) (local.set $__inc_tmp (call $v_bad)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))))

  (func $v__df_mapRight_0 (param $v_x i32) (result i32)
    (local $__con_0 i32)
    (local $v_a i32)
    (local $v_e i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_e)) (local.get $__drop_tmp))) (else (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $v__lam_10 (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (local.get $__con_0))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))))

  (func $v__df_mapRight_1 (param $v_x i32) (result i32)
    (local $__con_0 i32)
    (local $v_a i32)
    (local $v_e i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_e)) (local.get $__drop_tmp))) (else (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $v__lam_8 (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (local.get $__con_0))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))))
