...
(module
  ...
  (table 8 funcref)
  (elem (i32.const 0) $v_runIO $v__let_12 $v__lam_13 $v__let_14 $v__lam_15 $v__let_16 $v__df_mapRight_0 $v__df_mapRight_1)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_bad (result i32)
    ...
    (local $__con_1 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 22)) (local.get $__con_1))) (local.get $__con_0)))

  (func $v_main (result i32)
    (local $__drop_tmp i32)
    (call $v__let_16 (call $v__df_mapRight_0 (call $v_ok))))
  ...
  (func $v__lam_13 (param $v_n i32) (result i32)
    (local $__drop_tmp i32)
    (local.get $v_n))

  (func $v__let_14 (param $v_mappedOk i32) (param $v_mappedBad i32) (result i32)
    (local $__con_0 i32)
    (local $v___p0 i32)
    (local $v__m i32)
    (local $v_n i32)
  ...
  (func $v__df_mapRight_1 (param $v_x i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_e)) (local.get $__drop_tmp))) (else (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $v__lam_13 (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (local.get $__con_0))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))))
