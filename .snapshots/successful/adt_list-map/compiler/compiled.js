...
(() => {
  ...
  const v_shout = v_s => __concat(v_s, "!");
            ...
            const v_t = __s[2];
            {
              ...
              switch (__s[0]) {
                ...
                case 4: {
                  const v_hStr = __s[1];
                  const __t0 = [15, v_t];
                  const __t1 = (v__args[0] = 20, v__args[1] = v__k, v__args[2] = v_hStr, v__args);
                  v__args = __t0;
                  v__k = __t1;
                  continue;
                }
  ...
  const v__scc_show_showCons = v__args =>
    v__cps__scc_show_showCons(v__args, [19]);
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          ...
          case 14: {
            ...
            const v_tail = __s[2];
            const __t0 = v_tail;
            const __t1 = (v_list[0] = 18, v_list[1] = v__k, v_list[2] = v_head, v_list);
            v_list = __t0;
            v__k = __t1;
            continue;
          }
  ...
  const v__df_map_0 = v_list => v__cps__df_map_0(v_list, [17]);
