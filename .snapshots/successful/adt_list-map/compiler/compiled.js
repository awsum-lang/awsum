          ...
          const v_t = __s[2];
          {
            ...
            switch (__s[0]) {
              ...
              case 4: {
                const v_hStr = __s[1];
                const __t0 = [15, v_t];
                const __t1 = (v__args[0] = 22, v__args[1] = v__k, v__args[2] = v_hStr, v__args);
                v__args = __t0;
                v__k = __t1;
                continue;
              }
...
const v__scc_show_showCons = (v__args) => {
    return (v__cps__scc_show_showCons)(v__args, [21]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 20: {
          ...
          const v_head = __s[2];
          const __t0 = v__pk_20;
          const __t1 = (v__k[0] = 14, v__k[1] = (v_shout)(v_head), v__k[2] = v__x, v__k);
          v__k = __t0;
          v__x = __t1;
          continue;
        }
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        case 13: {
          return (v__apply__df_map_0)(v__k, [13]);
        }
        case 14: {
          const v_head = __s[1];
          const v_tail = __s[2];
          const __t0 = v_tail;
          const __t1 = (v_list[0] = 20, v_list[1] = v__k, v_list[2] = v_head, v_list);
          v_list = __t0;
          v__k = __t1;
          continue;
        }
...
const v__df_map_0 = (v_list) => {
    return (v__cps__df_map_0)(v_list, [19]);
};

const main = (v__let_24)((v_show)((v__df_map_0)([14, "a", [14, "b", [14, "c", (v__lift_23)([13])]]])));
