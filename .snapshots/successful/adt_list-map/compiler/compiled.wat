...
(module
  ...
  (table 10 funcref)
  (elem (i32.const 0) $v_runIO $v_shout $v__let_13 $v__df_map_0 $v__cps__df_map_0 $v__apply__df_map_0 $v__scc_show_showCons $v__cps__scc_show_showCons $v__apply__scc_show_showCons $v_show)
