...
(module
  ...
  (table 13 funcref)
  (elem (i32.const 0) $v_runIO $v_shout $v__lift_23 $v__cps__lift_23 $v__apply__lift_23 $v__let_24 $v__df_map_0 $v__cps__df_map_0 $v__apply__df_map_0 $v__scc_show_showCons $v__cps__scc_show_showCons $v__apply__scc_show_showCons $v_show)
  ...
  (func $v_shout (param i32) (result i32)
    (local i32)
    (local i32)
    block (result i32)
      local.get 0
  ...
  (func $v__df_map_0 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
  ...
  (func $v__scc_show_showCons (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
