...
tco.case.arm.1.34:
  ...
  switch i64 %t41, label %tco.case.default.42 [ i64 0, label %tco.case.arm.0.43 i64 1, label %tco.case.arm.1.51 ]
tco.case.arm.0.43:
...
tco.case.arm.1.28:
  ...
  switch i64 %t34, label %tco.case.default.35 [ i64 0, label %tco.case.arm.0.36 i64 1, label %tco.case.arm.1.43 ]
tco.case.arm.0.36:
