...
define internal ptr @v_res() {
  ...
  %t24 = call ptr @v_$cps$$df$map$0(ptr %t3, ptr %t21)
  %t25 = getelementptr ptr, ptr %t0, i32 1
  store ptr %t24, ptr %t25
  %t26 = call ptr @__alloc(i64 8, i32 0)
  %t27 = inttoptr i64 28 to ptr
  %t28 = getelementptr ptr, ptr %t26, i32 0
  store ptr %t27, ptr %t28
  %t29 = call ptr @v_$cps$$scc$show__showCons(ptr %t0, ptr %t26)
  ret ptr %t29
}
...
define internal ptr @v_$cps$$df$map$0(ptr %v_list, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.13.11:
  ...
  %t12 = call ptr @v_$apply$$df$map$0(ptr %t6, ptr %t5)
...
define internal ptr @v_$apply$$df$map$0(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.23.12:
  ...
  call void @__inc_ref(ptr %t16)
  %t17 = call ptr @__concat(ptr %t16, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
...
define internal ptr @v_$cps$$scc$show__showCons(ptr %v_$args, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 20, label %tco.case.arm.20.11 i64 21, label %tco.case.arm.21.45 ]
tco.case.arm.20.11:
...
tco.case.arm.13.18:
  ...
  %t23 = call ptr @v_$apply$$scc$show__showCons(ptr %t6, ptr %t19)
...
tco.case.arm.3.54:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t47)
  %t55 = call ptr @v_$apply$$scc$show__showCons(ptr %t6, ptr %t47)
...
define internal ptr @v_$apply$$scc$show__showCons(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
