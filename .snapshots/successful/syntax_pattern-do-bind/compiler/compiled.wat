...
(module
  ...
  (table 4 funcref)
  (elem (i32.const 0) $v_pureEither $v_opTuple $v_main $v__let_1)
  ...
  (func $v__let_1 (param $v_res i32) (result i32)
    ...
    (local $v_n i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_res)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v_e)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 502975519)) (then (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (call $__print (i32.const 65))) (else (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 589989748)) (then (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (call $__print (i32.const 90))) (else (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (call $__print (i32.const 106)))))))) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (call $__print (call $__show_i32 (local.get $v_n)))))))
