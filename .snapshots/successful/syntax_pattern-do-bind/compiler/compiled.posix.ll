...
case.join.5:
  ...
  %t64 = call ptr @v__let_12(ptr %t63)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 23, label %tco.case.arm.23.11 i64 24, label %tco.case.arm.24.143 i64 25, label %tco.case.arm.25.166 i64 26, label %tco.case.arm.26.189 i64 27, label %tco.case.arm.27.212 i64 28, label %tco.case.arm.28.235 i64 29, label %tco.case.arm.29.258 ]
tco.case.arm.23.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 36, label %tco.case.arm.36.11 i64 37, label %tco.case.arm.37.12 i64 38, label %tco.case.arm.38.16 i64 39, label %tco.case.arm.39.20 i64 40, label %tco.case.arm.40.24 i64 41, label %tco.case.arm.41.28 i64 42, label %tco.case.arm.42.32 ]
tco.case.arm.36.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
