...
case.join.5:
  ...
  %t64 = call ptr @v__let_18(ptr %t63)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 27, label %tco.case.arm.27.11 i64 28, label %tco.case.arm.28.203 i64 29, label %tco.case.arm.29.226 i64 30, label %tco.case.arm.30.249 i64 31, label %tco.case.arm.31.272 i64 32, label %tco.case.arm.32.295 i64 33, label %tco.case.arm.33.318 i64 34, label %tco.case.arm.34.341 i64 35, label %tco.case.arm.35.364 i64 36, label %tco.case.arm.36.387 ]
tco.case.arm.27.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 43, label %tco.case.arm.43.11 i64 44, label %tco.case.arm.44.12 i64 45, label %tco.case.arm.45.16 i64 46, label %tco.case.arm.46.20 i64 47, label %tco.case.arm.47.24 i64 48, label %tco.case.arm.48.28 i64 49, label %tco.case.arm.49.32 i64 50, label %tco.case.arm.50.36 i64 51, label %tco.case.arm.51.40 i64 52, label %tco.case.arm.52.44 ]
tco.case.arm.43.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
