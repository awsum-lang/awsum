  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 8: {
          const v___f0 = __s[1];
          return (v__apply__lift_20)(v__k, [8, [23, v___f0]]);
        }
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_20)(v__k, [9, [24, v___f0]]);
        }
      }
    }
  }
...
const v__lift_20 = (v___input) => {
    return (v__cps__lift_20)(v___input, [36]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 6: {
          const v___f0 = __s[1];
          return (v__apply__lift_17)(v__k, [6, [3801428867, v___f0]]);
        }
        case 7: {
          const v___f0 = __s[1];
          const v___f1 = __s[2];
        ...
        case 8: {
          const v___f0 = __s[1];
          return (v__apply__lift_17)(v__k, [8, [21, v___f0]]);
        }
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_17)(v__k, [9, [22, v___f0]]);
        }
      }
    }
  }
...
const v__lift_17 = (v___input) => {
    return (v__cps__lift_17)(v___input, [34]);
};
...
const v__df_handleErrorIO_0 = (v_io) => {
    return (v__cps__df_handleErrorIO_0)(v_io, [38]);
};

const v__apply__df__rowspec_16_3 = (v__k, v__x) => {
  while (true) {
    {
      const __s = v__k;
      switch (__s[0]) {
...
const v__cps__df__rowspec_16_3 = (v_io, v__k) => {
  while (true) {
    {
      const __s = v_io;
      switch (__s[0]) {
        case 5: {
          const v_a = __s[1];
          return (v__apply__df__rowspec_16_3)(v__k, (v__lift_17)((v_processArgs)(v_a)));
        }
        case 6: {
          const v_e = __s[1];
          return (v__apply__df__rowspec_16_3)(v__k, [6, v_e]);
        }
        case 7: {
          const v_s = __s[1];
          const v_next = __s[2];
        ...
        case 8: {
          const v_cont = __s[1];
          return (v__apply__df__rowspec_16_3)(v__k, [8, [18, v_cont]]);
        }
        case 9: {
          const v_cont = __s[1];
          return (v__apply__df__rowspec_16_3)(v__k, [9, [19, v_cont]]);
        }
      }
    }
  }
...
const v__df__rowspec_16_3 = (v_io) => {
    return (v__cps__df__rowspec_16_3)(v_io, [40]);
};

const v__apply__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_23_4__df__lam_24_5__lift_18__lift_19__lift_21__lift_22 = (v__k, v__x) => {
  while (true) {
    {
      const __s = v__k;
      switch (__s[0]) {
        ...
        case 45: {
          ...
          const __t0 = v__pk_45;
          const __t1 = (v__df__rowspec_16_3)((v__lift_20)(v__x));
          v__k = __t0;
          v__x = __t1;
          continue;
        }
...
const v__cps__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_23_4__df__lam_24_5__lift_18__lift_19__lift_21__lift_22 = (v__args, v__k) => {
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
        case 25: {
          ...
          const v__arg0 = __s[2];
          {
            ...
            switch (__s[0]) {
              ...
              case 20: {
                return (v__apply__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_23_4__df__lam_24_5__lift_18__lift_19__lift_21__lift_22)(v__k, (v__io_getargs_cont)(v__arg0));
              }
              case 21: {
                const v__cap21_0 = __s[1];
                const __t0 = (v__args[0] = 30, v__args[1] = v__cap21_0, v__args[2] = v__arg0, v__args);
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
              ...
              case 22: {
                ...
                const __t0 = (v__args[0] = 31, v__args[1] = v__cap22_0, v__args[2] = v__arg0, v__args);
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
              ...
              case 23: {
                ...
                const __t0 = (v__args[0] = 32, v__args[1] = v__cap23_0, v__args[2] = v__arg0, v__args);
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
              ...
              case 24: {
                ...
                const __t0 = (v__args[0] = 33, v__args[1] = v__cap24_0, v__args[2] = v__arg0, v__args);
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
        ...
        case 30: {
          const v___f = __s[1];
          const v___arg = __s[2];
          const __t0 = (v__args[0] = 25, v__args[1] = v___f, v__args[2] = v___arg, v__args);
          const __t1 = [47, v__k];
          v__args = __t0;
          v__k = __t1;
          continue;
...
const v__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_23_4__df__lam_24_5__lift_18__lift_19__lift_21__lift_22 = (v__args) => {
    return (v__cps__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_23_4__df__lam_24_5__lift_18__lift_19__lift_21__lift_22)(v__args, [42]);
};

const v__apply1 = (v__cl, v__arg0) => {
    return (v__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_23_4__df__lam_24_5__lift_18__lift_19__lift_21__lift_22)([25, v__cl, v__arg0]);
};
...
const main = (v__df_handleErrorIO_0)((v__df__rowspec_16_3)([8, [20]]));
