...
case.join.5:
  ...
  %t64 = call ptr @v__let_13(ptr %t63)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 24, label %tco.case.arm.24.11 i64 25, label %tco.case.arm.25.143 i64 26, label %tco.case.arm.26.166 i64 27, label %tco.case.arm.27.189 i64 28, label %tco.case.arm.28.212 i64 29, label %tco.case.arm.29.235 i64 30, label %tco.case.arm.30.258 ]
tco.case.arm.24.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 17, label %tco.case.arm.17.20 i64 18, label %tco.case.arm.18.40 i64 19, label %tco.case.arm.19.60 i64 20, label %tco.case.arm.20.80 i64 21, label %tco.case.arm.21.100 i64 22, label %tco.case.arm.22.120 i64 23, label %tco.case.arm.23.140 ]
tco.case.arm.17.20:
