...
case.arm.0.5:
  ...
  switch i64 %t11, label %case.default.12 [ i64 502975519, label %case.arm.502975519.14 i64 589989748, label %case.arm.589989748.38 i64 2448244154, label %case.arm.2448244154.62 ]
...
case.join.46:
  ...
  br label %case.end.589989748.39
case.end.589989748.39:
  br label %case.join.13
...
case.default.12:
  unreachable
case.join.13:
  %t86 = phi ptr [%t37, %case.end.502975519.15], [%t61, %case.end.589989748.39], [%t85, %case.end.2448244154.63]
  br label %case.end.0.6
case.end.0.6:
  br label %case.join.4
case.arm.1.87:
