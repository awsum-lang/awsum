...
tco.case.arm.10.18:
  ...
  %t28 = inttoptr i64 36 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @v_$cps$$scc$$apply1__$df$$lam$11$4__$df$$lam$2$12__$df$$lam$2$8(ptr %t20, ptr %t27)
...
define internal ptr @v_$cps$bytesToHexStringNoPrefix(ptr %v_bytes, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.13.11:
  ...
  %t16 = call ptr @v_$apply$bytesToHexStringNoPrefix(ptr %t6, ptr %t12)
...
define internal ptr @v_$apply$bytesToHexStringNoPrefix(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
...
define internal ptr @v_main() {
  ...
  %t8 = inttoptr i64 34 to ptr
  %t9 = getelementptr ptr, ptr %t7, i32 0
  store ptr %t8, ptr %t9
  %t10 = call ptr @v_$cps$$df$andThenIO$9(ptr %t0, ptr %t7)
  %t11 = call ptr @__alloc(i64 8, i32 0)
  %t12 = inttoptr i64 32 to ptr
  %t13 = getelementptr ptr, ptr %t11, i32 0
  store ptr %t12, ptr %t13
  %t14 = call ptr @v_$cps$$df$andThenIO$5(ptr %t10, ptr %t11)
  %t15 = call ptr @__alloc(i64 8, i32 0)
  %t16 = inttoptr i64 30 to ptr
  %t17 = getelementptr ptr, ptr %t15, i32 0
  store ptr %t16, ptr %t17
  %t18 = call ptr @v_$cps$$df$handleErrorIO$1(ptr %t14, ptr %t15)
  ret ptr %t18
}

define internal ptr @v_$cps$$df$handleErrorIO$1(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.13 i64 7, label %tco.case.arm.7.27 i64 10, label %tco.case.arm.10.52 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t12 = call ptr @v_$apply$$df$handleErrorIO$1(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.13:
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.1, i64 12), ptr %t17
  ...
  %t26 = call ptr @v_$apply$$df$handleErrorIO$1(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.10.52:
  ...
  %t63 = call ptr @v_$apply$$df$handleErrorIO$1(ptr %t6, ptr %t55)
...
define internal ptr @v_$apply$$df$handleErrorIO$1(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
define internal ptr @v_$cps$$df$andThenIO$5(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.27 i64 7, label %tco.case.arm.7.29 i64 10, label %tco.case.arm.10.54 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  ...
  store ptr %t18, ptr %t25
  %t26 = call ptr @v_$apply$$df$andThenIO$5(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t26, ptr %t2
  br label %tco.exit.1
tco.case.arm.6.27:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t28 = call ptr @v_$apply$$df$andThenIO$5(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.10.54:
  ...
  %t65 = call ptr @v_$apply$$df$andThenIO$5(ptr %t6, ptr %t57)
...
define internal ptr @v_$apply$$df$andThenIO$5(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
define internal ptr @v_$cps$$df$andThenIO$9(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.41 i64 7, label %tco.case.arm.7.43 i64 10, label %tco.case.arm.10.68 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  ...
  %t16 = getelementptr ptr, ptr %t14, i32 0
  store ptr %t15, ptr %t16
  %t17 = call ptr @v_$cps$bytesToHexStringNoPrefix(ptr %t13, ptr %t14)
  %t18 = getelementptr ptr, ptr %t17, i32 0
  %t19 = load ptr, ptr %t18
  %t20 = ptrtoint ptr %t19 to i64
  switch i64 %t20, label %case.default.21 [ i64 3, label %case.arm.3.23 i64 4, label %case.arm.4.31 ]
case.arm.3.23:
  %t25 = call ptr @__alloc(i64 16, i32 1)
  %t26 = inttoptr i64 6 to ptr
  %t27 = getelementptr ptr, ptr %t25, i32 0
  store ptr %t26, ptr %t27
  %t28 = getelementptr ptr, ptr %t17, i32 1
  %t29 = load ptr, ptr %t28
  call void @__inc_ref(ptr %t29)
...
case.arm.4.31:
  ...
  %t36 = getelementptr ptr, ptr %t17, i32 1
...
case.default.21:
  unreachable
case.join.22:
  %t39 = phi ptr [ %t25, %case.end.3.24 ], [ %t33, %case.end.4.32 ]
  call void @__free_recursive(ptr %t17)
  %t40 = call ptr @v_$apply$$df$andThenIO$9(ptr %t6, ptr %t39)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.41:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t42 = call ptr @v_$apply$$df$andThenIO$9(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
reuse.in_place.57:
  ...
  store ptr %t45, ptr %t51
  br label %reuse.in_place.end.60
reuse.in_place.end.60:
  br label %reuse.join.59
reuse.copy.58:
  %t62 = call ptr @__alloc(i64 24, i32 2)
  %t63 = inttoptr i64 35 to ptr
  ...
  %t66 = getelementptr ptr, ptr %t62, i32 2
  store ptr %t45, ptr %t66
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.61
reuse.copy.end.61:
  br label %reuse.join.59
reuse.join.59:
  %t67 = phi ptr [ %t5, %reuse.in_place.end.60 ], [ %t62, %reuse.copy.end.61 ]
  call void @__free_recursive(ptr %t6)
  store ptr %t47, ptr %t3
...
tco.case.arm.10.68:
  ...
  %t78 = getelementptr ptr, ptr %t71, i32 1
  store ptr %t74, ptr %t78
  %t79 = call ptr @v_$apply$$df$andThenIO$9(ptr %t6, ptr %t71)
...
define internal ptr @v_$apply$$df$andThenIO$9(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
define internal ptr @v_$cps$$scc$$apply1__$df$$lam$11$4__$df$$lam$2$12__$df$$lam$2$8(ptr %v_$args, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 24, label %tco.case.arm.24.11 i64 25, label %tco.case.arm.25.50 i64 26, label %tco.case.arm.26.61 i64 27, label %tco.case.arm.27.72 ]
tco.case.arm.24.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 20, label %tco.case.arm.20.20 i64 21, label %tco.case.arm.21.28 i64 22, label %tco.case.arm.22.36 i64 23, label %tco.case.arm.23.44 ]
tco.case.arm.20.20:
...
tco.case.arm.23.44:
  ...
  %t49 = call ptr @v_$apply$$scc$$apply1__$df$$lam$11$4__$df$$lam$2$12__$df$$lam$2$8(ptr %t6, ptr %t45)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.25.50:
  ...
  %t56 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t55, ptr %t56
  %t57 = call ptr @__alloc(i64 16, i32 1)
  %t58 = inttoptr i64 37 to ptr
  %t59 = getelementptr ptr, ptr %t57, i32 0
  store ptr %t58, ptr %t59
  call void @__inc_ref(ptr %t6)
...
define internal ptr @v_$apply$$scc$$apply1__$df$$lam$11$4__$df$$lam$2$12__$df$$lam$2$8(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 36, label %tco.case.arm.36.11 i64 37, label %tco.case.arm.37.12 i64 38, label %tco.case.arm.38.19 i64 39, label %tco.case.arm.39.26 ]
tco.case.arm.36.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
tco.case.arm.37.12:
  ...
  %t17 = getelementptr ptr, ptr %t15, i32 0
  store ptr %t16, ptr %t17
  %t18 = call ptr @v_$cps$$df$handleErrorIO$1(ptr %t6, ptr %t15)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  store ptr %t14, ptr %t3
...
tco.case.arm.38.19:
  ...
  %t25 = call ptr @v_$cps$$df$andThenIO$9(ptr %t6, ptr %t22)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  store ptr %t21, ptr %t3
...
tco.case.arm.39.26:
  ...
  %t30 = inttoptr i64 32 to ptr
  %t31 = getelementptr ptr, ptr %t29, i32 0
  store ptr %t30, ptr %t31
  %t32 = call ptr @v_$cps$$df$andThenIO$5(ptr %t6, ptr %t29)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
