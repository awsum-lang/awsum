...
define ptr @v_main(ptr %v__input) {
  ...
  %t11 = call ptr @malloc(i64 4)
  store i32 0, ptr %t11
  %t12 = call ptr @__negInt32(ptr %t11)
  ...
  %t17 = call ptr @v_maxInt32()
  %t18 = call ptr @__negInt32(ptr %t17)
  ...
  %t23 = call ptr @v_minInt32()
  %t24 = call ptr @__negInt32(ptr %t23)
