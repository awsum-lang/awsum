...
(module
  ...
  (table 6 funcref)
  (elem (i32.const 0) $v_runIO $v__let_23 $v__scc_handleA_handleB $v__cps__scc_handleA_handleB $v__apply__scc_handleA_handleB $v_handleA)
  ...
  (func $v__scc_handleA_handleB (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
  ...
  (func $v_handleA (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
