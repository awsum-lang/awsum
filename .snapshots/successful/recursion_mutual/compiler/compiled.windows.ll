...
define internal ptr @v_res() {
  ...
  store ptr %t8, ptr %t9
  %t10 = call ptr @v_$cps$$scc$handleA__handleB(ptr %t0, ptr %t7)
  ret ptr %t10
}
...
define internal ptr @v_$cps$$scc$handleA__handleB(ptr %v_$args, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.27.37:
  ...
  %t42 = call ptr @v_$apply$$scc$handleA__handleB(ptr %t6, ptr %t38)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.27.79:
  ...
  %t84 = call ptr @v_$apply$$scc$handleA__handleB(ptr %t6, ptr %t80)
  call void @__free_recursive(ptr %t45)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$scc$handleA__handleB(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 34, label %tco.case.arm.34.11 i64 35, label %tco.case.arm.35.12 i64 36, label %tco.case.arm.36.24 i64 37, label %tco.case.arm.37.36 ]
tco.case.arm.34.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
