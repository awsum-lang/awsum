...
@.str.2 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"A" }
@.str.3 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"B" }
@.str.4 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"C" }
...
tco.loop.0:
  ...
  switch i64 %t9, label %tco.case.default.10 [ i64 23, label %tco.case.arm.23.11 i64 24, label %tco.case.arm.24.46 ]
tco.case.arm.23.11:
  ...
  switch i64 %t16, label %tco.case.default.17 [ i64 19, label %tco.case.arm.19.18 i64 20, label %tco.case.arm.20.30 i64 21, label %tco.case.arm.21.35 i64 22, label %tco.case.arm.22.40 ]
tco.case.arm.19.18:
...
tco.case.arm.22.40:
  ...
  %t45 = call ptr @v__apply__scc_handleA_handleB(ptr %t6, ptr %t41)
...
tco.case.arm.24.46:
  ...
  switch i64 %t51, label %tco.case.default.52 [ i64 19, label %tco.case.arm.19.53 i64 20, label %tco.case.arm.20.58 i64 21, label %tco.case.arm.21.70 i64 22, label %tco.case.arm.22.82 ]
tco.case.arm.19.53:
...
tco.case.arm.22.82:
  ...
  %t84 = inttoptr i64 4 to ptr
  %t85 = getelementptr ptr, ptr %t83, i32 0
  store ptr %t84, ptr %t85
  %t86 = getelementptr ptr, ptr %t83, i32 1
  store ptr @.str.1, ptr %t86
  %t87 = call ptr @v__apply__scc_handleA_handleB(ptr %t6, ptr %t83)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 25, label %tco.case.arm.25.11 i64 26, label %tco.case.arm.26.12 i64 27, label %tco.case.arm.27.30 i64 28, label %tco.case.arm.28.48 ]
tco.case.arm.25.11:
  store ptr %t6, ptr %t2
  br label %tco.exit.1
tco.case.arm.26.12:
  ...
  switch i64 %t17, label %tco.case.default.18 [ i64 3, label %tco.case.arm.3.19 i64 4, label %tco.case.arm.4.26 ]
tco.case.arm.3.19:
...
tco.case.arm.4.26:
  ...
  %t29 = call ptr @__concat(ptr @.str.2, ptr %t28)
  store ptr %t14, ptr %t3
...
tco.case.arm.27.30:
  ...
  %t33 = getelementptr ptr, ptr %t6, i32 0
  %t34 = load ptr, ptr %t33
  %t35 = ptrtoint ptr %t34 to i64
  switch i64 %t35, label %tco.case.default.36 [ i64 3, label %tco.case.arm.3.37 i64 4, label %tco.case.arm.4.44 ]
tco.case.arm.3.37:
...
tco.case.arm.4.44:
  ...
  %t47 = call ptr @__concat(ptr @.str.3, ptr %t46)
  store ptr %t32, ptr %t3
...
tco.case.arm.28.48:
  ...
  %t50 = load ptr, ptr %t49
  %t51 = getelementptr ptr, ptr %t6, i32 0
  %t52 = load ptr, ptr %t51
  %t53 = ptrtoint ptr %t52 to i64
  switch i64 %t53, label %tco.case.default.54 [ i64 3, label %tco.case.arm.3.55 i64 4, label %tco.case.arm.4.62 ]
tco.case.arm.3.55:
...
tco.case.arm.4.62:
  ...
  %t65 = call ptr @__concat(ptr @.str.4, ptr %t64)
  store ptr %t50, ptr %t3
