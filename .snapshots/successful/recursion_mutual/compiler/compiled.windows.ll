...
tco.loop.0:
  ...
  switch i64 %t9, label %tco.case.default.10 [ i64 0, label %tco.case.arm.0.11 i64 1, label %tco.case.arm.1.46 ]
tco.case.arm.0.11:
...
tco.case.arm.1.46:
  ...
  switch i64 %t51, label %tco.case.default.52 [ i64 0, label %tco.case.arm.0.53 i64 1, label %tco.case.arm.1.58 i64 2, label %tco.case.arm.2.70 i64 3, label %tco.case.arm.3.82 ]
tco.case.arm.0.53:
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 0, label %tco.case.arm.0.11 i64 1, label %tco.case.arm.1.12 i64 2, label %tco.case.arm.2.30 i64 3, label %tco.case.arm.3.48 ]
tco.case.arm.0.11:
  store ptr %t6, ptr %t2
  br label %tco.exit.1
tco.case.arm.1.12:
...
tco.case.arm.2.30:
  ...
  switch i64 %t35, label %tco.case.default.36 [ i64 0, label %tco.case.arm.0.37 i64 1, label %tco.case.arm.1.44 ]
tco.case.arm.0.37:
...
tco.case.arm.3.48:
  ...
  switch i64 %t53, label %tco.case.default.54 [ i64 0, label %tco.case.arm.0.55 i64 1, label %tco.case.arm.1.62 ]
tco.case.arm.0.55:
