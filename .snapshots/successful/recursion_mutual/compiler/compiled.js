      ...
      switch (__s[0]) {
          ...
          const v__pk_27 = __s[1];
          {
            ...
            switch (__s[0]) {
              case 3: {
                ...
                const __t0 = v__pk_27;
                const __t1 = (v__x[0] = 3, v__x[1] = v__do_e_14_5, v__x);
                v__k = null;
                v__k = __t0;
                v__x = __t1;
                continue;
        ...
        case 28: {
          const v__pk_28 = __s[1];
          {
            ...
            switch (__s[0]) {
              case 3: {
                const v__do_e_23_5 = __s[1];
                const __t0 = v__pk_28;
                const __t1 = (v__x[0] = 3, v__x[1] = v__do_e_23_5, v__x);
                v__k = null;
                v__k = __t0;
                v__x = __t1;
                continue;
        ...
        case 29: {
          const v__pk_29 = __s[1];
          {
            ...
            switch (__s[0]) {
              case 3: {
                const v__do_e_27_5 = __s[1];
                const __t0 = v__pk_29;
                const __t1 = (v__x[0] = 3, v__x[1] = v__do_e_27_5, v__x);
                v__k = null;
                v__k = __t0;
                v__x = __t1;
                continue;
