      ...
      switch (__s[0]) {
        case 28: {
          const v_step = __s[1];
          {
            ...
            switch (__s[0]) {
              case 24: {
                const __t0 = (v__args[0] = 29, v__args[1] = [25], v__args);
                const __t1 = [31, v__k];
                v__args = __t0;
                v__k = __t1;
                continue;
              ...
              case 25: {
                const __t0 = (v__args[0] = 29, v__args[1] = v_step, v__args);
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
        ...
        case 29: {
          const v_step = __s[1];
          {
            ...
            switch (__s[0]) {
              case 24: {
                const __t0 = (v__args[0] = 28, v__args[1] = v_step, v__args);
                const __t1 = v__k;
                v__args = __t0;
                v__k = __t1;
                continue;
              ...
              case 25: {
                const __t0 = (v__args[0] = 28, v__args[1] = [26], v__args);
                const __t1 = [32, v__k];
                v__args = __t0;
                v__k = __t1;
                continue;
              ...
              case 26: {
                const __t0 = (v__args[0] = 28, v__args[1] = [27], v__args);
                const __t1 = [33, v__k];
                v__args = __t0;
                v__k = __t1;
                continue;
...
const main = (v__let_23)((v_handleA)([24]));
