...
case.arm.1.96:
  ...
  switch i64 %t103, label %case.default.104 [ i64 0, label %case.arm.0.106 i64 1, label %case.arm.1.114 ]
case.arm.0.106:
...
case.arm.1.186:
  ...
  switch i64 %t193, label %case.default.194 [ i64 0, label %case.arm.0.196 i64 1, label %case.arm.1.204 ]
case.arm.0.196:
...
case.default.212:
  unreachable
case.join.213:
  %t227 = phi ptr [%t218, %case.end.0.215], [%t226, %case.end.1.223]
...
case.default.194:
  unreachable
case.join.195:
  %t228 = phi ptr [%t200, %case.end.0.197], [%t227, %case.end.1.205]
...
case.default.176:
  unreachable
case.join.177:
  %t229 = phi ptr [%t182, %case.end.0.179], [%t228, %case.end.1.187]
  br label %case.end.1.169
case.end.1.169:
  br label %case.join.159
case.default.158:
  unreachable
case.join.159:
  %t230 = phi ptr [%t164, %case.end.0.161], [%t229, %case.end.1.169]
...
case.default.140:
  unreachable
case.join.141:
  %t231 = phi ptr [%t146, %case.end.0.143], [%t230, %case.end.1.151]
  br label %case.end.1.133
case.end.1.133:
  br label %case.join.123
case.default.122:
  unreachable
case.join.123:
  %t232 = phi ptr [%t128, %case.end.0.125], [%t231, %case.end.1.133]
  br label %case.end.1.115
case.end.1.115:
  br label %case.join.105
case.default.104:
  unreachable
case.join.105:
  %t233 = phi ptr [%t110, %case.end.0.107], [%t232, %case.end.1.115]
...
case.default.86:
  unreachable
case.join.87:
  %t234 = phi ptr [%t92, %case.end.0.89], [%t233, %case.end.1.97]
...
case.default.66:
  unreachable
case.join.67:
  %t235 = phi ptr [%t72, %case.end.0.69], [%t234, %case.end.1.77]
...
case.default.46:
  unreachable
case.join.47:
  %t236 = phi ptr [%t52, %case.end.0.49], [%t235, %case.end.1.57]
...
case.default.26:
  unreachable
case.join.27:
  %t237 = phi ptr [%t32, %case.end.0.29], [%t236, %case.end.1.37]
...
case.default.6:
  unreachable
case.join.7:
  %t238 = phi ptr [%t12, %case.end.0.9], [%t237, %case.end.1.17]
  %t239 = call ptr @v__let_2(ptr %t238)
  ret ptr %t239
}
