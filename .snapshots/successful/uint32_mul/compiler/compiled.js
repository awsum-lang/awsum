...
(() => {
  ...
  const v__inl3_r = [4, 4294967295 >>> 0];
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
      ...
      case 4: {
        ...
        const v__inl6_r = [3, [18]];
        {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v__inl9_r = __mulUInt32(v_maxUInt32, v_maxUInt32);
              {
                const __s = (s => {
                  switch (s[0]) {
                    case 3: {
                ...
                switch (__s[0]) {
                  ...
                  case 4: {
                    const v_c = __s[1];
                    const v__inl12_r = __mulUInt32(v_minUInt32, v_maxUInt32);
                    {
                      const __s = (s => {
                        switch (s[0]) {
                          case 3: {
                      ...
                      switch (__s[0]) {
                        ...
                        case 4: {
                          const v_d = __s[1];
                          const v__inl15_r = [4, 2147483648 >>> 0];
                          {
                            const __s = (s => {
                              switch (s[0]) {
                                case 3: {
  ...
  const v__inl21_x = v_res;
  const main = v__cps__df_handleErrorIO_0(
    v__cps__df_andThenIO_4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v__inl21_x[1]];
          }
          case 4: {
            return [5, v__inl21_x[1]];
          }
        }
      })(v__inl21_x),
      [22]
