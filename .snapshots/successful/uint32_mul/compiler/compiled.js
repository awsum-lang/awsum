...
(() => {
  ...
  const __mulUInt32 = (a, b) => {
    const p = BigInt(a) * BigInt(b);
    return p > 4294967295n ? [3, [18]] : [4, Number(p) >>> 0];
  };
  ...
  const v_$inl3$r = [4, 4294967295 >>> 0];
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
      ...
      case 4: {
        ...
        const v_$inl6$r = [3, [18]];
        {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v_$inl9$r = __mulUInt32(v_maxUInt32, v_maxUInt32);
              {
                const __s = (s => {
                  switch (s[0]) {
                    case 3: {
                ...
                switch (__s[0]) {
                  ...
                  case 4: {
                    const v_c = __s[1];
                    const v_$inl12$r = __mulUInt32(v_minUInt32, v_maxUInt32);
                    {
                      const __s = (s => {
                        switch (s[0]) {
                          case 3: {
                      ...
                      switch (__s[0]) {
                        ...
                        case 4: {
                          const v_d = __s[1];
                          const v_$inl15$r = [4, 2147483648 >>> 0];
                          {
                            const __s = (s => {
                              switch (s[0]) {
                                case 3: {
  ...
  const v_$inl21$x = v_res;
  const main = v_$cps$$df$handleErrorIO$0(
    v_$cps$$df$andThenIO$4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v_$inl21$x[1]];
          }
          case 4: {
            return [5, v_$inl21$x[1]];
          }
        }
      })(v_$inl21$x),
      [22]
