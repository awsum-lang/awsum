...
tco.case.arm.8.18:
  ...
  %t30 = call ptr @v__cps__scc__apply1__df__lam_13_5__df__lam_9_1(ptr %t20, ptr %t27)
...
define internal ptr @v_label(ptr %v_k) {
  %v__inl1_scrut.jslot = alloca ptr
...
case.join.20:
  ...
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t3)
  store ptr %t46, ptr %v__inl1_scrut.jslot
  br label %join.0
join.case.default.7:
  unreachable
join.0:
  %t47 = load ptr, ptr %v__inl1_scrut.jslot
...
case.join.18:
  ...
  %t78 = call ptr @v__apply__df__rowmono_0_andThenIO_4(ptr %t6, ptr %t77)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.79:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t80 = call ptr @v__apply__df__rowmono_0_andThenIO_4(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.106:
  ...
  %t117 = call ptr @v__apply__df__rowmono_0_andThenIO_4(ptr %t6, ptr %t109)
...
define internal ptr @v__cps__scc__apply1__df__lam_13_5__df__lam_9_1(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
case.join.41:
  ...
  %t59 = call ptr @v__apply__scc__apply1__df__lam_13_5__df__lam_9_1(ptr %t6, ptr %t58)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v__apply__scc__apply1__df__lam_13_5__df__lam_9_1(ptr %v__k, ptr %v__x) {
entry:
  %t3 = alloca ptr
  store ptr %v__k, ptr %t3
  %t4 = alloca ptr
