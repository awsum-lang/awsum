...
case.arm.4.48:
  ...
  store i32 1, ptr %t53
  %t54 = call ptr @__addInt32(ptr %t52, ptr %t53)
...
case.arm.4.69:
  ...
  store i32 -1, ptr %t74
  %t75 = call ptr @__addInt32(ptr %t73, ptr %t74)
...
case.arm.4.90:
  ...
  %t94 = call ptr @v_maxInt32()
  %t95 = call ptr @v_minInt32()
  %t96 = call ptr @__addInt32(ptr %t94, ptr %t95)
