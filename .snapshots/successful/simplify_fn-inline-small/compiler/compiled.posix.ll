...
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [5 x i8]} { i32 0, i32 0, i32 0, i32 5, i32 5, [5 x i8] c"again" }
...
define internal ptr @v_main() {
  ...
  store ptr %t1, ptr %t2
  %t3 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
  %t4 = getelementptr ptr, ptr %t3, i32 0
  %t5 = load ptr, ptr %t4
  %t6 = ptrtoint ptr %t5 to i64
  switch i64 %t6, label %case.default.7 [ i64 3, label %case.arm.3.9 i64 4, label %case.arm.4.11 ]
case.arm.3.9:
...
case.default.7:
  unreachable
case.join.8:
  %t15 = phi ptr [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.3.10 ], [ %t14, %case.end.4.12 ]
  ...
  %t24 = getelementptr ptr, ptr %t0, i32 2
  store ptr %t17, ptr %t24
  %t25 = call ptr @__alloc(i64 8, i32 0)
  %t26 = inttoptr i64 8 to ptr
  %t27 = getelementptr ptr, ptr %t25, i32 0
  store ptr %t26, ptr %t27
  %t28 = call ptr @v__cps__df_andThenIO_0(ptr %t0, ptr %t25)
  ret ptr %t28
}
...
tco.loop.0:
  ...
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 7, label %tco.case.arm.7.38 ]
tco.case.arm.5.11:
  ...
  %t15 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.3, i64 12), ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
  %t16 = getelementptr ptr, ptr %t15, i32 0
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %case.default.19 [ i64 3, label %case.arm.3.21 i64 4, label %case.arm.4.23 ]
case.arm.3.21:
...
case.default.19:
  unreachable
case.join.20:
  %t27 = phi ptr [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.3.22 ], [ %t26, %case.end.4.24 ]
  call void @__free_recursive(ptr %t15)
  %t28 = getelementptr ptr, ptr %t12, i32 1
  ...
  %t36 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t29, ptr %t36
  %t37 = call ptr @v__apply__df_andThenIO_0(ptr %t6, ptr %t12)
...
tco.case.arm.7.38:
  ...
  %t49 = getelementptr i8, ptr %t5, i64 -8
...
reuse.in_place.52:
  ...
  br label %reuse.in_place.end.55
reuse.in_place.end.55:
...
reuse.copy.53:
  ...
  store ptr %t40, ptr %t61
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.56
reuse.copy.end.56:
  br label %reuse.join.54
reuse.join.54:
  %t62 = phi ptr [ %t5, %reuse.in_place.end.55 ], [ %t57, %reuse.copy.end.56 ]
  call void @__free_recursive(ptr %t6)
