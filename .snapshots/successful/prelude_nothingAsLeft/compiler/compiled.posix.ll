...
@.str.4 = private unnamed_addr constant {i32, i32, i32, i32, i32, [2 x i8]} { i32 0, i32 0, i32 0, i32 2, i32 2, [2 x i8] c"hi" }
...
define internal ptr @v_main() {
  ...
  store ptr %t4, ptr %t5
  %t6 = call ptr @v__lift_14(ptr %t3)
  %t7 = call ptr @v_nothingAsLeft(ptr %t0, ptr %t6)
  %t8 = call ptr @v__let_15(ptr %t7)
  ret ptr %t8
}
...
define internal ptr @v__let_13(ptr %v_fromNothing, ptr %v_fromJust) {
...
case.arm.4.32:
  ...
  call void @__inc_ref(ptr %t17)
  %t36 = call ptr @__concat(ptr %t17, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
...
case.arm.4.50:
  ...
  call void @__inc_ref(ptr %t53)
  call void @__inc_ref(ptr %t35)
  %t54 = call ptr @__concat(ptr %t53, ptr %t35)
...
case.join.5:
  ...
  %t58 = call ptr @v__let_12(ptr %t57)
...
define internal ptr @v__let_15(ptr %v_fromNothing) {
  call void @__inc_ref(ptr %v_fromNothing)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 22 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  ...
  %t8 = call ptr @v__let_13(ptr %v_fromNothing, ptr %t7)
  call void @__free_recursive(ptr %v_fromNothing)
  ret ptr %t8
}
