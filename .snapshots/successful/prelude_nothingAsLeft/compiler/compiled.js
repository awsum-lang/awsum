...
const v__let_27 = (v_fromNothing, v_fromJust) => {
    return (v__let_26)(v_fromJust, v_fromNothing, ((s) => { switch(s[0]) { case 3: { const v__do_e_0 = s[1]; return [3, v__do_e_0]; } case 4: { const v_h = s[1]; return (v_pureEither)(v_h); } } })((v_nothingAsLeft)([24], (v__lift_25)((v_headList)([14, "first", [14, "second", (v__lift_24)([13])]])))));
};
