...
(module
  ...
  (data (i32.const 198) "\00\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\02\00\00\00hi")
  (table 7 funcref)
  (elem (i32.const 0) $v_nothingAsLeft $v_runIO $v_show $v__let_12 $v__let_13 $v__lift_14 $v__let_15)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__let_15 (call $v_nothingAsLeft (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 22)) (local.get $__con_0)) (call $v__lift_14 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 10)) (local.get $__con_0))))))
  ...
  (func $v__let_13 (param $v_fromNothing i32) (param $v_fromJust i32) (result i32)
    (local $__con_0 i32)
    (local $v__do_e_0 i32)
    (local $v__do_e_1 i32)
    (local $v__do_e_2 i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (block (result i32) (local.set $__scrut (call $v_show (block (result i32) (local.set $__inc_tmp (local.get $v_fromNothing)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_2 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_2)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_2)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_2)) (local.get $__drop_tmp))) (else (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (call $v_show (block (result i32) (local.set $__inc_tmp (local.get $v_fromJust)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_1 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_1)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_1)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_1)) (local.get $__drop_tmp))) (else (local.set $v_b (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_b)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 189))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_0)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__do_e_0)) (local.get $__drop_tmp))) (else (local.set $v_sep (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_sep)) (block (result i32) (local.set $__drop_tmp (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_sep)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_b)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__free_recursive (local.get $v_sep)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_b)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp)))))))
  ...
  (func $v__let_15 (param $v_fromNothing i32) (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__let_13 (block (result i32) (local.set $__inc_tmp (local.get $v_fromNothing)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_nothingAsLeft (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 22)) (local.get $__con_0)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 11)) (i32.store offset=4 (local.get $__con_0) (i32.const 210)) (local.get $__con_0)))))
