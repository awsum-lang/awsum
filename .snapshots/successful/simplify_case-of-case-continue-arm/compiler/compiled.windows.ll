...
define internal ptr @v_go(ptr %v_n) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  store i32 0, ptr %t6
  %t7 = call ptr @__eqUInt32(ptr %t4, ptr %t6)
...
join.5:
  ...
  switch i64 %t20, label %tco.case.default.21 [ i64 1, label %tco.case.arm.1.22 i64 2, label %tco.case.arm.2.24 ]
tco.case.arm.1.22:
  call void @__inc_ref(ptr %t4)
  %t23 = call ptr @__showUInt32(ptr %t4)
...
tco.case.arm.2.24:
  ...
  store i32 1, ptr %t25
  %t26 = call ptr @__subUInt32(ptr %t4, ptr %t25)
