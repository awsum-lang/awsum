...
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [6 x i8]} { i32 0, i32 0, i32 0, i32 6, i32 6, [6 x i8] c"NO_ARG" }
...
define internal ptr @v_handleInputError(ptr %v__e) {
...
define internal ptr @v_printInput(ptr %v_s) {
  %t0 = call ptr @__alloc(i64 24, i32 2)
  %t1 = inttoptr i64 7 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
...
define internal ptr @v_printFirstArg(ptr %v_args) {
...
case.arm.11.5:
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.1, i64 12), ptr %t9
...
case.arm.12.18:
  ...
  call void @__inc_ref(ptr %t20)
  %t21 = call ptr @v_printInput(ptr %t20)
  call void @__free_recursive(ptr %t0)
...
tco.case.arm.10.74:
  ...
  %t85 = call ptr @v__apply__lift_19(ptr %t6, ptr %t77)
...
tco.case.arm.6.19:
  ...
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t21)
  %t22 = call ptr @v_handleInputError(ptr %t21)
...
tco.case.arm.5.11:
  ...
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t13)
  %t14 = call ptr @v_printFirstArg(ptr %t13)
...
define internal ptr @v__scc__apply1__df__lam_14_1__df__lam_15_2__df__lam_16_3__df__lam_23_5__df__lam_24_6__df__lam_25_7__lift_20__lift_21__lift_22(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 41 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_14_1__df__lam_15_2__df__lam_16_3__df__lam_23_5__df__lam_24_6__df__lam_25_7__lift_20__lift_21__lift_22(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_14_1__df__lam_15_2__df__lam_16_3__df__lam_23_5__df__lam_24_6__df__lam_25_7__lift_20__lift_21__lift_22(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 25, label %tco.case.arm.25.11 i64 26, label %tco.case.arm.26.203 i64 27, label %tco.case.arm.27.226 i64 28, label %tco.case.arm.28.249 i64 29, label %tco.case.arm.29.272 i64 30, label %tco.case.arm.30.295 i64 31, label %tco.case.arm.31.318 i64 32, label %tco.case.arm.32.341 i64 33, label %tco.case.arm.33.364 i64 34, label %tco.case.arm.34.387 ]
tco.case.arm.25.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
...
tco.case.arm.21.140:
  ...
  %t142 = call ptr @v__apply__scc__apply1__df__lam_14_1__df__lam_15_2__df__lam_16_3__df__lam_23_5__df__lam_24_6__df__lam_25_7__lift_20__lift_21__lift_22(ptr %t6, ptr %t141)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v__apply__scc__apply1__df__lam_14_1__df__lam_15_2__df__lam_16_3__df__lam_23_5__df__lam_24_6__df__lam_25_7__lift_20__lift_21__lift_22(ptr %v__k, ptr %v__x) {
entry:
  %t3 = alloca ptr
  store ptr %v__k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 41, label %tco.case.arm.41.11 i64 42, label %tco.case.arm.42.12 i64 43, label %tco.case.arm.43.16 i64 44, label %tco.case.arm.44.20 i64 45, label %tco.case.arm.45.24 i64 46, label %tco.case.arm.46.28 i64 47, label %tco.case.arm.47.32 i64 48, label %tco.case.arm.48.36 i64 49, label %tco.case.arm.49.40 i64 50, label %tco.case.arm.50.44 ]
tco.case.arm.41.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
...
tco.case.arm.48.36:
  ...
  call void @__inc_ref(ptr %t6)
  %t39 = call ptr @v__lift_19(ptr %t6)
  call void @__inc_ref(ptr %t38)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
tco.case.arm.49.40:
  ...
  call void @__inc_ref(ptr %t42)
  call void @__inc_ref(ptr %t6)
  %t43 = call ptr @v__lift_19(ptr %t6)
  call void @__inc_ref(ptr %t42)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t42)
...
tco.case.arm.50.44:
  ...
  call void @__inc_ref(ptr %t6)
  %t47 = call ptr @v__lift_19(ptr %t6)
  call void @__inc_ref(ptr %t46)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_14_1__df__lam_15_2__df__lam_16_3__df__lam_23_5__df__lam_24_6__df__lam_25_7__lift_20__lift_21__lift_22(ptr %t0)
