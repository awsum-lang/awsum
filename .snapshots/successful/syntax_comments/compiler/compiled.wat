...
(module
  ...
  (func $v_main (param $v_inputArg i32) (result i32)
    ...
    (local $v_input i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_inputArg)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__print (i32.const 65))) (else (local.set $v_input (i32.load offset=4 (local.get $__scrut))) (call $__print (local.get $v_input))))))
