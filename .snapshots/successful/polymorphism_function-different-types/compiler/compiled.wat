...
(module
  ...
  (data (i32.const 65) "from box\00")
  (data (i32.const 74) " \00")
  (data (i32.const 76) "nested\00")
  (data (i32.const 83) "STRING_TOO_LONG\00")
  (table 4 funcref)
  (elem (i32.const 0) $v_unwrap $v_showResult $v_main $v__let_1)
  ...
  (func $v_main (param $v__input i32) (result i32)
    ...
    (local $v_s0 i32)
    (local $__scrut i32)
    (call $v__let_1 (block (result i32) (local.set $__scrut (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (call $v_unwrap (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_1) (i32.const 65)) (local.get $__con_1))) (i32.const 74))) (local.get $__con_0))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__do_e_20_9 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_20_9)) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (local.get $v_s0) (call $v_showResult (call $v_unwrap (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_2) (i32.const 76)) (local.get $__con_2))) (local.get $__con_1)))))) (local.get $__con_0)))))))
