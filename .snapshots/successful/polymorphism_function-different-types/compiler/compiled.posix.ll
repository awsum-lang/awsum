...
@.str.0 = private unnamed_addr constant {i32, i32, [8 x i8]} { i32 8, i32 8, [8 x i8] c"from box" }
@.str.1 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c" " }
@.str.2 = private unnamed_addr constant {i32, i32, [6 x i8]} { i32 6, i32 6, [6 x i8] c"nested" }
...
define internal ptr @v_main() {
  ...
  %t5 = call ptr @__concat(ptr %t4, ptr @.str.1)
