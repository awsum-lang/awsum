...
case.arm.1.21:
  ...
  %t31 = getelementptr [7 x i8], ptr @.str.2, i64 0, i64 0
  ...
  %t35 = call ptr @v_showResult(ptr %t34)
  %t36 = call ptr @__concat(ptr %t24, ptr %t35)
...
case.default.11:
  unreachable
case.join.12:
  %t37 = phi ptr [%t17, %case.end.0.14], [%t36, %case.end.1.22]
  %t38 = call ptr @v__let_2(ptr %t37)
  ret ptr %t38
}
