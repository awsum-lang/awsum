...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [8 x i8]} { i32 0, i32 0, i32 0, i32 8, i32 8, [8 x i8] c"from box" }
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [1 x i8]} { i32 0, i32 0, i32 0, i32 1, i32 1, [1 x i8] c" " }
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [6 x i8]} { i32 0, i32 0, i32 0, i32 6, i32 6, [6 x i8] c"nested" }
...
case.arm.19.4:
  %t5 = getelementptr ptr, ptr %v_box, i32 1
  %t6 = load ptr, ptr %t5
  call void @__inc_ref(ptr %t6)
  call void @__free_recursive(ptr %v_box)
  ret ptr %t6
case.default.3:
  unreachable
}
...
define internal ptr @v_main() {
  ...
  %t5 = call ptr @__concat(ptr %t4, ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
...
case.arm.4.19:
  ...
  %t31 = call ptr @v_unwrap(ptr %t23)
  %t32 = call ptr @v_showResult(ptr %t31)
  %t33 = call ptr @__concat(ptr %t22, ptr %t32)
...
case.default.9:
  unreachable
case.join.10:
  %t34 = phi ptr [%t15, %case.end.3.12], [%t33, %case.end.4.20]
  call void @__free_recursive(ptr %t5)
  %t35 = call ptr @v__let_7(ptr %t34)
  ret ptr %t35
}
