...
(module
  ...
  (table 8 funcref)
  (elem (i32.const 0) $v_show $v__cps_show $v__apply_show $v_shout $v_main $v__df_map_0 $v__cps__df_map_0 $v__apply__df_map_0)
