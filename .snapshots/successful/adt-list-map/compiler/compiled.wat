...
(module
  ...
  (func $v_map (param $v_f i32) (param $v_list i32) (result i32)
    (local $__con_0 i32)
  ...
  (func $v__cps_map (param $v_f i32) (param $v_list i32) (param $v__k i32) (result i32)
    (local $__con_0 i32)
    (local $v_head i32)
    (local $v_tail i32)
    (local $__scrut i32)
  ...
  (func $v__apply_map (param $v__k i32) (param $v__x i32) (result i32)
    (local $v__pk_1 i32)
    (local $v_f i32)
    (local $v_head i32)
    (local $__scrut i32)
