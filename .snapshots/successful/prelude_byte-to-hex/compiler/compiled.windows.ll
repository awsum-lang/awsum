...
define internal ptr @v_main() {
  ...
  switch i64 %t39, label %case.default.40 [ i64 3, label %case.arm.3.42 i64 4, label %case.arm.4.56 ]
case.arm.3.42:
...
case.arm.4.56:
  %t58 = getelementptr ptr, ptr %t36, i32 1
...
case.default.40:
  unreachable
case.join.41:
  %t72 = phi ptr [ %t44, %case.end.3.43 ], [ %t60, %case.end.4.57 ]
