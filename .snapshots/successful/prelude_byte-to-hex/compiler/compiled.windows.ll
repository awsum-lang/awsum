...
define internal ptr @v_res() {
  ...
  %t6 = inttoptr i64 14 to ptr
  %t7 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t6, ptr %t7
  %t8 = call ptr @__alloc(i64 1, i32 0)
  store i8 15, ptr %t8
  %t9 = getelementptr ptr, ptr %t5, i32 1
  store ptr %t8, ptr %t9
  %t10 = call ptr @__alloc(i64 24, i32 2)
  %t11 = inttoptr i64 14 to ptr
  %t12 = getelementptr ptr, ptr %t10, i32 0
  store ptr %t11, ptr %t12
  %t13 = call ptr @__alloc(i64 1, i32 0)
  store i8 16, ptr %t13
  ...
  %t18 = call ptr @__alloc(i64 1, i32 0)
  store i8 171, ptr %t18
  %t19 = getelementptr ptr, ptr %t15, i32 1
  store ptr %t18, ptr %t19
  %t20 = call ptr @__alloc(i64 24, i32 2)
  %t21 = inttoptr i64 14 to ptr
  %t22 = getelementptr ptr, ptr %t20, i32 0
  store ptr %t21, ptr %t22
  %t23 = call ptr @__alloc(i64 1, i32 0)
  store i8 255, ptr %t23
  %t24 = getelementptr ptr, ptr %t20, i32 1
  store ptr %t23, ptr %t24
  %t25 = call ptr @__alloc(i64 8, i32 0)
  %t26 = inttoptr i64 13 to ptr
  %t27 = getelementptr ptr, ptr %t25, i32 0
  store ptr %t26, ptr %t27
  %t28 = getelementptr ptr, ptr %t20, i32 2
  store ptr %t25, ptr %t28
  %t29 = getelementptr ptr, ptr %t15, i32 2
  store ptr %t20, ptr %t29
  %t30 = getelementptr ptr, ptr %t10, i32 2
  store ptr %t15, ptr %t30
  %t31 = getelementptr ptr, ptr %t5, i32 2
  store ptr %t10, ptr %t31
  %t32 = getelementptr ptr, ptr %t0, i32 2
  store ptr %t5, ptr %t32
  %t33 = call ptr @__alloc(i64 8, i32 0)
  %t34 = inttoptr i64 20 to ptr
  %t35 = getelementptr ptr, ptr %t33, i32 0
  store ptr %t34, ptr %t35
  %t36 = call ptr @v_$cps$bytesToHexStringNoPrefix(ptr %t0, ptr %t33)
  ret ptr %t36
}
