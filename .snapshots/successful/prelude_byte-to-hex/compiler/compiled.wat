...
(module
  ...
  (table 7 funcref)
  (elem (i32.const 0) $v_runIO $v_bytesToHexStringNoPrefix $v__cps_bytesToHexStringNoPrefix $v__apply_bytesToHexStringNoPrefix $v__lam_12 $v__let_13 $v__df_bindEither_0)
