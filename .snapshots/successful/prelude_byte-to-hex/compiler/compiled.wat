...
(module
  ...
  (table 8 funcref)
  (elem (i32.const 0) $v_runIO $v_bytesToHexStringNoPrefix $v__cps_bytesToHexStringNoPrefix $v__apply_bytesToHexStringNoPrefix $v__lift_0 $v__lam_17 $v__let_18 $v__df_bindEither_0)
