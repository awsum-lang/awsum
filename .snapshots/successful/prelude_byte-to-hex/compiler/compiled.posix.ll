...
define internal ptr @v_main() {
  ...
  %t28 = call ptr @v__lift_23(ptr %t25)
  %t29 = getelementptr ptr, ptr %t20, i32 2
  store ptr %t28, ptr %t29
  %t30 = getelementptr ptr, ptr %t15, i32 2
  store ptr %t20, ptr %t30
  %t31 = getelementptr ptr, ptr %t10, i32 2
  store ptr %t15, ptr %t31
  %t32 = getelementptr ptr, ptr %t5, i32 2
  store ptr %t10, ptr %t32
  %t33 = getelementptr ptr, ptr %t0, i32 2
  store ptr %t5, ptr %t33
  %t34 = call ptr @v__let_24(ptr %t0)
  ret ptr %t34
}
...
define internal ptr @v__let_24(ptr %v_bytes) {
  call void @__inc_ref(ptr %v_bytes)
