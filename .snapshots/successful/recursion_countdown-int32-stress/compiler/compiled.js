...
(() => {
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 1: {
            return v_$apply$countDown(v_$k, [4, 0 | 0]);
          }
          case 2: {
            {
              ...
              switch (__s[0]) {
                case 3: {
                  const v_e = __s[1];
                  return v_$apply$countDown(v_$k, [3, v_e]);
                }
                case 4: {
                  const v_m = __s[1];
                  v_n = v_m;
  ...
  const v_$inl3$r = v_$cps$countDown(100000 | 0, [20]);
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
      ...
      case 4: {
        return __concat("right: ", String(v_$inl3$r[1]));
      }
    }
  })(v_$inl3$r);
