...
(module
  ...
  (func $v__cps_countDown (param $v_n i32) (param $v__k i32) (result i32)
    ...
    (local $__k0 i32)
    (local $__k1 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (call $__eq_i32 (local.get $v_n) (call $__box_i32 (i32.const 0)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (call $v__apply_countDown (local.get $v__k) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 0))) (local.get $__con_0)))) (else (block (result i32) (local.set $__scrut (call $__predInt32 (local.get $v_n))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $v__apply_countDown (local.get $v__k) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (local.get $__con_0)))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (local.get $v_m)) (local.set $__k1 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (local.get $v__k)) (local.get $__con_0))) (local.set $v_n (local.get $__k0)) (local.set $v__k (local.get $__k1)) (br $tco_top)))))))))
  ...
  (func $v_main (param $v__input i32) (result i32)
    (call $v__let_2 (call $v_showResult (call $v_countDown (call $__box_i32 (i32.const 100000))))))
