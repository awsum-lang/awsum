...
(() => {
  ...
  const v_res = (s => {
    switch (s[0]) {
      ...
      case 4: {
        const v_a = s[1];
        const v_$inl6$r = __subUInt8(v_maxUInt8, v_minUInt8);
        {
          const __s = (s => {
            switch (s[0]) {
              case 3: {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v_$inl9$r = __subUInt8(v_minUInt8, 1 & 0xFF);
              {
                const __s = (s => {
                  switch (s[0]) {
                    case 3: {
                ...
                switch (__s[0]) {
                  ...
                  case 4: {
                    const v_c = __s[1];
                    const v_$inl12$r = __subUInt8(v_minUInt8, v_maxUInt8);
                    {
                      const __s = (s => {
                        switch (s[0]) {
                          case 3: {
