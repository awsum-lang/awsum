...
(() => {
  ...
  const v_$inl25$____input = __concat("answer=", String(30 | 0));
  const v_res = (s => {
    switch (s[0]) {
      case 3: {
        return [3, [589989748, v_$inl25$____input[1]]];
      }
      case 4: {
        return v_$inl25$____input;
      }
    }
  })(v_$inl25$____input);
