...
@.str.0 = private unnamed_addr constant {i32, i32, [8 x i8]} { i32 8, i32 8, [8 x i8] c"overflow" }
@.str.1 = private unnamed_addr constant {i32, i32, [7 x i8]} { i32 7, i32 7, [7 x i8] c"answer=" }
@.str.2 = private unnamed_addr constant {i32, i32, [15 x i8]} { i32 15, i32 15, [15 x i8] c"STRING_TOO_LONG" }
@.str.3 = private unnamed_addr constant {i32, i32, [5 x i8]} { i32 5, i32 5, [5 x i8] c"err: " }
...
case.default.5:
  unreachable
case.join.6:
  %t23 = phi ptr [%t11, %case.end.3.8], [%t19, %case.end.4.16]
  ret ptr %t23
}
...
case.arm.4.18:
  ...
  %t22 = call ptr @v__let_7(ptr %t21, ptr @.str.1)
...
case.default.4:
  unreachable
case.join.5:
  %t23 = phi ptr [%t10, %case.end.3.7], [%t22, %case.end.4.19]
  ret ptr %t23
}
...
case.arm.589989748.5:
  ...
  switch i64 %t11, label %case.default.12 [ i64 15, label %case.arm.15.14 ]
case.arm.15.14:
  ...
  br label %case.end.15.15
case.end.15.15:
  br label %case.join.13
case.default.12:
  unreachable
case.join.13:
  %t20 = phi ptr [%t16, %case.end.15.15]
