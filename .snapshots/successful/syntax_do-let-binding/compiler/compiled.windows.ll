...
case.default.5:
  unreachable
case.join.6:
  %t23 = phi ptr [%t11, %case.end.0.8], [%t19, %case.end.1.16]
  ret ptr %t23
}
...
case.arm.1.18:
  ...
  %t22 = call ptr @v__let_2(ptr %t21, ptr @.str.1)
...
case.default.4:
  unreachable
case.join.5:
  %t23 = phi ptr [%t10, %case.end.0.7], [%t22, %case.end.1.19]
  ret ptr %t23
}
...
define internal ptr @v_main(ptr %v__input) {
  ...
  %t3 = load ptr, ptr %t2
  %t4 = ptrtoint ptr %t3 to i64
  switch i64 %t4, label %case.default.5 [ i64 0, label %case.arm.0.7 i64 1, label %case.arm.1.50 ]
case.arm.0.7:
  %t9 = getelementptr ptr, ptr %t1, i32 1
  %t10 = load ptr, ptr %t9
  ...
  switch i64 %t14, label %case.default.15 [ i64 0, label %case.arm.0.17 i64 1, label %case.arm.1.33 ]
case.arm.0.17:
...
case.default.15:
  unreachable
case.join.16:
  %t49 = phi ptr [%t21, %case.end.0.18], [%t37, %case.end.1.34]
  br label %case.end.0.8
case.end.0.8:
  br label %case.join.6
case.arm.1.50:
...
case.default.5:
  unreachable
case.join.6:
  %t66 = phi ptr [%t49, %case.end.0.8], [%t54, %case.end.1.51]
  ret ptr %t66
}
