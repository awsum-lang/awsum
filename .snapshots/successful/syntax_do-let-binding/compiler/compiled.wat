...
(module
  ...
  (func $v_step1 (param $v_n i32) (result i32)
    ...
    (local $v_m i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $__addInt32 (local.get $v_n) (call $__box_i32 (i32.const 10)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__e (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (i32.const 72)) (local.get $__con_0))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (local.get $v_m)) (local.get $__con_0))))))
  ...
  (func $v_step2 (param $v_n i32) (result i32)
    ...
    (local $v_m i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (call $__mulInt32 (local.get $v_n) (call $__box_i32 (i32.const 2)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v__e (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (i32.const 72)) (local.get $__con_0))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (local.get $v_m)) (local.get $__con_0))))))
  ...
  (func $v_renderErr (param $v_e i32) (result i32)
    ...
    (local $v_s i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_e)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 589989748)) (then (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v___rw)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (i32.const 103)) (local.get $__con_0)))) (else (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (call $__concat (i32.const 126) (local.get $v_s))))))
