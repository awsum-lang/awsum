...
case.default.158:
  unreachable
case.join.159:
  %t175 = phi ptr [%t164, %case.end.0.161], [%t174, %case.end.1.169]
...
case.default.140:
  unreachable
case.join.141:
  %t176 = phi ptr [%t146, %case.end.0.143], [%t175, %case.end.1.151]
...
case.default.120:
  unreachable
case.join.121:
  %t177 = phi ptr [%t126, %case.end.0.123], [%t176, %case.end.1.131]
...
case.default.102:
  unreachable
case.join.103:
  %t178 = phi ptr [%t108, %case.end.0.105], [%t177, %case.end.1.113]
...
case.default.82:
  unreachable
case.join.83:
  %t179 = phi ptr [%t88, %case.end.0.85], [%t178, %case.end.1.93]
...
case.default.64:
  unreachable
case.join.65:
  %t180 = phi ptr [%t70, %case.end.0.67], [%t179, %case.end.1.75]
...
case.default.44:
  unreachable
case.join.45:
  %t181 = phi ptr [%t50, %case.end.0.47], [%t180, %case.end.1.55]
...
case.default.26:
  unreachable
case.join.27:
  %t182 = phi ptr [%t32, %case.end.0.29], [%t181, %case.end.1.37]
...
case.default.6:
  unreachable
case.join.7:
  %t183 = phi ptr [%t12, %case.end.0.9], [%t182, %case.end.1.17]
  %t184 = call ptr @v__let_2(ptr %t183)
  ret ptr %t184
}
