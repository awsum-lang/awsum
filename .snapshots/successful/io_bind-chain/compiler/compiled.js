...
const main = (v__df_andThenIO_0)((v__lift_13)([7, "a", [5, [0]]]));
...
function v__lam_12(v__u){
    return [7, "b", [5, [0]]];
}

function v__lift_13(v___input){
    return (v__cps__lift_13)(v___input, [25]);
}

function v__cps__lift_13(v___input, v__k){
  while (true) {
    {
      const __s = v___input;
      switch (__s[0]) {
        ...
        case 8: {
          const v___f0 = __s[1];
          return (v__apply__lift_13)(v__k, [8, [12, v___f0]]);
        }
        case 9: {
          const v___f0 = __s[1];
          return (v__apply__lift_13)(v__k, [9, [13, v___f0]]);
        }
      }
    }
  }
...
function v__apply__lift_13(v__k, v__x){
  while (true) {
    {
      const __s = v__k;
      switch (__s[0]) {
...
function v__df_andThenIO_0(v_io){
    return (v__cps__df_andThenIO_0)(v_io, [27]);
}
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 9: {
          const v_cont = __s[1];
          return (v__apply__df_andThenIO_0)(v__k, [9, [11, v_cont]]);
        }
      }
    }
  }
...
function v__scc__apply1__df__lam_4_1__df__lam_5_2__lift_14__lift_15__lift_2__lift_3(v__args){
    return (v__cps__scc__apply1__df__lam_4_1__df__lam_5_2__lift_14__lift_15__lift_2__lift_3)(v__args, [29]);
}

function v__cps__scc__apply1__df__lam_4_1__df__lam_5_2__lift_14__lift_15__lift_2__lift_3(v__args, v__k){
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
...
function v__apply1(v__cl, v__arg0){
    return (v__scc__apply1__df__lam_4_1__df__lam_5_2__lift_14__lift_15__lift_2__lift_3)([16, v__cl, v__arg0]);
}
