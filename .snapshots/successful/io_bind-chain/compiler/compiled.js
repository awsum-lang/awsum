...
const main = (v__df_andThenIO_0)((v__lift_8)([2, "a", [0, [0]]]));
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 3: {
          const v___f0 = __s[1];
          return (v__apply__lift_1)(v__k, [3, [1, v___f0]]);
        }
      }
    }
  }
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 3: {
          const v___f0 = __s[1];
          return (v__apply__lift_8)(v__k, [3, [2, v___f0]]);
        }
      }
    }
  }
...
function v__scc__apply1__df__lam_3_1__lift_2__lift_9(v__args){
    return (v__cps__scc__apply1__df__lam_3_1__lift_2__lift_9)(v__args, [0]);
}
...
function v__apply1(v__cl, v__arg0){
    return (v__scc__apply1__df__lam_3_1__lift_2__lift_9)([0, v__cl, v__arg0]);
}
