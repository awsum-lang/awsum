...
(() => {
  ...
  const v__cps__scc__apply1__df__lam_0_1__df__lam_1_2__df__lam_2_3 = (
    v__args,
    v__k
  ) => {
    while (true) {
  ...
  const v__scc__apply1__df__lam_0_1__df__lam_1_2__df__lam_2_3 = (v__args) => {
    return v__cps__scc__apply1__df__lam_0_1__df__lam_1_2__df__lam_2_3(
      v__args,
      [20]
    );
  };
  ...
  const v__apply1 = (v__cl, v__arg0) => {
    return v__scc__apply1__df__lam_0_1__df__lam_1_2__df__lam_2_3(
      [14, v__cl, v__arg0]
    );
  };
  ...
  const v__df_andThenIO_0 = (v_io) => {
    return v__cps__df_andThenIO_0(v_io, [18]);
  };
