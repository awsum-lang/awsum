...
case.arm.3.5:
  ...
  switch i64 %t11, label %case.default.12 [ i64 2252990199, label %case.arm.2252990199.14 i64 2269767818, label %case.arm.2269767818.38 ]
...
case.default.21:
  unreachable
case.join.22:
  %t37 = phi ptr [%t25, %case.end.19.24]
...
case.arm.2269767818.38:
  ...
  switch i64 %t44, label %case.default.45 [ i64 20, label %case.arm.20.47 ]
case.arm.20.47:
  ...
  br label %case.end.20.48
case.end.20.48:
  br label %case.join.46
case.default.45:
  unreachable
case.join.46:
  %t61 = phi ptr [%t49, %case.end.20.48]
...
case.default.12:
  unreachable
case.join.13:
  %t62 = phi ptr [%t37, %case.end.2252990199.15], [%t61, %case.end.2269767818.39]
...
case.default.3:
  unreachable
case.join.4:
  %t80 = phi ptr [%t62, %case.end.3.6], [%t67, %case.end.4.64]
  ret ptr %t80
}
