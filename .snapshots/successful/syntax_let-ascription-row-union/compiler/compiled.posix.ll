...
case.arm.4.40:
  ...
  %t45 = call ptr @v__lift_18(ptr %t44)
...
case.join.5:
  ...
  %t48 = call ptr @v__let_19(ptr %t47)
  ret ptr %t48
}
...
define internal ptr @v__let_19(ptr %v_res) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 3, label %case.arm.3.4 i64 4, label %case.arm.4.51 ]
case.arm.3.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 2252990199, label %case.arm.2252990199.11 i64 2269767818, label %case.arm.2269767818.31 ]
...
case.arm.24.18:
  ...
  %t30 = getelementptr ptr, ptr %t19, i32 2
...
case.default.10:
  unreachable
case.arm.4.51:
  %t52 = getelementptr ptr, ptr %v_res, i32 1
  ...
  call void @__inc_ref(ptr %t53)
  %t57 = call ptr @__showInt32(ptr %t53)
  ...
  %t66 = getelementptr ptr, ptr %t54, i32 2
