...
case.arm.0.5:
  ...
  switch i64 %t11, label %case.default.12 [ i64 2252990199, label %case.arm.2252990199.14 i64 2269767818, label %case.arm.2269767818.30 i64 2448244154, label %case.arm.2448244154.46 ]
...
case.default.12:
  unreachable
case.join.13:
  %t62 = phi ptr [%t18, %case.end.2252990199.15], [%t34, %case.end.2269767818.31], [%t50, %case.end.2448244154.47]
