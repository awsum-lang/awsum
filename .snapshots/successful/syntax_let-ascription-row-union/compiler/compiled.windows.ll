...
@.str.0 = private unnamed_addr constant {i32, i32, [5 x i8]} { i32 5, i32 5, [5 x i8] c"ERR_A" }
@.str.1 = private unnamed_addr constant {i32, i32, [5 x i8]} { i32 5, i32 5, [5 x i8] c"ERR_B" }
...
define internal ptr @v__let_2(ptr %v_res) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 0, label %case.arm.0.5 i64 1, label %case.arm.1.87 ]
case.arm.0.5:
  ...
  switch i64 %t11, label %case.default.12 [ i64 2252990199, label %case.arm.2252990199.14 i64 2269767818, label %case.arm.2269767818.38 i64 2448244154, label %case.arm.2448244154.62 ]
...
case.default.45:
  unreachable
case.join.46:
  %t61 = phi ptr [%t49, %case.end.0.48]
  br label %case.end.2269767818.39
case.end.2269767818.39:
  br label %case.join.13
case.arm.2448244154.62:
  %t64 = getelementptr ptr, ptr %t8, i32 1
  %t65 = load ptr, ptr %t64
  %t66 = getelementptr ptr, ptr %t65, i32 0
  %t67 = load ptr, ptr %t66
  %t68 = ptrtoint ptr %t67 to i64
  switch i64 %t68, label %case.default.69 [ i64 0, label %case.arm.0.71 ]
case.arm.0.71:
  %t73 = call ptr @malloc(i64 24)
  %t74 = inttoptr i64 2 to ptr
  %t75 = getelementptr ptr, ptr %t73, i32 0
  store ptr %t74, ptr %t75
  %t76 = getelementptr ptr, ptr %t73, i32 1
  store ptr @.str.2, ptr %t76
  ...
  %t84 = getelementptr ptr, ptr %t73, i32 2
...
case.default.69:
  unreachable
case.join.70:
  %t85 = phi ptr [%t73, %case.end.0.72]
  br label %case.end.2448244154.63
case.end.2448244154.63:
  br label %case.join.13
case.default.12:
  unreachable
case.join.13:
  %t86 = phi ptr [%t37, %case.end.2252990199.15], [%t61, %case.end.2269767818.39], [%t85, %case.end.2448244154.63]
  br label %case.end.0.6
case.end.0.6:
  br label %case.join.4
case.arm.1.87:
  %t89 = getelementptr ptr, ptr %v_res, i32 1
  %t90 = load ptr, ptr %t89
  %t91 = call ptr @malloc(i64 24)
  %t92 = inttoptr i64 2 to ptr
  %t93 = getelementptr ptr, ptr %t91, i32 0
  store ptr %t92, ptr %t93
  %t94 = call ptr @__showInt32(ptr %t90)
  ...
  %t103 = getelementptr ptr, ptr %t91, i32 2
...
case.default.3:
  unreachable
case.join.4:
  %t104 = phi ptr [%t86, %case.end.0.6], [%t91, %case.end.1.88]
  ret ptr %t104
}
