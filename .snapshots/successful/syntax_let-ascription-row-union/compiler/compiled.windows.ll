...
case.arm.0.5:
  ...
  switch i64 %t11, label %case.default.12 [ i64 2252990199, label %case.arm.2252990199.14 i64 2269767818, label %case.arm.2269767818.20 i64 2448244154, label %case.arm.2448244154.26 ]
...
case.arm.2269767818.20:
  ...
  %t24 = getelementptr [6 x i8], ptr @.str.1, i64 0, i64 0
...
case.default.12:
  unreachable
case.join.13:
  %t32 = phi ptr [%t19, %case.end.2252990199.15], [%t25, %case.end.2269767818.21], [%t31, %case.end.2448244154.27]
