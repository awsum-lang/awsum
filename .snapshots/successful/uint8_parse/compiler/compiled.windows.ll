...
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [3 x i8]} { i32 0, i32 0, i32 0, i32 3, i32 3, [3 x i8] c"255" }
@.str.4 = private unnamed_addr constant {i32, i32, i32, i32, i32, [3 x i8]} { i32 0, i32 0, i32 0, i32 3, i32 3, [3 x i8] c"256" }
...
@.str.10 = private unnamed_addr constant {i32, i32, i32, i32, i32, [2 x i8]} { i32 0, i32 0, i32 0, i32 2, i32 2, [2 x i8] c", " }
@.str.11 = private unnamed_addr constant {i32, i32, i32, i32, i32, [15 x i8]} { i32 0, i32 0, i32 0, i32 15, i32 15, [15 x i8] c"STRING_TOO_LONG" }
...
case.arm.4.32:
  ...
  %t36 = call ptr @__parseUInt8(ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
...
case.arm.4.48:
  ...
  %t52 = call ptr @__showUInt8(ptr %t51)
...
case.arm.4.68:
  ...
  %t72 = call ptr @__parseUInt8(ptr getelementptr inbounds (i8, ptr @.str.4, i64 12))
...
case.arm.4.84:
  ...
  %t88 = call ptr @__showUInt8(ptr %t87)
...
case.arm.4.104:
  ...
  %t108 = call ptr @__parseUInt8(ptr getelementptr inbounds (i8, ptr @.str.5, i64 12))
...
case.arm.4.120:
  ...
  %t124 = call ptr @__showUInt8(ptr %t123)
...
case.arm.4.140:
  ...
  %t144 = call ptr @__parseUInt8(ptr getelementptr inbounds (i8, ptr @.str.6, i64 12))
...
case.arm.4.156:
  ...
  %t160 = call ptr @__showUInt8(ptr %t159)
...
case.arm.4.176:
  ...
  %t180 = call ptr @__parseUInt8(ptr getelementptr inbounds (i8, ptr @.str.7, i64 12))
...
case.arm.4.192:
  ...
  %t196 = call ptr @__showUInt8(ptr %t195)
...
case.arm.4.212:
  ...
  %t216 = call ptr @__parseUInt8(ptr getelementptr inbounds (i8, ptr @.str.8, i64 12))
...
case.arm.4.228:
  ...
  %t232 = call ptr @__showUInt8(ptr %t231)
...
case.arm.4.248:
  ...
  %t252 = call ptr @__parseUInt8(ptr getelementptr inbounds (i8, ptr @.str.9, i64 12))
...
case.arm.4.264:
  ...
  %t268 = call ptr @__showUInt8(ptr %t267)
...
case.arm.4.284:
  ...
  call void @__inc_ref(ptr %t35)
  %t288 = call ptr @__concat(ptr %t35, ptr getelementptr inbounds (i8, ptr @.str.10, i64 12))
  %t289 = getelementptr ptr, ptr %t288, i32 0
  %t290 = load ptr, ptr %t289
  %t291 = ptrtoint ptr %t290 to i64
  switch i64 %t291, label %case.default.292 [ i64 3, label %case.arm.3.294 i64 4, label %case.arm.4.302 ]
case.arm.3.294:
  %t296 = getelementptr ptr, ptr %t288, i32 1
  %t297 = load ptr, ptr %t296
  call void @__inc_ref(ptr %t297)
  %t298 = call ptr @__alloc(i64 16, i32 1)
  %t299 = inttoptr i64 3 to ptr
...
case.arm.4.302:
  %t304 = getelementptr ptr, ptr %t288, i32 1
  %t305 = load ptr, ptr %t304
  call void @__inc_ref(ptr %t305)
  call void @__inc_ref(ptr %t305)
  call void @__inc_ref(ptr %t71)
  %t306 = call ptr @__concat(ptr %t305, ptr %t71)
...
case.arm.4.320:
  ...
  call void @__inc_ref(ptr %t323)
  %t324 = call ptr @__concat(ptr %t323, ptr getelementptr inbounds (i8, ptr @.str.10, i64 12))
...
case.arm.4.338:
  ...
  call void @__inc_ref(ptr %t341)
  call void @__inc_ref(ptr %t107)
  %t342 = call ptr @__concat(ptr %t341, ptr %t107)
...
case.arm.4.356:
  ...
  call void @__inc_ref(ptr %t359)
  %t360 = call ptr @__concat(ptr %t359, ptr getelementptr inbounds (i8, ptr @.str.10, i64 12))
...
case.arm.4.374:
  ...
  call void @__inc_ref(ptr %t377)
  call void @__inc_ref(ptr %t143)
  %t378 = call ptr @__concat(ptr %t377, ptr %t143)
...
case.arm.4.392:
  ...
  call void @__inc_ref(ptr %t395)
  %t396 = call ptr @__concat(ptr %t395, ptr getelementptr inbounds (i8, ptr @.str.10, i64 12))
...
case.arm.4.410:
  ...
  call void @__inc_ref(ptr %t413)
  call void @__inc_ref(ptr %t179)
  %t414 = call ptr @__concat(ptr %t413, ptr %t179)
...
case.arm.4.428:
  ...
  call void @__inc_ref(ptr %t431)
  %t432 = call ptr @__concat(ptr %t431, ptr getelementptr inbounds (i8, ptr @.str.10, i64 12))
...
case.arm.4.446:
  ...
  call void @__inc_ref(ptr %t449)
  call void @__inc_ref(ptr %t215)
  %t450 = call ptr @__concat(ptr %t449, ptr %t215)
...
case.arm.4.464:
  ...
  call void @__inc_ref(ptr %t467)
  %t468 = call ptr @__concat(ptr %t467, ptr getelementptr inbounds (i8, ptr @.str.10, i64 12))
...
case.arm.4.482:
  ...
  call void @__inc_ref(ptr %t485)
  call void @__inc_ref(ptr %t251)
  %t486 = call ptr @__concat(ptr %t485, ptr %t251)
...
case.arm.4.500:
  ...
  call void @__inc_ref(ptr %t503)
  %t504 = call ptr @__concat(ptr %t503, ptr getelementptr inbounds (i8, ptr @.str.10, i64 12))
...
case.arm.4.518:
  ...
  call void @__inc_ref(ptr %t521)
  call void @__inc_ref(ptr %t287)
  %t522 = call ptr @__concat(ptr %t521, ptr %t287)
...
case.default.508:
  unreachable
case.join.509:
  %t523 = phi ptr [ %t514, %case.end.3.511 ], [ %t522, %case.end.4.519 ]
...
case.default.490:
  unreachable
case.join.491:
  %t524 = phi ptr [ %t496, %case.end.3.493 ], [ %t523, %case.end.4.501 ]
...
case.default.472:
  unreachable
case.join.473:
  %t525 = phi ptr [ %t478, %case.end.3.475 ], [ %t524, %case.end.4.483 ]
...
case.default.454:
  unreachable
case.join.455:
  %t526 = phi ptr [ %t460, %case.end.3.457 ], [ %t525, %case.end.4.465 ]
...
case.default.436:
  unreachable
case.join.437:
  %t527 = phi ptr [ %t442, %case.end.3.439 ], [ %t526, %case.end.4.447 ]
...
case.default.418:
  unreachable
case.join.419:
  %t528 = phi ptr [ %t424, %case.end.3.421 ], [ %t527, %case.end.4.429 ]
...
case.default.400:
  unreachable
case.join.401:
  %t529 = phi ptr [ %t406, %case.end.3.403 ], [ %t528, %case.end.4.411 ]
...
case.default.382:
  unreachable
case.join.383:
  %t530 = phi ptr [ %t388, %case.end.3.385 ], [ %t529, %case.end.4.393 ]
...
case.default.364:
  unreachable
case.join.365:
  %t531 = phi ptr [ %t370, %case.end.3.367 ], [ %t530, %case.end.4.375 ]
...
case.default.346:
  unreachable
case.join.347:
  %t532 = phi ptr [ %t352, %case.end.3.349 ], [ %t531, %case.end.4.357 ]
...
case.default.328:
  unreachable
case.join.329:
  %t533 = phi ptr [ %t334, %case.end.3.331 ], [ %t532, %case.end.4.339 ]
...
case.default.310:
  unreachable
case.join.311:
  %t534 = phi ptr [ %t316, %case.end.3.313 ], [ %t533, %case.end.4.321 ]
  call void @__free_recursive(ptr %t306)
  br label %case.end.4.303
case.end.4.303:
  br label %case.join.293
case.default.292:
  unreachable
case.join.293:
  %t535 = phi ptr [ %t298, %case.end.3.295 ], [ %t534, %case.end.4.303 ]
...
case.default.274:
  unreachable
case.join.275:
  %t536 = phi ptr [ %t280, %case.end.3.277 ], [ %t535, %case.end.4.285 ]
...
case.default.238:
  unreachable
case.join.239:
  %t537 = phi ptr [ %t244, %case.end.3.241 ], [ %t536, %case.end.4.249 ]
...
case.default.202:
  unreachable
case.join.203:
  %t538 = phi ptr [ %t208, %case.end.3.205 ], [ %t537, %case.end.4.213 ]
...
case.default.166:
  unreachable
case.join.167:
  %t539 = phi ptr [ %t172, %case.end.3.169 ], [ %t538, %case.end.4.177 ]
...
case.default.130:
  unreachable
case.join.131:
  %t540 = phi ptr [ %t136, %case.end.3.133 ], [ %t539, %case.end.4.141 ]
...
case.default.94:
  unreachable
case.join.95:
  %t541 = phi ptr [ %t100, %case.end.3.97 ], [ %t540, %case.end.4.105 ]
...
case.default.58:
  unreachable
case.join.59:
  %t542 = phi ptr [ %t64, %case.end.3.61 ], [ %t541, %case.end.4.69 ]
...
case.default.22:
  unreachable
case.join.23:
  %t543 = phi ptr [ %t28, %case.end.3.25 ], [ %t542, %case.end.4.33 ]
...
tco.case.arm.6.13:
  ...
  store ptr getelementptr inbounds (i8, ptr @.str.11, i64 12), ptr %t17
