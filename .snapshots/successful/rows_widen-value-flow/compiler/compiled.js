...
(() => {
  ...
  const v_strWiden = (v__inl3___input =>
    (s => {
      switch (s[0]) {
        case 3: {
  ...
  const v_defBodyRight = (v__inl24___input =>
    (s => {
      switch (s[0]) {
        case 3: {
    ...
    })(v__inl24___input))(v_vOkA);

  const v_defBodyLeft = (v__inl21___input =>
    (s => {
      switch (s[0]) {
        case 3: {
