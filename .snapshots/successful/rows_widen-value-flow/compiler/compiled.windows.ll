...
case.arm.1.4:
  %t5 = call ptr @v_vErrA()
  %t6 = call ptr @v__lift_13(ptr %t5)
  call void @__free_recursive(ptr %v_flag)
  ret ptr %t6
case.arm.2.7:
  %t8 = call ptr @v_vErrB()
  %t9 = call ptr @v__lift_14(ptr %t8)
  call void @__free_recursive(ptr %v_flag)
  ret ptr %t9
case.default.3:
  unreachable
...
case.arm.1.14:
  ...
  %t16 = call ptr @v__lift_17(ptr %t15)
...
define internal ptr @v__let_15(ptr %v_x) {
  call void @__inc_ref(ptr %v_x)
  %t0 = call ptr @v__lift_14(ptr %v_x)
  call void @__free_recursive(ptr %v_x)
  ret ptr %t0
}
