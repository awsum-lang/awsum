...
case.arm.4.14:
  ...
  switch i64 %t22, label %case.default.23 [ i64 3, label %case.arm.3.25 i64 4, label %case.arm.4.37 ]
case.arm.3.25:
  ...
  %t31 = inttoptr i64 589989748 to ptr
  %t32 = getelementptr ptr, ptr %t30, i32 0
  store ptr %t31, ptr %t32
  %t33 = getelementptr ptr, ptr %t19, i32 1
  %t34 = load ptr, ptr %t33
  call void @__inc_ref(ptr %t34)
  %t35 = getelementptr ptr, ptr %t30, i32 1
  store ptr %t34, ptr %t35
  %t36 = getelementptr ptr, ptr %t27, i32 1
...
case.default.23:
  unreachable
case.join.24:
  %t39 = phi ptr [ %t27, %case.end.3.26 ], [ %t19, %case.end.4.38 ]
...
case.default.4:
  unreachable
case.join.5:
  %t40 = phi ptr [ %t10, %case.end.3.7 ], [ %t39, %case.end.4.15 ]
