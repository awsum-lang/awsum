...
define internal ptr @v_un(ptr %v_c) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.4 i64 20, label %case.arm.20.7 i64 21, label %case.arm.21.10 i64 22, label %case.arm.22.13 i64 23, label %case.arm.23.16 i64 24, label %case.arm.24.19 i64 25, label %case.arm.25.22 i64 26, label %case.arm.26.25 i64 27, label %case.arm.27.28 i64 28, label %case.arm.28.31 i64 29, label %case.arm.29.34 i64 30, label %case.arm.30.37 i64 31, label %case.arm.31.40 i64 32, label %case.arm.32.43 i64 33, label %case.arm.33.46 i64 34, label %case.arm.34.49 i64 35, label %case.arm.35.52 i64 36, label %case.arm.36.55 i64 37, label %case.arm.37.58 i64 38, label %case.arm.38.61 i64 39, label %case.arm.39.64 i64 40, label %case.arm.40.67 i64 41, label %case.arm.41.70 i64 42, label %case.arm.42.73 i64 43, label %case.arm.43.76 i64 44, label %case.arm.44.79 i64 45, label %case.arm.45.82 i64 46, label %case.arm.46.85 i64 47, label %case.arm.47.88 i64 48, label %case.arm.48.91 i64 49, label %case.arm.49.94 i64 50, label %case.arm.50.97 i64 51, label %case.arm.51.100 i64 52, label %case.arm.52.103 i64 53, label %case.arm.53.106 i64 54, label %case.arm.54.109 i64 55, label %case.arm.55.112 i64 56, label %case.arm.56.115 i64 57, label %case.arm.57.118 i64 58, label %case.arm.58.121 i64 59, label %case.arm.59.124 i64 60, label %case.arm.60.127 i64 61, label %case.arm.61.130 i64 62, label %case.arm.62.133 i64 63, label %case.arm.63.136 i64 64, label %case.arm.64.139 i64 65, label %case.arm.65.142 i64 66, label %case.arm.66.145 i64 67, label %case.arm.67.148 i64 68, label %case.arm.68.151 i64 69, label %case.arm.69.154 i64 70, label %case.arm.70.157 i64 71, label %case.arm.71.160 i64 72, label %case.arm.72.163 i64 73, label %case.arm.73.166 i64 74, label %case.arm.74.169 i64 75, label %case.arm.75.172 i64 76, label %case.arm.76.175 i64 77, label %case.arm.77.178 i64 78, label %case.arm.78.181 i64 79, label %case.arm.79.184 i64 80, label %case.arm.80.187 i64 81, label %case.arm.81.190 i64 82, label %case.arm.82.193 i64 83, label %case.arm.83.196 i64 84, label %case.arm.84.199 i64 85, label %case.arm.85.202 i64 86, label %case.arm.86.205 i64 87, label %case.arm.87.208 i64 88, label %case.arm.88.211 i64 89, label %case.arm.89.214 i64 90, label %case.arm.90.217 i64 91, label %case.arm.91.220 i64 92, label %case.arm.92.223 i64 93, label %case.arm.93.226 i64 94, label %case.arm.94.229 i64 95, label %case.arm.95.232 i64 96, label %case.arm.96.235 i64 97, label %case.arm.97.238 i64 98, label %case.arm.98.241 i64 99, label %case.arm.99.244 i64 100, label %case.arm.100.247 i64 101, label %case.arm.101.250 i64 102, label %case.arm.102.253 i64 103, label %case.arm.103.256 i64 104, label %case.arm.104.259 i64 105, label %case.arm.105.262 i64 106, label %case.arm.106.265 i64 107, label %case.arm.107.268 i64 108, label %case.arm.108.271 i64 109, label %case.arm.109.274 i64 110, label %case.arm.110.277 i64 111, label %case.arm.111.280 i64 112, label %case.arm.112.283 i64 113, label %case.arm.113.286 i64 114, label %case.arm.114.289 i64 115, label %case.arm.115.292 i64 116, label %case.arm.116.295 i64 117, label %case.arm.117.298 i64 118, label %case.arm.118.301 i64 119, label %case.arm.119.304 i64 120, label %case.arm.120.307 i64 121, label %case.arm.121.310 i64 122, label %case.arm.122.313 i64 123, label %case.arm.123.316 i64 124, label %case.arm.124.319 i64 125, label %case.arm.125.322 i64 126, label %case.arm.126.325 i64 127, label %case.arm.127.328 i64 128, label %case.arm.128.331 i64 129, label %case.arm.129.334 i64 130, label %case.arm.130.337 i64 131, label %case.arm.131.340 i64 132, label %case.arm.132.343 i64 133, label %case.arm.133.346 i64 134, label %case.arm.134.349 i64 135, label %case.arm.135.352 i64 136, label %case.arm.136.355 i64 137, label %case.arm.137.358 i64 138, label %case.arm.138.361 i64 139, label %case.arm.139.364 i64 140, label %case.arm.140.367 i64 141, label %case.arm.141.370 i64 142, label %case.arm.142.373 i64 143, label %case.arm.143.376 i64 144, label %case.arm.144.379 i64 145, label %case.arm.145.382 i64 146, label %case.arm.146.385 i64 147, label %case.arm.147.388 i64 148, label %case.arm.148.391 i64 149, label %case.arm.149.394 i64 150, label %case.arm.150.397 i64 151, label %case.arm.151.400 i64 152, label %case.arm.152.403 i64 153, label %case.arm.153.406 i64 154, label %case.arm.154.409 i64 155, label %case.arm.155.412 i64 156, label %case.arm.156.415 i64 157, label %case.arm.157.418 i64 158, label %case.arm.158.421 i64 159, label %case.arm.159.424 i64 160, label %case.arm.160.427 i64 161, label %case.arm.161.430 i64 162, label %case.arm.162.433 i64 163, label %case.arm.163.436 i64 164, label %case.arm.164.439 i64 165, label %case.arm.165.442 i64 166, label %case.arm.166.445 i64 167, label %case.arm.167.448 i64 168, label %case.arm.168.451 i64 169, label %case.arm.169.454 i64 170, label %case.arm.170.457 i64 171, label %case.arm.171.460 i64 172, label %case.arm.172.463 i64 173, label %case.arm.173.466 i64 174, label %case.arm.174.469 i64 175, label %case.arm.175.472 i64 176, label %case.arm.176.475 i64 177, label %case.arm.177.478 i64 178, label %case.arm.178.481 i64 179, label %case.arm.179.484 i64 180, label %case.arm.180.487 i64 181, label %case.arm.181.490 i64 182, label %case.arm.182.493 i64 183, label %case.arm.183.496 i64 184, label %case.arm.184.499 i64 185, label %case.arm.185.502 i64 186, label %case.arm.186.505 i64 187, label %case.arm.187.508 i64 188, label %case.arm.188.511 i64 189, label %case.arm.189.514 i64 190, label %case.arm.190.517 i64 191, label %case.arm.191.520 i64 192, label %case.arm.192.523 i64 193, label %case.arm.193.526 i64 194, label %case.arm.194.529 i64 195, label %case.arm.195.532 i64 196, label %case.arm.196.535 i64 197, label %case.arm.197.538 i64 198, label %case.arm.198.541 i64 199, label %case.arm.199.544 i64 200, label %case.arm.200.547 i64 201, label %case.arm.201.550 i64 202, label %case.arm.202.553 i64 203, label %case.arm.203.556 i64 204, label %case.arm.204.559 i64 205, label %case.arm.205.562 i64 206, label %case.arm.206.565 i64 207, label %case.arm.207.568 i64 208, label %case.arm.208.571 i64 209, label %case.arm.209.574 i64 210, label %case.arm.210.577 i64 211, label %case.arm.211.580 i64 212, label %case.arm.212.583 i64 213, label %case.arm.213.586 i64 214, label %case.arm.214.589 i64 215, label %case.arm.215.592 i64 216, label %case.arm.216.595 i64 217, label %case.arm.217.598 i64 218, label %case.arm.218.601 i64 219, label %case.arm.219.604 i64 220, label %case.arm.220.607 i64 221, label %case.arm.221.610 i64 222, label %case.arm.222.613 i64 223, label %case.arm.223.616 i64 224, label %case.arm.224.619 i64 225, label %case.arm.225.622 i64 226, label %case.arm.226.625 i64 227, label %case.arm.227.628 i64 228, label %case.arm.228.631 i64 229, label %case.arm.229.634 i64 230, label %case.arm.230.637 i64 231, label %case.arm.231.640 i64 232, label %case.arm.232.643 i64 233, label %case.arm.233.646 i64 234, label %case.arm.234.649 i64 235, label %case.arm.235.652 i64 236, label %case.arm.236.655 i64 237, label %case.arm.237.658 i64 238, label %case.arm.238.661 i64 239, label %case.arm.239.664 i64 240, label %case.arm.240.667 i64 241, label %case.arm.241.670 i64 242, label %case.arm.242.673 i64 243, label %case.arm.243.676 i64 244, label %case.arm.244.679 i64 245, label %case.arm.245.682 i64 246, label %case.arm.246.685 i64 247, label %case.arm.247.688 i64 248, label %case.arm.248.691 i64 249, label %case.arm.249.694 i64 250, label %case.arm.250.697 i64 251, label %case.arm.251.700 i64 252, label %case.arm.252.703 i64 253, label %case.arm.253.706 i64 254, label %case.arm.254.709 i64 255, label %case.arm.255.712 i64 256, label %case.arm.256.715 i64 257, label %case.arm.257.718 i64 258, label %case.arm.258.721 i64 259, label %case.arm.259.724 i64 260, label %case.arm.260.727 i64 261, label %case.arm.261.730 i64 262, label %case.arm.262.733 i64 263, label %case.arm.263.736 i64 264, label %case.arm.264.739 i64 265, label %case.arm.265.742 i64 266, label %case.arm.266.745 i64 267, label %case.arm.267.748 i64 268, label %case.arm.268.751 i64 269, label %case.arm.269.754 i64 270, label %case.arm.270.757 i64 271, label %case.arm.271.760 i64 272, label %case.arm.272.763 i64 273, label %case.arm.273.766 i64 274, label %case.arm.274.769 i64 275, label %case.arm.275.772 i64 276, label %case.arm.276.775 i64 277, label %case.arm.277.778 i64 278, label %case.arm.278.781 i64 279, label %case.arm.279.784 i64 280, label %case.arm.280.787 i64 281, label %case.arm.281.790 i64 282, label %case.arm.282.793 i64 283, label %case.arm.283.796 i64 284, label %case.arm.284.799 i64 285, label %case.arm.285.802 i64 286, label %case.arm.286.805 i64 287, label %case.arm.287.808 i64 288, label %case.arm.288.811 i64 289, label %case.arm.289.814 i64 290, label %case.arm.290.817 i64 291, label %case.arm.291.820 i64 292, label %case.arm.292.823 i64 293, label %case.arm.293.826 i64 294, label %case.arm.294.829 i64 295, label %case.arm.295.832 i64 296, label %case.arm.296.835 i64 297, label %case.arm.297.838 i64 298, label %case.arm.298.841 i64 299, label %case.arm.299.844 i64 300, label %case.arm.300.847 i64 301, label %case.arm.301.850 i64 302, label %case.arm.302.853 i64 303, label %case.arm.303.856 i64 304, label %case.arm.304.859 i64 305, label %case.arm.305.862 i64 306, label %case.arm.306.865 i64 307, label %case.arm.307.868 i64 308, label %case.arm.308.871 i64 309, label %case.arm.309.874 i64 310, label %case.arm.310.877 i64 311, label %case.arm.311.880 i64 312, label %case.arm.312.883 i64 313, label %case.arm.313.886 i64 314, label %case.arm.314.889 i64 315, label %case.arm.315.892 i64 316, label %case.arm.316.895 i64 317, label %case.arm.317.898 i64 318, label %case.arm.318.901 ]
case.arm.19.4:
