...
define internal ptr @v_un(ptr %v_c) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 20, label %case.arm.20.4 i64 21, label %case.arm.21.7 i64 22, label %case.arm.22.10 i64 23, label %case.arm.23.13 i64 24, label %case.arm.24.16 i64 25, label %case.arm.25.19 i64 26, label %case.arm.26.22 i64 27, label %case.arm.27.25 i64 28, label %case.arm.28.28 i64 29, label %case.arm.29.31 i64 30, label %case.arm.30.34 i64 31, label %case.arm.31.37 i64 32, label %case.arm.32.40 i64 33, label %case.arm.33.43 i64 34, label %case.arm.34.46 i64 35, label %case.arm.35.49 i64 36, label %case.arm.36.52 i64 37, label %case.arm.37.55 i64 38, label %case.arm.38.58 i64 39, label %case.arm.39.61 i64 40, label %case.arm.40.64 i64 41, label %case.arm.41.67 i64 42, label %case.arm.42.70 i64 43, label %case.arm.43.73 i64 44, label %case.arm.44.76 i64 45, label %case.arm.45.79 i64 46, label %case.arm.46.82 i64 47, label %case.arm.47.85 i64 48, label %case.arm.48.88 i64 49, label %case.arm.49.91 i64 50, label %case.arm.50.94 i64 51, label %case.arm.51.97 i64 52, label %case.arm.52.100 i64 53, label %case.arm.53.103 i64 54, label %case.arm.54.106 i64 55, label %case.arm.55.109 i64 56, label %case.arm.56.112 i64 57, label %case.arm.57.115 i64 58, label %case.arm.58.118 i64 59, label %case.arm.59.121 i64 60, label %case.arm.60.124 i64 61, label %case.arm.61.127 i64 62, label %case.arm.62.130 i64 63, label %case.arm.63.133 i64 64, label %case.arm.64.136 i64 65, label %case.arm.65.139 i64 66, label %case.arm.66.142 i64 67, label %case.arm.67.145 i64 68, label %case.arm.68.148 i64 69, label %case.arm.69.151 i64 70, label %case.arm.70.154 i64 71, label %case.arm.71.157 i64 72, label %case.arm.72.160 i64 73, label %case.arm.73.163 i64 74, label %case.arm.74.166 i64 75, label %case.arm.75.169 i64 76, label %case.arm.76.172 i64 77, label %case.arm.77.175 i64 78, label %case.arm.78.178 i64 79, label %case.arm.79.181 i64 80, label %case.arm.80.184 i64 81, label %case.arm.81.187 i64 82, label %case.arm.82.190 i64 83, label %case.arm.83.193 i64 84, label %case.arm.84.196 i64 85, label %case.arm.85.199 i64 86, label %case.arm.86.202 i64 87, label %case.arm.87.205 i64 88, label %case.arm.88.208 i64 89, label %case.arm.89.211 i64 90, label %case.arm.90.214 i64 91, label %case.arm.91.217 i64 92, label %case.arm.92.220 i64 93, label %case.arm.93.223 i64 94, label %case.arm.94.226 i64 95, label %case.arm.95.229 i64 96, label %case.arm.96.232 i64 97, label %case.arm.97.235 i64 98, label %case.arm.98.238 i64 99, label %case.arm.99.241 i64 100, label %case.arm.100.244 i64 101, label %case.arm.101.247 i64 102, label %case.arm.102.250 i64 103, label %case.arm.103.253 i64 104, label %case.arm.104.256 i64 105, label %case.arm.105.259 i64 106, label %case.arm.106.262 i64 107, label %case.arm.107.265 i64 108, label %case.arm.108.268 i64 109, label %case.arm.109.271 i64 110, label %case.arm.110.274 i64 111, label %case.arm.111.277 i64 112, label %case.arm.112.280 i64 113, label %case.arm.113.283 i64 114, label %case.arm.114.286 i64 115, label %case.arm.115.289 i64 116, label %case.arm.116.292 i64 117, label %case.arm.117.295 i64 118, label %case.arm.118.298 i64 119, label %case.arm.119.301 i64 120, label %case.arm.120.304 i64 121, label %case.arm.121.307 i64 122, label %case.arm.122.310 i64 123, label %case.arm.123.313 i64 124, label %case.arm.124.316 i64 125, label %case.arm.125.319 i64 126, label %case.arm.126.322 i64 127, label %case.arm.127.325 i64 128, label %case.arm.128.328 i64 129, label %case.arm.129.331 i64 130, label %case.arm.130.334 i64 131, label %case.arm.131.337 i64 132, label %case.arm.132.340 i64 133, label %case.arm.133.343 i64 134, label %case.arm.134.346 i64 135, label %case.arm.135.349 i64 136, label %case.arm.136.352 i64 137, label %case.arm.137.355 i64 138, label %case.arm.138.358 i64 139, label %case.arm.139.361 i64 140, label %case.arm.140.364 i64 141, label %case.arm.141.367 i64 142, label %case.arm.142.370 i64 143, label %case.arm.143.373 i64 144, label %case.arm.144.376 i64 145, label %case.arm.145.379 i64 146, label %case.arm.146.382 i64 147, label %case.arm.147.385 i64 148, label %case.arm.148.388 i64 149, label %case.arm.149.391 i64 150, label %case.arm.150.394 i64 151, label %case.arm.151.397 i64 152, label %case.arm.152.400 i64 153, label %case.arm.153.403 i64 154, label %case.arm.154.406 i64 155, label %case.arm.155.409 i64 156, label %case.arm.156.412 i64 157, label %case.arm.157.415 i64 158, label %case.arm.158.418 i64 159, label %case.arm.159.421 i64 160, label %case.arm.160.424 i64 161, label %case.arm.161.427 i64 162, label %case.arm.162.430 i64 163, label %case.arm.163.433 i64 164, label %case.arm.164.436 i64 165, label %case.arm.165.439 i64 166, label %case.arm.166.442 i64 167, label %case.arm.167.445 i64 168, label %case.arm.168.448 i64 169, label %case.arm.169.451 i64 170, label %case.arm.170.454 i64 171, label %case.arm.171.457 i64 172, label %case.arm.172.460 i64 173, label %case.arm.173.463 i64 174, label %case.arm.174.466 i64 175, label %case.arm.175.469 i64 176, label %case.arm.176.472 i64 177, label %case.arm.177.475 i64 178, label %case.arm.178.478 i64 179, label %case.arm.179.481 i64 180, label %case.arm.180.484 i64 181, label %case.arm.181.487 i64 182, label %case.arm.182.490 i64 183, label %case.arm.183.493 i64 184, label %case.arm.184.496 i64 185, label %case.arm.185.499 i64 186, label %case.arm.186.502 i64 187, label %case.arm.187.505 i64 188, label %case.arm.188.508 i64 189, label %case.arm.189.511 i64 190, label %case.arm.190.514 i64 191, label %case.arm.191.517 i64 192, label %case.arm.192.520 i64 193, label %case.arm.193.523 i64 194, label %case.arm.194.526 i64 195, label %case.arm.195.529 i64 196, label %case.arm.196.532 i64 197, label %case.arm.197.535 i64 198, label %case.arm.198.538 i64 199, label %case.arm.199.541 i64 200, label %case.arm.200.544 i64 201, label %case.arm.201.547 i64 202, label %case.arm.202.550 i64 203, label %case.arm.203.553 i64 204, label %case.arm.204.556 i64 205, label %case.arm.205.559 i64 206, label %case.arm.206.562 i64 207, label %case.arm.207.565 i64 208, label %case.arm.208.568 i64 209, label %case.arm.209.571 i64 210, label %case.arm.210.574 i64 211, label %case.arm.211.577 i64 212, label %case.arm.212.580 i64 213, label %case.arm.213.583 i64 214, label %case.arm.214.586 i64 215, label %case.arm.215.589 i64 216, label %case.arm.216.592 i64 217, label %case.arm.217.595 i64 218, label %case.arm.218.598 i64 219, label %case.arm.219.601 i64 220, label %case.arm.220.604 i64 221, label %case.arm.221.607 i64 222, label %case.arm.222.610 i64 223, label %case.arm.223.613 i64 224, label %case.arm.224.616 i64 225, label %case.arm.225.619 i64 226, label %case.arm.226.622 i64 227, label %case.arm.227.625 i64 228, label %case.arm.228.628 i64 229, label %case.arm.229.631 i64 230, label %case.arm.230.634 i64 231, label %case.arm.231.637 i64 232, label %case.arm.232.640 i64 233, label %case.arm.233.643 i64 234, label %case.arm.234.646 i64 235, label %case.arm.235.649 i64 236, label %case.arm.236.652 i64 237, label %case.arm.237.655 i64 238, label %case.arm.238.658 i64 239, label %case.arm.239.661 i64 240, label %case.arm.240.664 i64 241, label %case.arm.241.667 i64 242, label %case.arm.242.670 i64 243, label %case.arm.243.673 i64 244, label %case.arm.244.676 i64 245, label %case.arm.245.679 i64 246, label %case.arm.246.682 i64 247, label %case.arm.247.685 i64 248, label %case.arm.248.688 i64 249, label %case.arm.249.691 i64 250, label %case.arm.250.694 i64 251, label %case.arm.251.697 i64 252, label %case.arm.252.700 i64 253, label %case.arm.253.703 i64 254, label %case.arm.254.706 i64 255, label %case.arm.255.709 i64 256, label %case.arm.256.712 i64 257, label %case.arm.257.715 i64 258, label %case.arm.258.718 i64 259, label %case.arm.259.721 i64 260, label %case.arm.260.724 i64 261, label %case.arm.261.727 i64 262, label %case.arm.262.730 i64 263, label %case.arm.263.733 i64 264, label %case.arm.264.736 i64 265, label %case.arm.265.739 i64 266, label %case.arm.266.742 i64 267, label %case.arm.267.745 i64 268, label %case.arm.268.748 i64 269, label %case.arm.269.751 i64 270, label %case.arm.270.754 i64 271, label %case.arm.271.757 i64 272, label %case.arm.272.760 i64 273, label %case.arm.273.763 i64 274, label %case.arm.274.766 i64 275, label %case.arm.275.769 i64 276, label %case.arm.276.772 i64 277, label %case.arm.277.775 i64 278, label %case.arm.278.778 i64 279, label %case.arm.279.781 i64 280, label %case.arm.280.784 i64 281, label %case.arm.281.787 i64 282, label %case.arm.282.790 i64 283, label %case.arm.283.793 i64 284, label %case.arm.284.796 i64 285, label %case.arm.285.799 i64 286, label %case.arm.286.802 i64 287, label %case.arm.287.805 i64 288, label %case.arm.288.808 i64 289, label %case.arm.289.811 i64 290, label %case.arm.290.814 i64 291, label %case.arm.291.817 i64 292, label %case.arm.292.820 i64 293, label %case.arm.293.823 i64 294, label %case.arm.294.826 i64 295, label %case.arm.295.829 i64 296, label %case.arm.296.832 i64 297, label %case.arm.297.835 i64 298, label %case.arm.298.838 i64 299, label %case.arm.299.841 i64 300, label %case.arm.300.844 i64 301, label %case.arm.301.847 i64 302, label %case.arm.302.850 i64 303, label %case.arm.303.853 i64 304, label %case.arm.304.856 i64 305, label %case.arm.305.859 i64 306, label %case.arm.306.862 i64 307, label %case.arm.307.865 i64 308, label %case.arm.308.868 i64 309, label %case.arm.309.871 i64 310, label %case.arm.310.874 i64 311, label %case.arm.311.877 i64 312, label %case.arm.312.880 i64 313, label %case.arm.313.883 i64 314, label %case.arm.314.886 i64 315, label %case.arm.315.889 i64 316, label %case.arm.316.892 i64 317, label %case.arm.317.895 i64 318, label %case.arm.318.898 i64 319, label %case.arm.319.901 ]
case.arm.20.4:
