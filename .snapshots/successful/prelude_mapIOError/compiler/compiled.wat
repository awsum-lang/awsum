...
(module
  ...
  (table 11 funcref)
  (elem (i32.const 0) $v_failIO $v_runIO $v_handler $v__lam_13 $v__let_14 $v__df_mapIOError_0 $v__cps__df_mapIOError_0 $v__apply__df_mapIOError_0 $v__df_handleErrorIO_4 $v__cps__df_handleErrorIO_4 $v__apply__df_handleErrorIO_4)
