...
define internal ptr @v_main() {
  ...
  %t6 = inttoptr i64 28 to ptr
  %t7 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t6, ptr %t7
  %t8 = call ptr @v_$cps$$df$handleErrorIO$4(ptr %t4, ptr %t5)
  ret ptr %t8
}
...
tco.case.arm.6.13:
  ...
  %t21 = call ptr @v_$apply$$df$mapIOError$0(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.13:
  ...
  %t26 = call ptr @v_$apply$$df$handleErrorIO$4(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
