...
define internal ptr @v_main() {
  ...
  store ptr %t6, ptr %t7
  %t8 = call ptr @v__cps__df_handleErrorIO_4(ptr %t4, ptr %t5)
  ret ptr %t8
}
...
tco.case.arm.6.13:
  ...
  %t21 = call ptr @v__apply__df_mapIOError_0(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.13:
  ...
  %t26 = call ptr @v__apply__df_handleErrorIO_4(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
