...
(() => {
  ...
  const v__cps__df_mapIOError_0 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 6: {
          return v__apply__df_mapIOError_0(v__k, [6, [25]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v__cps__df_handleErrorIO_4 = (v_io, v__k) => {
    while (true) {
      switch (v_io[0]) {
        ...
        case 6: {
          return v__apply__df_handleErrorIO_4(v__k, [7, "ErrB", [5, [0]]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const main = v__cps__df_handleErrorIO_4(
    v__cps__df_mapIOError_0(v_action, [26]),
    [28]
  );
