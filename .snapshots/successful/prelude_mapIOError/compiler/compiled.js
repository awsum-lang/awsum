...
const v_action = (v_failIO)([24]);

const v__lam_23 = (v__a) => {
    return [25];
};

const v__cps__scc__apply1__df__lam_11_1__df__lam_12_2__df__lam_13_3__df__lam_14_5__df__lam_15_6__df__lam_16_7 = (v__args, v__k) => {
  while (true) {
    {
      const __s = v__args;
      switch (__s[0]) {
...
const v__scc__apply1__df__lam_11_1__df__lam_12_2__df__lam_13_3__df__lam_14_5__df__lam_15_6__df__lam_16_7 = (v__args) => {
    return (v__cps__scc__apply1__df__lam_11_1__df__lam_12_2__df__lam_13_3__df__lam_14_5__df__lam_15_6__df__lam_16_7)(v__args, [43]);
};

const v__apply1 = (v__cl, v__arg0) => {
    return (v__scc__apply1__df__lam_11_1__df__lam_12_2__df__lam_13_3__df__lam_14_5__df__lam_15_6__df__lam_16_7)([32, v__cl, v__arg0]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 6: {
          const v_e = __s[1];
          return (v__apply__df_mapIOError_0)(v__k, [6, (v__lam_23)(v_e)]);
        }
        case 7: {
          const v_s = __s[1];
          const v_next = __s[2];
        ...
        case 8: {
          const v_cont = __s[1];
          return (v__apply__df_mapIOError_0)(v__k, [8, [26, v_cont]]);
        }
        case 9: {
          const v_cont = __s[1];
          return (v__apply__df_mapIOError_0)(v__k, [9, [27, v_cont]]);
        }
        case 10: {
          const v_cont = __s[1];
          return (v__apply__df_mapIOError_0)(v__k, [10, [28, v_cont]]);
        }
      }
    }
  }
...
const v__df_mapIOError_0 = (v_io) => {
    return (v__cps__df_mapIOError_0)(v_io, [39]);
};
  ...
  while (true) {
    {
      ...
      switch (__s[0]) {
        ...
        case 8: {
          const v_cont = __s[1];
          return (v__apply__df_handleErrorIO_4)(v__k, [8, [29, v_cont]]);
        }
        case 9: {
          const v_cont = __s[1];
          return (v__apply__df_handleErrorIO_4)(v__k, [9, [30, v_cont]]);
        }
        case 10: {
          const v_cont = __s[1];
...
const v__let_24 = (v_renamed) => {
    return (v__df_handleErrorIO_4)(v_renamed);
};

const main = (v__let_24)((v__df_mapIOError_0)(v_action));
