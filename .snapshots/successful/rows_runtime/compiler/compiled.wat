...
(module
  ...
  (data (i32.const 84) "\00\00\00\00\00\00\00\00\00\00\00\00\07\00\00\00\07\00\00\00String ")
  (data (i32.const 111) "\00\00\00\00\00\00\00\00\00\00\00\00\05\00\00\00\05\00\00\00hello")
  (data (i32.const 136) "\00\00\00\00\00\00\00\00\00\00\00\00\0f\00\00\00\0f\00\00\00STRING_TOO_LONG")
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v_describe $v__let_12)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_describe (param $v_x i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s)) (block (result i32) (local.set $__drop_tmp (call $__concat (i32.const 96) (block (result i32) (local.set $__inc_tmp (local.get $v_s)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__free_recursive (local.get $v_s)) (local.get $__drop_tmp))))

  (func $v_main (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (call $v_describe (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 1615808600)) (i32.store offset=4 (local.get $__con_0) (i32.const 123)) (local.get $__con_0)))))
