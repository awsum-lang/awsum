...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__let_7 (call $v_describe (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 1615808600)) (i32.store offset=4 (local.get $__con_0) (i32.const 123)) (local.get $__con_0)))))
