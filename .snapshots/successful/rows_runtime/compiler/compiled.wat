...
(module
  ...
  (table 3 funcref)
  (elem (i32.const 0) $v_describe $v_main $v__let_1)
  ...
  (func $v_main (param $v__input i32) (result i32)
    (local $__con_0 i32)
    (call $v__let_1 (call $v_describe (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1615808600)) (i32.store offset=4 (local.get $__con_0) (i32.const 80)) (local.get $__con_0)))))
