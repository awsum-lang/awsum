...
(module
  ...
  (data (i32.const 65) "String \00")
  (data (i32.const 73) "Int32 \00")
  (data (i32.const 80) "hello\00")
  (data (i32.const 86) "STRING_TOO_LONG\00")
  (table 4 funcref)
  (elem (i32.const 0) $v_runIO $v_describe $v_main $v__let_2)
  ...
  (func $v_describe (param $v_x i32) (result i32)
    ...
    (local $v_s i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1615808600)) (then (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (i32.const 65) (local.get $v_s))) (local.get $__con_0))) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__concat (i32.const 73) (call $__show_i32 (local.get $v_n)))) (local.get $__con_0))))))

  (func $v_main (param $v__input i32) (result i32)
    (local $__con_0 i32)
    (call $v__let_2 (call $v_describe (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1615808600)) (i32.store offset=4 (local.get $__con_0) (i32.const 80)) (local.get $__con_0)))))
