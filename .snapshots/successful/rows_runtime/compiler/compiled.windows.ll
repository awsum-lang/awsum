...
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [7 x i8]} { i32 0, i32 0, i32 0, i32 7, i32 7, [7 x i8] c"String " }
...
define internal ptr @v_main() {
  ...
  %t6 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.1, i64 12), ptr %t5)
  %t7 = getelementptr ptr, ptr %t6, i32 0
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %case.default.10 [ i64 3, label %case.arm.3.12 i64 4, label %case.arm.4.26 ]
case.arm.3.12:
...
case.default.10:
  unreachable
case.join.11:
  %t42 = phi ptr [ %t14, %case.end.3.13 ], [ %t30, %case.end.4.27 ]
