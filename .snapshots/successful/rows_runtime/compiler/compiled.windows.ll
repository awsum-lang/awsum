...
@.str.0 = private unnamed_addr constant [8 x i8] c"String \00"
@.str.1 = private unnamed_addr constant [7 x i8] c"Int32 \00"
...
define internal ptr @v_describe(ptr %v_x) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 1615808600, label %case.arm.1615808600.5 i64 2711245919, label %case.arm.2711245919.15 ]
case.arm.1615808600.5:
  ...
  %t12 = getelementptr [8 x i8], ptr @.str.0, i64 0, i64 0
...
case.arm.2711245919.15:
  %t17 = getelementptr ptr, ptr %v_x, i32 1
  %t18 = load ptr, ptr %t17
  %t19 = call ptr @malloc(i64 16)
  %t20 = inttoptr i64 1 to ptr
  %t21 = getelementptr ptr, ptr %t19, i32 0
  store ptr %t20, ptr %t21
  %t22 = getelementptr [7 x i8], ptr @.str.1, i64 0, i64 0
  %t23 = call ptr @__showInt32(ptr %t18)
  %t24 = call ptr @__concat(ptr %t22, ptr %t23)
  %t25 = getelementptr ptr, ptr %t19, i32 1
  store ptr %t24, ptr %t25
  br label %case.end.2711245919.16
case.end.2711245919.16:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t26 = phi ptr [%t9, %case.end.1615808600.6], [%t19, %case.end.2711245919.16]
  ret ptr %t26
}
...
define internal ptr @v_main(ptr %v__input) {
  ...
  store ptr %t1, ptr %t2
  %t3 = getelementptr [6 x i8], ptr @.str.2, i64 0, i64 0
  %t4 = getelementptr ptr, ptr %t0, i32 1
  store ptr %t3, ptr %t4
  %t5 = call ptr @v_describe(ptr %t0)
  %t6 = call ptr @v__let_1(ptr %t5)
  ret ptr %t6
}
