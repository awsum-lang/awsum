...
(() => {
  ...
  const v__inl8___input = v_defaultJust;
  const v__inl11_m = (s => {
    switch (s[0]) {
      case 11: {
      ...
      case 4: {
        const v_a = s[1];
        {
          ...
          switch (__s[0]) {
            ...
            case 4: {
              const v_b = __s[1];
              const v__inl15___input = v_defaultRight;
              const v__inl21_r = (s => {
                switch (s[0]) {
                  case 3: {
  ...
  const v__inl24_x = v_res;
  const main = v__cps__df_handleErrorIO_0(
    v__cps__df_andThenIO_4(
      (s => {
        switch (s[0]) {
          case 3: {
            return [6, v__inl24_x[1]];
          }
          case 4: {
            return [5, v__inl24_x[1]];
          }
        }
      })(v__inl24_x),
      [33]
