...
@.str.1 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"T" }
@.str.2 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"F" }
@.str.3 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"N" }
@.str.4 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"J" }
@.str.5 = private unnamed_addr constant {i32, i32, [0 x i8]} { i32 0, i32 0, [0 x i8] zeroinitializer }
@.str.6 = private unnamed_addr constant {i32, i32, [4 x i8]} { i32 4, i32 4, [4 x i8] c"ErrA" }
@.str.7 = private unnamed_addr constant {i32, i32, [3 x i8]} { i32 3, i32 3, [3 x i8] c" / " }
@.str.8 = private unnamed_addr constant {i32, i32, [15 x i8]} { i32 15, i32 15, [15 x i8] c"STRING_TOO_LONG" }
...
define internal ptr @v_dispatchInner(ptr %v_x) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 796142685, label %case.arm.796142685.5 i64 1759602215, label %case.arm.1759602215.19 ]
case.arm.796142685.5:
  ...
  switch i64 %t11, label %case.default.12 [ i64 0, label %case.arm.0.14 i64 1, label %case.arm.1.16 ]
case.arm.0.14:
...
case.default.12:
  unreachable
case.join.13:
  %t18 = phi ptr [@.str.1, %case.end.0.15], [@.str.2, %case.end.1.17]
  br label %case.end.796142685.6
case.end.796142685.6:
  br label %case.join.4
case.arm.1759602215.19:
  %t21 = getelementptr ptr, ptr %v_x, i32 1
  %t22 = load ptr, ptr %t21
  %t23 = call ptr @v_showUnit(ptr %t22)
  br label %case.end.1759602215.20
case.end.1759602215.20:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t24 = phi ptr [%t18, %case.end.796142685.6], [%t23, %case.end.1759602215.20]
  ret ptr %t24
}
...
case.arm.1.11:
  ...
  %t16 = call ptr @__concat(ptr @.str.4, ptr %t15)
...
case.default.3:
  unreachable
case.join.4:
  %t17 = phi ptr [%t7, %case.end.0.6], [%t16, %case.end.1.12]
  ret ptr %t17
}
...
case.arm.1.56:
  ...
  %t60 = call ptr @__concat(ptr %t19, ptr @.str.7)
...
case.arm.1.92:
  ...
  %t96 = call ptr @__concat(ptr %t95, ptr @.str.7)
