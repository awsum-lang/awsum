...
case.arm.1.12:
  ...
  %t16 = getelementptr [2 x i8], ptr @.str.4, i64 0, i64 0
  %t17 = call ptr @v_dispatchInner(ptr %t15)
...
case.default.3:
  unreachable
case.join.4:
  %t19 = phi ptr [%t7, %case.end.0.6], [%t18, %case.end.1.13]
  ret ptr %t19
}
...
case.arm.1.56:
  ...
  %t60 = getelementptr [4 x i8], ptr @.str.7, i64 0, i64 0
  %t61 = call ptr @__concat(ptr %t19, ptr %t60)
...
case.arm.1.75:
  ...
  %t79 = call ptr @__concat(ptr %t78, ptr %t39)
...
case.arm.1.93:
  ...
  %t97 = getelementptr [4 x i8], ptr @.str.7, i64 0, i64 0
...
case.arm.1.112:
  ...
  %t116 = call ptr @__concat(ptr %t115, ptr %t59)
...
case.default.102:
  unreachable
case.join.103:
  %t117 = phi ptr [%t108, %case.end.0.105], [%t116, %case.end.1.113]
...
case.default.83:
  unreachable
case.join.84:
  %t118 = phi ptr [%t89, %case.end.0.86], [%t117, %case.end.1.94]
...
case.default.65:
  unreachable
case.join.66:
  %t119 = phi ptr [%t71, %case.end.0.68], [%t118, %case.end.1.76]
...
case.default.46:
  unreachable
case.join.47:
  %t120 = phi ptr [%t52, %case.end.0.49], [%t119, %case.end.1.57]
...
case.default.26:
  unreachable
case.join.27:
  %t121 = phi ptr [%t32, %case.end.0.29], [%t120, %case.end.1.37]
...
case.default.6:
  unreachable
case.join.7:
  %t122 = phi ptr [%t12, %case.end.0.9], [%t121, %case.end.1.17]
  ret ptr %t122
}
