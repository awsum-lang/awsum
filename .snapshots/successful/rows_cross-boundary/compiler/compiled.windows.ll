...
define internal ptr @v_$cps$describeLst(ptr %v_xs, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.25.11:
  ...
  %t16 = call ptr @v_$apply$describeLst(ptr %t6, ptr %t12)
...
define internal ptr @v_$apply$describeLst(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
...
define internal ptr @v_$cps$$lift$14(ptr %v_____input, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.25.11:
  ...
  %t12 = call ptr @v_$apply$$lift$14(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$lift$14(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
