...
@.str.0 = private unnamed_addr constant {i32, i32, [9 x i8]} { i32 9, i32 9, [9 x i8] c"not found" }
@.str.1 = private unnamed_addr constant {i32, i32, [5 x i8]} { i32 5, i32 5, [5 x i8] c"hello" }
@.str.2 = private unnamed_addr constant {i32, i32, [2 x i8]} { i32 2, i32 2, [2 x i8] c", " }
...
define internal ptr @v_unwrap(ptr %v_x) {
  %t0 = getelementptr ptr, ptr %v_x, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.5 i64 20, label %case.arm.20.9 ]
case.arm.19.5:
...
case.default.3:
  unreachable
case.join.4:
  %t11 = phi ptr [%t8, %case.end.19.6], [@.str.0, %case.end.20.10]
  ret ptr %t11
}
...
define internal ptr @v_main() {
  ...
  %t5 = call ptr @__concat(ptr %t4, ptr @.str.2)
...
case.arm.4.19:
  ...
  %t24 = inttoptr i64 20 to ptr
  %t25 = getelementptr ptr, ptr %t23, i32 0
  store ptr %t24, ptr %t25
  %t26 = call ptr @v__lift_7(ptr %t23)
...
define internal ptr @v__lift_7(ptr %v___input) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.5 i64 20, label %case.arm.20.13 ]
case.arm.19.5:
  %t7 = getelementptr ptr, ptr %v___input, i32 1
  %t8 = load ptr, ptr %t7
  %t9 = call ptr @malloc(i64 16)
  %t10 = inttoptr i64 19 to ptr
...
case.arm.20.13:
  ...
  %t17 = getelementptr ptr, ptr %t15, i32 0
  store ptr %t16, ptr %t17
  br label %case.end.20.14
case.end.20.14:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t18 = phi ptr [%t9, %case.end.19.6], [%t15, %case.end.20.14]
  ret ptr %t18
}
