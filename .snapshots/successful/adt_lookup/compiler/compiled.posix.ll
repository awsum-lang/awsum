...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"not found" }
...
define internal ptr @v_unwrap(ptr %v_x) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.4 i64 20, label %case.arm.20.7 ]
case.arm.19.4:
...
define internal ptr @v_main() {
  ...
  %t5 = call ptr @__concat(ptr %t4, ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
...
define internal ptr @v__lift_7(ptr %v___input) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.4 i64 20, label %case.arm.20.11 ]
case.arm.19.4:
  %t5 = getelementptr ptr, ptr %v___input, i32 1
  %t6 = load ptr, ptr %t5
  call void @__inc_ref(ptr %t6)
  %t7 = call ptr @__alloc(i64 16, i32 1)
  %t8 = inttoptr i64 19 to ptr
