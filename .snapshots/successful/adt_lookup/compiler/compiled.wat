...
(module
  ...
  (func $v_unwrap (param $v_x i32) (result i32)
    (local $v_value i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v_value (i32.load offset=4 (local.get $__scrut))) (local.get $v_value)) (else (i32.const 65)))))
