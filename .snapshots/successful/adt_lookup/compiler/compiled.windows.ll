...
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"not found" }
...
define internal ptr @v_res() {
  ...
  switch i64 %t6, label %case.default.7 [ i64 24, label %case.arm.24.9 i64 25, label %case.arm.25.13 ]
case.arm.24.9:
...
case.arm.25.13:
  br label %case.end.25.14
case.end.25.14:
  br label %case.join.8
case.default.7:
  unreachable
case.join.8:
  %t15 = phi ptr [ %t12, %case.end.24.10 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.25.14 ]
  call void @__free_recursive(ptr %t0)
  %t16 = call ptr @__concat(ptr %t15, ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
...
case.arm.4.30:
  ...
  %t37 = getelementptr ptr, ptr %t34, i32 0
  %t38 = load ptr, ptr %t37
  %t39 = ptrtoint ptr %t38 to i64
  switch i64 %t39, label %case.default.40 [ i64 24, label %case.arm.24.42 i64 25, label %case.arm.25.46 ]
case.arm.24.42:
  %t44 = getelementptr ptr, ptr %t34, i32 1
  %t45 = load ptr, ptr %t44
  call void @__inc_ref(ptr %t45)
  br label %case.end.24.43
case.end.24.43:
  br label %case.join.41
case.arm.25.46:
  br label %case.end.25.47
case.end.25.47:
  br label %case.join.41
case.default.40:
  unreachable
case.join.41:
  %t48 = phi ptr [ %t45, %case.end.24.43 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.25.47 ]
  call void @__free_recursive(ptr %t34)
  %t49 = call ptr @__concat(ptr %t33, ptr %t48)
...
case.default.20:
  unreachable
case.join.21:
  %t50 = phi ptr [ %t26, %case.end.3.23 ], [ %t49, %case.end.4.31 ]
