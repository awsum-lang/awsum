...
define internal ptr @v_unwrap(ptr %v_x) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 24, label %case.arm.24.4 i64 25, label %case.arm.25.7 ]
case.arm.24.4:
...
case.arm.4.19:
  ...
  %t26 = call ptr @v__lift_23(ptr %t23)
...
case.join.10:
  ...
  %t30 = call ptr @v__let_24(ptr %t29)
  ret ptr %t30
}
...
define internal ptr @v__lift_23(ptr %v___input) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 24, label %case.arm.24.4 i64 25, label %case.arm.25.11 ]
case.arm.24.4:
