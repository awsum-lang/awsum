...
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [5 x i8]} { i32 0, i32 0, i32 0, i32 5, i32 5, [5 x i8] c"hello" }
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"not found" }
...
define internal ptr @v_main() {
  ...
  store ptr %t3, ptr %t4
  %t5 = getelementptr ptr, ptr %t2, i32 1
  store ptr getelementptr inbounds (i8, ptr @.str.1, i64 12), ptr %t5
  %t6 = getelementptr ptr, ptr %t2, i32 0
  %t7 = load ptr, ptr %t6
  %t8 = ptrtoint ptr %t7 to i64
  switch i64 %t8, label %case.default.9 [ i64 24, label %case.arm.24.11 i64 25, label %case.arm.25.15 ]
case.arm.24.11:
...
case.default.9:
  unreachable
case.join.10:
  %t17 = phi ptr [ %t14, %case.end.24.12 ], [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.25.16 ]
  call void @__free_recursive(ptr %t2)
  %t18 = call ptr @__concat(ptr %t17, ptr getelementptr inbounds (i8, ptr @.str.3, i64 12))
...
join.case.arm.4.37:
  ...
  %t43 = getelementptr ptr, ptr %t40, i32 0
...
case.arm.24.48:
  %t50 = getelementptr ptr, ptr %t40, i32 1
...
case.default.46:
  unreachable
case.join.47:
  %t54 = phi ptr [ %t51, %case.end.24.49 ], [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.25.53 ]
  call void @__free_recursive(ptr %t40)
  %t55 = call ptr @__concat(ptr %t39, ptr %t54)
  call void @__free_recursive(ptr %t18)
  store ptr %t55, ptr %v__inl8_scrut.jslot
  br label %join.0
join.case.default.22:
  unreachable
join.0:
  %t56 = load ptr, ptr %v__inl8_scrut.jslot
  %t57 = getelementptr ptr, ptr %t56, i32 0
  %t58 = load ptr, ptr %t57
  %t59 = ptrtoint ptr %t58 to i64
  switch i64 %t59, label %case.default.60 [ i64 3, label %case.arm.3.62 i64 4, label %case.arm.4.76 ]
case.arm.3.62:
  %t64 = call ptr @__alloc(i64 24, i32 2)
  %t65 = inttoptr i64 7 to ptr
  %t66 = getelementptr ptr, ptr %t64, i32 0
  store ptr %t65, ptr %t66
  %t67 = getelementptr ptr, ptr %t64, i32 1
  store ptr getelementptr inbounds (i8, ptr @.str.0, i64 12), ptr %t67
  ...
  %t75 = getelementptr ptr, ptr %t64, i32 2
...
case.arm.4.76:
  ...
  %t81 = getelementptr ptr, ptr %t56, i32 1
  ...
  %t91 = getelementptr ptr, ptr %t78, i32 2
...
case.default.60:
  unreachable
case.join.61:
  %t92 = phi ptr [ %t64, %case.end.3.63 ], [ %t78, %case.end.4.77 ]
  call void @__free_recursive(ptr %t56)
  br label %join.end.93
join.end.93:
  br label %join.after.1
join.after.1:
  %t94 = phi ptr [ %t24, %join.val.36 ], [ %t92, %join.end.93 ]
  ret ptr %t94
}
