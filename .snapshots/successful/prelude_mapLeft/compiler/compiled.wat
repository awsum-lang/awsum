...
(module
  ...
  (global $heap (mut i32) (i32.const 219))
  ...
  (data (i32.const 119) "\00\00\00\00\00\00\00\00\00\00\00\00\11\00\00\00\11\00\00\00bad-Left bad-Left")
  ...
  (table 8 funcref)
  (elem (i32.const 0) $v_runIO $v__let_12 $v__lam_13 $v__let_14 $v__lam_15 $v__let_16 $v__df_mapLeft_0 $v__df_mapLeft_1)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_good (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 42))) (local.get $__con_0)))

  (func $v_main (result i32)
    (local $__drop_tmp i32)
    (call $v__let_16 (call $v__df_mapLeft_0 (call $v_bad))))
  ...
  (func $v__let_14 (param $v_renamedBad i32) (param $v_renamedGood i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_12 (block (result i32) (local.set $__scrut (local.get $v_renamedBad)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___p0)) (block (result i32) (local.set $__scrut (local.get $v_renamedGood)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___p0)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 131)) (local.get $__con_0)))) (call $__free_recursive (local.get $v___p0)) (local.get $__drop_tmp))) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_n)) (block (result i32) (local.set $__drop_tmp (call $__concat (i32.const 168) (call $__show_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))) (call $__free_recursive (local.get $v_n)) (local.get $__drop_tmp))))))) (call $__free_recursive (local.get $v___p0)) (local.get $__drop_tmp))) (else (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___w0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 208)) (local.get $__con_0))) (call $__free_recursive (local.get $v___w0)) (local.get $__drop_tmp)))))))

  (func $v__lam_15 (param $v__a i32) (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 23)) (local.get $__con_0)))

  (func $v__let_16 (param $v_renamedBad i32) (result i32)
    (local $__drop_tmp i32)
    (call $v__let_14 (block (result i32) (local.set $__inc_tmp (local.get $v_renamedBad)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v__df_mapLeft_1 (call $v_good))))
  ...
  (func $v__df_mapLeft_0 (param $v_x i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (call $v__lam_15 (block (result i32) (local.set $__inc_tmp (local.get $v_e)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (local.get $__con_0))) (call $__free_recursive (local.get $v_e)) (local.get $__drop_tmp))) (else (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (local.get $v_a)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))))

  (func $v__df_mapLeft_1 (param $v_x i32) (result i32)
    (local $__con_0 i32)
    (local $v_a i32)
    (local $v_e i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (call $v__lam_13 (block (result i32) (local.set $__inc_tmp (local.get $v_e)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (local.get $__con_0))) (call $__free_recursive (local.get $v_e)) (local.get $__drop_tmp))) (else (local.set $v_a (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_a)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (local.get $v_a)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_a)) (local.get $__drop_tmp))))))
