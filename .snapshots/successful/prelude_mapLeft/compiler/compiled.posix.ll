...
define internal ptr @v__lam_13(ptr %v__a) {
...
define internal ptr @v__let_14(ptr %v_renamedBad, ptr %v_renamedGood) {
...
case.arm.3.5:
  ...
  switch i64 %t11, label %case.default.12 [ i64 23, label %case.arm.23.14 ]
case.arm.23.14:
...
case.arm.3.21:
  ...
  switch i64 %t27, label %case.default.28 [ i64 23, label %case.arm.23.30 ]
case.arm.23.30:
  ...
  br label %case.end.23.31
case.end.23.31:
  br label %case.join.29
case.default.28:
  unreachable
case.join.29:
  %t36 = phi ptr [%t32, %case.end.23.31]
...
case.join.20:
  ...
  br label %case.end.23.15
case.end.23.15:
  br label %case.join.13
case.default.12:
  unreachable
case.join.13:
  %t44 = phi ptr [%t43, %case.end.23.15]
...
define internal ptr @v__let_16(ptr %v_renamedBad) {
  call void @__inc_ref(ptr %v_renamedBad)
  %t0 = call ptr @v_good()
  %t1 = call ptr @v__df_mapLeft_1(ptr %t0)
  %t2 = call ptr @v__let_14(ptr %v_renamedBad, ptr %t1)
  call void @__free_recursive(ptr %v_renamedBad)
  ret ptr %t2
}
