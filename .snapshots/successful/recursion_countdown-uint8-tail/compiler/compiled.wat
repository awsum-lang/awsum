...
(module
  ...
  (table 5 funcref)
  (elem (i32.const 0) $v_runIO $v_showUnderflowError $v_countDown $v_showResult $v__let_7)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    (local $__drop_tmp i32)
    (call $v__let_7 (call $v_showResult (call $v_countDown (call $__box_i32 (i32.const 255)) (i32.const 76)))))
