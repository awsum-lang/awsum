...
tco.case.arm.1.53:
  ...
  %t56 = getelementptr [2 x i8], ptr @.str.1, i64 0, i64 0
  %t57 = call ptr @__concat(ptr %t55, ptr %t56)
  %t58 = getelementptr ptr, ptr %t57, i32 0
  %t59 = load ptr, ptr %t58
  %t60 = ptrtoint ptr %t59 to i64
  switch i64 %t60, label %tco.case.default.61 [ i64 0, label %tco.case.arm.0.62 i64 1, label %tco.case.arm.1.73 ]
tco.case.arm.0.62:
  ...
  %t69 = inttoptr i64 3768445577 to ptr
...
case.arm.3768445577.23:
  ...
  %t27 = getelementptr [7 x i8], ptr @.str.3, i64 0, i64 0
  %t28 = call ptr @v_showUnderflowError(ptr %t26)
...
case.default.12:
  unreachable
case.join.13:
  %t30 = phi ptr [%t18, %case.end.589989748.15], [%t29, %case.end.3768445577.24]
...
case.arm.1.31:
  ...
  %t35 = getelementptr [8 x i8], ptr @.str.4, i64 0, i64 0
  %t36 = call ptr @__concat(ptr %t35, ptr %t34)
