...
(module
  ...
  (table 7 funcref)
  (elem (i32.const 0) $v_runIO $v_showUnderflowError $v_showResult $v_main $v__let_2 $v__scc_pingOne_pongTwo $v_pingOne)
  ...
  (func $v_main (param $v__input i32) (result i32)
    (call $v__let_2 (call $v_showResult (call $v_pingOne (call $__box_i32 (i32.const 100000))))))
  ...
  (func $v__scc_pingOne_pongTwo (param $v__args i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__k0 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (local.get $v__args)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__eq_i32 (local.get $v_n) (call $__box_i32 (i32.const 0)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 0))) (local.get $__con_0))) (else (block (result i32) (local.set $__scrut (call $__predInt32 (local.get $v_n))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (local.get $__con_0))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (local.get $v_m)) (i32.store offset=8 (local.get $__con_0) (call $__box_i32 (i32.const 0))) (local.get $__con_0))) (local.set $v__args (local.get $__k0)) (br $tco_top)))))))) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (local.set $v__acc (i32.load offset=8 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__eq_i32 (local.get $v_n) (call $__box_i32 (i32.const 0)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 1)) (i32.store offset=4 (local.get $__con_0) (call $__box_i32 (i32.const 0))) (local.get $__con_0))) (else (block (result i32) (local.set $__scrut (call $__predInt32 (local.get $v_n))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (local.get $__con_0))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v_m)) (local.get $__con_0))) (local.set $v__args (local.get $__k0)) (br $tco_top))))))))))))

  (func $v_pingOne (param $v_n i32) (result i32)
    (local $__con_0 i32)
    (call $v__scc_pingOne_pongTwo (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 0)) (i32.store offset=4 (local.get $__con_0) (local.get $v_n)) (local.get $__con_0))))
