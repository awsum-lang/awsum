...
define internal ptr @v_res() {
  ...
  store ptr %t3, ptr %t4
  %t5 = call ptr @v_$scc$pingOne__pongTwo(ptr %t0)
...
define internal ptr @v_$scc$pingOne__pongTwo(ptr %v_$args) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t6 = load ptr, ptr %t5
  %t7 = ptrtoint ptr %t6 to i64
  switch i64 %t7, label %tco.case.default.8 [ i64 20, label %tco.case.arm.20.9 i64 21, label %tco.case.arm.21.46 ]
tco.case.arm.20.9:
  %t10 = getelementptr ptr, ptr %t4, i32 1
  %t11 = load ptr, ptr %t10
  call void @__inc_ref(ptr %t11)
