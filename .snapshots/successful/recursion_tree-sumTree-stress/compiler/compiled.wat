...
(module
  ...
  (table 6 funcref)
  (elem (i32.const 0) $v_runIO $v_buildLeft $v_addOr0 $v_sumTree $v__scc__apply_sumTree__cps_sumTree $v__cps_sumTree)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_buildLeft (param $v_n i32) (param $v_acc i32) (result i32)
    (local $__con_0 i32)
    (local $__con_1 i32)
    (local $v_e i32)
    (local $v_m i32)
    ...
    (local $__k0 i32)
    (local $__k1 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (call $__eq_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $__box_i32 (i32.const 0)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1)) (then (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (local.get $v_acc)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v_acc)) (local.get $__drop_tmp))) (else (block (result i32) (local.set $__scrut (call $__predInt32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__drop_tmp (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v_e)) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v_acc)) (local.get $__drop_tmp))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_m)) (local.set $__k0 (local.get $v_m)) (local.set $__k1 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 16) (i32.const 3))) (i32.const 20)) (i32.store offset=4 (local.get $__con_0) (local.get $v_acc)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (i32.store offset=8 (local.get $__con_0) (call $__box_i32 (i32.const 1))) (i32.store offset=12 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 19)) (local.get $__con_1))) (local.get $__con_0))) (call $__inc_ref (local.get $__k0)) (call $__free_recursive (local.get $v_acc)) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v_m)) (local.set $v_n (local.get $__k0)) (local.set $v_acc (local.get $__k1)) (br $tco_top)))))))))

  (func $v_addOr0 (param $v_a i32) (param $v_b i32) (result i32)
    (local $v__e i32)
    (local $v_v i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (call $__addInt32 (block (result i32) (local.set $__inc_tmp (local.get $v_a)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_b)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__e)) (block (result i32) (local.set $__drop_tmp (call $__box_i32 (i32.const 0))) (call $__free_recursive (local.get $v__e)) (local.get $__drop_tmp))) (else (local.set $v_v (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_v)) (block (result i32) (local.set $__drop_tmp (local.get $v_v)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_v)) (local.get $__drop_tmp))))))

  (func $v_sumTree (param $v_t i32) (param $v_acc i32) (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__cps_sumTree (block (result i32) (local.set $__inc_tmp (local.get $v_t)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_acc)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 21)) (local.get $__con_0))))
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (call $v_buildLeft (call $__box_i32 (i32.const 100000)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 19)) (local.get $__con_0)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__e)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (i32.const 96)) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0))) (else (local.set $v_t (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_t)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (call $__show_i32 (call $v_sumTree (block (result i32) (local.set $__inc_tmp (local.get $v_t)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $__box_i32 (i32.const 0))))) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0))))))

  (func $v__scc__apply_sumTree__cps_sumTree (param $v__args i32) (result i32)
    (local $__con_0 i32)
    (local $v__k i32)
    (local $v__pk_22 i32)
    (local $v__x i32)
    ...
    (local $__drop_tmp i32)
    (local $__k0 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (local.get $v__args)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 23)) (then (local.set $v__k (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__k)) (local.set $v__x (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v__x)) (block (result i32) (local.set $__scrut (local.get $v__k)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 21)) (then (block (result i32) (local.set $__drop_tmp (local.get $v__x)) (call $__free_recursive (local.get $v__k)) (call $__free_recursive (local.get $v__args)) (local.get $__drop_tmp))) (else (local.set $v__pk_22 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__pk_22)) (local.set $v_r (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_r)) (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 16) (i32.const 3))) (i32.const 24)) (i32.store offset=4 (local.get $__con_0) (local.get $v_r)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (i32.store offset=8 (local.get $__con_0) (local.get $v__x)) (call $__inc_ref (i32.load offset=8 (local.get $__con_0))) (i32.store offset=12 (local.get $__con_0) (local.get $v__pk_22)) (call $__inc_ref (i32.load offset=12 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__args)) (call $__free_recursive (local.get $v_r)) (call $__free_recursive (local.get $v__pk_22)) (call $__free_recursive (local.get $v__x)) (call $__free_recursive (local.get $v__k)) (local.set $v__args (local.get $__k0)) (br $tco_top))))) (else (local.set $v_t (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_t)) (local.set $v_acc (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_acc)) (local.set $v__k (i32.load offset=12 (local.get $__scrut))) (call $__inc_ref (local.get $v__k)) (block (result i32) (local.set $__scrut (local.get $v_t)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 19)) (then (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 23)) (i32.store offset=4 (local.get $__con_0) (local.get $v__k)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (i32.store offset=8 (local.get $__con_0) (local.get $v_acc)) (call $__inc_ref (i32.load offset=8 (local.get $__con_0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__args)) (call $__free_recursive (local.get $v__k)) (call $__free_recursive (local.get $v_acc)) (call $__free_recursive (local.get $v_t)) (local.set $v__args (local.get $__k0)) (br $tco_top)) (else (local.set $v_l (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_l)) (local.set $v_v (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_v)) (local.set $v_r (i32.load offset=12 (local.get $__scrut))) (call $__inc_ref (local.get $v_r)) (local.set $__k0 (if (result i32) (i32.eq (i32.load (i32.sub (local.get $v__args) (i32.const 8))) (i32.const 1)) (then (block (result i32) (call $__free_recursive (i32.load offset=4 (local.get $v__args))) (call $__free_recursive (i32.load offset=8 (local.get $v__args))) (call $__free_recursive (i32.load offset=12 (local.get $v__args))) (i32.store (local.get $v__args) (i32.const 24)) (i32.store offset=4 (local.get $v__args) (local.get $v_l)) (call $__inc_ref (i32.load offset=4 (local.get $v__args))) (i32.store offset=8 (local.get $v__args) (call $v_addOr0 (block (result i32) (local.set $__inc_tmp (local.get $v_acc)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_v)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (i32.store offset=12 (local.get $v__args) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 22)) (i32.store offset=4 (local.get $__con_0) (local.get $v__k)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (i32.store offset=8 (local.get $__con_0) (local.get $v_r)) (call $__inc_ref (i32.load offset=8 (local.get $__con_0))) (local.get $__con_0))) (local.get $v__args))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 16) (i32.const 3))) (i32.const 24)) (i32.store offset=4 (local.get $__con_0) (local.get $v_l)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (i32.store offset=8 (local.get $__con_0) (call $v_addOr0 (block (result i32) (local.set $__inc_tmp (local.get $v_acc)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_v)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (i32.store offset=12 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 22)) (i32.store offset=4 (local.get $__con_1) (local.get $v__k)) (call $__inc_ref (i32.load offset=4 (local.get $__con_1))) (i32.store offset=8 (local.get $__con_1) (local.get $v_r)) (call $__inc_ref (i32.load offset=8 (local.get $__con_1))) (local.get $__con_1))) (call $__free_recursive (local.get $v__args)) (local.get $__con_0))))) (call $__free_recursive (local.get $v_r)) (call $__free_recursive (local.get $v_v)) (call $__free_recursive (local.get $v_l)) (call $__free_recursive (local.get $v__k)) (call $__free_recursive (local.get $v_acc)) (call $__free_recursive (local.get $v_t)) (local.set $v__args (local.get $__k0)) (br $tco_top)))))))))

  (func $v__cps_sumTree (param $v_t i32) (param $v_acc i32) (param $v__k i32) (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__scc__apply_sumTree__cps_sumTree (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 16) (i32.const 3))) (i32.const 24)) (i32.store offset=4 (local.get $__con_0) (local.get $v_t)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (i32.store offset=8 (local.get $__con_0) (local.get $v_acc)) (call $__inc_ref (i32.load offset=8 (local.get $__con_0))) (i32.store offset=12 (local.get $__con_0) (local.get $v__k)) (call $__inc_ref (i32.load offset=12 (local.get $__con_0))) (local.get $__con_0))))
