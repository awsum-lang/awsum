...
case.join.9:
  ...
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @v__cps__df_andThenIO_4(ptr %t26, ptr %t27)
...
tco.case.arm.5.11:
  ...
  %t14 = getelementptr ptr, ptr %t12, i32 0
  store ptr %t13, ptr %t14
  %t15 = call ptr @__alloc(i64 32, i32 3)
  ...
  store ptr %t24, ptr %t25
  %t26 = getelementptr ptr, ptr %t15, i32 3
  store ptr %t23, ptr %t26
  %t27 = call ptr @v__scc__apply_sumTree__cps_sumTree(ptr %t15)
  ...
  %t38 = call ptr @v__apply__df_andThenIO_4(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.39:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t40 = call ptr @v__apply__df_andThenIO_4(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.loop.0:
  ...
  %t6 = load ptr, ptr %t5
  %t7 = ptrtoint ptr %t6 to i64
  switch i64 %t7, label %tco.case.default.8 [ i64 32, label %tco.case.arm.32.9 i64 33, label %tco.case.arm.33.30 ]
tco.case.arm.32.9:
  %t10 = getelementptr ptr, ptr %t4, i32 1
  %t11 = load ptr, ptr %t10
  call void @__inc_ref(ptr %t11)
