...
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [2 x i8]} { i32 0, i32 0, i32 0, i32 2, i32 2, [2 x i8] c"no" }
...
define internal ptr @v_main() {
  ...
  %t8 = getelementptr ptr, ptr %t5, i32 0
  %t9 = load ptr, ptr %t8
  %t10 = ptrtoint ptr %t9 to i64
  switch i64 %t10, label %join.case.default.11 [ i64 1, label %join.case.arm.1.12 i64 2, label %join.case.arm.2.13 ]
join.case.arm.1.12:
  call void @__inc_ref(ptr %t5)
  store ptr %t5, ptr %v__inl4_scrut.jslot
  br label %join.6
join.case.arm.2.13:
...
join.case.default.11:
  unreachable
join.6:
  %t15 = load ptr, ptr %v__inl4_scrut.jslot
...
case.default.19:
  unreachable
case.join.20:
  %t25 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.1.22 ], [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.2.24 ]
  call void @__free_recursive(ptr %t15)
  br label %join.end.26
join.end.26:
  br label %join.after.7
join.after.7:
  %t27 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %join.val.14 ], [ %t25, %join.end.26 ]
  ...
  %t36 = getelementptr ptr, ptr %t0, i32 2
