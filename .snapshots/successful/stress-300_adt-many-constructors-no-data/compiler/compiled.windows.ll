...
define internal ptr @v_un(ptr %v_x) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 0, label %case.arm.0.5 i64 1, label %case.arm.1.10 i64 2, label %case.arm.2.15 i64 3, label %case.arm.3.20 i64 4, label %case.arm.4.25 i64 5, label %case.arm.5.30 i64 6, label %case.arm.6.35 i64 7, label %case.arm.7.40 i64 8, label %case.arm.8.45 i64 9, label %case.arm.9.50 i64 10, label %case.arm.10.55 i64 11, label %case.arm.11.60 i64 12, label %case.arm.12.65 i64 13, label %case.arm.13.70 i64 14, label %case.arm.14.75 i64 15, label %case.arm.15.80 i64 16, label %case.arm.16.85 i64 17, label %case.arm.17.90 i64 18, label %case.arm.18.95 i64 19, label %case.arm.19.100 i64 20, label %case.arm.20.105 i64 21, label %case.arm.21.110 i64 22, label %case.arm.22.115 i64 23, label %case.arm.23.120 i64 24, label %case.arm.24.125 i64 25, label %case.arm.25.130 i64 26, label %case.arm.26.135 i64 27, label %case.arm.27.140 i64 28, label %case.arm.28.145 i64 29, label %case.arm.29.150 i64 30, label %case.arm.30.155 i64 31, label %case.arm.31.160 i64 32, label %case.arm.32.165 i64 33, label %case.arm.33.170 i64 34, label %case.arm.34.175 i64 35, label %case.arm.35.180 i64 36, label %case.arm.36.185 i64 37, label %case.arm.37.190 i64 38, label %case.arm.38.195 i64 39, label %case.arm.39.200 i64 40, label %case.arm.40.205 i64 41, label %case.arm.41.210 i64 42, label %case.arm.42.215 i64 43, label %case.arm.43.220 i64 44, label %case.arm.44.225 i64 45, label %case.arm.45.230 i64 46, label %case.arm.46.235 i64 47, label %case.arm.47.240 i64 48, label %case.arm.48.245 i64 49, label %case.arm.49.250 i64 50, label %case.arm.50.255 i64 51, label %case.arm.51.260 i64 52, label %case.arm.52.265 i64 53, label %case.arm.53.270 i64 54, label %case.arm.54.275 i64 55, label %case.arm.55.280 i64 56, label %case.arm.56.285 i64 57, label %case.arm.57.290 i64 58, label %case.arm.58.295 i64 59, label %case.arm.59.300 i64 60, label %case.arm.60.305 i64 61, label %case.arm.61.310 i64 62, label %case.arm.62.315 i64 63, label %case.arm.63.320 i64 64, label %case.arm.64.325 i64 65, label %case.arm.65.330 i64 66, label %case.arm.66.335 i64 67, label %case.arm.67.340 i64 68, label %case.arm.68.345 i64 69, label %case.arm.69.350 i64 70, label %case.arm.70.355 i64 71, label %case.arm.71.360 i64 72, label %case.arm.72.365 i64 73, label %case.arm.73.370 i64 74, label %case.arm.74.375 i64 75, label %case.arm.75.380 i64 76, label %case.arm.76.385 i64 77, label %case.arm.77.390 i64 78, label %case.arm.78.395 i64 79, label %case.arm.79.400 i64 80, label %case.arm.80.405 i64 81, label %case.arm.81.410 i64 82, label %case.arm.82.415 i64 83, label %case.arm.83.420 i64 84, label %case.arm.84.425 i64 85, label %case.arm.85.430 i64 86, label %case.arm.86.435 i64 87, label %case.arm.87.440 i64 88, label %case.arm.88.445 i64 89, label %case.arm.89.450 i64 90, label %case.arm.90.455 i64 91, label %case.arm.91.460 i64 92, label %case.arm.92.465 i64 93, label %case.arm.93.470 i64 94, label %case.arm.94.475 i64 95, label %case.arm.95.480 i64 96, label %case.arm.96.485 i64 97, label %case.arm.97.490 i64 98, label %case.arm.98.495 i64 99, label %case.arm.99.500 i64 100, label %case.arm.100.505 i64 101, label %case.arm.101.510 i64 102, label %case.arm.102.515 i64 103, label %case.arm.103.520 i64 104, label %case.arm.104.525 i64 105, label %case.arm.105.530 i64 106, label %case.arm.106.535 i64 107, label %case.arm.107.540 i64 108, label %case.arm.108.545 i64 109, label %case.arm.109.550 i64 110, label %case.arm.110.555 i64 111, label %case.arm.111.560 i64 112, label %case.arm.112.565 i64 113, label %case.arm.113.570 i64 114, label %case.arm.114.575 i64 115, label %case.arm.115.580 i64 116, label %case.arm.116.585 i64 117, label %case.arm.117.590 i64 118, label %case.arm.118.595 i64 119, label %case.arm.119.600 i64 120, label %case.arm.120.605 i64 121, label %case.arm.121.610 i64 122, label %case.arm.122.615 i64 123, label %case.arm.123.620 i64 124, label %case.arm.124.625 i64 125, label %case.arm.125.630 i64 126, label %case.arm.126.635 i64 127, label %case.arm.127.640 i64 128, label %case.arm.128.645 i64 129, label %case.arm.129.650 i64 130, label %case.arm.130.655 i64 131, label %case.arm.131.660 i64 132, label %case.arm.132.665 i64 133, label %case.arm.133.670 i64 134, label %case.arm.134.675 i64 135, label %case.arm.135.680 i64 136, label %case.arm.136.685 i64 137, label %case.arm.137.690 i64 138, label %case.arm.138.695 i64 139, label %case.arm.139.700 i64 140, label %case.arm.140.705 i64 141, label %case.arm.141.710 i64 142, label %case.arm.142.715 i64 143, label %case.arm.143.720 i64 144, label %case.arm.144.725 i64 145, label %case.arm.145.730 i64 146, label %case.arm.146.735 i64 147, label %case.arm.147.740 i64 148, label %case.arm.148.745 i64 149, label %case.arm.149.750 i64 150, label %case.arm.150.755 i64 151, label %case.arm.151.760 i64 152, label %case.arm.152.765 i64 153, label %case.arm.153.770 i64 154, label %case.arm.154.775 i64 155, label %case.arm.155.780 i64 156, label %case.arm.156.785 i64 157, label %case.arm.157.790 i64 158, label %case.arm.158.795 i64 159, label %case.arm.159.800 i64 160, label %case.arm.160.805 i64 161, label %case.arm.161.810 i64 162, label %case.arm.162.815 i64 163, label %case.arm.163.820 i64 164, label %case.arm.164.825 i64 165, label %case.arm.165.830 i64 166, label %case.arm.166.835 i64 167, label %case.arm.167.840 i64 168, label %case.arm.168.845 i64 169, label %case.arm.169.850 i64 170, label %case.arm.170.855 i64 171, label %case.arm.171.860 i64 172, label %case.arm.172.865 i64 173, label %case.arm.173.870 i64 174, label %case.arm.174.875 i64 175, label %case.arm.175.880 i64 176, label %case.arm.176.885 i64 177, label %case.arm.177.890 i64 178, label %case.arm.178.895 i64 179, label %case.arm.179.900 i64 180, label %case.arm.180.905 i64 181, label %case.arm.181.910 i64 182, label %case.arm.182.915 i64 183, label %case.arm.183.920 i64 184, label %case.arm.184.925 i64 185, label %case.arm.185.930 i64 186, label %case.arm.186.935 i64 187, label %case.arm.187.940 i64 188, label %case.arm.188.945 i64 189, label %case.arm.189.950 i64 190, label %case.arm.190.955 i64 191, label %case.arm.191.960 i64 192, label %case.arm.192.965 i64 193, label %case.arm.193.970 i64 194, label %case.arm.194.975 i64 195, label %case.arm.195.980 i64 196, label %case.arm.196.985 i64 197, label %case.arm.197.990 i64 198, label %case.arm.198.995 i64 199, label %case.arm.199.1000 i64 200, label %case.arm.200.1005 i64 201, label %case.arm.201.1010 i64 202, label %case.arm.202.1015 i64 203, label %case.arm.203.1020 i64 204, label %case.arm.204.1025 i64 205, label %case.arm.205.1030 i64 206, label %case.arm.206.1035 i64 207, label %case.arm.207.1040 i64 208, label %case.arm.208.1045 i64 209, label %case.arm.209.1050 i64 210, label %case.arm.210.1055 i64 211, label %case.arm.211.1060 i64 212, label %case.arm.212.1065 i64 213, label %case.arm.213.1070 i64 214, label %case.arm.214.1075 i64 215, label %case.arm.215.1080 i64 216, label %case.arm.216.1085 i64 217, label %case.arm.217.1090 i64 218, label %case.arm.218.1095 i64 219, label %case.arm.219.1100 i64 220, label %case.arm.220.1105 i64 221, label %case.arm.221.1110 i64 222, label %case.arm.222.1115 i64 223, label %case.arm.223.1120 i64 224, label %case.arm.224.1125 i64 225, label %case.arm.225.1130 i64 226, label %case.arm.226.1135 i64 227, label %case.arm.227.1140 i64 228, label %case.arm.228.1145 i64 229, label %case.arm.229.1150 i64 230, label %case.arm.230.1155 i64 231, label %case.arm.231.1160 i64 232, label %case.arm.232.1165 i64 233, label %case.arm.233.1170 i64 234, label %case.arm.234.1175 i64 235, label %case.arm.235.1180 i64 236, label %case.arm.236.1185 i64 237, label %case.arm.237.1190 i64 238, label %case.arm.238.1195 i64 239, label %case.arm.239.1200 i64 240, label %case.arm.240.1205 i64 241, label %case.arm.241.1210 i64 242, label %case.arm.242.1215 i64 243, label %case.arm.243.1220 i64 244, label %case.arm.244.1225 i64 245, label %case.arm.245.1230 i64 246, label %case.arm.246.1235 i64 247, label %case.arm.247.1240 i64 248, label %case.arm.248.1245 i64 249, label %case.arm.249.1250 i64 250, label %case.arm.250.1255 i64 251, label %case.arm.251.1260 i64 252, label %case.arm.252.1265 i64 253, label %case.arm.253.1270 i64 254, label %case.arm.254.1275 i64 255, label %case.arm.255.1280 i64 256, label %case.arm.256.1285 i64 257, label %case.arm.257.1290 i64 258, label %case.arm.258.1295 i64 259, label %case.arm.259.1300 i64 260, label %case.arm.260.1305 i64 261, label %case.arm.261.1310 i64 262, label %case.arm.262.1315 i64 263, label %case.arm.263.1320 i64 264, label %case.arm.264.1325 i64 265, label %case.arm.265.1330 i64 266, label %case.arm.266.1335 i64 267, label %case.arm.267.1340 i64 268, label %case.arm.268.1345 i64 269, label %case.arm.269.1350 i64 270, label %case.arm.270.1355 i64 271, label %case.arm.271.1360 i64 272, label %case.arm.272.1365 i64 273, label %case.arm.273.1370 i64 274, label %case.arm.274.1375 i64 275, label %case.arm.275.1380 i64 276, label %case.arm.276.1385 i64 277, label %case.arm.277.1390 i64 278, label %case.arm.278.1395 i64 279, label %case.arm.279.1400 i64 280, label %case.arm.280.1405 i64 281, label %case.arm.281.1410 i64 282, label %case.arm.282.1415 i64 283, label %case.arm.283.1420 i64 284, label %case.arm.284.1425 i64 285, label %case.arm.285.1430 i64 286, label %case.arm.286.1435 i64 287, label %case.arm.287.1440 i64 288, label %case.arm.288.1445 i64 289, label %case.arm.289.1450 i64 290, label %case.arm.290.1455 i64 291, label %case.arm.291.1460 i64 292, label %case.arm.292.1465 i64 293, label %case.arm.293.1470 i64 294, label %case.arm.294.1475 i64 295, label %case.arm.295.1480 i64 296, label %case.arm.296.1485 i64 297, label %case.arm.297.1490 i64 298, label %case.arm.298.1495 i64 299, label %case.arm.299.1500 ]
case.arm.0.5:
...
case.arm.292.1465:
  ...
  br label %case.end.292.1466
case.end.292.1466:
  br label %case.join.4
case.arm.293.1470:
  %t1472 = call ptr @malloc(i64 8)
  %t1473 = inttoptr i64 0 to ptr
  %t1474 = getelementptr ptr, ptr %t1472, i32 0
  store ptr %t1473, ptr %t1474
  br label %case.end.293.1471
case.end.293.1471:
  br label %case.join.4
case.arm.294.1475:
  %t1477 = call ptr @malloc(i64 8)
  %t1478 = inttoptr i64 0 to ptr
  %t1479 = getelementptr ptr, ptr %t1477, i32 0
  store ptr %t1478, ptr %t1479
  br label %case.end.294.1476
case.end.294.1476:
  br label %case.join.4
case.arm.295.1480:
  %t1482 = call ptr @malloc(i64 8)
  %t1483 = inttoptr i64 0 to ptr
  %t1484 = getelementptr ptr, ptr %t1482, i32 0
  store ptr %t1483, ptr %t1484
  br label %case.end.295.1481
case.end.295.1481:
  br label %case.join.4
case.arm.296.1485:
  %t1487 = call ptr @malloc(i64 8)
  %t1488 = inttoptr i64 0 to ptr
  %t1489 = getelementptr ptr, ptr %t1487, i32 0
  store ptr %t1488, ptr %t1489
  br label %case.end.296.1486
case.end.296.1486:
  br label %case.join.4
case.arm.297.1490:
  %t1492 = call ptr @malloc(i64 8)
  %t1493 = inttoptr i64 0 to ptr
  %t1494 = getelementptr ptr, ptr %t1492, i32 0
  store ptr %t1493, ptr %t1494
  br label %case.end.297.1491
case.end.297.1491:
  br label %case.join.4
case.arm.298.1495:
  %t1497 = call ptr @malloc(i64 8)
  %t1498 = inttoptr i64 0 to ptr
  %t1499 = getelementptr ptr, ptr %t1497, i32 0
  store ptr %t1498, ptr %t1499
  br label %case.end.298.1496
case.end.298.1496:
  br label %case.join.4
case.arm.299.1500:
  %t1502 = call ptr @malloc(i64 8)
  %t1503 = inttoptr i64 0 to ptr
  %t1504 = getelementptr ptr, ptr %t1502, i32 0
  store ptr %t1503, ptr %t1504
  br label %case.end.299.1501
case.end.299.1501:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t1505 = phi ptr [%t7, %case.end.0.6], [%t12, %case.end.1.11], [%t17, %case.end.2.16], [%t22, %case.end.3.21], [%t27, %case.end.4.26], [%t32, %case.end.5.31], [%t37, %case.end.6.36], [%t42, %case.end.7.41], [%t47, %case.end.8.46], [%t52, %case.end.9.51], [%t57, %case.end.10.56], [%t62, %case.end.11.61], [%t67, %case.end.12.66], [%t72, %case.end.13.71], [%t77, %case.end.14.76], [%t82, %case.end.15.81], [%t87, %case.end.16.86], [%t92, %case.end.17.91], [%t97, %case.end.18.96], [%t102, %case.end.19.101], [%t107, %case.end.20.106], [%t112, %case.end.21.111], [%t117, %case.end.22.116], [%t122, %case.end.23.121], [%t127, %case.end.24.126], [%t132, %case.end.25.131], [%t137, %case.end.26.136], [%t142, %case.end.27.141], [%t147, %case.end.28.146], [%t152, %case.end.29.151], [%t157, %case.end.30.156], [%t162, %case.end.31.161], [%t167, %case.end.32.166], [%t172, %case.end.33.171], [%t177, %case.end.34.176], [%t182, %case.end.35.181], [%t187, %case.end.36.186], [%t192, %case.end.37.191], [%t197, %case.end.38.196], [%t202, %case.end.39.201], [%t207, %case.end.40.206], [%t212, %case.end.41.211], [%t217, %case.end.42.216], [%t222, %case.end.43.221], [%t227, %case.end.44.226], [%t232, %case.end.45.231], [%t237, %case.end.46.236], [%t242, %case.end.47.241], [%t247, %case.end.48.246], [%t252, %case.end.49.251], [%t257, %case.end.50.256], [%t262, %case.end.51.261], [%t267, %case.end.52.266], [%t272, %case.end.53.271], [%t277, %case.end.54.276], [%t282, %case.end.55.281], [%t287, %case.end.56.286], [%t292, %case.end.57.291], [%t297, %case.end.58.296], [%t302, %case.end.59.301], [%t307, %case.end.60.306], [%t312, %case.end.61.311], [%t317, %case.end.62.316], [%t322, %case.end.63.321], [%t327, %case.end.64.326], [%t332, %case.end.65.331], [%t337, %case.end.66.336], [%t342, %case.end.67.341], [%t347, %case.end.68.346], [%t352, %case.end.69.351], [%t357, %case.end.70.356], [%t362, %case.end.71.361], [%t367, %case.end.72.366], [%t372, %case.end.73.371], [%t377, %case.end.74.376], [%t382, %case.end.75.381], [%t387, %case.end.76.386], [%t392, %case.end.77.391], [%t397, %case.end.78.396], [%t402, %case.end.79.401], [%t407, %case.end.80.406], [%t412, %case.end.81.411], [%t417, %case.end.82.416], [%t422, %case.end.83.421], [%t427, %case.end.84.426], [%t432, %case.end.85.431], [%t437, %case.end.86.436], [%t442, %case.end.87.441], [%t447, %case.end.88.446], [%t452, %case.end.89.451], [%t457, %case.end.90.456], [%t462, %case.end.91.461], [%t467, %case.end.92.466], [%t472, %case.end.93.471], [%t477, %case.end.94.476], [%t482, %case.end.95.481], [%t487, %case.end.96.486], [%t492, %case.end.97.491], [%t497, %case.end.98.496], [%t502, %case.end.99.501], [%t507, %case.end.100.506], [%t512, %case.end.101.511], [%t517, %case.end.102.516], [%t522, %case.end.103.521], [%t527, %case.end.104.526], [%t532, %case.end.105.531], [%t537, %case.end.106.536], [%t542, %case.end.107.541], [%t547, %case.end.108.546], [%t552, %case.end.109.551], [%t557, %case.end.110.556], [%t562, %case.end.111.561], [%t567, %case.end.112.566], [%t572, %case.end.113.571], [%t577, %case.end.114.576], [%t582, %case.end.115.581], [%t587, %case.end.116.586], [%t592, %case.end.117.591], [%t597, %case.end.118.596], [%t602, %case.end.119.601], [%t607, %case.end.120.606], [%t612, %case.end.121.611], [%t617, %case.end.122.616], [%t622, %case.end.123.621], [%t627, %case.end.124.626], [%t632, %case.end.125.631], [%t637, %case.end.126.636], [%t642, %case.end.127.641], [%t647, %case.end.128.646], [%t652, %case.end.129.651], [%t657, %case.end.130.656], [%t662, %case.end.131.661], [%t667, %case.end.132.666], [%t672, %case.end.133.671], [%t677, %case.end.134.676], [%t682, %case.end.135.681], [%t687, %case.end.136.686], [%t692, %case.end.137.691], [%t697, %case.end.138.696], [%t702, %case.end.139.701], [%t707, %case.end.140.706], [%t712, %case.end.141.711], [%t717, %case.end.142.716], [%t722, %case.end.143.721], [%t727, %case.end.144.726], [%t732, %case.end.145.731], [%t737, %case.end.146.736], [%t742, %case.end.147.741], [%t747, %case.end.148.746], [%t752, %case.end.149.751], [%t757, %case.end.150.756], [%t762, %case.end.151.761], [%t767, %case.end.152.766], [%t772, %case.end.153.771], [%t777, %case.end.154.776], [%t782, %case.end.155.781], [%t787, %case.end.156.786], [%t792, %case.end.157.791], [%t797, %case.end.158.796], [%t802, %case.end.159.801], [%t807, %case.end.160.806], [%t812, %case.end.161.811], [%t817, %case.end.162.816], [%t822, %case.end.163.821], [%t827, %case.end.164.826], [%t832, %case.end.165.831], [%t837, %case.end.166.836], [%t842, %case.end.167.841], [%t847, %case.end.168.846], [%t852, %case.end.169.851], [%t857, %case.end.170.856], [%t862, %case.end.171.861], [%t867, %case.end.172.866], [%t872, %case.end.173.871], [%t877, %case.end.174.876], [%t882, %case.end.175.881], [%t887, %case.end.176.886], [%t892, %case.end.177.891], [%t897, %case.end.178.896], [%t902, %case.end.179.901], [%t907, %case.end.180.906], [%t912, %case.end.181.911], [%t917, %case.end.182.916], [%t922, %case.end.183.921], [%t927, %case.end.184.926], [%t932, %case.end.185.931], [%t937, %case.end.186.936], [%t942, %case.end.187.941], [%t947, %case.end.188.946], [%t952, %case.end.189.951], [%t957, %case.end.190.956], [%t962, %case.end.191.961], [%t967, %case.end.192.966], [%t972, %case.end.193.971], [%t977, %case.end.194.976], [%t982, %case.end.195.981], [%t987, %case.end.196.986], [%t992, %case.end.197.991], [%t997, %case.end.198.996], [%t1002, %case.end.199.1001], [%t1007, %case.end.200.1006], [%t1012, %case.end.201.1011], [%t1017, %case.end.202.1016], [%t1022, %case.end.203.1021], [%t1027, %case.end.204.1026], [%t1032, %case.end.205.1031], [%t1037, %case.end.206.1036], [%t1042, %case.end.207.1041], [%t1047, %case.end.208.1046], [%t1052, %case.end.209.1051], [%t1057, %case.end.210.1056], [%t1062, %case.end.211.1061], [%t1067, %case.end.212.1066], [%t1072, %case.end.213.1071], [%t1077, %case.end.214.1076], [%t1082, %case.end.215.1081], [%t1087, %case.end.216.1086], [%t1092, %case.end.217.1091], [%t1097, %case.end.218.1096], [%t1102, %case.end.219.1101], [%t1107, %case.end.220.1106], [%t1112, %case.end.221.1111], [%t1117, %case.end.222.1116], [%t1122, %case.end.223.1121], [%t1127, %case.end.224.1126], [%t1132, %case.end.225.1131], [%t1137, %case.end.226.1136], [%t1142, %case.end.227.1141], [%t1147, %case.end.228.1146], [%t1152, %case.end.229.1151], [%t1157, %case.end.230.1156], [%t1162, %case.end.231.1161], [%t1167, %case.end.232.1166], [%t1172, %case.end.233.1171], [%t1177, %case.end.234.1176], [%t1182, %case.end.235.1181], [%t1187, %case.end.236.1186], [%t1192, %case.end.237.1191], [%t1197, %case.end.238.1196], [%t1202, %case.end.239.1201], [%t1207, %case.end.240.1206], [%t1212, %case.end.241.1211], [%t1217, %case.end.242.1216], [%t1222, %case.end.243.1221], [%t1227, %case.end.244.1226], [%t1232, %case.end.245.1231], [%t1237, %case.end.246.1236], [%t1242, %case.end.247.1241], [%t1247, %case.end.248.1246], [%t1252, %case.end.249.1251], [%t1257, %case.end.250.1256], [%t1262, %case.end.251.1261], [%t1267, %case.end.252.1266], [%t1272, %case.end.253.1271], [%t1277, %case.end.254.1276], [%t1282, %case.end.255.1281], [%t1287, %case.end.256.1286], [%t1292, %case.end.257.1291], [%t1297, %case.end.258.1296], [%t1302, %case.end.259.1301], [%t1307, %case.end.260.1306], [%t1312, %case.end.261.1311], [%t1317, %case.end.262.1316], [%t1322, %case.end.263.1321], [%t1327, %case.end.264.1326], [%t1332, %case.end.265.1331], [%t1337, %case.end.266.1336], [%t1342, %case.end.267.1341], [%t1347, %case.end.268.1346], [%t1352, %case.end.269.1351], [%t1357, %case.end.270.1356], [%t1362, %case.end.271.1361], [%t1367, %case.end.272.1366], [%t1372, %case.end.273.1371], [%t1377, %case.end.274.1376], [%t1382, %case.end.275.1381], [%t1387, %case.end.276.1386], [%t1392, %case.end.277.1391], [%t1397, %case.end.278.1396], [%t1402, %case.end.279.1401], [%t1407, %case.end.280.1406], [%t1412, %case.end.281.1411], [%t1417, %case.end.282.1416], [%t1422, %case.end.283.1421], [%t1427, %case.end.284.1426], [%t1432, %case.end.285.1431], [%t1437, %case.end.286.1436], [%t1442, %case.end.287.1441], [%t1447, %case.end.288.1446], [%t1452, %case.end.289.1451], [%t1457, %case.end.290.1456], [%t1462, %case.end.291.1461], [%t1467, %case.end.292.1466], [%t1472, %case.end.293.1471], [%t1477, %case.end.294.1476], [%t1482, %case.end.295.1481], [%t1487, %case.end.296.1486], [%t1492, %case.end.297.1491], [%t1497, %case.end.298.1496], [%t1502, %case.end.299.1501]
  ret ptr %t1505
}
