...
define internal ptr @v_un(ptr %v_x) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 22, label %case.arm.22.4 i64 23, label %case.arm.23.8 i64 24, label %case.arm.24.12 i64 25, label %case.arm.25.16 i64 26, label %case.arm.26.20 i64 27, label %case.arm.27.24 i64 28, label %case.arm.28.28 i64 29, label %case.arm.29.32 i64 30, label %case.arm.30.36 i64 31, label %case.arm.31.40 i64 32, label %case.arm.32.44 i64 33, label %case.arm.33.48 i64 34, label %case.arm.34.52 i64 35, label %case.arm.35.56 i64 36, label %case.arm.36.60 i64 37, label %case.arm.37.64 i64 38, label %case.arm.38.68 i64 39, label %case.arm.39.72 i64 40, label %case.arm.40.76 i64 41, label %case.arm.41.80 i64 42, label %case.arm.42.84 i64 43, label %case.arm.43.88 i64 44, label %case.arm.44.92 i64 45, label %case.arm.45.96 i64 46, label %case.arm.46.100 i64 47, label %case.arm.47.104 i64 48, label %case.arm.48.108 i64 49, label %case.arm.49.112 i64 50, label %case.arm.50.116 i64 51, label %case.arm.51.120 i64 52, label %case.arm.52.124 i64 53, label %case.arm.53.128 i64 54, label %case.arm.54.132 i64 55, label %case.arm.55.136 i64 56, label %case.arm.56.140 i64 57, label %case.arm.57.144 i64 58, label %case.arm.58.148 i64 59, label %case.arm.59.152 i64 60, label %case.arm.60.156 i64 61, label %case.arm.61.160 i64 62, label %case.arm.62.164 i64 63, label %case.arm.63.168 i64 64, label %case.arm.64.172 i64 65, label %case.arm.65.176 i64 66, label %case.arm.66.180 i64 67, label %case.arm.67.184 i64 68, label %case.arm.68.188 i64 69, label %case.arm.69.192 i64 70, label %case.arm.70.196 i64 71, label %case.arm.71.200 i64 72, label %case.arm.72.204 i64 73, label %case.arm.73.208 i64 74, label %case.arm.74.212 i64 75, label %case.arm.75.216 i64 76, label %case.arm.76.220 i64 77, label %case.arm.77.224 i64 78, label %case.arm.78.228 i64 79, label %case.arm.79.232 i64 80, label %case.arm.80.236 i64 81, label %case.arm.81.240 i64 82, label %case.arm.82.244 i64 83, label %case.arm.83.248 i64 84, label %case.arm.84.252 i64 85, label %case.arm.85.256 i64 86, label %case.arm.86.260 i64 87, label %case.arm.87.264 i64 88, label %case.arm.88.268 i64 89, label %case.arm.89.272 i64 90, label %case.arm.90.276 i64 91, label %case.arm.91.280 i64 92, label %case.arm.92.284 i64 93, label %case.arm.93.288 i64 94, label %case.arm.94.292 i64 95, label %case.arm.95.296 i64 96, label %case.arm.96.300 i64 97, label %case.arm.97.304 i64 98, label %case.arm.98.308 i64 99, label %case.arm.99.312 i64 100, label %case.arm.100.316 i64 101, label %case.arm.101.320 i64 102, label %case.arm.102.324 i64 103, label %case.arm.103.328 i64 104, label %case.arm.104.332 i64 105, label %case.arm.105.336 i64 106, label %case.arm.106.340 i64 107, label %case.arm.107.344 i64 108, label %case.arm.108.348 i64 109, label %case.arm.109.352 i64 110, label %case.arm.110.356 i64 111, label %case.arm.111.360 i64 112, label %case.arm.112.364 i64 113, label %case.arm.113.368 i64 114, label %case.arm.114.372 i64 115, label %case.arm.115.376 i64 116, label %case.arm.116.380 i64 117, label %case.arm.117.384 i64 118, label %case.arm.118.388 i64 119, label %case.arm.119.392 i64 120, label %case.arm.120.396 i64 121, label %case.arm.121.400 i64 122, label %case.arm.122.404 i64 123, label %case.arm.123.408 i64 124, label %case.arm.124.412 i64 125, label %case.arm.125.416 i64 126, label %case.arm.126.420 i64 127, label %case.arm.127.424 i64 128, label %case.arm.128.428 i64 129, label %case.arm.129.432 i64 130, label %case.arm.130.436 i64 131, label %case.arm.131.440 i64 132, label %case.arm.132.444 i64 133, label %case.arm.133.448 i64 134, label %case.arm.134.452 i64 135, label %case.arm.135.456 i64 136, label %case.arm.136.460 i64 137, label %case.arm.137.464 i64 138, label %case.arm.138.468 i64 139, label %case.arm.139.472 i64 140, label %case.arm.140.476 i64 141, label %case.arm.141.480 i64 142, label %case.arm.142.484 i64 143, label %case.arm.143.488 i64 144, label %case.arm.144.492 i64 145, label %case.arm.145.496 i64 146, label %case.arm.146.500 i64 147, label %case.arm.147.504 i64 148, label %case.arm.148.508 i64 149, label %case.arm.149.512 i64 150, label %case.arm.150.516 i64 151, label %case.arm.151.520 i64 152, label %case.arm.152.524 i64 153, label %case.arm.153.528 i64 154, label %case.arm.154.532 i64 155, label %case.arm.155.536 i64 156, label %case.arm.156.540 i64 157, label %case.arm.157.544 i64 158, label %case.arm.158.548 i64 159, label %case.arm.159.552 i64 160, label %case.arm.160.556 i64 161, label %case.arm.161.560 i64 162, label %case.arm.162.564 i64 163, label %case.arm.163.568 i64 164, label %case.arm.164.572 i64 165, label %case.arm.165.576 i64 166, label %case.arm.166.580 i64 167, label %case.arm.167.584 i64 168, label %case.arm.168.588 i64 169, label %case.arm.169.592 i64 170, label %case.arm.170.596 i64 171, label %case.arm.171.600 i64 172, label %case.arm.172.604 i64 173, label %case.arm.173.608 i64 174, label %case.arm.174.612 i64 175, label %case.arm.175.616 i64 176, label %case.arm.176.620 i64 177, label %case.arm.177.624 i64 178, label %case.arm.178.628 i64 179, label %case.arm.179.632 i64 180, label %case.arm.180.636 i64 181, label %case.arm.181.640 i64 182, label %case.arm.182.644 i64 183, label %case.arm.183.648 i64 184, label %case.arm.184.652 i64 185, label %case.arm.185.656 i64 186, label %case.arm.186.660 i64 187, label %case.arm.187.664 i64 188, label %case.arm.188.668 i64 189, label %case.arm.189.672 i64 190, label %case.arm.190.676 i64 191, label %case.arm.191.680 i64 192, label %case.arm.192.684 i64 193, label %case.arm.193.688 i64 194, label %case.arm.194.692 i64 195, label %case.arm.195.696 i64 196, label %case.arm.196.700 i64 197, label %case.arm.197.704 i64 198, label %case.arm.198.708 i64 199, label %case.arm.199.712 i64 200, label %case.arm.200.716 i64 201, label %case.arm.201.720 i64 202, label %case.arm.202.724 i64 203, label %case.arm.203.728 i64 204, label %case.arm.204.732 i64 205, label %case.arm.205.736 i64 206, label %case.arm.206.740 i64 207, label %case.arm.207.744 i64 208, label %case.arm.208.748 i64 209, label %case.arm.209.752 i64 210, label %case.arm.210.756 i64 211, label %case.arm.211.760 i64 212, label %case.arm.212.764 i64 213, label %case.arm.213.768 i64 214, label %case.arm.214.772 i64 215, label %case.arm.215.776 i64 216, label %case.arm.216.780 i64 217, label %case.arm.217.784 i64 218, label %case.arm.218.788 i64 219, label %case.arm.219.792 i64 220, label %case.arm.220.796 i64 221, label %case.arm.221.800 i64 222, label %case.arm.222.804 i64 223, label %case.arm.223.808 i64 224, label %case.arm.224.812 i64 225, label %case.arm.225.816 i64 226, label %case.arm.226.820 i64 227, label %case.arm.227.824 i64 228, label %case.arm.228.828 i64 229, label %case.arm.229.832 i64 230, label %case.arm.230.836 i64 231, label %case.arm.231.840 i64 232, label %case.arm.232.844 i64 233, label %case.arm.233.848 i64 234, label %case.arm.234.852 i64 235, label %case.arm.235.856 i64 236, label %case.arm.236.860 i64 237, label %case.arm.237.864 i64 238, label %case.arm.238.868 i64 239, label %case.arm.239.872 i64 240, label %case.arm.240.876 i64 241, label %case.arm.241.880 i64 242, label %case.arm.242.884 i64 243, label %case.arm.243.888 i64 244, label %case.arm.244.892 i64 245, label %case.arm.245.896 i64 246, label %case.arm.246.900 i64 247, label %case.arm.247.904 i64 248, label %case.arm.248.908 i64 249, label %case.arm.249.912 i64 250, label %case.arm.250.916 i64 251, label %case.arm.251.920 i64 252, label %case.arm.252.924 i64 253, label %case.arm.253.928 i64 254, label %case.arm.254.932 i64 255, label %case.arm.255.936 i64 256, label %case.arm.256.940 i64 257, label %case.arm.257.944 i64 258, label %case.arm.258.948 i64 259, label %case.arm.259.952 i64 260, label %case.arm.260.956 i64 261, label %case.arm.261.960 i64 262, label %case.arm.262.964 i64 263, label %case.arm.263.968 i64 264, label %case.arm.264.972 i64 265, label %case.arm.265.976 i64 266, label %case.arm.266.980 i64 267, label %case.arm.267.984 i64 268, label %case.arm.268.988 i64 269, label %case.arm.269.992 i64 270, label %case.arm.270.996 i64 271, label %case.arm.271.1000 i64 272, label %case.arm.272.1004 i64 273, label %case.arm.273.1008 i64 274, label %case.arm.274.1012 i64 275, label %case.arm.275.1016 i64 276, label %case.arm.276.1020 i64 277, label %case.arm.277.1024 i64 278, label %case.arm.278.1028 i64 279, label %case.arm.279.1032 i64 280, label %case.arm.280.1036 i64 281, label %case.arm.281.1040 i64 282, label %case.arm.282.1044 i64 283, label %case.arm.283.1048 i64 284, label %case.arm.284.1052 i64 285, label %case.arm.285.1056 i64 286, label %case.arm.286.1060 i64 287, label %case.arm.287.1064 i64 288, label %case.arm.288.1068 i64 289, label %case.arm.289.1072 i64 290, label %case.arm.290.1076 i64 291, label %case.arm.291.1080 i64 292, label %case.arm.292.1084 i64 293, label %case.arm.293.1088 i64 294, label %case.arm.294.1092 i64 295, label %case.arm.295.1096 i64 296, label %case.arm.296.1100 i64 297, label %case.arm.297.1104 i64 298, label %case.arm.298.1108 i64 299, label %case.arm.299.1112 i64 300, label %case.arm.300.1116 i64 301, label %case.arm.301.1120 i64 302, label %case.arm.302.1124 i64 303, label %case.arm.303.1128 i64 304, label %case.arm.304.1132 i64 305, label %case.arm.305.1136 i64 306, label %case.arm.306.1140 i64 307, label %case.arm.307.1144 i64 308, label %case.arm.308.1148 i64 309, label %case.arm.309.1152 i64 310, label %case.arm.310.1156 i64 311, label %case.arm.311.1160 i64 312, label %case.arm.312.1164 i64 313, label %case.arm.313.1168 i64 314, label %case.arm.314.1172 i64 315, label %case.arm.315.1176 i64 316, label %case.arm.316.1180 i64 317, label %case.arm.317.1184 i64 318, label %case.arm.318.1188 i64 319, label %case.arm.319.1192 i64 320, label %case.arm.320.1196 i64 321, label %case.arm.321.1200 ]
case.arm.22.4:
