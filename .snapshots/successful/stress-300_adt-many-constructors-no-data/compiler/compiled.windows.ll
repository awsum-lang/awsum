...
define internal ptr @v_un(ptr %v_x) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.4 i64 20, label %case.arm.20.8 i64 21, label %case.arm.21.12 i64 22, label %case.arm.22.16 i64 23, label %case.arm.23.20 i64 24, label %case.arm.24.24 i64 25, label %case.arm.25.28 i64 26, label %case.arm.26.32 i64 27, label %case.arm.27.36 i64 28, label %case.arm.28.40 i64 29, label %case.arm.29.44 i64 30, label %case.arm.30.48 i64 31, label %case.arm.31.52 i64 32, label %case.arm.32.56 i64 33, label %case.arm.33.60 i64 34, label %case.arm.34.64 i64 35, label %case.arm.35.68 i64 36, label %case.arm.36.72 i64 37, label %case.arm.37.76 i64 38, label %case.arm.38.80 i64 39, label %case.arm.39.84 i64 40, label %case.arm.40.88 i64 41, label %case.arm.41.92 i64 42, label %case.arm.42.96 i64 43, label %case.arm.43.100 i64 44, label %case.arm.44.104 i64 45, label %case.arm.45.108 i64 46, label %case.arm.46.112 i64 47, label %case.arm.47.116 i64 48, label %case.arm.48.120 i64 49, label %case.arm.49.124 i64 50, label %case.arm.50.128 i64 51, label %case.arm.51.132 i64 52, label %case.arm.52.136 i64 53, label %case.arm.53.140 i64 54, label %case.arm.54.144 i64 55, label %case.arm.55.148 i64 56, label %case.arm.56.152 i64 57, label %case.arm.57.156 i64 58, label %case.arm.58.160 i64 59, label %case.arm.59.164 i64 60, label %case.arm.60.168 i64 61, label %case.arm.61.172 i64 62, label %case.arm.62.176 i64 63, label %case.arm.63.180 i64 64, label %case.arm.64.184 i64 65, label %case.arm.65.188 i64 66, label %case.arm.66.192 i64 67, label %case.arm.67.196 i64 68, label %case.arm.68.200 i64 69, label %case.arm.69.204 i64 70, label %case.arm.70.208 i64 71, label %case.arm.71.212 i64 72, label %case.arm.72.216 i64 73, label %case.arm.73.220 i64 74, label %case.arm.74.224 i64 75, label %case.arm.75.228 i64 76, label %case.arm.76.232 i64 77, label %case.arm.77.236 i64 78, label %case.arm.78.240 i64 79, label %case.arm.79.244 i64 80, label %case.arm.80.248 i64 81, label %case.arm.81.252 i64 82, label %case.arm.82.256 i64 83, label %case.arm.83.260 i64 84, label %case.arm.84.264 i64 85, label %case.arm.85.268 i64 86, label %case.arm.86.272 i64 87, label %case.arm.87.276 i64 88, label %case.arm.88.280 i64 89, label %case.arm.89.284 i64 90, label %case.arm.90.288 i64 91, label %case.arm.91.292 i64 92, label %case.arm.92.296 i64 93, label %case.arm.93.300 i64 94, label %case.arm.94.304 i64 95, label %case.arm.95.308 i64 96, label %case.arm.96.312 i64 97, label %case.arm.97.316 i64 98, label %case.arm.98.320 i64 99, label %case.arm.99.324 i64 100, label %case.arm.100.328 i64 101, label %case.arm.101.332 i64 102, label %case.arm.102.336 i64 103, label %case.arm.103.340 i64 104, label %case.arm.104.344 i64 105, label %case.arm.105.348 i64 106, label %case.arm.106.352 i64 107, label %case.arm.107.356 i64 108, label %case.arm.108.360 i64 109, label %case.arm.109.364 i64 110, label %case.arm.110.368 i64 111, label %case.arm.111.372 i64 112, label %case.arm.112.376 i64 113, label %case.arm.113.380 i64 114, label %case.arm.114.384 i64 115, label %case.arm.115.388 i64 116, label %case.arm.116.392 i64 117, label %case.arm.117.396 i64 118, label %case.arm.118.400 i64 119, label %case.arm.119.404 i64 120, label %case.arm.120.408 i64 121, label %case.arm.121.412 i64 122, label %case.arm.122.416 i64 123, label %case.arm.123.420 i64 124, label %case.arm.124.424 i64 125, label %case.arm.125.428 i64 126, label %case.arm.126.432 i64 127, label %case.arm.127.436 i64 128, label %case.arm.128.440 i64 129, label %case.arm.129.444 i64 130, label %case.arm.130.448 i64 131, label %case.arm.131.452 i64 132, label %case.arm.132.456 i64 133, label %case.arm.133.460 i64 134, label %case.arm.134.464 i64 135, label %case.arm.135.468 i64 136, label %case.arm.136.472 i64 137, label %case.arm.137.476 i64 138, label %case.arm.138.480 i64 139, label %case.arm.139.484 i64 140, label %case.arm.140.488 i64 141, label %case.arm.141.492 i64 142, label %case.arm.142.496 i64 143, label %case.arm.143.500 i64 144, label %case.arm.144.504 i64 145, label %case.arm.145.508 i64 146, label %case.arm.146.512 i64 147, label %case.arm.147.516 i64 148, label %case.arm.148.520 i64 149, label %case.arm.149.524 i64 150, label %case.arm.150.528 i64 151, label %case.arm.151.532 i64 152, label %case.arm.152.536 i64 153, label %case.arm.153.540 i64 154, label %case.arm.154.544 i64 155, label %case.arm.155.548 i64 156, label %case.arm.156.552 i64 157, label %case.arm.157.556 i64 158, label %case.arm.158.560 i64 159, label %case.arm.159.564 i64 160, label %case.arm.160.568 i64 161, label %case.arm.161.572 i64 162, label %case.arm.162.576 i64 163, label %case.arm.163.580 i64 164, label %case.arm.164.584 i64 165, label %case.arm.165.588 i64 166, label %case.arm.166.592 i64 167, label %case.arm.167.596 i64 168, label %case.arm.168.600 i64 169, label %case.arm.169.604 i64 170, label %case.arm.170.608 i64 171, label %case.arm.171.612 i64 172, label %case.arm.172.616 i64 173, label %case.arm.173.620 i64 174, label %case.arm.174.624 i64 175, label %case.arm.175.628 i64 176, label %case.arm.176.632 i64 177, label %case.arm.177.636 i64 178, label %case.arm.178.640 i64 179, label %case.arm.179.644 i64 180, label %case.arm.180.648 i64 181, label %case.arm.181.652 i64 182, label %case.arm.182.656 i64 183, label %case.arm.183.660 i64 184, label %case.arm.184.664 i64 185, label %case.arm.185.668 i64 186, label %case.arm.186.672 i64 187, label %case.arm.187.676 i64 188, label %case.arm.188.680 i64 189, label %case.arm.189.684 i64 190, label %case.arm.190.688 i64 191, label %case.arm.191.692 i64 192, label %case.arm.192.696 i64 193, label %case.arm.193.700 i64 194, label %case.arm.194.704 i64 195, label %case.arm.195.708 i64 196, label %case.arm.196.712 i64 197, label %case.arm.197.716 i64 198, label %case.arm.198.720 i64 199, label %case.arm.199.724 i64 200, label %case.arm.200.728 i64 201, label %case.arm.201.732 i64 202, label %case.arm.202.736 i64 203, label %case.arm.203.740 i64 204, label %case.arm.204.744 i64 205, label %case.arm.205.748 i64 206, label %case.arm.206.752 i64 207, label %case.arm.207.756 i64 208, label %case.arm.208.760 i64 209, label %case.arm.209.764 i64 210, label %case.arm.210.768 i64 211, label %case.arm.211.772 i64 212, label %case.arm.212.776 i64 213, label %case.arm.213.780 i64 214, label %case.arm.214.784 i64 215, label %case.arm.215.788 i64 216, label %case.arm.216.792 i64 217, label %case.arm.217.796 i64 218, label %case.arm.218.800 i64 219, label %case.arm.219.804 i64 220, label %case.arm.220.808 i64 221, label %case.arm.221.812 i64 222, label %case.arm.222.816 i64 223, label %case.arm.223.820 i64 224, label %case.arm.224.824 i64 225, label %case.arm.225.828 i64 226, label %case.arm.226.832 i64 227, label %case.arm.227.836 i64 228, label %case.arm.228.840 i64 229, label %case.arm.229.844 i64 230, label %case.arm.230.848 i64 231, label %case.arm.231.852 i64 232, label %case.arm.232.856 i64 233, label %case.arm.233.860 i64 234, label %case.arm.234.864 i64 235, label %case.arm.235.868 i64 236, label %case.arm.236.872 i64 237, label %case.arm.237.876 i64 238, label %case.arm.238.880 i64 239, label %case.arm.239.884 i64 240, label %case.arm.240.888 i64 241, label %case.arm.241.892 i64 242, label %case.arm.242.896 i64 243, label %case.arm.243.900 i64 244, label %case.arm.244.904 i64 245, label %case.arm.245.908 i64 246, label %case.arm.246.912 i64 247, label %case.arm.247.916 i64 248, label %case.arm.248.920 i64 249, label %case.arm.249.924 i64 250, label %case.arm.250.928 i64 251, label %case.arm.251.932 i64 252, label %case.arm.252.936 i64 253, label %case.arm.253.940 i64 254, label %case.arm.254.944 i64 255, label %case.arm.255.948 i64 256, label %case.arm.256.952 i64 257, label %case.arm.257.956 i64 258, label %case.arm.258.960 i64 259, label %case.arm.259.964 i64 260, label %case.arm.260.968 i64 261, label %case.arm.261.972 i64 262, label %case.arm.262.976 i64 263, label %case.arm.263.980 i64 264, label %case.arm.264.984 i64 265, label %case.arm.265.988 i64 266, label %case.arm.266.992 i64 267, label %case.arm.267.996 i64 268, label %case.arm.268.1000 i64 269, label %case.arm.269.1004 i64 270, label %case.arm.270.1008 i64 271, label %case.arm.271.1012 i64 272, label %case.arm.272.1016 i64 273, label %case.arm.273.1020 i64 274, label %case.arm.274.1024 i64 275, label %case.arm.275.1028 i64 276, label %case.arm.276.1032 i64 277, label %case.arm.277.1036 i64 278, label %case.arm.278.1040 i64 279, label %case.arm.279.1044 i64 280, label %case.arm.280.1048 i64 281, label %case.arm.281.1052 i64 282, label %case.arm.282.1056 i64 283, label %case.arm.283.1060 i64 284, label %case.arm.284.1064 i64 285, label %case.arm.285.1068 i64 286, label %case.arm.286.1072 i64 287, label %case.arm.287.1076 i64 288, label %case.arm.288.1080 i64 289, label %case.arm.289.1084 i64 290, label %case.arm.290.1088 i64 291, label %case.arm.291.1092 i64 292, label %case.arm.292.1096 i64 293, label %case.arm.293.1100 i64 294, label %case.arm.294.1104 i64 295, label %case.arm.295.1108 i64 296, label %case.arm.296.1112 i64 297, label %case.arm.297.1116 i64 298, label %case.arm.298.1120 i64 299, label %case.arm.299.1124 i64 300, label %case.arm.300.1128 i64 301, label %case.arm.301.1132 i64 302, label %case.arm.302.1136 i64 303, label %case.arm.303.1140 i64 304, label %case.arm.304.1144 i64 305, label %case.arm.305.1148 i64 306, label %case.arm.306.1152 i64 307, label %case.arm.307.1156 i64 308, label %case.arm.308.1160 i64 309, label %case.arm.309.1164 i64 310, label %case.arm.310.1168 i64 311, label %case.arm.311.1172 i64 312, label %case.arm.312.1176 i64 313, label %case.arm.313.1180 i64 314, label %case.arm.314.1184 i64 315, label %case.arm.315.1188 i64 316, label %case.arm.316.1192 i64 317, label %case.arm.317.1196 i64 318, label %case.arm.318.1200 ]
case.arm.19.4:
