...
@.str.1 = private unnamed_addr constant {i32, i32, [1 x i8]} { i32 1, i32 1, [1 x i8] c"c" }
...
tco.case.arm.8.37:
  ...
  %t47 = getelementptr ptr, ptr %t40, i32 1
  store ptr %t43, ptr %t47
  %t48 = call ptr @v__apply__lift_8(ptr %t6, ptr %t40)
  store ptr %t48, ptr %t2
  br label %tco.exit.1
tco.case.default.10:
  unreachable
...
tco.case.arm.8.35:
  ...
  %t46 = call ptr @v__apply__df_andThenIO_0(ptr %t6, ptr %t38)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 13, label %tco.case.arm.13.11 i64 14, label %tco.case.arm.14.52 i64 15, label %tco.case.arm.15.66 i64 16, label %tco.case.arm.16.80 i64 17, label %tco.case.arm.17.94 ]
tco.case.arm.13.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  ...
  switch i64 %t18, label %tco.case.default.19 [ i64 9, label %tco.case.arm.9.20 i64 10, label %tco.case.arm.10.28 i64 11, label %tco.case.arm.11.36 i64 12, label %tco.case.arm.12.44 ]
tco.case.arm.9.20:
...
tco.case.arm.17.94:
  ...
  %t97 = getelementptr ptr, ptr %t5, i32 2
...
define internal ptr @v__apply__scc__apply1__df__lam_3_1__df__lam_3_3__lift_2__lift_9(ptr %v__k, ptr %v__x) {
entry:
  %t3 = alloca ptr
  store ptr %v__k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 26, label %tco.case.arm.26.11 i64 27, label %tco.case.arm.27.12 i64 28, label %tco.case.arm.28.16 i64 29, label %tco.case.arm.29.20 i64 30, label %tco.case.arm.30.24 ]
tco.case.arm.26.11:
  store ptr %t6, ptr %t2
  br label %tco.exit.1
tco.case.arm.27.12:
...
tco.case.arm.28.16:
  ...
  %t19 = call ptr @v__df_andThenIO_2(ptr %t6)
