...
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"unwrapped" }
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [15 x i8]} { i32 0, i32 0, i32 0, i32 15, i32 15, [15 x i8] c"unwrapped-named" }
@.str.4 = private unnamed_addr constant {i32, i32, i32, i32, i32, [6 x i8]} { i32 0, i32 0, i32 0, i32 6, i32 6, [6 x i8] c"paired" }
...
case.arm.4.14:
  ...
  call void @__inc_ref(ptr %t17)
  call void @__inc_ref(ptr %t17)
  %t18 = call ptr @__concat(ptr %t17, ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
...
case.arm.4.32:
  ...
  call void @__inc_ref(ptr %t35)
  %t36 = call ptr @__concat(ptr %t35, ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
...
case.arm.4.68:
  ...
  call void @__inc_ref(ptr %t71)
  %t72 = call ptr @__concat(ptr %t71, ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
...
case.arm.4.86:
  ...
  call void @__inc_ref(ptr %t89)
  %t90 = call ptr @__concat(ptr %t89, ptr getelementptr inbounds (i8, ptr @.str.4, i64 12))
...
case.default.76:
  unreachable
case.join.77:
  %t91 = phi ptr [ %t82, %case.end.3.79 ], [ %t90, %case.end.4.87 ]
...
case.default.58:
  unreachable
case.join.59:
  %t92 = phi ptr [ %t64, %case.end.3.61 ], [ %t91, %case.end.4.69 ]
...
case.default.40:
  unreachable
case.join.41:
  %t93 = phi ptr [ %t46, %case.end.3.43 ], [ %t92, %case.end.4.51 ]
...
case.default.22:
  unreachable
case.join.23:
  %t94 = phi ptr [ %t28, %case.end.3.25 ], [ %t93, %case.end.4.33 ]
...
case.default.4:
  unreachable
case.join.5:
  %t95 = phi ptr [ %t10, %case.end.3.7 ], [ %t94, %case.end.4.15 ]
