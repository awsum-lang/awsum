...
(module
  ...
  (global $heap (mut i32) (i32.const 357))
  ...
  (data (i32.const 84) "\00\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\02\00\00\00hi")
  (data (i32.const 106) "\00\00\00\00\00\00\00\00\00\00\00\00\09\00\00\00\09\00\00\00unwrapped")
  (data (i32.const 135) "\00\00\00\00\00\00\00\00\00\00\00\00\0f\00\00\00\0f\00\00\00unwrapped-named")
  (data (i32.const 170) "\00\00\00\00\00\00\00\00\00\00\00\00\06\00\00\00\06\00\00\00paired")
  (data (i32.const 196) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00x")
  (data (i32.const 217) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00 ")
  (data (i32.const 238) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00a")
  (data (i32.const 259) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00b")
  (data (i32.const 280) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00l")
  ...
  (table 6 funcref)
  (elem (i32.const 0) $v_runIO $v_greeting $v_unwrapBox $v_unwrapBoxNamed $v_showPair $v__let_7)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_unwrapBox (param $v_b i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_b)) (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___w0)) (block (result i32) (local.set $__drop_tmp (i32.const 118)) (call $__free_recursive (local.get $v___w0)) (local.get $__drop_tmp))))

  (func $v_unwrapBoxNamed (param $v_b i32) (result i32)
    (local $v__v i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_b)) (local.set $v__v (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__v)) (block (result i32) (local.set $__drop_tmp (i32.const 147)) (call $__free_recursive (local.get $v__v)) (local.get $__drop_tmp))))
  ...
  (func $v_showPair (param $v_p i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_p)) (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___w0)) (local.set $v___w1 (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v___w1)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__drop_tmp (i32.const 182)) (call $__free_recursive (local.get $v___w1)) (local.get $__drop_tmp))) (call $__free_recursive (local.get $v___w0)) (local.get $__drop_tmp))))
  ...
  (func $v_main (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (call $v__let_7 (block (result i32) (local.set $__scrut (call $__concat (call $v_greeting (i32.const 208)) (i32.const 229))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_26_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_26_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_26_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_unwrapBox (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 19)) (i32.store offset=4 (local.get $__con_0) (i32.const 250)) (local.get $__con_0))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_27_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_27_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_27_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s1 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s1)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s1)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 229))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_28_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_28_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_28_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s2 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s2)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s2)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_unwrapBoxNamed (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 19)) (i32.store offset=4 (local.get $__con_0) (i32.const 271)) (local.get $__con_0))))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_29_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_29_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_29_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s3)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s3)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 229))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_30_9 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_30_9)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_30_9)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_s4 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s4)) (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s4)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_showPair (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 20)) (i32.store offset=4 (local.get $__con_0) (i32.const 292)) (i32.store offset=8 (local.get $__con_0) (i32.const 313)) (local.get $__con_0)))))))))))))))))))))
