...
case.default.3:
  unreachable
case.join.4:
  %t11 = phi ptr [@.str.3, %case.end.0.6]
  ret ptr %t11
}
...
case.arm.1.79:
  ...
  switch i64 %t86, label %case.default.87 [ i64 0, label %case.arm.0.89 i64 1, label %case.arm.1.97 ]
case.arm.0.89:
  %t91 = getelementptr ptr, ptr %t83, i32 1
  %t92 = load ptr, ptr %t91
  %t93 = call ptr @malloc(i64 16)
  %t94 = inttoptr i64 0 to ptr
...
case.arm.1.97:
  ...
  br label %case.end.1.98
case.end.1.98:
  br label %case.join.88
case.default.87:
  unreachable
case.join.88:
  %t108 = phi ptr [%t93, %case.end.0.90], [%t107, %case.end.1.98]
...
case.default.69:
  unreachable
case.join.70:
  %t109 = phi ptr [%t75, %case.end.0.72], [%t108, %case.end.1.80]
...
case.default.46:
  unreachable
case.join.47:
  %t110 = phi ptr [%t52, %case.end.0.49], [%t109, %case.end.1.57]
...
case.default.28:
  unreachable
case.join.29:
  %t111 = phi ptr [%t34, %case.end.0.31], [%t110, %case.end.1.39]
...
case.default.5:
  unreachable
case.join.6:
  %t112 = phi ptr [%t11, %case.end.0.8], [%t111, %case.end.1.16]
  %t113 = call ptr @v__let_2(ptr %t112)
  ret ptr %t113
}
