...
case.arm.12.8:
  ...
  call void @__inc_ref(ptr %t10)
  %t14 = call ptr @v__lift_20(ptr %t10)
...
case.arm.25.4:
  ...
  store ptr %t8, ptr %t9
  call void @__inc_ref(ptr %t6)
  %t10 = call ptr @v__lift_19(ptr %t6)
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 35, label %tco.case.arm.35.11 i64 36, label %tco.case.arm.36.200 i64 37, label %tco.case.arm.37.223 i64 38, label %tco.case.arm.38.246 i64 39, label %tco.case.arm.39.269 i64 40, label %tco.case.arm.40.292 i64 41, label %tco.case.arm.41.315 i64 42, label %tco.case.arm.42.338 i64 43, label %tco.case.arm.43.361 i64 44, label %tco.case.arm.44.384 ]
tco.case.arm.35.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %tco.case.default.19 [ i64 26, label %tco.case.arm.26.20 i64 27, label %tco.case.arm.27.40 i64 28, label %tco.case.arm.28.60 i64 29, label %tco.case.arm.29.80 i64 30, label %tco.case.arm.30.100 i64 31, label %tco.case.arm.31.120 i64 32, label %tco.case.arm.32.140 i64 33, label %tco.case.arm.33.160 i64 34, label %tco.case.arm.34.180 ]
tco.case.arm.26.20:
