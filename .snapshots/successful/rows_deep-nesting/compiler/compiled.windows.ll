...
case.arm.23.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 10, label %case.arm.10.11 i64 11, label %case.arm.11.12 ]
case.arm.10.11:
  call void @__free_recursive(ptr %t6)
...
case.arm.11.8:
  ...
  call void @__inc_ref(ptr %t10)
  %t14 = call ptr @v__lift_17(ptr %t10)
...
case.arm.23.4:
  ...
  store ptr %t8, ptr %t9
  call void @__inc_ref(ptr %t6)
  %t10 = call ptr @v__lift_16(ptr %t6)
...
define internal ptr @v__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_4_4__df__lam_5_5__lift_13__lift_14__lift_19__lift_2__lift_20__lift_3(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 55 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_4_4__df__lam_5_5__lift_13__lift_14__lift_19__lift_2__lift_20__lift_3(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_4_4__df__lam_5_5__lift_13__lift_14__lift_19__lift_2__lift_20__lift_3(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 34, label %tco.case.arm.34.11 i64 35, label %tco.case.arm.35.220 i64 36, label %tco.case.arm.36.243 i64 37, label %tco.case.arm.37.266 i64 38, label %tco.case.arm.38.289 i64 39, label %tco.case.arm.39.312 i64 40, label %tco.case.arm.40.335 i64 41, label %tco.case.arm.41.358 i64 42, label %tco.case.arm.42.381 i64 43, label %tco.case.arm.43.404 i64 44, label %tco.case.arm.44.427 ]
tco.case.arm.34.11:
  %t12 = getelementptr ptr, ptr %t5, i32 1
  %t13 = load ptr, ptr %t12
  call void @__inc_ref(ptr %t13)
  ...
  %t17 = load ptr, ptr %t16
  %t18 = ptrtoint ptr %t17 to i64
  switch i64 %t18, label %tco.case.default.19 [ i64 24, label %tco.case.arm.24.20 i64 25, label %tco.case.arm.25.40 i64 26, label %tco.case.arm.26.60 i64 27, label %tco.case.arm.27.80 i64 28, label %tco.case.arm.28.100 i64 29, label %tco.case.arm.29.120 i64 30, label %tco.case.arm.30.140 i64 31, label %tco.case.arm.31.160 i64 32, label %tco.case.arm.32.180 i64 33, label %tco.case.arm.33.200 ]
tco.case.arm.24.20:
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_10_1__df__lam_11_2__df__lam_4_4__df__lam_5_5__lift_13__lift_14__lift_19__lift_2__lift_20__lift_3(ptr %t0)
