...
(module
  ...
  (global $heap (mut i32) (i32.const 157))
  ...
  (data (i32.const 84) "\00\00\00\00\00\00\00\00\00\00\00\00\04\00\00\00\04\00\00\00FAIL")
  (data (i32.const 108) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00 ")
  (data (i32.const 129) "\00\00\00\00\00\00\00\00\00\00\00\00\08\00\00\00\08\00\00\00OVERFLOW")
  (table 2 funcref)
  (elem (i32.const 0) $v_runIO $v_identity)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_direct (result i32)
    (local $__drop_tmp i32)
    (call $__show_i32 (call $__box_i32 (i32.const 42))))

  (func $v_throughHof (result i32)
    (local $__drop_tmp i32)
    (call $__show_i32 (call $v_identity (call $__box_i32 (i32.const 10)))))

  (func $v_ascribedCall (result i32)
    (local $v___w0 i32)
    (local $v_n i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (call $__predInt32 (call $__box_i32 (i32.const 5)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v___w0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___w0)) (i32.const 96)) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_n)) (call $__show_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))))))

  (func $v_joined (result i32)
    (local $__con_0 i32)
    (local $v__do_e_35_3 i32)
    (local $v__do_e_36_3 i32)
    (local $v__do_e_37_3 i32)
    (local $v_ab i32)
    (local $v_abc i32)
    (local $v_abcd i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (call $__concat (call $v_direct) (i32.const 120))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_35_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_35_3)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_35_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_ab (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_ab)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_ab)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_throughHof))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_36_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_36_3)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_36_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_abc (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_abc)) (block (result i32) (local.set $__scrut (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_abc)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (i32.const 120))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v__do_e_37_3 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__do_e_37_3)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v__do_e_37_3)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (else (local.set $v_abcd (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_abcd)) (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_abcd)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (call $v_ascribedCall))))))))))))
