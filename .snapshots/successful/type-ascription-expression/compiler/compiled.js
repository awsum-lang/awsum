...
const v_joined = ((s) => { switch(s[0]) { case 3: { const v__do_e_35_3 = s[1]; return [3, v__do_e_35_3]; } case 4: { const v_ab = s[1]; return ((s) => { switch(s[0]) { case 3: { const v__do_e_36_3 = s[1]; return [3, v__do_e_36_3]; } case 4: { const v_abc = s[1]; return ((s) => { switch(s[0]) { case 3: { const v__do_e_37_3 = s[1]; return [3, v__do_e_37_3]; } case 4: { const v_abcd = s[1]; return __concat(v_abcd, v_ascribedCall); } } })(__concat(v_abc, " ")); } } })(__concat(v_ab, v_throughHof)); } } })(__concat(v_direct, " "));
