...
case.join.28:
  ...
  %t68 = call ptr @v_$apply$$df$andThenIO$0(ptr %t6, ptr %t12)
...
case.join.30:
  ...
  %t70 = call ptr @v_$apply$$df$andThenIO$4(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
