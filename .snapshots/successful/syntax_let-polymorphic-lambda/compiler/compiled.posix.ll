...
case.arm.4.16:
  ...
  call void @__inc_ref(ptr %t19)
  %t20 = call ptr @__concat(ptr %t19, ptr getelementptr inbounds (i8, ptr @.str.1, i64 12))
...
case.arm.4.34:
  ...
  call void @__inc_ref(ptr %t37)
  %t38 = call ptr @__concat(ptr %t37, ptr getelementptr inbounds (i8, ptr @.str.0, i64 12))
...
case.arm.4.52:
  ...
  call void @__inc_ref(ptr %t55)
  %t56 = call ptr @__concat(ptr %t55, ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
...
case.default.42:
  unreachable
case.join.43:
  %t57 = phi ptr [ %t48, %case.end.3.45 ], [ %t56, %case.end.4.53 ]
...
case.default.24:
  unreachable
case.join.25:
  %t58 = phi ptr [ %t30, %case.end.3.27 ], [ %t57, %case.end.4.35 ]
...
case.default.6:
  unreachable
case.join.7:
  %t59 = phi ptr [ %t12, %case.end.3.9 ], [ %t58, %case.end.4.17 ]
