...
case.default.21:
  unreachable
case.join.22:
  %t27 = phi ptr [%t26, %case.end.19.24]
...
case.default.12:
  unreachable
case.join.13:
  %t28 = phi ptr [%t27, %case.end.19.15]
...
define internal ptr @v_main() {
  ...
  %t14 = getelementptr ptr, ptr %t3, i32 1
  store ptr %t6, ptr %t14
  %t15 = call ptr @v_unwrap(ptr %t3)
