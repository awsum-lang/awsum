...
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"base-true" }
@.str.3 = private unnamed_addr constant {i32, i32, i32, i32, i32, [10 x i8]} { i32 0, i32 0, i32 0, i32 10, i32 10, [10 x i8] c"base-false" }
...
tco.case.arm.8.18:
  ...
  %t30 = call ptr @v_$cps$$scc$$apply1__$df$$lam$15$8__$df$$lam$9$4(ptr %t20, ptr %t27)
...
define internal ptr @v_main() {
  ...
  store ptr %t8, ptr %t9
  %t10 = call ptr @v_$cps$$df$$rowmono$0$andThenIO$7(ptr %t0, ptr %t7)
  %t11 = call ptr @__alloc(i64 8, i32 0)
  %t12 = inttoptr i64 32 to ptr
  %t13 = getelementptr ptr, ptr %t11, i32 0
  store ptr %t12, ptr %t13
  %t14 = call ptr @v_$cps$$df$handleErrorIO$3(ptr %t10, ptr %t11)
  ret ptr %t14
}
...
case.join.20:
  ...
  call void @__free_recursive(ptr %t15)
  %t50 = call ptr @v_$apply$$df$handleErrorIO$3(ptr %t6, ptr %t49)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.8.76:
  ...
  %t87 = call ptr @v_$apply$$df$handleErrorIO$3(ptr %t6, ptr %t79)
...
define internal ptr @v_$cps$$df$$rowmono$0$andThenIO$7(ptr %v_io, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.81 i64 7, label %tco.case.arm.7.83 i64 8, label %tco.case.arm.8.108 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  ...
  switch i64 %t19, label %case.default.20 [ i64 13, label %case.arm.13.22 i64 14, label %case.arm.14.35 ]
case.arm.13.22:
  ...
  %t27 = call ptr @__alloc(i64 16, i32 1)
  %t28 = inttoptr i64 796142685 to ptr
  %t29 = getelementptr ptr, ptr %t27, i32 0
  store ptr %t28, ptr %t29
  %t30 = call ptr @__alloc(i64 8, i32 0)
  ...
  %t33 = getelementptr ptr, ptr %t27, i32 1
  store ptr %t30, ptr %t33
  %t34 = getelementptr ptr, ptr %t24, i32 1
  store ptr %t27, ptr %t34
  br label %case.end.13.23
case.end.13.23:
...
case.arm.14.35:
  ...
  %t41 = inttoptr i64 796142685 to ptr
  ...
  %t47 = getelementptr ptr, ptr %t37, i32 1
...
case.arm.25.54:
  ...
  switch i64 %t62, label %case.default.63 [ i64 1, label %case.arm.1.65 i64 2, label %case.arm.2.67 ]
case.arm.1.65:
...
case.default.63:
  unreachable
case.join.64:
  %t69 = phi ptr [ getelementptr inbounds (i8, ptr @.str.2, i64 12), %case.end.1.66 ], [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.2.68 ]
  call void @__free_recursive(ptr %t59)
  call void @__free_recursive(ptr %t57)
  br label %case.end.25.55
case.end.25.55:
  br label %case.join.53
case.default.52:
  unreachable
case.join.53:
  %t70 = phi ptr [ %t69, %case.end.25.55 ]
  call void @__free_recursive(ptr %t48)
  %t71 = getelementptr ptr, ptr %t12, i32 1
  store ptr %t70, ptr %t71
  %t72 = call ptr @__alloc(i64 16, i32 1)
  %t73 = inttoptr i64 5 to ptr
  ...
  %t79 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t72, ptr %t79
  %t80 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$7(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.81:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t82 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$7(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
reuse.in_place.97:
  ...
  %t92 = inttoptr i64 35 to ptr
  %t93 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t92, ptr %t93
  call void @__inc_ref(ptr %t6)
  %t90 = getelementptr ptr, ptr %t5, i32 1
  store ptr %t6, ptr %t90
  %t91 = getelementptr ptr, ptr %t5, i32 2
  store ptr %t85, ptr %t91
  br label %reuse.in_place.end.100
reuse.in_place.end.100:
  br label %reuse.join.99
reuse.copy.98:
  %t102 = call ptr @__alloc(i64 24, i32 2)
  %t103 = inttoptr i64 35 to ptr
  ...
  %t106 = getelementptr ptr, ptr %t102, i32 2
  store ptr %t85, ptr %t106
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.101
reuse.copy.end.101:
  br label %reuse.join.99
reuse.join.99:
  %t107 = phi ptr [ %t5, %reuse.in_place.end.100 ], [ %t102, %reuse.copy.end.101 ]
  call void @__free_recursive(ptr %t6)
  store ptr %t87, ptr %t3
  store ptr %t107, ptr %t4
  br label %tco.loop.0
tco.case.arm.8.108:
  ...
  call void @__inc_ref(ptr %t6)
  %t111 = call ptr @__alloc(i64 16, i32 1)
  ...
  %t118 = getelementptr ptr, ptr %t111, i32 1
  store ptr %t114, ptr %t118
  %t119 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$7(ptr %t6, ptr %t111)
  call void @__free_recursive(ptr %t110)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t119, ptr %t2
  br label %tco.exit.1
tco.case.default.10:
  unreachable
tco.exit.1:
...
define internal ptr @v_$apply$$df$$rowmono$0$andThenIO$7(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
define internal ptr @v_$cps$$scc$$apply1__$df$$lam$15$8__$df$$lam$9$4(ptr %v_$args, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
case.join.41:
  ...
  %t59 = call ptr @v_$apply$$scc$$apply1__$df$$lam$15$8__$df$$lam$9$4(ptr %t6, ptr %t58)
  call void @__free_recursive(ptr %t15)
  call void @__free_recursive(ptr %t13)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$$scc$$apply1__$df$$lam$15$8__$df$$lam$9$4(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 36, label %tco.case.arm.36.11 i64 37, label %tco.case.arm.37.12 i64 38, label %tco.case.arm.38.19 ]
tco.case.arm.36.11:
  call void @__free_recursive(ptr %t5)
  store ptr %t6, ptr %t2
  br label %tco.exit.1
tco.case.arm.37.12:
  ...
  %t18 = call ptr @v_$cps$$df$$rowmono$0$andThenIO$7(ptr %t6, ptr %t15)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
  store ptr %t14, ptr %t3
...
tco.case.arm.38.19:
  ...
  %t23 = inttoptr i64 32 to ptr
  %t24 = getelementptr ptr, ptr %t22, i32 0
  store ptr %t23, ptr %t24
  %t25 = call ptr @v_$cps$$df$handleErrorIO$3(ptr %t6, ptr %t22)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %t5)
