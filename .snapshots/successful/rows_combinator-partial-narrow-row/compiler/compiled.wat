...
(module
  ...
  (table 7 funcref)
  (elem (i32.const 0) $v_runIO $v_cont $v_describe $v__lift_18 $v__lift_19 $v__df__rowmono_0_bindEither_1 $v__df_partialB_0)
  ...
  (func $v__df__rowmono_0_bindEither_1 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v__df_partialB_0 (result i32)
    (local i32)
    (local i32)
    call 15
    call 19
