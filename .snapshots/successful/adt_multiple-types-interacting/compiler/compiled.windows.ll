...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [3 x i8]} { i32 0, i32 0, i32 0, i32 3, i32 3, [3 x i8] c"red" }
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [5 x i8]} { i32 0, i32 0, i32 0, i32 5, i32 5, [5 x i8] c"green" }
...
define internal ptr @v_res() {
  ...
  switch i64 %t11, label %case.default.12 [ i64 24, label %case.arm.24.14 i64 25, label %case.arm.25.16 ]
case.arm.24.14:
...
case.default.12:
  unreachable
case.join.13:
  %t18 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.24.15 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.25.17 ]
  call void @__free_recursive(ptr %t8)
  call void @__free_recursive(ptr %t0)
  %t19 = call ptr @__concat(ptr %t18, ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
...
case.arm.4.33:
  ...
  %t50 = getelementptr ptr, ptr %t49, i32 1
  %t51 = load ptr, ptr %t50
  call void @__inc_ref(ptr %t51)
  %t52 = getelementptr ptr, ptr %t51, i32 0
  %t53 = load ptr, ptr %t52
  %t54 = ptrtoint ptr %t53 to i64
  switch i64 %t54, label %case.default.55 [ i64 24, label %case.arm.24.57 i64 25, label %case.arm.25.59 ]
case.arm.24.57:
  br label %case.end.24.58
case.end.24.58:
  br label %case.join.56
case.arm.25.59:
  br label %case.end.25.60
case.end.25.60:
  br label %case.join.56
case.default.55:
  unreachable
case.join.56:
  %t61 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.24.58 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.25.60 ]
  call void @__free_recursive(ptr %t51)
  call void @__free_recursive(ptr %t49)
  call void @__free_recursive(ptr %t37)
  %t62 = call ptr @__concat(ptr %t36, ptr %t61)
...
case.default.23:
  unreachable
case.join.24:
  %t63 = phi ptr [ %t29, %case.end.3.26 ], [ %t62, %case.end.4.34 ]
