...
@.str.0 = private unnamed_addr constant {i32, i32, [3 x i8]} { i32 3, i32 3, [3 x i8] c"red" }
@.str.1 = private unnamed_addr constant {i32, i32, [5 x i8]} { i32 5, i32 5, [5 x i8] c"green" }
...
define internal ptr @v_colorName(ptr %v_c) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 19, label %case.arm.19.5 i64 20, label %case.arm.20.7 ]
case.arm.19.5:
  br label %case.end.19.6
case.end.19.6:
  br label %case.join.4
case.arm.20.7:
  br label %case.end.20.8
case.end.20.8:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t9 = phi ptr [@.str.0, %case.end.19.6], [@.str.1, %case.end.20.8]
  ret ptr %t9
}
...
define internal ptr @v_showBoxedColor(ptr %v_bc) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 22, label %case.arm.22.5 ]
case.arm.22.5:
  %t7 = getelementptr ptr, ptr %v_bc, i32 1
  %t8 = load ptr, ptr %t7
  %t9 = call ptr @v_colorName(ptr %t8)
  br label %case.end.22.6
case.end.22.6:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t10 = phi ptr [%t9, %case.end.22.6]
  ret ptr %t10
}
...
define internal ptr @v_showResult(ptr %v_r) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 23, label %case.arm.23.5 ]
case.arm.23.5:
  %t7 = getelementptr ptr, ptr %v_r, i32 1
  %t8 = load ptr, ptr %t7
  %t9 = call ptr @v_showBoxedColor(ptr %t8)
  br label %case.end.23.6
case.end.23.6:
  br label %case.join.4
case.default.3:
  unreachable
case.join.4:
  %t10 = phi ptr [%t9, %case.end.23.6]
  ret ptr %t10
}
...
define internal ptr @v_main() {
  ...
  %t8 = call ptr @__concat(ptr %t7, ptr @.str.2)
