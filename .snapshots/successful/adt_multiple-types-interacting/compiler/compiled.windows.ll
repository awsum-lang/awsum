...
define internal ptr @v_colorName(ptr %v_c) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 24, label %case.arm.24.4 i64 25, label %case.arm.25.5 ]
case.arm.24.4:
...
define internal ptr @v_showBoxedColor(ptr %v_bc) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 27, label %case.arm.27.4 ]
case.arm.27.4:
  %t5 = getelementptr ptr, ptr %v_bc, i32 1
  %t6 = load ptr, ptr %t5
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t6)
  %t7 = call ptr @v_colorName(ptr %t6)
  call void @__free_recursive(ptr %t6)
  call void @__free_recursive(ptr %v_bc)
  ret ptr %t7
case.default.3:
  unreachable
}
...
define internal ptr @v_showResult(ptr %v_r) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 28, label %case.arm.28.4 ]
case.arm.28.4:
  %t5 = getelementptr ptr, ptr %v_r, i32 1
  %t6 = load ptr, ptr %t5
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t6)
  %t7 = call ptr @v_showBoxedColor(ptr %t6)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_main() {
  ...
  store ptr %t3, ptr %t6
  %t7 = call ptr @v_showBoxedColor(ptr %t0)
...
case.arm.4.22:
  ...
  %t37 = call ptr @v_showResult(ptr %t26)
  %t38 = call ptr @__concat(ptr %t25, ptr %t37)
...
case.default.12:
  unreachable
case.join.13:
  %t39 = phi ptr [ %t18, %case.end.3.15 ], [ %t38, %case.end.4.23 ]
  call void @__free_recursive(ptr %t8)
  %t40 = call ptr @v__let_23(ptr %t39)
  ret ptr %t40
}
