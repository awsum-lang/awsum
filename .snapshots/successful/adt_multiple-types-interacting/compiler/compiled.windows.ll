...
define internal ptr @v_colorName(ptr %v_c) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 22, label %case.arm.22.4 i64 23, label %case.arm.23.5 ]
case.arm.22.4:
...
define internal ptr @v_showResult(ptr %v_r) {
  ...
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 26, label %case.arm.26.4 ]
case.arm.26.4:
...
case.join.13:
  ...
  %t40 = call ptr @v__let_12(ptr %t39)
  ret ptr %t40
}
