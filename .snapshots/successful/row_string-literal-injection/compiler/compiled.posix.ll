...
@.str.2 = private unnamed_addr constant {i32, i32, i32, i32, i32, [1 x i8]} { i32 0, i32 0, i32 0, i32 1, i32 1, [1 x i8] c"L" }
...
define internal ptr @v_iv() {
  %t0 = call ptr @__alloc(i64 16, i32 1)
  %t1 = inttoptr i64 2711245919 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
...
define internal ptr @v_d(ptr %v_x) {
  %t0 = getelementptr ptr, ptr %v_x, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 1615808600, label %case.arm.1615808600.4 i64 2711245919, label %case.arm.2711245919.7 ]
case.arm.1615808600.4:
  ...
  ret ptr %t6
case.arm.2711245919.7:
  %t8 = getelementptr ptr, ptr %v_x, i32 1
  %t9 = load ptr, ptr %t8
...
define internal ptr @v_pick(ptr %v_b) {
  %t0 = getelementptr ptr, ptr %v_b, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 1, label %case.arm.1.4 i64 2, label %case.arm.2.9 ]
case.arm.1.4:
  %t5 = call ptr @__alloc(i64 16, i32 1)
  %t6 = inttoptr i64 1615808600 to ptr
...
case.arm.2.9:
  ...
  %t11 = inttoptr i64 2711245919 to ptr
  %t12 = getelementptr ptr, ptr %t10, i32 0
  store ptr %t11, ptr %t12
  %t13 = call ptr @__alloc(i64 4, i32 0)
  store i32 1, ptr %t13
...
define internal ptr @v_fromLet(ptr %v__b) {
  %t0 = call ptr @__alloc(i64 16, i32 1)
  %t1 = inttoptr i64 1615808600 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
...
define internal ptr @v_main() {
  ...
  %t14 = call ptr @v__lift_25(ptr %t0)
  %t15 = call ptr @v__df_andThenIO_12(ptr %t14)
  %t16 = call ptr @v__df_andThenIO_8(ptr %t15)
  %t17 = call ptr @v__df_andThenIO_4(ptr %t16)
  %t18 = call ptr @v__df_andThenIO_0(ptr %t17)
  ret ptr %t18
}
...
define internal ptr @v__let_23(ptr %v_lv) {
  call void @__inc_ref(ptr %v_lv)
  %t0 = call ptr @v_d(ptr %v_lv)
  call void @__free_recursive(ptr %v_lv)
  ret ptr %t0
}
...
define internal ptr @v__lam_29(ptr %v__u) {
  ...
  %t5 = getelementptr ptr, ptr %t3, i32 0
  store ptr %t4, ptr %t5
  %t6 = call ptr @v_pick(ptr %t3)
  %t7 = call ptr @v_d(ptr %t6)
  ...
  %t17 = call ptr @v__lift_25(ptr %t0)
  call void @__free_recursive(ptr %v__u)
  ret ptr %t17
}
...
define internal ptr @v__scc__apply1__df__lam_5_1__df__lam_5_13__df__lam_5_5__df__lam_5_9__df__lam_6_10__df__lam_6_14__df__lam_6_2__df__lam_6_6__df__lam_7_11__df__lam_7_15__df__lam_7_3__df__lam_7_7__lift_2__lift_26__lift_27__lift_28__lift_3__lift_4(ptr %v__args) {
  call void @__inc_ref(ptr %v__args)
  %t0 = call ptr @__alloc(i64 8, i32 0)
  %t1 = inttoptr i64 60 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @v__cps__scc__apply1__df__lam_5_1__df__lam_5_13__df__lam_5_5__df__lam_5_9__df__lam_6_10__df__lam_6_14__df__lam_6_2__df__lam_6_6__df__lam_7_11__df__lam_7_15__df__lam_7_3__df__lam_7_7__lift_2__lift_26__lift_27__lift_28__lift_3__lift_4(ptr %v__args, ptr %t0)
  call void @__free_recursive(ptr %v__args)
  ret ptr %t3
}

define internal ptr @v__cps__scc__apply1__df__lam_5_1__df__lam_5_13__df__lam_5_5__df__lam_5_9__df__lam_6_10__df__lam_6_14__df__lam_6_2__df__lam_6_6__df__lam_7_11__df__lam_7_15__df__lam_7_3__df__lam_7_7__lift_2__lift_26__lift_27__lift_28__lift_3__lift_4(ptr %v__args, ptr %v__k) {
entry:
  %t3 = alloca ptr
...
define internal ptr @v__apply1(ptr %v__cl, ptr %v__arg0) {
  ...
  %t5 = call ptr @v__scc__apply1__df__lam_5_1__df__lam_5_13__df__lam_5_5__df__lam_5_9__df__lam_6_10__df__lam_6_14__df__lam_6_2__df__lam_6_6__df__lam_7_11__df__lam_7_15__df__lam_7_3__df__lam_7_7__lift_2__lift_26__lift_27__lift_28__lift_3__lift_4(ptr %t0)
