...
case.join.23:
  ...
  %t43 = call ptr @v_$apply$$df$andThenIO$0(ptr %t6, ptr %t12)
...
case.join.24:
  ...
  %t44 = call ptr @v_$apply$$df$andThenIO$4(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
case.join.23:
  ...
  %t42 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t35, ptr %t42
  %t43 = call ptr @v_$apply$$df$andThenIO$8(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t43, ptr %t2
  br label %tco.exit.1
...
tco.loop.0:
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 7, label %tco.case.arm.7.41 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  %t12 = call ptr @__alloc(i64 24, i32 2)
  %t13 = inttoptr i64 7 to ptr
  ...
  switch i64 %t18, label %case.default.19 [ i64 1615808600, label %case.arm.1615808600.21 i64 2711245919, label %case.arm.2711245919.25 ]
...
case.arm.2711245919.25:
  %t27 = getelementptr ptr, ptr %t15, i32 1
  %t28 = load ptr, ptr %t27
  call void @__inc_ref(ptr %t28)
  %t29 = call ptr @__showInt32(ptr %t28)
  br label %case.end.2711245919.26
case.end.2711245919.26:
  br label %case.join.20
case.default.19:
  unreachable
case.join.20:
  %t30 = phi ptr [ %t24, %case.end.1615808600.22 ], [ %t29, %case.end.2711245919.26 ]
  call void @__free_recursive(ptr %t15)
  %t31 = getelementptr ptr, ptr %t12, i32 1
  ...
  %t39 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t32, ptr %t39
  %t40 = call ptr @v_$apply$$df$andThenIO$12(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
