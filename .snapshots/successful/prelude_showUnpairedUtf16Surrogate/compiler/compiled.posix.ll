...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [22 x i8]} { i32 0, i32 0, i32 0, i32 22, i32 22, [22 x i8] c"UnpairedUtf16Surrogate" }
...
define internal ptr @v_showUnpairedUtf16Surrogate(ptr %v__wild0) {
...
define internal ptr @v_main() {
  ...
  store ptr %t4, ptr %t5
  %t6 = call ptr @v_showUnpairedUtf16Surrogate(ptr %t3)
