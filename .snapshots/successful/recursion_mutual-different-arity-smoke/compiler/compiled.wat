...
(module
  ...
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v__scc_parseBinary_parseExpr $v_parseExpr)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_main (result i32)
    ...
    (local $__con_2 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (call $__show_i32 (call $v_parseExpr (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 20)) (local.get $__con_1))))) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0)))
  ...
  (func $v__scc_parseBinary_parseExpr (param $v__args i32) (result i32)
    ...
    (local $__drop_tmp i32)
    (local $__k0 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (local.get $v__args)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 21)) (then (local.set $v_tok (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_tok)) (local.set $v__acc (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v__acc)) (block (result i32) (local.set $__scrut (local.get $v_tok)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 19)) (then (block (result i32) (local.set $__drop_tmp (call $__box_i32 (i32.const 0))) (call $__free_recursive (local.get $v__acc)) (call $__free_recursive (local.get $v_tok)) (call $__free_recursive (local.get $v__args)) (local.get $__drop_tmp))) (else (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 22)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 19)) (local.get $__con_1))) (local.get $__con_0))) (call $__free_recursive (local.get $v__args)) (call $__free_recursive (local.get $v__acc)) (call $__free_recursive (local.get $v_tok)) (local.set $v__args (local.get $__k0)) (br $tco_top))))) (else (local.set $v_tok (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_tok)) (block (result i32) (local.set $__scrut (local.get $v_tok)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 19)) (then (block (result i32) (local.set $__drop_tmp (call $__box_i32 (i32.const 0))) (call $__free_recursive (local.get $v_tok)) (call $__free_recursive (local.get $v__args)) (local.get $__drop_tmp))) (else (local.set $__k0 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 21)) (i32.store offset=4 (local.get $__con_0) (local.get $v_tok)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (i32.store offset=8 (local.get $__con_0) (call $__box_i32 (i32.const 0))) (local.get $__con_0))) (call $__free_recursive (local.get $v__args)) (call $__free_recursive (local.get $v_tok)) (local.set $v__args (local.get $__k0)) (br $tco_top)))))))))

  (func $v_parseExpr (param $v_tok i32) (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__scc_parseBinary_parseExpr (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 22)) (i32.store offset=4 (local.get $__con_0) (local.get $v_tok)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))))
