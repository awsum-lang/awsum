...
(module
  ...
  (global $heap (mut i32) (i32.const 82))
  ...
  (func $v_showBoxedColor (export "v_showBoxedColor") (param $v_bc i32) (result i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_bc)) (call $v_colorName (i32.load offset=4 (local.get $__scrut)))))

  (func $v_showResult (export "v_showResult") (param $v_r i32) (result i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (call $v_showBoxedColor (i32.load offset=4 (local.get $__scrut)))) (else (i32.load offset=4 (local.get $__scrut))))))
