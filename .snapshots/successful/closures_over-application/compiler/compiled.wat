...
(module
  ...
  (table 6 funcref)
  (elem (i32.const 0) $v_runIO $v_inc $v__df_identity_0 $v__apply2 $v__scc__apply1_applyOnce $v_applyOnce)
  ...
  (func $v_inc (param i32) (result i32)
    (local i32)
    (local i32)
    local.get 0)
  ...
  (func $v__df_identity_0 (result i32)
    (local i32)
    (local i32)
    (local i32)
    i32.const 4
  ...
  (func $v__apply2 (param i32 i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    local.get 0
  ...
  (func $v__scc__apply1_applyOnce (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v_applyOnce (param i32 i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
