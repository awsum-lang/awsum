...
define internal ptr @v__apply2(ptr %v__cl, ptr %v__arg0, ptr %v__arg1) {
  %t0 = getelementptr ptr, ptr %v__cl, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
  switch i64 %t2, label %case.default.3 [ i64 10, label %case.arm.10.4 ]
case.arm.10.4:
  call void @__inc_ref(ptr %v__arg0)
  call void @__inc_ref(ptr %v__arg1)
  %t5 = call ptr @v_applyOnce(ptr %v__arg0, ptr %v__arg1)
  call void @__free_recursive(ptr %v__cl)
  call void @__free_recursive(ptr %v__arg0)
  call void @__free_recursive(ptr %v__arg1)
  ret ptr %t5
case.default.3:
  unreachable
}
