...
define internal ptr @v_main() {
  ...
  %t14 = inttoptr i64 14 to ptr
  %t15 = getelementptr ptr, ptr %t13, i32 0
  store ptr %t14, ptr %t15
  %t16 = call ptr @v_$cps$$df$andThenIO$12(ptr %t0, ptr %t13)
  %t17 = call ptr @__alloc(i64 8, i32 0)
  %t18 = inttoptr i64 12 to ptr
  %t19 = getelementptr ptr, ptr %t17, i32 0
  store ptr %t18, ptr %t19
  %t20 = call ptr @v_$cps$$df$andThenIO$8(ptr %t16, ptr %t17)
  %t21 = call ptr @__alloc(i64 8, i32 0)
  %t22 = inttoptr i64 10 to ptr
  %t23 = getelementptr ptr, ptr %t21, i32 0
  store ptr %t22, ptr %t23
  %t24 = call ptr @v_$cps$$df$andThenIO$4(ptr %t20, ptr %t21)
  %t25 = call ptr @__alloc(i64 8, i32 0)
  %t26 = inttoptr i64 8 to ptr
  %t27 = getelementptr ptr, ptr %t25, i32 0
  store ptr %t26, ptr %t27
  %t28 = call ptr @v_$cps$$df$andThenIO$0(ptr %t24, ptr %t25)
  ret ptr %t28
}
