...
(() => {
  ...
  const v_$cps$$df$andThenIO$8 = (v_io, v_$k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v_$apply$$df$andThenIO$8(v_$k, [7, "mu", [5, [0]]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_$cps$$df$andThenIO$16 = (v_io, v_$k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v_$apply$$df$andThenIO$16(v_$k, [7, "mu", [5, [0]]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
  ...
  const v_$cps$$df$andThenIO$0 = (v_io, v_$k) => {
    while (true) {
      switch (v_io[0]) {
        case 5: {
          return v_$apply$$df$andThenIO$0(v_$k, [7, "mt", [5, [0]]]);
        }
        case 7: {
          const v_s = v_io[1];
          const v_next = v_io[2];
      ...
      v_$cps$$df$andThenIO$8(
        v_$cps$$df$andThenIO$12(
          v_$cps$$df$andThenIO$16(
            v_$cps$$df$andThenIO$20([7, "mt", [5, [0]]], [37]),
            [35]
          ),
          [33]
        ),
