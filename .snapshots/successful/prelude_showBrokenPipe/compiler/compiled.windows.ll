...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [10 x i8]} { i32 0, i32 0, i32 0, i32 10, i32 10, [10 x i8] c"BrokenPipe" }
...
define internal ptr @v_showBrokenPipe(ptr %v__wild0) {
...
define internal ptr @v_main() {
  ...
  store ptr %t4, ptr %t5
  %t6 = call ptr @v_showBrokenPipe(ptr %t3)
