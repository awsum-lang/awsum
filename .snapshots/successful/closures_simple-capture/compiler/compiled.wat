...
(module
  ...
  (table 4 funcref)
  (elem (i32.const 0) $v_runIO $v_captureFn $v__lam_7 $v__df_apply_0)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v__lam_7 (param $v_k i32) (param $v__n i32) (result i32)
    (local $__drop_tmp i32)
    (local.get $v_k))

  (func $v__df_apply_0 (param $v_x i32) (param $v__df_apply_0_cap0_0 i32) (result i32)
    (local $__drop_tmp i32)
    (call $v__lam_7 (block (result i32) (local.set $__inc_tmp (local.get $v__df_apply_0_cap0_0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_x)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))
