...
(module
  ...
  (global $heap (mut i32) (i32.const 218))
  ...
  (data (i32.const 126) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00z")
  (data (i32.const 147) "\00\00\00\00\00\00\00\00\00\00\00\00\03\00\00\00\03\00\00\00UPS")
  ...
  (table 8 funcref)
  (elem (i32.const 0) $v_runIO $v_label $v__cps__df_handleErrorIO_0 $v__apply__df_handleErrorIO_0 $v__cps__df__rowmono_0_andThenIO_4 $v__apply__df__rowmono_0_andThenIO_4 $v__cps__scc__apply1__df__lam_13_5__df__lam_9_1 $v__apply__scc__apply1__df__lam_13_5__df__lam_9_1)
  ...
  (func $v_label (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
