...
define internal ptr @v_label(ptr %v_k) {
  ...
  store i32 7, ptr %t1
  %t2 = call ptr @__eqInt32(ptr %v_k, ptr %t1)
  %t3 = getelementptr ptr, ptr %t2, i32 0
  %t4 = load ptr, ptr %t3
  %t5 = ptrtoint ptr %t4 to i64
  switch i64 %t5, label %case.default.6 [ i64 1, label %case.arm.1.7 i64 2, label %case.arm.2.8 ]
case.arm.1.7:
...
case.arm.2.8:
  ...
  store i32 0, ptr %t9
  %t10 = call ptr @__eqInt32(ptr %v_k, ptr %t9)
  %t11 = getelementptr ptr, ptr %t10, i32 0
  %t12 = load ptr, ptr %t11
  %t13 = ptrtoint ptr %t12 to i64
  switch i64 %t13, label %case.default.14 [ i64 1, label %case.arm.1.16 i64 2, label %case.arm.2.21 ]
case.arm.1.16:
...
case.arm.2.21:
  ...
  store i32 1, ptr %t23
  %t24 = call ptr @__eqInt32(ptr %v_k, ptr %t23)
  %t25 = getelementptr ptr, ptr %t24, i32 0
  %t26 = load ptr, ptr %t25
  %t27 = ptrtoint ptr %t26 to i64
  switch i64 %t27, label %case.default.28 [ i64 1, label %case.arm.1.30 i64 2, label %case.arm.2.35 ]
case.arm.1.30:
...
case.default.28:
  unreachable
case.join.29:
  %t40 = phi ptr [ %t32, %case.end.1.31 ], [ %t37, %case.end.2.36 ]
...
case.default.6:
  unreachable
join.0:
  %t42 = load ptr, ptr %v_$inl1$scrut.jslot
  %t43 = getelementptr ptr, ptr %t42, i32 0
  %t44 = load ptr, ptr %t43
  %t45 = ptrtoint ptr %t44 to i64
  switch i64 %t45, label %case.default.46 [ i64 24, label %case.arm.24.47 i64 25, label %case.arm.25.48 i64 26, label %case.arm.26.49 ]
case.arm.24.47:
