...
define internal ptr @v_$cps$mklist(ptr %v_a, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_a, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.1.13:
  ...
  %t17 = call ptr @v_$apply$mklist(ptr %t6, ptr %t14)
...
tco.case.arm.2.18:
  ...
  switch i64 %t22, label %tco.case.default.23 [ i64 3, label %tco.case.arm.3.24 i64 4, label %tco.case.arm.4.29 ]
tco.case.arm.3.24:
  call void @__inc_ref(ptr %t6)
  %t25 = call ptr @__alloc(i64 8, i32 0)
  %t26 = inttoptr i64 24 to ptr
  %t27 = getelementptr ptr, ptr %t25, i32 0
  store ptr %t26, ptr %t27
  %t28 = call ptr @v_$apply$mklist(ptr %t6, ptr %t25)
  call void @__free_recursive(ptr %t19)
  call void @__free_recursive(ptr %t8)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$mklist(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
...
define internal ptr @v_$cps$mkmb(ptr %v_c, ptr %v_$k) {
entry:
  %t3 = alloca ptr
...
tco.case.arm.1.13:
  call void @__inc_ref(ptr %t6)
  %t14 = call ptr @__alloc(i64 8, i32 0)
  %t15 = inttoptr i64 11 to ptr
  %t16 = getelementptr ptr, ptr %t14, i32 0
  store ptr %t15, ptr %t16
  %t17 = call ptr @v_$apply$mkmb(ptr %t6, ptr %t14)
  call void @__free_recursive(ptr %t8)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t17, ptr %t2
...
tco.case.arm.3.24:
  ...
  %t27 = getelementptr ptr, ptr %t25, i32 0
  store ptr %t26, ptr %t27
  %t28 = call ptr @v_$apply$mkmb(ptr %t6, ptr %t25)
  call void @__free_recursive(ptr %t19)
  call void @__free_recursive(ptr %t8)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
define internal ptr @v_$apply$mkmb(ptr %v_$k, ptr %v_$x) {
entry:
  %t3 = alloca ptr
  store ptr %v_$k, ptr %t3
  %t4 = alloca ptr
...
tco.case.arm.35.12:
  ...
  switch i64 %t17, label %tco.case.default.18 [ i64 11, label %tco.case.arm.11.19 i64 12, label %tco.case.arm.12.26 ]
tco.case.arm.11.19:
  %t20 = call ptr @__alloc(i64 16, i32 1)
  %t21 = inttoptr i64 12 to ptr
  %t22 = getelementptr ptr, ptr %t20, i32 0
  store ptr %t21, ptr %t22
...
entry:
  ...
  %t4 = alloca ptr
  store ptr %v_$k, ptr %t4
  %v_$inl20$scrut.jslot = alloca ptr
  %t2 = alloca ptr
  br label %tco.loop.0
tco.loop.0:
  %t5 = load ptr, ptr %t3
  ...
  %t8 = load ptr, ptr %t7
  %t9 = ptrtoint ptr %t8 to i64
  switch i64 %t9, label %tco.case.default.10 [ i64 5, label %tco.case.arm.5.11 i64 6, label %tco.case.arm.6.106 i64 7, label %tco.case.arm.7.108 i64 8, label %tco.case.arm.8.133 ]
tco.case.arm.5.11:
  call void @__inc_ref(ptr %t6)
  ...
  switch i64 %t16, label %case.default.17 [ i64 13, label %case.arm.13.19 i64 14, label %case.arm.14.22 ]
case.arm.13.19:
...
case.arm.14.22:
  %t24 = getelementptr ptr, ptr %t13, i32 1
  %t25 = load ptr, ptr %t24
  call void @__inc_ref(ptr %t25)
  %t26 = call ptr @__parseInt32(ptr %t25)
  %t27 = getelementptr ptr, ptr %t26, i32 0
  %t28 = load ptr, ptr %t27
  %t29 = ptrtoint ptr %t28 to i64
  switch i64 %t29, label %case.default.30 [ i64 3, label %case.arm.3.32 i64 4, label %case.arm.4.35 ]
case.arm.3.32:
...
case.arm.4.35:
  %t37 = getelementptr ptr, ptr %t26, i32 1
...
case.default.30:
  unreachable
case.join.31:
  %t39 = phi ptr [ %t34, %case.end.3.33 ], [ %t38, %case.end.4.36 ]
  call void @__free_recursive(ptr %t26)
  br label %case.end.14.23
case.end.14.23:
  br label %case.join.18
case.default.17:
  unreachable
case.join.18:
  %t40 = phi ptr [ %t21, %case.end.13.20 ], [ %t39, %case.end.14.23 ]
  ...
  store i32 5, ptr %t46
  %t47 = call ptr @__eqInt32(ptr %t40, ptr %t46)
  %t48 = getelementptr ptr, ptr %t47, i32 0
  %t49 = load ptr, ptr %t48
  %t50 = ptrtoint ptr %t49 to i64
  switch i64 %t50, label %case.default.51 [ i64 1, label %case.arm.1.53 i64 2, label %case.arm.2.58 ]
case.arm.1.53:
...
case.arm.2.58:
  ...
  %t63 = call ptr @v_$cps$mkmb(ptr %t40, ptr %t60)
  br label %case.end.2.59
case.end.2.59:
  br label %case.join.52
case.default.51:
  unreachable
case.join.52:
  %t64 = phi ptr [ %t55, %case.end.1.54 ], [ %t63, %case.end.2.59 ]
  call void @__free_recursive(ptr %t47)
  %t65 = getelementptr ptr, ptr %t64, i32 0
  %t66 = load ptr, ptr %t65
  %t67 = ptrtoint ptr %t66 to i64
  switch i64 %t67, label %join.case.default.68 [ i64 11, label %join.case.arm.11.69 i64 12, label %join.case.arm.12.72 ]
join.case.arm.11.69:
  %t70 = call ptr @__alloc(i64 4, i32 0)
  store i32 9, ptr %t70
  call void @__free_recursive(ptr %t64)
  br label %join.val.71
join.val.71:
  br label %join.after.45
join.case.arm.12.72:
  %t73 = getelementptr ptr, ptr %t64, i32 1
  %t74 = load ptr, ptr %t73
  call void @__inc_ref(ptr %t74)
  call void @__inc_ref(ptr %t74)
  %t75 = call ptr @__alloc(i64 8, i32 0)
  %t76 = inttoptr i64 32 to ptr
  %t77 = getelementptr ptr, ptr %t75, i32 0
  store ptr %t76, ptr %t77
  %t78 = call ptr @v_$cps$mklist(ptr %t74, ptr %t75)
  call void @__free_recursive(ptr %t74)
  call void @__free_recursive(ptr %t64)
  store ptr %t78, ptr %v_$inl20$scrut.jslot
  br label %join.44
join.case.default.68:
  unreachable
join.44:
  %t79 = load ptr, ptr %v_$inl20$scrut.jslot
  %t80 = getelementptr ptr, ptr %t79, i32 0
  %t81 = load ptr, ptr %t80
  %t82 = ptrtoint ptr %t81 to i64
  switch i64 %t82, label %case.default.83 [ i64 24, label %case.arm.24.85 i64 25, label %case.arm.25.88 ]
case.arm.24.85:
  %t87 = call ptr @__alloc(i64 4, i32 0)
  store i32 0, ptr %t87
  br label %case.end.24.86
case.end.24.86:
  br label %case.join.84
case.arm.25.88:
  %t90 = getelementptr ptr, ptr %t79, i32 1
  %t91 = load ptr, ptr %t90
  call void @__inc_ref(ptr %t91)
  br label %case.end.25.89
case.end.25.89:
  br label %case.join.84
case.default.83:
  unreachable
case.join.84:
  %t92 = phi ptr [ %t87, %case.end.24.86 ], [ %t91, %case.end.25.89 ]
  call void @__free_recursive(ptr %t79)
  br label %join.end.93
join.end.93:
  br label %join.after.45
join.after.45:
  %t94 = phi ptr [ %t70, %join.val.71 ], [ %t92, %join.end.93 ]
  %t95 = call ptr @__showInt32(ptr %t94)
  %t96 = getelementptr ptr, ptr %t41, i32 1
  ...
  %t104 = getelementptr ptr, ptr %t41, i32 2
  store ptr %t97, ptr %t104
  call void @__free_recursive(ptr %t40)
  call void @__free_recursive(ptr %t13)
  %t105 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$4(ptr %t6, ptr %t41)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.6.106:
  call void @__inc_ref(ptr %t6)
  call void @__inc_ref(ptr %t5)
  %t107 = call ptr @v_$apply$$df$$rowmono$0$andThenIO$4(ptr %t6, ptr %t5)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
...
tco.case.arm.7.108:
  ...
  %t111 = getelementptr ptr, ptr %t5, i32 2
  %t112 = load ptr, ptr %t111
  call void @__inc_ref(ptr %t112)
  %t119 = getelementptr i8, ptr %t5, i64 -8
  %t120 = load i32, ptr %t119
  %t121 = icmp eq i32 %t120, 1
  br i1 %t121, label %reuse.in_place.122, label %reuse.copy.123
reuse.in_place.122:
  %t113 = getelementptr ptr, ptr %t5, i32 2
  %t114 = load ptr, ptr %t113
  call void @__free_recursive(ptr %t114)
  %t117 = inttoptr i64 39 to ptr
  %t118 = getelementptr ptr, ptr %t5, i32 0
  store ptr %t117, ptr %t118
  call void @__inc_ref(ptr %t6)
  %t115 = getelementptr ptr, ptr %t5, i32 1
  store ptr %t6, ptr %t115
  %t116 = getelementptr ptr, ptr %t5, i32 2
  store ptr %t110, ptr %t116
  br label %reuse.in_place.end.125
reuse.in_place.end.125:
  br label %reuse.join.124
reuse.copy.123:
  %t127 = call ptr @__alloc(i64 24, i32 2)
  %t128 = inttoptr i64 39 to ptr
  ...
  %t131 = getelementptr ptr, ptr %t127, i32 2
  store ptr %t110, ptr %t131
  call void @__free_recursive(ptr %t5)
  br label %reuse.copy.end.126
reuse.copy.end.126:
  br label %reuse.join.124
reuse.join.124:
  %t132 = phi ptr [ %t5, %reuse.in_place.end.125 ], [ %t127, %reuse.copy.end.126 ]
  call void @__free_recursive(ptr %t6)
  store ptr %t112, ptr %t3
  store ptr %t132, ptr %t4
  br label %tco.loop.0
tco.case.arm.8.133:
