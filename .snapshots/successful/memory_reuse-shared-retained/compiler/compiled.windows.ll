...
case.join.16:
  ...
  %t46 = inttoptr i64 26 to ptr
  %t47 = getelementptr ptr, ptr %t45, i32 0
  store ptr %t46, ptr %t47
  %t48 = call ptr @v_$cps$$df$andThenIO$0(ptr %t5, ptr %t4, ptr %t45)
  call void @__free_recursive(ptr %t4)
  ret ptr %t48
}

define internal ptr @v_$cps$$df$andThenIO$0(ptr %v_io, ptr %v_$df$andThenIO$0$cap0$0, ptr %v_$k) {
entry:
  %t3 = alloca ptr
  store ptr %v_io, ptr %t3
  %t4 = alloca ptr
  store ptr %v_$df$andThenIO$0$cap0$0, ptr %t4
  %t5 = alloca ptr
...
case.arm.25.24:
  %t26 = getelementptr ptr, ptr %t7, i32 2
...
case.arm.25.35:
  %t37 = getelementptr ptr, ptr %t27, i32 1
...
case.default.31:
  unreachable
case.join.32:
  %t39 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.24.34 ], [ %t38, %case.end.25.36 ]
...
case.join.21:
  ...
  %t50 = call ptr @v_$apply$$df$andThenIO$0(ptr %t8, ptr %t14)
  call void @__free_recursive(ptr %t6)
