...
(module
  ...
  (func $v_unwrap (export "v_unwrap") (param $v_r i32) (result i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (block (result i32) (local.set $__scrut (i32.load offset=4 (local.get $__scrut))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (i32.load offset=4 (local.get $__scrut))) (else (i32.load offset=4 (local.get $__scrut)))))) (else (block (result i32) (local.set $__scrut (i32.load offset=4 (local.get $__scrut))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 0)) (then (i32.load offset=4 (local.get $__scrut))) (else (i32.load offset=4 (local.get $__scrut)))))))))
