...
case.join.31:
  ...
  %t47 = getelementptr ptr, ptr %t12, i32 2
  store ptr %t40, ptr %t47
  %t48 = call ptr @v_$apply$$df$andThenIO$4(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
  store ptr %t48, ptr %t2
  br label %tco.exit.1
...
case.join.32:
  ...
  %t50 = call ptr @v_$apply$$df$andThenIO$8(ptr %t6, ptr %t12)
  call void @__free_recursive(ptr %t5)
  call void @__free_recursive(ptr %t6)
