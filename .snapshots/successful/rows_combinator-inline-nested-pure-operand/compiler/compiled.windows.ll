...
define internal ptr @v_cPure(ptr %v_n) {
...
case.arm.3.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 348914022, label %case.arm.348914022.11 i64 365691641, label %case.arm.365691641.14 ]
case.arm.348914022.11:
...
define internal ptr @v__lam_18(ptr %v__m) {
  %t0 = call ptr @__alloc(i64 16, i32 1)
  %t1 = inttoptr i64 3 to ptr
  %t2 = getelementptr ptr, ptr %t0, i32 0
  store ptr %t1, ptr %t2
  %t3 = call ptr @__alloc(i64 16, i32 1)
  %t4 = inttoptr i64 365691641 to ptr
  ...
  call void @__free_recursive(ptr %v__m)
  ret ptr %t0
}

define internal ptr @v__lam_19(ptr %v__n) {
  %t0 = call ptr @v_ob()
  %t1 = call ptr @v__df__rowmono_1_bindEither_1(ptr %t0)
...
define internal ptr @v__df__rowmono_1_bindEither_1(ptr %v_x) {
  %t0 = getelementptr ptr, ptr %v_x, i32 0
  %t1 = load ptr, ptr %t0
  %t2 = ptrtoint ptr %t1 to i64
