...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [1 x i8]} { i32 0, i32 0, i32 0, i32 1, i32 1, [1 x i8] c"C" }
...
case.arm.4.15:
  ...
  %t21 = inttoptr i64 365691641 to ptr
...
case.default.11:
  unreachable
case.join.12:
  %t28 = phi ptr [ %t3, %case.end.3.14 ], [ %t17, %case.end.4.16 ]
  call void @__free_recursive(ptr %t3)
  %t29 = getelementptr ptr, ptr %t28, i32 0
  %t30 = load ptr, ptr %t29
  %t31 = ptrtoint ptr %t30 to i64
  switch i64 %t31, label %case.default.32 [ i64 3, label %case.arm.3.34 i64 4, label %case.arm.4.46 ]
case.arm.3.34:
  ...
  switch i64 %t40, label %case.default.41 [ i64 365691641, label %case.arm.365691641.43 ]
case.arm.365691641.43:
  br label %case.end.365691641.44
case.end.365691641.44:
  br label %case.join.42
case.default.41:
  unreachable
case.join.42:
  %t45 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.365691641.44 ]
...
case.default.32:
  unreachable
case.join.33:
  %t51 = phi ptr [ %t45, %case.end.3.35 ], [ %t50, %case.end.4.47 ]
  call void @__free_recursive(ptr %t28)
  %t52 = getelementptr ptr, ptr %t0, i32 1
  ...
  %t60 = getelementptr ptr, ptr %t0, i32 2
