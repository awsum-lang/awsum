...
(() => {
  ...
  const v__lam_13 = v__m => [3, [365691641, [26]]];
  ...
  const v__lam_14 = v__n => v__df__rowmono_1_bindEither_1(v_ob);
  ...
  const v_cPure = v_n => v__df__rowmono_0_bindEither_0(v_pureEither(v_n));
