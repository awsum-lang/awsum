...
(module
  ...
  (data (i32.const 82) "left: \00")
  (data (i32.const 89) "right: \00")
  (table 6 funcref)
  (elem (i32.const 0) $v_showUnderflowError $v_countDown $v__cps_countDown $v__apply_countDown $v_showResult $v_main)
