...
(module
  ...
  (table 8 funcref)
  (elem (i32.const 0) $v_runIO $v_showUnderflowError $v_countDown $v__cps_countDown $v__apply_countDown $v_showResult $v__lift_13 $v__let_14)
  ...
  (func $v_countDown (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    block (result i32)
