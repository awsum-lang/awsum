...
(module
  ...
  (global $heap (mut i32) (i32.const 227))
  ...
  (data (i32.const 118) "\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00,")
  ...
  (table 7 funcref)
  (elem (i32.const 0) $v_runIO $v_showUnderflowError $v_countDown $v__cps_countDown $v__apply_countDown $v_showResult $v__let_7)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_countDown (param $v_n i32) (result i32)
    (local $__con_0 i32)
    (local $__drop_tmp i32)
    (call $v__cps_countDown (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 16)) (local.get $__con_0))))
  ...
  (func $v__apply_countDown (param $v__k i32) (param $v__x i32) (result i32)
    ...
    (local $__k0 i32)
    (local $__k1 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (local.get $v__k)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 16)) (then (block (result i32) (local.set $__drop_tmp (local.get $v__x)) (call $__free_recursive (local.get $v__k)) (local.get $__drop_tmp))) (else (local.set $v__pk_17 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v__pk_17)) (local.set $v_n (i32.load offset=8 (local.get $__scrut))) (call $__inc_ref (local.get $v_n)) (block (result i32) (local.set $__scrut (local.get $v__x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (local.set $__k0 (local.get $v__pk_17)) (local.set $__k1 (if (result i32) (i32.eq (i32.load (i32.sub (local.get $v__x) (i32.const 8))) (i32.const 1)) (then (block (result i32) (call $__free_recursive (i32.load offset=4 (local.get $v__x))) (i32.store (local.get $v__x) (i32.const 3)) (i32.store offset=4 (local.get $v__x) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $v__x))) (local.get $v__x))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (call $__free_recursive (local.get $v__x)) (local.get $__con_0))))) (call $__inc_ref (local.get $__k0)) (call $__free_recursive (local.get $v__k)) (call $__free_recursive (local.get $v_e)) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v__pk_17)) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top)) (else (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s)) (block (result i32) (local.set $__scrut (call $__concat (call $__show_i32 (block (result i32) (local.set $__inc_tmp (local.get $v_n)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))) (i32.const 130))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (local.set $__k0 (local.get $v__pk_17)) (local.set $__k1 (if (result i32) (i32.eq (i32.load (i32.sub (local.get $v__x) (i32.const 8))) (i32.const 1)) (then (block (result i32) (call $__free_recursive (i32.load offset=4 (local.get $v__x))) (i32.store (local.get $v__x) (i32.const 3)) (i32.store offset=4 (local.get $v__x) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 589989748)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_0))) (local.get $__con_0))) (local.get $v__x))) (else (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 589989748)) (i32.store offset=4 (local.get $__con_1) (local.get $v_e)) (call $__inc_ref (i32.load offset=4 (local.get $__con_1))) (local.get $__con_1))) (call $__free_recursive (local.get $v__x)) (local.get $__con_0))))) (call $__inc_ref (local.get $__k0)) (call $__free_recursive (local.get $v__k)) (call $__free_recursive (local.get $v_e)) (call $__free_recursive (local.get $v_s)) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v__pk_17)) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top)) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s0)) (local.set $__k0 (local.get $v__pk_17)) (local.set $__k1 (call $__concat (block (result i32) (local.set $__inc_tmp (local.get $v_s0)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)) (block (result i32) (local.set $__inc_tmp (local.get $v_s)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__inc_ref (local.get $__k0)) (call $__free_recursive (local.get $v__x)) (call $__free_recursive (local.get $v__k)) (call $__free_recursive (local.get $v_s0)) (call $__free_recursive (local.get $v_s)) (call $__free_recursive (local.get $v_n)) (call $__free_recursive (local.get $v__pk_17)) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top))))))))))))
  ...
  (func $v_showResult (param $v_r i32) (result i32)
    ...
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_e)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v_e)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 589989748)) (then (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___rw)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___rw)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 151)) (local.get $__con_0)))) (call $__free_recursive (local.get $v___rw)) (local.get $__drop_tmp))) (else (local.set $v_u (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_u)) (block (result i32) (local.set $__drop_tmp (call $__concat (i32.const 186) (call $v_showUnderflowError (block (result i32) (local.set $__inc_tmp (local.get $v_u)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp))))) (call $__free_recursive (local.get $v_u)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v_e)) (local.get $__drop_tmp))) (else (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_s)) (block (result i32) (local.set $__drop_tmp (call $__concat (i32.const 212) (block (result i32) (local.set $__inc_tmp (local.get $v_s)) (call $__inc_ref (local.get $__inc_tmp)) (local.get $__inc_tmp)))) (call $__free_recursive (local.get $v_s)) (local.get $__drop_tmp))))))

  (func $v_main (result i32)
    (local $__drop_tmp i32)
    (call $v__let_7 (call $v_showResult (call $v_countDown (call $__box_i32 (i32.const 255))))))
