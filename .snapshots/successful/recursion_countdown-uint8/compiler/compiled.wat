...
(module
  ...
  (global $heap (mut i32) (i32.const 155))
  (data (i32.const 64) "\00\00\00\00\00\00\00\00")
  (data (i32.const 72) "\0e\00\00\00\0e\00\00\00UnderflowError")
  (data (i32.const 94) "\01\00\00\00\01\00\00\00,")
  (data (i32.const 103) "\0f\00\00\00\0f\00\00\00STRING_TOO_LONG")
  (data (i32.const 126) "\06\00\00\00\06\00\00\00left: ")
  (data (i32.const 140) "\07\00\00\00\07\00\00\00right: ")
  (table 7 funcref)
  ...
  (func $v_countDown (param $v_n i32) (result i32)
    (local $__con_0 i32)
    (call $v__cps_countDown (local.get $v_n) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 4))) (i32.const 16)) (local.get $__con_0))))
  ...
  (func $v__cps_countDown (param $v_n i32) (param $v__k i32) (result i32)
    ...
    (local $__k0 i32)
    (local $__k1 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (call $__eq_i32 (local.get $v_n) (call $__box_i32 (i32.const 0)))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 1)) (then (call $v__apply_countDown (local.get $v__k) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (call $__show_i32 (local.get $v_n))) (local.get $__con_0)))) (else (block (result i32) (local.set $__scrut (call $__predUInt8 (local.get $v_n))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (call $v__apply_countDown (local.get $v__k) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 3768445577)) (i32.store offset=4 (local.get $__con_1) (local.get $v_e)) (local.get $__con_1))) (local.get $__con_0)))) (else (local.set $v_m (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (local.get $v_m)) (local.set $__k1 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 17)) (i32.store offset=4 (local.get $__con_0) (local.get $v__k)) (i32.store offset=8 (local.get $__con_0) (local.get $v_n)) (local.get $__con_0))) (local.set $v_n (local.get $__k0)) (local.set $v__k (local.get $__k1)) (br $tco_top)))))))))
  ...
  (func $v__apply_countDown (param $v__k i32) (param $v__x i32) (result i32)
    ...
    (local $__k0 i32)
    (local $__k1 i32)
    (loop $tco_top (result i32) (block (result i32) (local.set $__scrut (local.get $v__k)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 16)) (then (local.get $v__x)) (else (local.set $v__pk_17 (i32.load offset=4 (local.get $__scrut))) (local.set $v_n (i32.load offset=8 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v__x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (local.get $v__pk_17)) (local.set $__k1 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (local.get $v_e)) (local.get $__con_0))) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top)) (else (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (call $__concat (call $__show_i32 (local.get $v_n)) (i32.const 94))) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (local.get $v__pk_17)) (local.set $__k1 (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 3)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 589989748)) (i32.store offset=4 (local.get $__con_1) (local.get $v_e)) (local.get $__con_1))) (local.get $__con_0))) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top)) (else (local.set $v_s0 (i32.load offset=4 (local.get $__scrut))) (local.set $__k0 (local.get $v__pk_17)) (local.set $__k1 (call $__concat (local.get $v_s0) (local.get $v_s))) (local.set $v__k (local.get $__k0)) (local.set $v__x (local.get $__k1)) (br $tco_top))))))))))))
  ...
  (func $v_showResult (param $v_r i32) (result i32)
    ...
    (local $v_u i32)
    (local $__scrut i32)
    (block (result i32) (local.set $__scrut (local.get $v_r)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 3)) (then (local.set $v_e (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v_e)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 589989748)) (then (local.set $v___rw (i32.load offset=4 (local.get $__scrut))) (block (result i32) (local.set $__scrut (local.get $v___rw)) (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 8))) (i32.const 4)) (i32.store offset=4 (local.get $__con_0) (i32.const 103)) (local.get $__con_0)))) (else (local.set $v_u (i32.load offset=4 (local.get $__scrut))) (call $__concat (i32.const 126) (call $v_showUnderflowError (local.get $v_u))))))) (else (local.set $v_s (i32.load offset=4 (local.get $__scrut))) (call $__concat (i32.const 140) (local.get $v_s))))))
