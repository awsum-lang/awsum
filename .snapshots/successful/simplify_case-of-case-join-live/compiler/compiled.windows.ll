...
@.str.1 = private unnamed_addr constant {i32, i32, i32, i32, i32, [5 x i8]} { i32 0, i32 0, i32 0, i32 5, i32 5, [5 x i8] c"other" }
...
case.default.22:
  unreachable
case.join.23:
  %t28 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.1.25 ], [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %case.end.2.27 ]
  call void @__free_recursive(ptr %t18)
  br label %join.end.29
join.end.29:
  br label %join.after.4
join.after.4:
  %t30 = phi ptr [ getelementptr inbounds (i8, ptr @.str.1, i64 12), %join.val.13 ], [ %t28, %join.end.29 ]
