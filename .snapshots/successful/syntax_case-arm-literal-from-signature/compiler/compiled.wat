...
(module
  ...
  (table 3 funcref)
  (elem (i32.const 0) $v_runIO $v_firstZero $v__lift_12)
...
;;     at block + 12 and we want to write at block + 8).
  ...
  (func $v_firstZero (param $v_x i32) (result i32)
    (local $v___p0 i32)
    (local $v_n i32)
    (local $__scrut i32)
    (local $__drop_tmp i32)
    (block (result i32) (local.set $__scrut (local.get $v_x)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 10)) (then (call $__box_i32 (i32.const 0))) (else (local.set $v___p0 (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v___p0)) (block (result i32) (local.set $__drop_tmp (block (result i32) (local.set $__scrut (local.get $v___p0)) (if (result i32) (i32.eq (i32.load (local.get $__scrut)) (i32.const 10)) (then (call $__box_i32 (i32.const 0))) (else (local.set $v_n (i32.load offset=4 (local.get $__scrut))) (call $__inc_ref (local.get $v_n)) (block (result i32) (local.set $__drop_tmp (local.get $v_n)) (call $__inc_ref (local.get $__drop_tmp)) (call $__free_recursive (local.get $v_n)) (local.get $__drop_tmp)))))) (call $__free_recursive (local.get $v___p0)) (local.get $__drop_tmp))))))
  ...
  (func $v_main (result i32)
    ...
    (local $__con_2 i32)
    (local $__drop_tmp i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc_shaped (i32.const 12) (i32.const 2))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (call $__show_i32 (call $v_firstZero (call $v__lift_12 (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 10)) (local.get $__con_1)))))) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc_shaped (i32.const 8) (i32.const 1))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc_shaped (i32.const 4) (i32.const 0))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0)))
