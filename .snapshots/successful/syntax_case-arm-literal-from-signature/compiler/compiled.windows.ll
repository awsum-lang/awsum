...
define internal ptr @v_firstZero(ptr %v_x) {
  ...
  switch i64 %t2, label %case.default.3 [ i64 9, label %case.arm.9.4 i64 10, label %case.arm.10.6 ]
case.arm.9.4:
...
case.arm.10.6:
  ...
  switch i64 %t11, label %case.default.12 [ i64 9, label %case.arm.9.13 i64 10, label %case.arm.10.15 ]
case.arm.9.13:
