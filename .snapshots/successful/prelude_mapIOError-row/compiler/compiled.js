...
(() => {
        ...
        switch (__s[0]) {
          case 5: {
            ...
            return v__apply__df_andThenIO_36(
              v__k,
              v__lift_1(v__lam_48(v__df_andThenIO_36_cap0_0, v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
  ...
  const v_line = (v_label, v_act) => {
    return v__df_andThenIO_32(
      v__df_andThenIO_36(
        v__df_andThenIO_40(v__lift_50([7, v_label, [5, [0]]])),
        v_act
      )
    );
  };
    ...
    while (true) {
      {
        ...
        switch (__s[0]) {
          case 5: {
            const v_a = __s[1];
            return v__apply__df__rowspec_35_28(
              v__k,
              v__lift_36(v__bi_IO_Stdout_print(v_a))
            );
          }
          case 6: {
            const v_e = __s[1];
  ...
  const v_observeABC = (v_io) => {
    return v__df_handleErrorIO_24(
      v__df__rowspec_35_28(v__lift_40(v__df_mapIO_20(v_io)))
    );
  };
  ...
  const main = v__df_andThenIO_44(
    v__df_andThenIO_48(
      v__df_andThenIO_52(
        v__df_andThenIO_56(
          v__lift_50(v_line("mappedA", v_observeAB(v_mappedA)))
        )
      )
    )
  );
