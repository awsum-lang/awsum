...
@.str.5 = private unnamed_addr constant {i32, i32, i32, i32, i32, [9 x i8]} { i32 0, i32 0, i32 0, i32 9, i32 9, [9 x i8] c"overflow2" }
@.str.6 = private unnamed_addr constant {i32, i32, i32, i32, i32, [2 x i8]} { i32 0, i32 0, i32 0, i32 2, i32 2, [2 x i8] c"no" }
...
define internal ptr @v_main() {
  ...
  switch i64 %t8, label %case.default.9 [ i64 1, label %case.arm.1.11 i64 2, label %case.arm.2.13 ]
case.arm.1.11:
...
case.default.9:
  unreachable
case.join.10:
  %t18 = phi ptr [ %t5, %case.end.1.12 ], [ %t15, %case.end.2.14 ]
  %t19 = getelementptr ptr, ptr %t18, i32 0
  %t20 = load ptr, ptr %t19
  %t21 = ptrtoint ptr %t20 to i64
  switch i64 %t21, label %case.default.22 [ i64 1, label %case.arm.1.24 i64 2, label %case.arm.2.52 ]
case.arm.1.24:
  %t26 = call ptr @__concat(ptr getelementptr inbounds (i8, ptr @.str.1, i64 12), ptr getelementptr inbounds (i8, ptr @.str.2, i64 12))
...
case.arm.4.34:
  ...
  call void @__inc_ref(ptr %t37)
  %t38 = call ptr @__concat(ptr %t37, ptr getelementptr inbounds (i8, ptr @.str.4, i64 12))
...
case.default.42:
  unreachable
case.join.43:
  %t50 = phi ptr [ getelementptr inbounds (i8, ptr @.str.5, i64 12), %case.end.3.45 ], [ %t49, %case.end.4.47 ]
...
case.default.30:
  unreachable
case.join.31:
  %t51 = phi ptr [ getelementptr inbounds (i8, ptr @.str.3, i64 12), %case.end.3.33 ], [ %t50, %case.end.4.35 ]
  call void @__free_recursive(ptr %t26)
  br label %case.end.1.25
case.end.1.25:
  br label %case.join.23
case.arm.2.52:
  br label %case.end.2.53
case.end.2.53:
  br label %case.join.23
case.default.22:
  unreachable
case.join.23:
  %t54 = phi ptr [ %t51, %case.end.1.25 ], [ getelementptr inbounds (i8, ptr @.str.6, i64 12), %case.end.2.53 ]
