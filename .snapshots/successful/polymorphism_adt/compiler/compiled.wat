...
(module
  ...
  (func $v_main (result i32)
    ...
    (local $__con_2 i32)
    (local $v_v i32)
    (block (result i32) (i32.store (local.tee $__con_0 (call $__alloc (i32.const 12))) (i32.const 7)) (i32.store offset=4 (local.get $__con_0) (block (result i32) (local.set $__scrut (call $v_identity (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 19)) (i32.store offset=4 (local.get $__con_1) (i32.const 72)) (local.get $__con_1)))) (local.set $v_v (i32.load offset=4 (local.get $__scrut))) (local.get $v_v))) (i32.store offset=8 (local.get $__con_0) (block (result i32) (i32.store (local.tee $__con_1 (call $__alloc (i32.const 8))) (i32.const 5)) (i32.store offset=4 (local.get $__con_1) (block (result i32) (i32.store (local.tee $__con_2 (call $__alloc (i32.const 4))) (i32.const 0)) (local.get $__con_2))) (local.get $__con_1))) (local.get $__con_0)))
