...
@.str.0 = private unnamed_addr constant {i32, i32, i32, i32, i32, [13 x i8]} { i32 0, i32 0, i32 0, i32 13, i32 13, [13 x i8] c"StringTooLong" }
...
define internal ptr @v_showStringTooLong(ptr %v__wild0) {
...
define internal ptr @v_main() {
  ...
  store ptr %t4, ptr %t5
  %t6 = call ptr @v_showStringTooLong(ptr %t3)
