...
define internal ptr @v_inner(ptr %v__z) {
  %t0 = call ptr @__alloc(i64 16, i32 1)
  ...
  store ptr %t3, ptr %t6
  call void @__free_recursive(ptr %v__z)
  ret ptr %t0
}
...
case.arm.3.4:
  ...
  switch i64 %t9, label %case.default.10 [ i64 332136403, label %case.arm.332136403.11 i64 365691641, label %case.arm.365691641.14 ]
