...
(module
  ...
  (table 8 funcref)
  (elem (i32.const 0) $v_pureEither $v_runIO $v_inner $v_describe $v__lam_13 $v__lift_14 $v__df__rowmono_0_bindEither_0 $v__df__rowmono_1_bindEither_1)
  ...
  (func $v_inner (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
  ...
  (func $v__df__rowmono_1_bindEither_1 (param i32) (result i32)
    (local i32)
    (local i32)
    (local i32)
    (local i32)
