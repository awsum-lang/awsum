...
define internal ptr @v_main() {
  ...
  switch i64 %t8, label %case.default.9 [ i64 11, label %case.arm.11.11 i64 12, label %case.arm.12.13 ]
case.arm.11.11:
...
case.join.23:
  ...
  br label %case.end.12.14
case.end.12.14:
  br label %case.join.10
case.default.9:
  unreachable
case.join.10:
  %t29 = phi ptr [ getelementptr inbounds (i8, ptr @.str.0, i64 12), %case.end.11.12 ], [ %t28, %case.end.12.14 ]
  ...
  %t38 = getelementptr ptr, ptr %t0, i32 2
