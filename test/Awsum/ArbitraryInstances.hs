...
instance Arbitrary Expr where
  ...
  shrink = \case
    ...
    -- Lambdas and 'do' blocks aren't generated by 'arbitrary' yet —
    -- shrink them down to the inner expression(s) so other shrinkers
    -- still terminate when one creeps in via a smart constructor.
